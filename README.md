...
* JavaScript, CSS, and web component - We build the JavaScript and CSS bundles that power the Pulumi Registry here under `themes/default/theme` directory. If you are making styling changes along-side content changes here, use `make serve-all` to enable hot reloading of both the pages and CSS/JS assets.
