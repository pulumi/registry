...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">pulumi:providers:aiven</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apitoken_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Token</a>
    ...
    <dd><p>Aiven Authentication Token</p>
</dd></dl>
</pulumi-choosable>
</div>
