...
<span class="k">def </span><span class="nx">Certificate</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">validation_options</span><span class="p">:</span> <span class="nx">Optional[Sequence[CertificateValidationOptionArgs]]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:acm:Certificate</span><span class="p"></span>
...
```java
var certificateResource = new com.pulumi.aws.acm.Certificate("certificateResource", com.pulumi.aws.acm.CertificateArgs.builder()
    .certificateAuthorityArn("string")
    .certificateBody("string")
    .certificateChain("string")
    .domainName("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificateauthorityarn_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authority<wbr>Arn</a>
    ...
    <dd>ARN of an ACM PCA</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatebody_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Body</a>
    ...
    <dd>Certificate's PEM-formatted public key</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatechain_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Chain</a>
    ...
    <dd>Certificate's PEM-formatted chain</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#domainname_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Name</a>
    ...
    <dd>Fully qualified domain name (FQDN) in the certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#earlyrenewalduration_csharp" style="color: inherit; text-decoration: inherit;">Early<wbr>Renewal<wbr>Duration</a>
    ...
    <dd>Amount of time to start automatic renewal process before expiration.
...
or a string such as <code>2160h</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#keyalgorithm_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Algorithm</a>
    ...
    <dd>Specifies the algorithm of the public and private key pair that your Amazon issued certificate uses to encrypt data. See <a href="https://docs.aws.amazon.com/acm/latest/userguide/acm-certificate.html#algorithms">ACM Certificate characteristics</a> for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
    ...
    <dd>Configuration block used to set certificate options. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatekey_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Key</a>
    ...
    <dd>Certificate's PEM-formatted private key</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subjectalternativenames_csharp" style="color: inherit; text-decoration: inherit;">Subject<wbr>Alternative<wbr>Names</a>
    ...
    <dd>Set of domains that should be SANs in the issued certificate.  To remove all elements of a previously configured list, set this value equal to an empty list (<code>[]</code>).</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationmethod_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Method</a>
    ...
    <dd>Which method to use for validation. <code>DNS</code> or <code>EMAIL</code> are valid. This parameter must not be set for certificates that were imported into ACM and then into Pulumi.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationoptions_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatevalidationoption">List&lt;Certificate<wbr>Validation<wbr>Option&gt;</a></span>
    </dt>
    <dd>Configuration block used to specify information about the initial validation of each domain name. Detailed below.</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationoptions_nodejs" style="color: inherit; text-decoration: inherit;">validation<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatevalidationoption">Certificate<wbr>Validation<wbr>Option[]</a></span>
    </dt>
    <dd>Configuration block used to specify information about the initial validation of each domain name. Detailed below.</p>
<ul>
<li>Importing an existing certificate</li>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#domainvalidationoptions_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Validation<wbr>Options</a>
    ...
    <dd>Set of domain validation objects which can be used to complete certificate validation.
Can have more than one element, e.g., if SANs are defined.
Only set if <code>DNS</code>-validation was used.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#notafter_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>After</a>
    ...
    <dd>Expiration date and time of the certificate.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#notbefore_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>Before</a>
    ...
    <dd>Start of the validity period of the certificate.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pendingrenewal_csharp" style="color: inherit; text-decoration: inherit;">Pending<wbr>Renewal</a>
    ...
    <dd><code>true</code> if a Private certificate eligible for managed renewal is within the <code>early_renewal_duration</code> period.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#renewaleligibility_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Eligibility</a>
    ...
    <dd>Whether the certificate is eligible for managed renewal.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#renewalsummaries_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Summaries</a>
    ...
    <dd>Contains information about the status of ACM's <a href="https://docs.aws.amazon.com/acm/latest/userguide/acm-renewal.html">managed renewal</a> for the certificate.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Status of the certificate.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>Source of the certificate.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationemails_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Emails</a>
    ...
    <dd>List of addresses that received a validation email. Only set if <code>EMAIL</code> validation was used.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:acm:Certificate</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_domainvalidationoptions_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Validation<wbr>Options</a>
    ...
    <dd>Set of domain validation objects which can be used to complete certificate validation.
Can have more than one element, e.g., if SANs are defined.
Only set if <code>DNS</code>-validation was used.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_notafter_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>After</a>
    ...
    <dd>Expiration date and time of the certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_notbefore_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>Before</a>
    ...
    <dd>Start of the validity period of the certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_pendingrenewal_csharp" style="color: inherit; text-decoration: inherit;">Pending<wbr>Renewal</a>
    ...
    <dd><code>true</code> if a Private certificate eligible for managed renewal is within the <code>early_renewal_duration</code> period.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_privatekey_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Key</a>
    ...
    <dd>Certificate's PEM-formatted private key</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_renewaleligibility_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Eligibility</a>
    ...
    <dd>Whether the certificate is eligible for managed renewal.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_renewalsummaries_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Summaries</a>
    ...
    <dd>Contains information about the status of ACM's <a href="https://docs.aws.amazon.com/acm/latest/userguide/acm-renewal.html">managed renewal</a> for the certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Status of the certificate.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>Source of the certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_validationemails_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Emails</a>
    ...
    <dd>List of addresses that received a validation email. Only set if <code>EMAIL</code> validation was used.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="certificatedomainvalidationoption">
Certificate<wbr>Domain<wbr>Validation<wbr>Option<pulumi-choosable type="language" values="python,go" class="inline">, Certificate<wbr>Domain<wbr>Validation<wbr>Option<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcerecordname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Record<wbr>Name</a>
    ...
    <dd>The name of the DNS record to create to validate the certificate</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcerecordtype_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Record<wbr>Type</a>
    ...
    <dd>The type of DNS record to create</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcerecordvalue_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Record<wbr>Value</a>
    ...
    <dd>The value the DNS record needs to have</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="certificateoptions">
Certificate<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Certificate<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatetransparencyloggingpreference_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Transparency<wbr>Logging<wbr>Preference</a>
    ...
    <dd>Whether certificate details should be added to a certificate transparency log. Valid values are <code>ENABLED</code> or <code>DISABLED</code>. See https://docs.aws.amazon.com/acm/latest/userguide/acm-concepts.html#concept-transparency for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="certificaterenewalsummary">
Certificate<wbr>Renewal<wbr>Summary<pulumi-choosable type="language" values="python,go" class="inline">, Certificate<wbr>Renewal<wbr>Summary<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#renewalstatus_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Status</a>
    ...
    <dd>The status of ACM's managed renewal of the certificate</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#renewalstatusreason_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Status<wbr>Reason</a>
    ...
    <dd>The reason that a renewal request was unsuccessful or is pending</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="certificatevalidationoption">
Certificate<wbr>Validation<wbr>Option<pulumi-choosable type="language" values="python,go" class="inline">, Certificate<wbr>Validation<wbr>Option<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#domainname_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Name</a>
    ...
    <dd>Fully qualified domain name (FQDN) in the certificate.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationdomain_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Domain</a>
    ...
    <dd>Domain name that you want ACM to use to send you validation emails. This domain name is the suffix of the email addresses that you want ACM to use. This must be the same as the <code>domain_name</code> value or a superdomain of the <code>domain_name</code> value. For example, if you request a certificate for <code>&quot;testing.example.com&quot;</code>, you can specify <code>&quot;example.com&quot;</code> for this value.</dd></dl>
</pulumi-choosable>
</div>
