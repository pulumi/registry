...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetCertificateAuthorityResult</a></span>> </span>getCertificateAuthority<span class="p">(</span><span class="nx">GetCertificateAuthorityArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of user-defined tags that are attached to the certificate authority.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#revocationconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Revocation<wbr>Configurations</a>
    ...
    <dd>Nested attribute containing revocation configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serial_csharp" style="color: inherit; text-decoration: inherit;">Serial</a>
    ...
    <dd>Serial number of the certificate authority. Only available after the certificate authority certificate has been imported.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Status of the certificate authority.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
    ...
    <dd>Key-value map of user-defined tags that are attached to the certificate authority.</dd><dt class="property-"
            title="">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>Type of the certificate authority.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usagemode_csharp" style="color: inherit; text-decoration: inherit;">Usage<wbr>Mode</a>
    ...
    <dd>Specifies whether the CA issues general-purpose certificates that typically require a revocation mechanism, or short-lived certificates that may optionally omit revocation because they expire quickly.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#crlconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Crl<wbr>Configurations</a>
    ...
    <dd>Nested attribute containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customcname_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Cname</a>
    ...
    <dd>Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Boolean value that specifies whether certificate revocation lists (CRLs) are enabled.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expirationindays_csharp" style="color: inherit; text-decoration: inherit;">Expiration<wbr>In<wbr>Days</a>
    ...
    <dd>Number of days until a certificate expires.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3bucketname_csharp" style="color: inherit; text-decoration: inherit;">S3Bucket<wbr>Name</a>
    ...
    <dd>Name of the S3 bucket that contains the CRL.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3objectacl_csharp" style="color: inherit; text-decoration: inherit;">S3Object<wbr>Acl</a>
    ...
    <dd>Whether the CRL is publicly readable or privately held in the CRL Amazon S3 bucket.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="getcertificateauthorityrevocationconfigurationocspconfiguration">Get<wbr>Certificate<wbr>Authority<wbr>Revocation<wbr>Configuration<wbr>Ocsp<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Boolean value that specifies whether a custom OCSP responder is enabled.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ocspcustomcname_csharp" style="color: inherit; text-decoration: inherit;">Ocsp<wbr>Custom<wbr>Cname</a>
    ...
    <dd>A CNAME specifying a customized OCSP domain.</dd></dl>
</pulumi-choosable>
</div>
