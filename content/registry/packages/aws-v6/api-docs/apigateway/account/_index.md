...
<span class="k">def </span><span class="nx">Account</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">reset_on_delete</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:apigateway:Account</span><span class="p"></span>
...
```csharp
var accountResource = new Aws.ApiGateway.Account("accountResource", new()
{
...
```go
example, err := apigateway.NewAccount(ctx, "accountResource", &apigateway.AccountArgs{
...
```java
var accountResource = new com.pulumi.aws.apigateway.Account("accountResource", com.pulumi.aws.apigateway.AccountArgs.builder()
    .cloudwatchRoleArn("string")
    .build());
```
...
```python
account_resource = aws.apigateway.Account("accountResource", cloudwatch_role_arn="string")
```
...
```typescript
const accountResource = new aws.apigateway.Account("accountResource", {cloudwatchRoleArn: "string"});
```
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchrolearn_csharp" style="color: inherit; text-decoration: inherit;">Cloudwatch<wbr>Role<wbr>Arn</a>
    ...
    <dd>ARN of an IAM role for CloudWatch (to allow logging &amp; monitoring). See more <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-stage-settings.html#how-to-stage-settings-console">in AWS Docs</a>. Logging &amp; monitoring can be enabled/disabled and otherwise tuned on the API Gateway Stage level.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="resetondelete_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resetondelete_csharp" style="color: inherit; text-decoration: inherit;">Reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>If <code>true</code>, destroying the resource will reset account settings to default, otherwise account settings are not modified.
Defaults to <code>false</code>.
Will be removed in a future major version of the provider.<p class="property-message">Deprecated: The &quot;reset_on_delete&quot; attribute will be removed in a future version of the provider</p></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resetondelete_go" style="color: inherit; text-decoration: inherit;">Reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchrolearn_java" style="color: inherit; text-decoration: inherit;">cloudwatch<wbr>Role<wbr>Arn</a>
    ...
    <dd>ARN of an IAM role for CloudWatch (to allow logging &amp; monitoring). See more <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-stage-settings.html#how-to-stage-settings-console">in AWS Docs</a>. Logging &amp; monitoring can be enabled/disabled and otherwise tuned on the API Gateway Stage level.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="resetondelete_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resetondelete_java" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resetondelete_nodejs" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reset_on_delete_python" style="color: inherit; text-decoration: inherit;">reset_<wbr>on_<wbr>delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchrolearn_yaml" style="color: inherit; text-decoration: inherit;">cloudwatch<wbr>Role<wbr>Arn</a>
    ...
    <dd>ARN of an IAM role for CloudWatch (to allow logging &amp; monitoring). See more <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-stage-settings.html#how-to-stage-settings-console">in AWS Docs</a>. Logging &amp; monitoring can be enabled/disabled and otherwise tuned on the API Gateway Stage level.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="resetondelete_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resetondelete_yaml" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apikeyversion_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Key<wbr>Version</a>
    ...
    <dd>The version of the API keys used for the account.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#features_csharp" style="color: inherit; text-decoration: inherit;">Features</a>
    ...
    <dd>A list of features supported for the account.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#throttlesettings_csharp" style="color: inherit; text-decoration: inherit;">Throttle<wbr>Settings</a>
    ...
    <dd>Account-Level throttle settings. See exported fields below.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:apigateway:Account</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_apikeyversion_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Key<wbr>Version</a>
    ...
    <dd>The version of the API keys used for the account.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_features_csharp" style="color: inherit; text-decoration: inherit;">Features</a>
    ...
    <dd>A list of features supported for the account.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="state_resetondelete_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resetondelete_csharp" style="color: inherit; text-decoration: inherit;">Reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>If <code>true</code>, destroying the resource will reset account settings to default, otherwise account settings are not modified.
Defaults to <code>false</code>.
Will be removed in a future major version of the provider.<p class="property-message">Deprecated: The &quot;reset_on_delete&quot; attribute will be removed in a future version of the provider</p></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resetondelete_go" style="color: inherit; text-decoration: inherit;">Reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_features_java" style="color: inherit; text-decoration: inherit;">features</a>
    ...
    <dd>A list of features supported for the account.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="state_resetondelete_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resetondelete_java" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resetondelete_nodejs" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_reset_on_delete_python" style="color: inherit; text-decoration: inherit;">reset_<wbr>on_<wbr>delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_features_yaml" style="color: inherit; text-decoration: inherit;">features</a>
    ...
    <dd>A list of features supported for the account.</dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="state_resetondelete_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resetondelete_yaml" style="color: inherit; text-decoration: inherit;">reset<wbr>On<wbr>Delete</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<h4 id="accountthrottlesetting">
Account<wbr>Throttle<wbr>Setting<pulumi-choosable type="language" values="python,go" class="inline">, Account<wbr>Throttle<wbr>Setting<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#burstlimit_csharp" style="color: inherit; text-decoration: inherit;">Burst<wbr>Limit</a>
    ...
    <dd>Absolute maximum number of times API Gateway allows the API to be called per second (RPS).</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ratelimit_csharp" style="color: inherit; text-decoration: inherit;">Rate<wbr>Limit</a>
    ...
    <dd>Number of times API Gateway allows the API to be called per second on average (RPS).</dd></dl>
</pulumi-choosable>
</div>
