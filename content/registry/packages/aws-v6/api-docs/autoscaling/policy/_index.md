...
<span class="k">def </span><span class="nx">Policy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">target_tracking_configuration</span><span class="p">:</span> <span class="nx">Optional[PolicyTargetTrackingConfigurationArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:autoscaling:Policy</span><span class="p"></span>
...
```java
var examplepolicyResourceResourceFromAutoscalingpolicy = new com.pulumi.aws.autoscaling.Policy("examplepolicyResourceResourceFromAutoscalingpolicy", com.pulumi.aws.autoscaling.PolicyArgs.builder()
    .autoscalingGroupName("string")
    .minAdjustmentMagnitude(0)
    .cooldown(0)
    .enabled(false)
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalinggroupname_csharp" style="color: inherit; text-decoration: inherit;">Autoscaling<wbr>Group<wbr>Name</a>
    ...
    <dd>Name of the autoscaling group.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#estimatedinstancewarmup_csharp" style="color: inherit; text-decoration: inherit;">Estimated<wbr>Instance<wbr>Warmup</a>
    ...
    <dd>Estimated time, in seconds, until a newly launched instance will contribute CloudWatch metrics. Without a value, AWS will default to the group's specified cooldown period.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policytype_csharp" style="color: inherit; text-decoration: inherit;">Policy<wbr>Type</a>
    ...
    <dd>Policy type, either &quot;SimpleScaling&quot;, &quot;StepScaling&quot;, &quot;TargetTrackingScaling&quot;, or &quot;PredictiveScaling&quot;. If this value isn't provided, AWS will default to &quot;SimpleScaling.&quot;</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predictivescalingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Predictive<wbr>Scaling<wbr>Configuration</a>
    ...
    <dd>Predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scalingadjustment_csharp" style="color: inherit; text-decoration: inherit;">Scaling<wbr>Adjustment</a>
    ...
    <dd>Number of members by which to
scale, when the adjustment bounds are breached. A positive value scales
up. A negative value scales down.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policytype_yaml" style="color: inherit; text-decoration: inherit;">policy<wbr>Type</a>
    ...
    <dd>Policy type, either &quot;SimpleScaling&quot;, &quot;StepScaling&quot;, &quot;TargetTrackingScaling&quot;, or &quot;PredictiveScaling&quot;. If this value isn't provided, AWS will default to &quot;SimpleScaling.&quot;</dd><dt class="property-optional"
            title="Optional">
        <span id="predictivescalingconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predictivescalingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">predictive<wbr>Scaling<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfiguration">Property Map</a></span>
    </dt>
    <dd>Predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stepadjustments_yaml" style="color: inherit; text-decoration: inherit;">step<wbr>Adjustments</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policystepadjustment">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>Set of adjustments that manage
group scaling. These have the following structure:</p>
<!-- raw HTML omitted -->
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targettrackingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Tracking<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfiguration">Property Map</a></span>
    </dt>
    <dd><p>Target tracking policy. These have the following structure:</p>
<!-- raw HTML omitted -->
<pre><code class="language-typescript">import * as pulumi from &quot;@pulumi/pulumi&quot;;
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:autoscaling:Policy</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<p>The following argument is only available to &quot;SimpleScaling&quot; and &quot;StepScaling&quot; type policies:</p>
            ...
            title="Optional">
        <span id="state_estimatedinstancewarmup_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_estimatedinstancewarmup_java" style="color: inherit; text-decoration: inherit;">estimated<wbr>Instance<wbr>Warmup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
    <dd>Estimated time, in seconds, until a newly launched instance will contribute CloudWatch metrics. Without a value, AWS will default to the group's specified cooldown period.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_metricaggregationtype_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_metricaggregationtype_java" style="color: inherit; text-decoration: inherit;">metric<wbr>Aggregation<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Aggregation type for the policy's metrics. Valid values are &quot;Minimum&quot;, &quot;Maximum&quot;, and &quot;Average&quot;. Without a value, AWS will treat the aggregation type as &quot;Average&quot;.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minadjustmentmagnitude_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minadjustmentmagnitude_java" style="color: inherit; text-decoration: inherit;">min<wbr>Adjustment<wbr>Magnitude</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_policytype_java" style="color: inherit; text-decoration: inherit;">policy<wbr>Type</a>
    ...
    <dd>Policy type, either &quot;SimpleScaling&quot;, &quot;StepScaling&quot;, &quot;TargetTrackingScaling&quot;, or &quot;PredictiveScaling&quot;. If this value isn't provided, AWS will default to &quot;SimpleScaling.&quot;</dd><dt class="property-optional"
            title="Optional">
        <span id="state_predictivescalingconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_predictivescalingconfiguration_java" style="color: inherit; text-decoration: inherit;">predictive<wbr>Scaling<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfiguration">Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration</a></span>
    </dt>
    <dd>Predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_scalingadjustment_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scalingadjustment_java" style="color: inherit; text-decoration: inherit;">scaling<wbr>Adjustment</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
up. A negative value scales down.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_stepadjustments_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_stepadjustments_java" style="color: inherit; text-decoration: inherit;">step<wbr>Adjustments</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policystepadjustment">List&lt;Policy<wbr>Step<wbr>Adjustment&gt;</a></span>
    </dt>
...
<p>The following fields are available in step adjustments:</p>
            ...
            title="Optional">
        <span id="state_targettrackingconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_targettrackingconfiguration_java" style="color: inherit; text-decoration: inherit;">target<wbr>Tracking<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfiguration">Policy<wbr>Target<wbr>Tracking<wbr>Configuration</a></span>
    </dt>
...
<p>The following argument is only available to &quot;SimpleScaling&quot; and &quot;StepScaling&quot; type policies:</p>
            ...
            title="Optional">
        <span id="state_estimatedinstancewarmup_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_estimatedinstancewarmup_yaml" style="color: inherit; text-decoration: inherit;">estimated<wbr>Instance<wbr>Warmup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
    <dd>Estimated time, in seconds, until a newly launched instance will contribute CloudWatch metrics. Without a value, AWS will default to the group's specified cooldown period.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_metricaggregationtype_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_metricaggregationtype_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Aggregation<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Aggregation type for the policy's metrics. Valid values are &quot;Minimum&quot;, &quot;Maximum&quot;, and &quot;Average&quot;. Without a value, AWS will treat the aggregation type as &quot;Average&quot;.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minadjustmentmagnitude_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minadjustmentmagnitude_yaml" style="color: inherit; text-decoration: inherit;">min<wbr>Adjustment<wbr>Magnitude</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_policytype_yaml" style="color: inherit; text-decoration: inherit;">policy<wbr>Type</a>
    ...
    <dd>Policy type, either &quot;SimpleScaling&quot;, &quot;StepScaling&quot;, &quot;TargetTrackingScaling&quot;, or &quot;PredictiveScaling&quot;. If this value isn't provided, AWS will default to &quot;SimpleScaling.&quot;</dd><dt class="property-optional"
            title="Optional">
        <span id="state_predictivescalingconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_predictivescalingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">predictive<wbr>Scaling<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfiguration">Property Map</a></span>
    </dt>
    <dd>Predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_scalingadjustment_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scalingadjustment_yaml" style="color: inherit; text-decoration: inherit;">scaling<wbr>Adjustment</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
up. A negative value scales down.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_stepadjustments_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_stepadjustments_yaml" style="color: inherit; text-decoration: inherit;">step<wbr>Adjustments</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policystepadjustment">List&lt;Property Map&gt;</a></span>
    </dt>
...
<p>The following fields are available in step adjustments:</p>
            ...
            title="Optional">
        <span id="state_targettrackingconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_targettrackingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Tracking<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfiguration">Property Map</a></span>
    </dt>
...
<h4 id="policypredictivescalingconfiguration">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricspecification_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Specification</a>
    ...
    <dd>This structure includes the metrics and target utilization to use for predictive scaling.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxcapacitybreachbehavior_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Capacity<wbr>Breach<wbr>Behavior</a>
    ...
    <dd>Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling group. Valid values are <code>HonorMaxCapacity</code> or <code>IncreaseMaxCapacity</code>. Default is <code>HonorMaxCapacity</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>Predictive scaling mode. Valid values are <code>ForecastAndScale</code> and <code>ForecastOnly</code>. Default is <code>ForecastOnly</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schedulingbuffertime_csharp" style="color: inherit; text-decoration: inherit;">Scheduling<wbr>Buffer<wbr>Time</a>
    ...
    <dd>Amount of time, in seconds, by which the instance launch time can be advanced. Minimum is <code>0</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metricspecification_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricspecification_java" style="color: inherit; text-decoration: inherit;">metric<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecification">Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification</a></span>
    </dt>
    <dd>This structure includes the metrics and target utilization to use for predictive scaling.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxcapacitybreachbehavior_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxcapacitybreachbehavior_java" style="color: inherit; text-decoration: inherit;">max<wbr>Capacity<wbr>Breach<wbr>Behavior</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling group. Valid values are <code>HonorMaxCapacity</code> or <code>IncreaseMaxCapacity</code>. Default is <code>HonorMaxCapacity</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxcapacitybuffer_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxcapacitybuffer_java" style="color: inherit; text-decoration: inherit;">max<wbr>Capacity<wbr>Buffer</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_java" style="color: inherit; text-decoration: inherit;">mode</a>
    ...
    <dd>Predictive scaling mode. Valid values are <code>ForecastAndScale</code> and <code>ForecastOnly</code>. Default is <code>ForecastOnly</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="schedulingbuffertime_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schedulingbuffertime_java" style="color: inherit; text-decoration: inherit;">scheduling<wbr>Buffer<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metricspecification_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricspecification_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecification">Property Map</a></span>
    </dt>
    <dd>This structure includes the metrics and target utilization to use for predictive scaling.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxcapacitybreachbehavior_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxcapacitybreachbehavior_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Capacity<wbr>Breach<wbr>Behavior</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling group. Valid values are <code>HonorMaxCapacity</code> or <code>IncreaseMaxCapacity</code>. Default is <code>HonorMaxCapacity</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxcapacitybuffer_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxcapacitybuffer_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Capacity<wbr>Buffer</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_yaml" style="color: inherit; text-decoration: inherit;">mode</a>
    ...
    <dd>Predictive scaling mode. Valid values are <code>ForecastAndScale</code> and <code>ForecastOnly</code>. Default is <code>ForecastOnly</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="schedulingbuffertime_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schedulingbuffertime_yaml" style="color: inherit; text-decoration: inherit;">scheduling<wbr>Buffer<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="policypredictivescalingconfigurationmetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedcapacitymetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Customized<wbr>Capacity<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Customized capacity metric specification. The field is only valid when you use <code>customized_load_metric_specification</code></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedloadmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Customized<wbr>Load<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Customized load metric specification.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedscalingmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Customized<wbr>Scaling<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Customized scaling metric specification.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedloadmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Load<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Predefined load metric specification.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricpairspecification_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Metric<wbr>Pair<wbr>Specification</a>
    ...
    <dd>Metric pair specification from which Amazon EC2 Auto Scaling determines the appropriate scaling metric and load metric to use.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedscalingmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Scaling<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Predefined scaling metric specification.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetvalue_java" style="color: inherit; text-decoration: inherit;">target<wbr>Value</a>
    ...
    <dd>Target value for the metric.</dd><dt class="property-optional"
            title="Optional">
        <span id="customizedcapacitymetricspecification_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedcapacitymetricspecification_java" style="color: inherit; text-decoration: inherit;">customized<wbr>Capacity<wbr>Metric<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecification">Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedloadmetricspecification_java" style="color: inherit; text-decoration: inherit;">predefined<wbr>Load<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Predefined load metric specification.</dd><dt class="property-optional"
            title="Optional">
        <span id="predefinedmetricpairspecification_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricpairspecification_java" style="color: inherit; text-decoration: inherit;">predefined<wbr>Metric<wbr>Pair<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationpredefinedmetricpairspecification">Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Metric<wbr>Pair<wbr>Specification</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetvalue_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Value</a>
    ...
    <dd>Target value for the metric.</dd><dt class="property-optional"
            title="Optional">
        <span id="customizedcapacitymetricspecification_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedcapacitymetricspecification_yaml" style="color: inherit; text-decoration: inherit;">customized<wbr>Capacity<wbr>Metric<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecification">Property Map</a></span>
    </dt>
    <dd>Customized capacity metric specification. The field is only valid when you use <code>customized_load_metric_specification</code></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedloadmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">customized<wbr>Load<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecification">Property Map</a></span>
    </dt>
    <dd>Customized load metric specification.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedscalingmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">customized<wbr>Scaling<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecification">Property Map</a></span>
    </dt>
    <dd>Customized scaling metric specification.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedloadmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">predefined<wbr>Load<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationpredefinedloadmetricspecification">Property Map</a></span>
    </dt>
    <dd>Predefined load metric specification.</dd><dt class="property-optional"
            title="Optional">
        <span id="predefinedmetricpairspecification_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricpairspecification_yaml" style="color: inherit; text-decoration: inherit;">predefined<wbr>Metric<wbr>Pair<wbr>Specification</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationpredefinedmetricpairspecification">Property Map</a></span>
    </dt>
    <dd>Metric pair specification from which Amazon EC2 Auto Scaling determines the appropriate scaling metric and load metric to use.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedscalingmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">predefined<wbr>Scaling<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationpredefinedscalingmetricspecification">Property Map</a></span>
    </dt>
    <dd>Predefined scaling metric specification.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Data<wbr>Queries</a>
    ...
    <dd>List of up to 10 structures that defines custom capacity metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metricdataqueries_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_java" style="color: inherit; text-decoration: inherit;">metric<wbr>Data<wbr>Queries</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquery">List&lt;Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query&gt;</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metricdataqueries_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Data<wbr>Queries</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquery">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of up to 10 structures that defines custom capacity metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquery">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>Short name for the metric used in predictive scaling policy.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Stat</a>
    ...
    <dd>Structure that defines CloudWatch metric to be used in predictive scaling policy. You must specify either <code>expression</code> or <code>metric_stat</code>, but not both.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Stat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquerymetricstat">Property Map</a></span>
    </dt>
    <dd>Structure that defines CloudWatch metric to be used in predictive scaling policy. You must specify either <code>expression</code> or <code>metric_stat</code>, but not both.</dd><dt class="property-optional"
            title="Optional">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metric_yaml" style="color: inherit; text-decoration: inherit;">metric</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquerymetricstatmetric">Property Map</a></span>
    </dt>
    <dd>Structure that defines the CloudWatch metric to return, including the metric name, namespace, and dimensions.</dd><dt class="property-required"
            title="Required">
        <span id="stat_yaml">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_yaml" style="color: inherit; text-decoration: inherit;">dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedcapacitymetricspecificationmetricdataquerymetricstatmetricdimension">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Capacity<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Data<wbr>Queries</a>
    ...
    <dd>List of up to 10 structures that defines custom load metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Data<wbr>Queries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecificationmetricdataquery">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of up to 10 structures that defines custom load metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecificationmetricdataquery">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Stat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecificationmetricdataquerymetricstat">Property Map</a></span>
    </dt>
    <dd>Structure that defines CloudWatch metric to be used in predictive scaling policy. You must specify either <code>expression</code> or <code>metric_stat</code>, but not both.</dd><dt class="property-optional"
            title="Optional">
        <span id="returndata_yaml">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metric_yaml" style="color: inherit; text-decoration: inherit;">metric</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecificationmetricdataquerymetricstatmetric">Property Map</a></span>
    </dt>
    <dd>Structure that defines the CloudWatch metric to return, including the metric name, namespace, and dimensions.</dd><dt class="property-required"
            title="Required">
        <span id="stat_yaml">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_yaml" style="color: inherit; text-decoration: inherit;">dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedloadmetricspecificationmetricdataquerymetricstatmetricdimension">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Load<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Data<wbr>Queries</a>
    ...
    <dd>List of up to 10 structures that defines custom scaling metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdataqueries_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Data<wbr>Queries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecificationmetricdataquery">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of up to 10 structures that defines custom scaling metric in predictive scaling policy</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecificationmetricdataquery">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Stat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecificationmetricdataquerymetricstat">Property Map</a></span>
    </dt>
    <dd>Structure that defines CloudWatch metric to be used in predictive scaling policy. You must specify either <code>expression</code> or <code>metric_stat</code>, but not both.</dd><dt class="property-optional"
            title="Optional">
        <span id="returndata_yaml">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metric_yaml" style="color: inherit; text-decoration: inherit;">metric</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecificationmetricdataquerymetricstatmetric">Property Map</a></span>
    </dt>
    <dd>Structure that defines the CloudWatch metric to return, including the metric name, namespace, and dimensions.</dd><dt class="property-required"
            title="Required">
        <span id="stat_yaml">
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_yaml" style="color: inherit; text-decoration: inherit;">dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypredictivescalingconfigurationmetricspecificationcustomizedscalingmetricspecificationmetricdataquerymetricstatmetricdimension">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Customized<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Data<wbr>Query<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policypredictivescalingconfigurationmetricspecificationpredefinedloadmetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Load<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Load<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetrictype_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Metric<wbr>Type</a>
    ...
    <dd>Metric type. Valid values are <code>ASGTotalCPUUtilization</code>, <code>ASGTotalNetworkIn</code>, <code>ASGTotalNetworkOut</code>, or <code>ALBTargetGroupRequestCount</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcelabel_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Label</a>
    ...
    <dd>Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to <a href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html">PredefinedMetricSpecification</a> for more information.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="policypredictivescalingconfigurationmetricspecificationpredefinedmetricpairspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Metric<wbr>Pair<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Metric<wbr>Pair<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policypredictivescalingconfigurationmetricspecificationpredefinedscalingmetricspecification">
Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Scaling<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Predictive<wbr>Scaling<wbr>Configuration<wbr>Metric<wbr>Specification<wbr>Predefined<wbr>Scaling<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetrictype_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Metric<wbr>Type</a>
    ...
    <dd>Describes a scaling metric for a predictive scaling policy. Valid values are <code>ASGAverageCPUUtilization</code>, <code>ASGAverageNetworkIn</code>, <code>ASGAverageNetworkOut</code>, or <code>ALBRequestCountPerTarget</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="resourcelabel_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcelabel_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Label</a>
</span>
...
<h4 id="policystepadjustment">
Policy<wbr>Step<wbr>Adjustment<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Step<wbr>Adjustment<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricintervallowerbound_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Interval<wbr>Lower<wbr>Bound</a>
    ...
    <dd>Lower bound for the
difference between the alarm threshold and the CloudWatch metric.
Without a value, AWS will treat this bound as negative infinity.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricintervalupperbound_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Interval<wbr>Upper<wbr>Bound</a>
    ...
    <dd><p>Upper bound for the
difference between the alarm threshold and the CloudWatch metric.
Without a value, AWS will treat this bound as positive infinity. The upper bound
must be greater than the lower bound.</p>
...
<h4 id="policytargettrackingconfiguration">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Customized<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Customized metric. Conflicts with <code>predefined_metric_specification</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disablescalein_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Scale<wbr>In</a>
    ...
    <dd>Whether scale in by the target tracking policy is disabled.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Metric<wbr>Specification</a>
    ...
    <dd>Predefined metric. Conflicts with <code>customized_metric_specification</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">customized<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecification">Property Map</a></span>
    </dt>
    <dd>Customized metric. Conflicts with <code>predefined_metric_specification</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricspecification_yaml" style="color: inherit; text-decoration: inherit;">predefined<wbr>Metric<wbr>Specification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationpredefinedmetricspecification">Property Map</a></span>
    </dt>
    <dd>Predefined metric. Conflicts with <code>customized_metric_specification</code>.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policytargettrackingconfigurationcustomizedmetricspecification">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_csharp" style="color: inherit; text-decoration: inherit;">Metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetric">List&lt;Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#period_csharp" style="color: inherit; text-decoration: inherit;">Period</a>
    ...
    <dd>The period of the metric in seconds.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statistic_csharp" style="color: inherit; text-decoration: inherit;">Statistic</a>
    ...
    <dd>Statistic of the metric.</dd><dt class="property-optional"
            title="Optional">
        <span id="unit_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_go" style="color: inherit; text-decoration: inherit;">Metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetric">[]Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric</a></span>
    </dt>
    <dd>Metrics to include, as a metric data query.</dd><dt class="property-optional"
            title="Optional">
        <span id="namespace_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_python" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetric">Sequence[Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric]</a></span>
    </dt>
    <dd>Metrics to include, as a metric data query.</dd><dt class="property-optional"
            title="Optional">
        <span id="namespace_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricdimensions_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricdimension">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd><dt class="property-optional"
            title="Optional">
        <span id="metricname_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_yaml" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetric">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Metrics to include, as a metric data query.</dd><dt class="property-optional"
            title="Optional">
        <span id="namespace_yaml">
...
<h4 id="policytargettrackingconfigurationcustomizedmetricspecificationmetric">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Stat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstat">Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricstat_yaml" style="color: inherit; text-decoration: inherit;">metric<wbr>Stat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstat">Property Map</a></span>
    </dt>
    <dd>Structure that defines CloudWatch metric to be used in target tracking scaling policy. You must specify either <code>expression</code> or <code>metric_stat</code>, but not both.</dd><dt class="property-optional"
            title="Optional">
        <span id="returndata_yaml">
...
<h4 id="policytargettrackingconfigurationcustomizedmetricspecificationmetricdimension">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Dimension<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Dimension<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstat">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metric_csharp" style="color: inherit; text-decoration: inherit;">Metric</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetric">Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric</a></span>
    </dt>
    <dd>Structure that defines the CloudWatch metric to return, including the metric name, namespace, and dimensions.</dd><dt class="property-required"
            title="Required">
        <span id="stat_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metric_yaml" style="color: inherit; text-decoration: inherit;">metric</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetric">Property Map</a></span>
    </dt>
    <dd>Structure that defines the CloudWatch metric to return, including the metric name, namespace, and dimensions.</dd><dt class="property-required"
            title="Required">
        <span id="stat_yaml">
...
<h4 id="policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetric">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_csharp" style="color: inherit; text-decoration: inherit;">Dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">List&lt;Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_go" style="color: inherit; text-decoration: inherit;">Dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">[]Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_python" style="color: inherit; text-decoration: inherit;">dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">Sequence[Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension]</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dimensions_yaml" style="color: inherit; text-decoration: inherit;">dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Dimensions of the metric.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="policytargettrackingconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policytargettrackingconfigurationpredefinedmetricspecification">
Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Predefined<wbr>Metric<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Target<wbr>Tracking<wbr>Configuration<wbr>Predefined<wbr>Metric<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcelabel_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Label</a>
    ...
    <dd>Identifies the resource associated with the metric type.</dd></dl>
</pulumi-choosable>
</div>
