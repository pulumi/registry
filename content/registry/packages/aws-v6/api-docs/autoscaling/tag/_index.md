...
<span class="k">def </span><span class="nx">Tag</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">tag</span><span class="p">:</span> <span class="nx">Optional[TagTagArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:autoscaling:Tag</span><span class="p"></span>
...
```java
var tagResource = new com.pulumi.aws.autoscaling.Tag("tagResource", com.pulumi.aws.autoscaling.TagArgs.builder()
    .autoscalingGroupName("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalinggroupname_csharp" style="color: inherit; text-decoration: inherit;">Autoscaling<wbr>Group<wbr>Name</a>
    ...
    <dd>Name of the Autoscaling Group to apply the tag to.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tagdetails_csharp" style="color: inherit; text-decoration: inherit;">Tag<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagtag">Tag<wbr>Tag</a></span>
    </dt>
    <dd>Tag to create. The <code>tag</code> block is documented below.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:autoscaling:Tag</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_autoscalinggroupname_csharp" style="color: inherit; text-decoration: inherit;">Autoscaling<wbr>Group<wbr>Name</a>
    ...
    <dd>Name of the Autoscaling Group to apply the tag to.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="tagtag">
Tag<wbr>Tag<pulumi-choosable type="language" values="python,go" class="inline">, Tag<wbr>Tag<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#propagateatlaunch_csharp" style="color: inherit; text-decoration: inherit;">Propagate<wbr>At<wbr>Launch</a>
    ...
    <dd>Whether to propagate the tags to instances launched by the ASG.</dd><dt class="property-required"
            title="Required">
