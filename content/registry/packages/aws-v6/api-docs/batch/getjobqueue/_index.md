...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetJobQueueResult</a></span>> </span>getJobQueue<span class="p">(</span><span class="nx">GetJobQueueArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the job queue.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the job queue.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobstatetimelimitactions_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>State<wbr>Time<wbr>Limit<wbr>Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getjobqueuejobstatetimelimitaction">List&lt;Get<wbr>Job<wbr>Queue<wbr>Job<wbr>State<wbr>Time<wbr>Limit<wbr>Action&gt;</a></span>
    </dt>
    <dd>Specifies an action that AWS Batch will take after the job has remained at the head of the queue in the specified state for longer than the specified time.</p>
<ul>
<li><code>job_state_time_limit_action.#.action</code> - The action to take when a job is at the head of the job queue in the specified state for the specified period of time.</li>
<li><code>job_state_time_limit_action.#.max_time_seconds</code> - The approximate amount of time, in seconds, that must pass with the job in the specified state before the action is taken.</li>
<li><code>job_state_time_limit_action.#.reason</code> - The reason to log for the action being taken.</li>
<li><code>job_state_time_limit_action.#.state</code> - The state of the job needed to trigger the action.</li>
</ul></dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>Priority of the job queue. Job queues with a higher priority are evaluated first when
associated with the same compute environment.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schedulingpolicyarn_csharp" style="color: inherit; text-decoration: inherit;">Scheduling<wbr>Policy<wbr>Arn</a>
    ...
    <dd>The ARN of the fair share scheduling policy. If this attribute has a value, the job queue uses a fair share scheduling policy. If this attribute does not have a value, the job queue uses a first in, first out (FIFO) scheduling policy.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Describes the ability of the queue to accept new jobs (for example, <code>ENABLED</code> or <code>DISABLED</code>).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Current status of the job queue (for example, <code>CREATING</code> or <code>VALID</code>).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statusreason_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Reason</a>
    ...
    <dd>Short, human-readable string to provide additional details about the current status
of the job queue.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobstatetimelimitactions_go" style="color: inherit; text-decoration: inherit;">Job<wbr>State<wbr>Time<wbr>Limit<wbr>Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getjobqueuejobstatetimelimitaction">[]Get<wbr>Job<wbr>Queue<wbr>Job<wbr>State<wbr>Time<wbr>Limit<wbr>Action</a></span>
    </dt>
    <dd>Specifies an action that AWS Batch will take after the job has remained at the head of the queue in the specified state for longer than the specified time.</p>
<ul>
<li><code>job_state_time_limit_action.#.action</code> - The action to take when a job is at the head of the job queue in the specified state for the specified period of time.</li>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#job_state_time_limit_actions_python" style="color: inherit; text-decoration: inherit;">job_<wbr>state_<wbr>time_<wbr>limit_<wbr>actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getjobqueuejobstatetimelimitaction">Sequence[Get<wbr>Job<wbr>Queue<wbr>Job<wbr>State<wbr>Time<wbr>Limit<wbr>Action]</a></span>
    </dt>
    <dd>Specifies an action that AWS Batch will take after the job has remained at the head of the queue in the specified state for longer than the specified time.</p>
<ul>
<li><code>job_state_time_limit_action.#.action</code> - The action to take when a job is at the head of the job queue in the specified state for the specified period of time.</li>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobstatetimelimitactions_yaml" style="color: inherit; text-decoration: inherit;">job<wbr>State<wbr>Time<wbr>Limit<wbr>Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getjobqueuejobstatetimelimitaction">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Specifies an action that AWS Batch will take after the job has remained at the head of the queue in the specified state for longer than the specified time.</p>
<ul>
<li><code>job_state_time_limit_action.#.action</code> - The action to take when a job is at the head of the job queue in the specified state for the specified period of time.</li>
...
<h4 id="getjobqueuejobstatetimelimitaction">Get<wbr>Job<wbr>Queue<wbr>Job<wbr>State<wbr>Time<wbr>Limit<wbr>Action</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Describes the ability of the queue to accept new jobs (for example, <code>ENABLED</code> or <code>DISABLED</code>).</dd></dl>
</pulumi-choosable>
</div>
