...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoadjustdatas_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Adjust<wbr>Datas</a>
    ...
    <dd>Object containing [AutoAdjustData] which determines the budget amount for an auto-adjusting budget.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#budgetexceeded_csharp" style="color: inherit; text-decoration: inherit;">Budget<wbr>Exceeded</a>
    ...
    <dd>Boolean indicating whether this budget has been exceeded.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#budgetlimits_csharp" style="color: inherit; text-decoration: inherit;">Budget<wbr>Limits</a>
    ...
    <dd>The total amount of cost, usage, RI utilization, RI coverage, Savings Plans utilization, or Savings Plans coverage that you want to track with your budget. Contains object Spend.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#budgettype_csharp" style="color: inherit; text-decoration: inherit;">Budget<wbr>Type</a>
    ...
    <dd>Whether this budget tracks monetary cost or usage.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#calculatedspends_csharp" style="color: inherit; text-decoration: inherit;">Calculated<wbr>Spends</a>
    ...
    <dd>The spend objects that are associated with this budget. The actualSpend tracks how much you've used, cost, usage, RI units, or Savings Plans units and the forecastedSpend tracks how much that you're predicted to spend based on your historical usage profile.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#costfilters_csharp" style="color: inherit; text-decoration: inherit;">Cost<wbr>Filters</a>
    ...
    <dd>A list of CostFilter name/values pair to apply to budget.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#costtypes_csharp" style="color: inherit; text-decoration: inherit;">Cost<wbr>Types</a>
    ...
    <dd>Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#notifications_csharp" style="color: inherit; text-decoration: inherit;">Notifications</a>
    ...
    <dd>Object containing Budget Notifications. Can be used multiple times to define more than one budget notification.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeperiodend_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Period<wbr>End</a>
    ...
    <dd>The end of the time period covered by the budget. There are no restrictions on the end date. Format: <code>2017-01-01_12:00</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeperiodstart_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Period<wbr>Start</a>
    ...
    <dd>The start of the time period covered by the budget. If you don't specify a start date, AWS defaults to the start of your chosen time period. The start date must come before the end date. Format: <code>2017-01-01_12:00</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeunit_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Unit</a>
    ...
    <dd>The length of time until a budget resets the actual and forecasted spend. Valid values: <code>MONTHLY</code>, <code>QUARTERLY</code>, <code>ANNUALLY</code>, and <code>DAILY</code>.</dd><dt class="property-"
            title="">
        <span id="nameprefix_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameprefix_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Prefix</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoadjusttype_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Adjust<wbr>Type</a>
    ...
    <dd>(Required) - The string that defines whether your budget auto-adjusts based on historical or forecasted data. Valid values: <code>FORECAST</code>,<code>HISTORICAL</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#historicaloptions_csharp" style="color: inherit; text-decoration: inherit;">Historical<wbr>Options</a>
    ...
    <dd>(Optional) - Configuration block of Historical Options. Required for <code>auto_adjust_type</code> of <code>HISTORICAL</code> Configuration block that defines the historical data that your auto-adjusting budget is based on.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#budgetadjustmentperiod_csharp" style="color: inherit; text-decoration: inherit;">Budget<wbr>Adjustment<wbr>Period</a>
    ...
    <dd>(Required) - The number of budget periods included in the moving-average calculation that determines your auto-adjusted budget amount.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amount_csharp" style="color: inherit; text-decoration: inherit;">Amount</a>
    ...
    <dd>The cost or usage amount that's associated with a budget forecast, actual spend, or budget threshold. Length Constraints: Minimum length of <code>1</code>. Maximum length of <code>2147483647</code>.</dd><dt class="property-required"
            title="Required">
        <span id="unit_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
    ...
    <dd>The unit of measurement that's used for the budget forecast, actual spend, or budget threshold, such as USD or GBP. Length Constraints: Minimum length of <code>1</code>. Maximum length of <code>2147483647</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includecredit_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Credit</a>
    ...
    <dd>A boolean value whether to include credits in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includediscount_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Discount</a>
    ...
    <dd>Whether a budget includes discounts. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includeothersubscription_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Other<wbr>Subscription</a>
    ...
    <dd>A boolean value whether to include other subscription costs in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includerecurring_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Recurring</a>
    ...
    <dd>A boolean value whether to include recurring costs in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includerefund_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Refund</a>
    ...
    <dd>A boolean value whether to include refunds in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includesubscription_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Subscription</a>
    ...
    <dd>A boolean value whether to include subscriptions in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includesupport_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Support</a>
    ...
    <dd>A boolean value whether to include support costs in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetax_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Tax</a>
    ...
    <dd>A boolean value whether to include tax in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includeupfront_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Upfront</a>
    ...
    <dd>A boolean value whether to include upfront costs in the cost budget. Defaults to <code>true</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useamortized_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Amortized</a>
    ...
    <dd>Whether a budget uses the amortized rate. Defaults to <code>false</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subscriberemailaddresses_csharp" style="color: inherit; text-decoration: inherit;">Subscriber<wbr>Email<wbr>Addresses</a>
    ...
    <dd>(Optional) E-Mail addresses to notify. Either this or <code>subscriber_sns_topic_arns</code> is required.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subscribersnstopicarns_csharp" style="color: inherit; text-decoration: inherit;">Subscriber<wbr>Sns<wbr>Topic<wbr>Arns</a>
    ...
    <dd>(Optional) SNS topics to notify. Either this or <code>subscriber_email_addresses</code> is required.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#thresholdtype_csharp" style="color: inherit; text-decoration: inherit;">Threshold<wbr>Type</a>
    ...
    <dd>(Required) What kind of threshold is defined. Can be <code>PERCENTAGE</code> OR <code>ABSOLUTE_VALUE</code>.</dd></dl>
</pulumi-choosable>
</div>
