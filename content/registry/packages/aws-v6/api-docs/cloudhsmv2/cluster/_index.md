...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:cloudhsmv2:Cluster</span><span class="p"></span>
...
```java
var clusterResource = new com.pulumi.aws.cloudhsmv2.Cluster("clusterResource", com.pulumi.aws.cloudhsmv2.ClusterArgs.builder()
    .hsmType("string")
    .subnetIds("string")
    .mode("string")
    .sourceBackupIdentifier("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmtype_csharp" style="color: inherit; text-decoration: inherit;">Hsm<wbr>Type</a>
    ...
    <dd>The type of HSM module in the cluster. Currently, <code>hsm1.medium</code> and <code>hsm2m.medium</code> are supported.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>The IDs of subnets in which cluster will operate.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="mode_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>The mode to use in the cluster. The allowed values are <code>FIPS</code> and <code>NON_FIPS</code>. This field is required if <code>hsm_type</code> is <code>hsm2m.medium</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcebackupidentifier_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Backup<wbr>Identifier</a>
    ...
    <dd>ID of Cloud HSM v2 cluster backup to be restored.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="hsmtype_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmtype_java" style="color: inherit; text-decoration: inherit;">hsm<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_java" style="color: inherit; text-decoration: inherit;">mode</a>
    ...
    <dd>The mode to use in the cluster. The allowed values are <code>FIPS</code> and <code>NON_FIPS</code>. This field is required if <code>hsm_type</code> is <code>hsm2m.medium</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="sourcebackupidentifier_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcebackupidentifier_java" style="color: inherit; text-decoration: inherit;">source<wbr>Backup<wbr>Identifier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="hsmtype_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmtype_yaml" style="color: inherit; text-decoration: inherit;">hsm<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_yaml" style="color: inherit; text-decoration: inherit;">mode</a>
    ...
    <dd>The mode to use in the cluster. The allowed values are <code>FIPS</code> and <code>NON_FIPS</code>. This field is required if <code>hsm_type</code> is <code>hsm2m.medium</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="sourcebackupidentifier_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcebackupidentifier_yaml" style="color: inherit; text-decoration: inherit;">source<wbr>Backup<wbr>Identifier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificates</a>
    ...
    <dd>The list of cluster certificates.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterid_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Id</a>
    ...
    <dd>The id of the CloudHSM cluster.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupid_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Id</a>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>The state of the CloudHSM cluster.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd>The id of the VPC that the CloudHSM cluster resides in.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterstate_go" style="color: inherit; text-decoration: inherit;">Cluster<wbr>State</a>
    ...
    <dd>The state of the CloudHSM cluster.</dd><dt class="property-"
            title="">
        <span id="id_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupid_go" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Id</a>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
        <span id="tagsall_go">
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="clustercertificates_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificates</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclustercertificate">List&lt;Cluster<wbr>Cluster<wbr>Certificate&gt;</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="clustercertificates_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificates</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclustercertificate">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The list of cluster certificates.</dd><dt class="property-"
            title="">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:cloudhsmv2:Cluster</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clustercertificates_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificates</a>
    ...
    <dd>The list of cluster certificates.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clusterid_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Id</a>
    ...
    <dd>The id of the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hsmtype_csharp" style="color: inherit; text-decoration: inherit;">Hsm<wbr>Type</a>
    ...
    <dd>The type of HSM module in the cluster. Currently, <code>hsm1.medium</code> and <code>hsm2m.medium</code> are supported.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>The mode to use in the cluster. The allowed values are <code>FIPS</code> and <code>NON_FIPS</code>. This field is required if <code>hsm_type</code> is <code>hsm2m.medium</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_securitygroupid_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Id</a>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>The state of the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>The IDs of subnets in which cluster will operate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clusterid_go" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Id</a>
    ...
    <dd>The id of the CloudHSM cluster.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_sourcebackupidentifier_go" style="color: inherit; text-decoration: inherit;">Source<wbr>Backup<wbr>Identifier</a>
    ...
    <dd>ID of Cloud HSM v2 cluster backup to be restored.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_clustercertificates_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clustercertificates_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificates</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclustercertificate">List&lt;Cluster<wbr>Cluster<wbr>Certificate&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clusterstate_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>State</a>
    ...
    <dd>The state of the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="state_hsmtype_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hsmtype_java" style="color: inherit; text-decoration: inherit;">hsm<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_securitygroupid_java" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Id</a>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="state_sourcebackupidentifier_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_sourcebackupidentifier_java" style="color: inherit; text-decoration: inherit;">source<wbr>Backup<wbr>Identifier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_clustercertificates_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clustercertificates_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificates</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclustercertificate">List&lt;Property Map&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clusterstate_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>State</a>
    ...
    <dd>The state of the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="state_hsmtype_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hsmtype_yaml" style="color: inherit; text-decoration: inherit;">hsm<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_securitygroupid_yaml" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Id</a>
    ...
    <dd>The ID of the security group associated with the CloudHSM cluster.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="state_sourcebackupidentifier_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_sourcebackupidentifier_yaml" style="color: inherit; text-decoration: inherit;">source<wbr>Backup<wbr>Identifier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="clusterclustercertificate">
Cluster<wbr>Cluster<wbr>Certificate<pulumi-choosable type="language" values="python,go" class="inline">, Cluster<wbr>Cluster<wbr>Certificate<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awshardwarecertificate_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Hardware<wbr>Certificate</a>
    ...
    <dd>The HSM hardware certificate issued (signed) by AWS CloudHSM.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificate_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificate</a>
    ...
    <dd>The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercsr_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Csr</a>
    ...
    <dd>The certificate signing request (CSR). Available only in <code>UNINITIALIZED</code> state after an HSM instance is added to the cluster.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmcertificate_csharp" style="color: inherit; text-decoration: inherit;">Hsm<wbr>Certificate</a>
    ...
    <dd>The HSM certificate issued (signed) by the HSM hardware.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#manufacturerhardwarecertificate_csharp" style="color: inherit; text-decoration: inherit;">Manufacturer<wbr>Hardware<wbr>Certificate</a>
    ...
    <dd>The HSM hardware certificate issued (signed) by the hardware manufacturer.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="awshardwarecertificate_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awshardwarecertificate_java" style="color: inherit; text-decoration: inherit;">aws<wbr>Hardware<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The HSM hardware certificate issued (signed) by AWS CloudHSM.</dd><dt class="property-optional"
            title="Optional">
        <span id="clustercertificate_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificate_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.</dd><dt class="property-optional"
            title="Optional">
        <span id="clustercsr_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercsr_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>Csr</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The certificate signing request (CSR). Available only in <code>UNINITIALIZED</code> state after an HSM instance is added to the cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="hsmcertificate_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmcertificate_java" style="color: inherit; text-decoration: inherit;">hsm<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The HSM certificate issued (signed) by the HSM hardware.</dd><dt class="property-optional"
            title="Optional">
        <span id="manufacturerhardwarecertificate_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#manufacturerhardwarecertificate_java" style="color: inherit; text-decoration: inherit;">manufacturer<wbr>Hardware<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="awshardwarecertificate_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awshardwarecertificate_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Hardware<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The HSM hardware certificate issued (signed) by AWS CloudHSM.</dd><dt class="property-optional"
            title="Optional">
        <span id="clustercertificate_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificate_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.</dd><dt class="property-optional"
            title="Optional">
        <span id="clustercsr_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercsr_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Csr</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The certificate signing request (CSR). Available only in <code>UNINITIALIZED</code> state after an HSM instance is added to the cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="hsmcertificate_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmcertificate_yaml" style="color: inherit; text-decoration: inherit;">hsm<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The HSM certificate issued (signed) by the HSM hardware.</dd><dt class="property-optional"
            title="Optional">
        <span id="manufacturerhardwarecertificate_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#manufacturerhardwarecertificate_yaml" style="color: inherit; text-decoration: inherit;">manufacturer<wbr>Hardware<wbr>Certificate</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
