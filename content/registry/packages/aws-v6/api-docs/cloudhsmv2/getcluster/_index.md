...
---
title: "getCluster"
title_tag: "aws.cloudhsmv2.getCluster"
meta_desc: "Documentation for the aws.cloudhsmv2.getCluster function with examples, input properties, output properties, and supporting types."
layout: api
...
def </span>get_cluster_output<span class="p">(</span><span class="nx">cluster_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                <span class="nx">cluster_state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> aws:cloudhsmv2/getCluster:getCluster
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterid_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Id</a>
    ...
    <dd>ID of Cloud HSM v2 cluster.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterstate_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>State</a>
    ...
    <dd>State of the cluster to be found.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclusterclustercertificate">List&lt;Get<wbr>Cluster<wbr>Cluster<wbr>Certificate&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupid_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Id</a>
    ...
    <dd>ID of the security group associated with the CloudHSM cluster.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>IDs of subnets in which cluster operates.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd>ID of the VPC that the CloudHSM cluster resides in.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_go" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclusterclustercertificate">[]Get<wbr>Cluster<wbr>Cluster<wbr>Certificate</a></span>
    </dt>
    <dd>The list of cluster certificates.</dd><dt class="property-"
            title="">
        <span id="clusterid_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cluster_certificates_python" style="color: inherit; text-decoration: inherit;">cluster_<wbr>certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclusterclustercertificate">Sequence[Get<wbr>Cluster<wbr>Cluster<wbr>Certificate]</a></span>
    </dt>
    <dd>The list of cluster certificates.</dd><dt class="property-"
            title="">
        <span id="cluster_id_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificates_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclusterclustercertificate">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The list of cluster certificates.</dd><dt class="property-"
            title="">
        <span id="clusterid_yaml">
...
<h4 id="getclusterclustercertificate">Get<wbr>Cluster<wbr>Cluster<wbr>Certificate</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awshardwarecertificate_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Hardware<wbr>Certificate</a>
    ...
    <dd>The HSM hardware certificate issued (signed) by AWS CloudHSM.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercertificate_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificate</a>
    ...
    <dd>The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clustercsr_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Csr</a>
    ...
    <dd>The certificate signing request (CSR). Available only in UNINITIALIZED state.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hsmcertificate_csharp" style="color: inherit; text-decoration: inherit;">Hsm<wbr>Certificate</a>
    ...
    <dd>The HSM certificate issued (signed) by the HSM hardware.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#manufacturerhardwarecertificate_csharp" style="color: inherit; text-decoration: inherit;">Manufacturer<wbr>Hardware<wbr>Certificate</a>
    ...
    <dd>The HSM hardware certificate issued (signed) by the hardware manufacturer.
The number of available cluster certificates may vary depending on state of the cluster.</dd></dl>
</pulumi-choosable>
</div>
