...
---
title: "Connection"
title_tag: "aws.codeconnections.Connection"
meta_desc: "Documentation for the aws.codeconnections.Connection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Connection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">timeouts</span><span class="p">:</span> <span class="nx">Optional[ConnectionTimeoutsArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:codeconnections:Connection</span><span class="p"></span>
...
```csharp
var awsConnectionResource = new Aws.CodeConnections.Connection("awsConnectionResource", new()
{
    HostArn = "string",
    Name = "string",
    ProviderType = "string",
    ...
    Timeouts = new Aws.CodeConnections.Inputs.ConnectionTimeoutsArgs
    {
        Create = "string",
        Delete = "string",
        Update = "string",
...
```go
example, err := codeconnections.NewConnection(ctx, "awsConnectionResource", &codeconnections.ConnectionArgs{
	...
	Timeouts: &codeconnections.ConnectionTimeoutsArgs{
...
```java
var awsConnectionResource = new com.pulumi.aws.codeconnections.Connection("awsConnectionResource", com.pulumi.aws.codeconnections.ConnectionArgs.builder()
    .hostArn("string")
    .name("string")
    .providerType("string")
    .tags(Map.of("string", "string"))
    .timeouts(ConnectionTimeoutsArgs.builder()
        .create("string")
        .delete("string")
        .update("string")
        .build())
...
```python
aws_connection_resource = aws.codeconnections.Connection("awsConnectionResource",
    host_arn="string",
    name="string",
...
```typescript
const awsConnectionResource = new aws.codeconnections.Connection("awsConnectionResource", {
    hostArn: "string",
    name: "string",
    providerType: "string",
    tags: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostarn_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the host associated with the connection. Conflicts with <code>provider_type</code></dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The name of the connection to be created. The name must be unique in the calling AWS account. Changing <code>name</code> will create a new resource.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#providertype_csharp" style="color: inherit; text-decoration: inherit;">Provider<wbr>Type</a>
    ...
    <dd>The name of the external provider where your third-party code repository is configured. Changing <code>provider_type</code> will create a new resource. Conflicts with <code>host_arn</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Map of key-value resource tags to associate with the resource. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeouts_csharp" style="color: inherit; text-decoration: inherit;">Timeouts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectiontimeouts">Connection<wbr>Timeouts</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeouts_go" style="color: inherit; text-decoration: inherit;">Timeouts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectiontimeouts">Connection<wbr>Timeouts<wbr>Args</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeouts_yaml" style="color: inherit; text-decoration: inherit;">timeouts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectiontimeouts">Property Map</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The codeconnections connection ARN.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#connectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd>The codeconnections connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">timeouts</span><span class="p">:</span> <span class="nx">Optional[ConnectionTimeoutsArgs]</span> = None<span class="p">) -&gt;</span> Connection</code></pre></div>
</div></pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The codeconnections connection ARN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd>The codeconnections connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Map of key-value resource tags to associate with the resource. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional property-deprecated"
...
<h4 id="connectiontimeouts">
Connection<wbr>Timeouts<pulumi-choosable type="language" values="python,go" class="inline">, Connection<wbr>Timeouts<wbr>Args</pulumi-choosable>
</h4>
