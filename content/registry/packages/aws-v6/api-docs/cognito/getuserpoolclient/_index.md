...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetUserPoolClientResult</a></span>> </span>getUserPoolClient<span class="p">(</span><span class="nx">GetUserPoolClientArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
    ...
    <dd>Client Id of the user pool.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accesstokenvalidity_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Token<wbr>Validity</a>
    ...
    <dd>(Optional) Time limit, between 5 minutes and 1 day, after which the access token is no longer valid and cannot be used. This value will be overridden if you have entered a value in <code>token_validity_units</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedoauthflows_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Oauth<wbr>Flows</a>
    ...
    <dd>(Optional) List of allowed OAuth flows (code, implicit, client_credentials).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedoauthflowsuserpoolclient_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Oauth<wbr>Flows<wbr>User<wbr>Pool<wbr>Client</a>
    ...
    <dd>(Optional) Whether the client is allowed to follow the OAuth protocol when interacting with Cognito user pools.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedoauthscopes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Oauth<wbr>Scopes</a>
    ...
    <dd>(Optional) List of allowed OAuth scopes (phone, email, openid, profile, and aws.cognito.signin.user.admin).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#analyticsconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Analytics<wbr>Configurations</a>
    ...
    <dd>(Optional) Configuration block for Amazon Pinpoint analytics for collecting metrics for this user pool. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#callbackurls_csharp" style="color: inherit; text-decoration: inherit;">Callback<wbr>Urls</a>
    ...
    <dd>(Optional) List of allowed callback URLs for the identity providers.</dd><dt class="property-"
            title="">
        <span id="clientid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultredirecturi_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Redirect<wbr>Uri</a>
    ...
    <dd>(Optional) Default redirect URI. Must be in the list of callback URLs.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabletokenrevocation_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Token<wbr>Revocation</a>
    ...
    <dd>(Optional) Enables or disables token revocation.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#explicitauthflows_csharp" style="color: inherit; text-decoration: inherit;">Explicit<wbr>Auth<wbr>Flows</a>
    ...
    <dd>(Optional) List of authentication flows (ADMIN_NO_SRP_AUTH, CUSTOM_AUTH_FLOW_ONLY, USER_PASSWORD_AUTH, ALLOW_ADMIN_USER_PASSWORD_AUTH, ALLOW_CUSTOM_AUTH, ALLOW_USER_PASSWORD_AUTH, ALLOW_USER_SRP_AUTH, ALLOW_REFRESH_TOKEN_AUTH).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#generatesecret_csharp" style="color: inherit; text-decoration: inherit;">Generate<wbr>Secret</a>
    ...
    <dd>(Optional) Should an application secret be generated.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#idtokenvalidity_csharp" style="color: inherit; text-decoration: inherit;">Id<wbr>Token<wbr>Validity</a>
    ...
    <dd>(Optional) Time limit, between 5 minutes and 1 day, after which the ID token is no longer valid and cannot be used. This value will be overridden if you have entered a value in <code>token_validity_units</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logouturls_csharp" style="color: inherit; text-decoration: inherit;">Logout<wbr>Urls</a>
    ...
    <dd>(Optional) List of allowed logout URLs for the identity providers.</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#preventuserexistenceerrors_csharp" style="color: inherit; text-decoration: inherit;">Prevent<wbr>User<wbr>Existence<wbr>Errors</a>
    ...
    <dd>(Optional) Choose which errors and responses are returned by Cognito APIs during authentication, account confirmation, and password recovery when the user does not exist in the user pool. When set to <code>ENABLED</code> and the user does not exist, authentication returns an error indicating either the username or password was incorrect, and account confirmation and password recovery return a response indicating a code was sent to a simulated destination. When set to <code>LEGACY</code>, those APIs will return a <code>UserNotFoundException</code> exception if the user does not exist in the user pool.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readattributes_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refreshtokenrotations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenrotations_csharp" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Token<wbr>Rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">List&lt;Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation&gt;</a></span>
    </dt>
    <dd>(Optional) A block that specifies the configuration of refresh token rotation. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenvalidity_csharp" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Token<wbr>Validity</a>
    ...
    <dd>(Optional) Time limit in days refresh tokens are valid for.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportedidentityproviders_csharp" style="color: inherit; text-decoration: inherit;">Supported<wbr>Identity<wbr>Providers</a>
    ...
    <dd>(Optional) List of provider names for the identity providers that are supported on this client. Uses the <code>provider_name</code> attribute of <code>aws.cognito.IdentityProvider</code> resource(s), or the equivalent string(s).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tokenvalidityunits_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Validity<wbr>Units</a>
    ...
    <dd>(Optional) Configuration block for units in which the validity times are represented in. Detailed below.</dd><dt class="property-"
            title="">
        <span id="userpoolid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userpoolid_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Pool<wbr>Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#writeattributes_csharp" style="color: inherit; text-decoration: inherit;">Write<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can write to.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readattributes_go" style="color: inherit; text-decoration: inherit;">Read<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refreshtokenrotations_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenrotations_go" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Token<wbr>Rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">[]Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation</a></span>
    </dt>
    <dd>(Optional) A block that specifies the configuration of refresh token rotation. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readattributes_java" style="color: inherit; text-decoration: inherit;">read<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refreshtokenrotations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenrotations_java" style="color: inherit; text-decoration: inherit;">refresh<wbr>Token<wbr>Rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">List&lt;Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readattributes_nodejs" style="color: inherit; text-decoration: inherit;">read<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refreshtokenrotations_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenrotations_nodejs" style="color: inherit; text-decoration: inherit;">refresh<wbr>Token<wbr>Rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#read_attributes_python" style="color: inherit; text-decoration: inherit;">read_<wbr>attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refresh_token_rotations_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refresh_token_rotations_python" style="color: inherit; text-decoration: inherit;">refresh_<wbr>token_<wbr>rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">Sequence[Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation]</a></span>
    </dt>
    <dd>(Optional) A block that specifies the configuration of refresh token rotation. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readattributes_yaml" style="color: inherit; text-decoration: inherit;">read<wbr>Attributes</a>
    ...
    <dd>(Optional) List of user pool attributes the application client can read from.</dd><dt class="property-"
            title="">
        <span id="refreshtokenrotations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtokenrotations_yaml" style="color: inherit; text-decoration: inherit;">refresh<wbr>Token<wbr>Rotations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getuserpoolclientrefreshtokenrotation">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>(Optional) A block that specifies the configuration of refresh token rotation. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applicationarn_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Arn</a>
    ...
    <dd>(Optional) Application ARN for an Amazon Pinpoint application. Conflicts with <code>external_id</code> and <code>role_arn</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applicationid_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Id</a>
    ...
    <dd>(Optional) Application ID for an Amazon Pinpoint application.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#externalid_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Id</a>
    ...
    <dd>(Optional) ID for the Analytics Configuration. Conflicts with <code>application_arn</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
    ...
    <dd>(Optional) ARN of an IAM role that authorizes Amazon Cognito to publish events to Amazon Pinpoint analytics. Conflicts with <code>application_arn</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userdatashared_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Data<wbr>Shared</a>
    ...
    <dd>(Optional) If set to <code>true</code>, Amazon Cognito will include user data in the events it publishes to Amazon Pinpoint analytics.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="getuserpoolclientrefreshtokenrotation">Get<wbr>User<wbr>Pool<wbr>Client<wbr>Refresh<wbr>Token<wbr>Rotation</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#feature_csharp" style="color: inherit; text-decoration: inherit;">Feature</a>
    ...
    <dd>(Required) The state of refresh token rotation for the current app client. Valid values are <code>ENABLED</code> or <code>DISABLED</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retrygraceperiodseconds_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Grace<wbr>Period<wbr>Seconds</a>
    ...
    <dd>(Optional) A period of time in seconds that the user has to use the old refresh token before it is invalidated. Valid values are between <code>0</code> and <code>60</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accesstoken_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Token</a>
    ...
    <dd>(Optional) Time unit in for the value in <code>access_token_validity</code>, defaults to <code>hours</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#idtoken_csharp" style="color: inherit; text-decoration: inherit;">Id<wbr>Token</a>
    ...
    <dd>(Optional) Time unit in for the value in <code>id_token_validity</code>, defaults to <code>hours</code>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#refreshtoken_csharp" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Token</a>
    ...
    <dd>(Optional) Time unit in for the value in <code>refresh_token_validity</code>, defaults to <code>days</code>.</dd></dl>
</pulumi-choosable>
</div>
