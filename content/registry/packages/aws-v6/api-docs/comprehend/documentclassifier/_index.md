...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:comprehend:DocumentClassifier</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inputdataconfig_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Data<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#documentclassifierinputdataconfig">Document<wbr>Classifier<wbr>Input<wbr>Data<wbr>Config</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>The document classification mode.
One of <code>MULTI_CLASS</code> or <code>MULTI_LABEL</code>.
<code>MULTI_CLASS</code> is also known as &quot;Single Label&quot; in the AWS Console.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#modelkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Model<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>KMS Key used to encrypt trained Document Classifiers.
Can be a KMS Key ID or a KMS Key ARN.</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outputdataconfig_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>Data<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#documentclassifieroutputdataconfig">Document<wbr>Classifier<wbr>Output<wbr>Data<wbr>Config</a></span>
    </dt>
    <dd>Configuration for the output results of training.
See the <code>output_data_config</code> Configuration Block section below.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#versionname_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Name</a>
    ...
    <dd>Name for the version of the Document Classifier.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#volumekmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>KMS Key used to encrypt storage volumes during job processing.
Can be a KMS Key ID or a KMS Key ARN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcconfig_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#documentclassifiervpcconfig">Document<wbr>Classifier<wbr>Vpc<wbr>Config</a></span>
    </dt>
    <dd>Configuration parameters for VPC to contain Document Classifier resources.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the Document Classifier version.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">DocumentClassifier</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">DocumentClassifierState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:comprehend:DocumentClassifier</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the Document Classifier version.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="documentclassifierinputdataconfig">
Document<wbr>Classifier<wbr>Input<wbr>Data<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Document<wbr>Classifier<wbr>Input<wbr>Data<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#labeldelimiter_csharp" style="color: inherit; text-decoration: inherit;">Label<wbr>Delimiter</a>
    ...
    <dd>Delimiter between labels when training a multi-label classifier.
...
Default is <code>|</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
    ...
    <dd>Location of training documents.
Used if <code>data_format</code> is <code>COMPREHEND_CSV</code>.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="documentclassifierinputdataconfigaugmentedmanifest">
Document<wbr>Classifier<wbr>Input<wbr>Data<wbr>Config<wbr>Augmented<wbr>Manifest<pulumi-choosable type="language" values="python,go" class="inline">, Document<wbr>Classifier<wbr>Input<wbr>Data<wbr>Config<wbr>Augmented<wbr>Manifest<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="documentclassifieroutputdataconfig">
Document<wbr>Classifier<wbr>Output<wbr>Data<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Document<wbr>Classifier<wbr>Output<wbr>Data<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
    ...
    <dd>Destination path for the output documents.
The full path to the output file will be returned in <code>output_s3_uri</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>KMS Key used to encrypt the output documents.
Can be a KMS Key ID, a KMS Key ARN, a KMS Alias name, or a KMS Alias ARN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outputs3uri_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>S3Uri</a>
    ...
    <dd>Full path for the output documents.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="documentclassifiervpcconfig">
Document<wbr>Classifier<wbr>Vpc<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Document<wbr>Classifier<wbr>Vpc<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
