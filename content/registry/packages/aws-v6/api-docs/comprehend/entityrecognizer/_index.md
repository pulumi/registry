        ...
        var example = new EntityRecognizer("example", EntityRecognizerArgs.builder()
            ...
            .inputDataConfig(EntityRecognizerInputDataConfigArgs.builder()
                ...
                .documents(EntityRecognizerInputDataConfigDocumentsArgs.builder()
                    .s3Uri(documents.id().applyValue(_id -> String.format("s3://%s/%s", documentsAwsS3Bucket.bucket(),_id)))
                    .build())
                .entityList(EntityRecognizerInputDataConfigEntityListArgs.builder()
                    .s3Uri(entities.id().applyValue(_id -> String.format("s3://%s/%s", entitiesAwsS3Bucket.bucket(),_id)))
                    .build())
                .build())
...
<span class="k">def </span><span class="nx">EntityRecognizer</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">vpc_config</span><span class="p">:</span> <span class="nx">Optional[EntityRecognizerVpcConfigArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEntityRecognizer</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">EntityRecognizerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">EntityRecognizer</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:comprehend:EntityRecognizer</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dataaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd>The ARN for an IAM Role which allows Comprehend to read the training and testing data.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inputdataconfig_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Data<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#entityrecognizerinputdataconfig">Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config</a></span>
    </dt>
    <dd>Configuration for the training and testing data.
See the <code>input_data_config</code> Configuration Block section below.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#languagecode_csharp" style="color: inherit; text-decoration: inherit;">Language<wbr>Code</a>
    ...
    <dd>Two-letter language code for the language.
One of <code>en</code>, <code>es</code>, <code>fr</code>, <code>it</code>, <code>de</code>, or <code>pt</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#modelkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Model<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>The ID or ARN of a KMS Key used to encrypt trained Entity Recognizers.</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#versionname_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Name</a>
    ...
    <dd>Name for the version of the Entity Recognizer.
...
Conflicts with <code>version_name_prefix</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#versionnameprefix_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique version name beginning with the specified prefix.
Has a maximum length of 37 characters.
Can contain upper- and lower-case letters, numbers, and hypen (<code>-</code>).
Conflicts with <code>version_name</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#volumekmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>ID or ARN of a KMS Key used to encrypt storage volumes during job processing.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcconfig_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#entityrecognizervpcconfig">Entity<wbr>Recognizer<wbr>Vpc<wbr>Config</a></span>
    </dt>
    <dd>Configuration parameters for VPC to contain Entity Recognizer resources.
See the <code>vpc_config</code> Configuration Block section below.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the Entity Recognizer version.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetEntityRecognizer<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">EntityRecognizerState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">EntityRecognizer</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">EntityRecognizer</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">EntityRecognizerState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:comprehend:EntityRecognizer</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the Entity Recognizer version.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dataaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd>The ARN for an IAM Role which allows Comprehend to read the training and testing data.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_inputdataconfig_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Data<wbr>Config</a>
    ...
    <dd>Configuration for the training and testing data.
See the <code>input_data_config</code> Configuration Block section below.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="entityrecognizerinputdataconfig">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entitytypes_csharp" style="color: inherit; text-decoration: inherit;">Entity<wbr>Types</a>
    ...
    <dd>Set of entity types to be recognized.
Has a maximum of 25 items.
See the <code>entity_types</code> Configuration Block section below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#annotations_csharp" style="color: inherit; text-decoration: inherit;">Annotations</a>
    ...
    <dd>Specifies location of the document annotation data.
See the <code>annotations</code> Configuration Block section below.
One of <code>annotations</code> or <code>entity_list</code> is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#augmentedmanifests_csharp" style="color: inherit; text-decoration: inherit;">Augmented<wbr>Manifests</a>
    ...
    <dd>List of training datasets produced by Amazon SageMaker AI Ground Truth.
Used if <code>data_format</code> is <code>AUGMENTED_MANIFEST</code>.
See the <code>augmented_manifests</code> Configuration Block section below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dataformat_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Format</a>
    ...
    <dd>The format for the training data.
One of <code>COMPREHEND_CSV</code> or <code>AUGMENTED_MANIFEST</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#documents_csharp" style="color: inherit; text-decoration: inherit;">Documents</a>
    ...
    <dd>Specifies a collection of training documents.
Used if <code>data_format</code> is <code>COMPREHEND_CSV</code>.
See the <code>documents</code> Configuration Block section below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entitylist_csharp" style="color: inherit; text-decoration: inherit;">Entity<wbr>List</a>
    ...
    <dd>Specifies location of the entity list data.
See the <code>entity_list</code> Configuration Block section below.
One of <code>entity_list</code> or <code>annotations</code> is required.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="entityrecognizerinputdataconfigannotations">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Annotations<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Annotations<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
    ...
    <dd>Location of training annotations.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="entityrecognizerinputdataconfigaugmentedmanifest">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Augmented<wbr>Manifest<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Augmented<wbr>Manifest<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#attributenames_csharp" style="color: inherit; text-decoration: inherit;">Attribute<wbr>Names</a>
    ...
    <dd>The JSON attribute that contains the annotations for the training documents.</dd><dt class="property-required"
            title="Required">
        <span id="s3uri_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
</span>
    ...
    <dd>Location of augmented manifest file.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#annotationdatas3uri_csharp" style="color: inherit; text-decoration: inherit;">Annotation<wbr>Data<wbr>S3Uri</a>
    ...
    <dd>Location of annotation files.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#documenttype_csharp" style="color: inherit; text-decoration: inherit;">Document<wbr>Type</a>
    ...
    <dd>Type of augmented manifest.
One of <code>PLAIN_TEXT_DOCUMENT</code> or <code>SEMI_STRUCTURED_DOCUMENT</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcedocumentss3uri_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Documents<wbr>S3Uri</a>
    ...
    <dd>Location of source PDF files.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#split_csharp" style="color: inherit; text-decoration: inherit;">Split</a>
    ...
    <dd>Purpose of data in augmented manifest.
One of <code>TRAIN</code> or <code>TEST</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="entityrecognizerinputdataconfigdocuments">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Documents<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Documents<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
    ...
    <dd>Location of training documents.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inputformat_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Format</a>
    ...
    <dd>Specifies how the input files should be processed.
One of <code>ONE_DOC_PER_LINE</code> or <code>ONE_DOC_PER_FILE</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="tests3uri_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tests3uri_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>S3Uri</a>
</span>
...
<h4 id="entityrecognizerinputdataconfigentitylist">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Entity<wbr>List<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Entity<wbr>List<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3uri_csharp" style="color: inherit; text-decoration: inherit;">S3Uri</a>
    ...
    <dd>Location of entity list.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="entityrecognizerinputdataconfigentitytype">
Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Entity<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Input<wbr>Data<wbr>Config<wbr>Entity<wbr>Type<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>An entity type to be matched by the Entity Recognizer.
Cannot contain a newline (<code>\n</code>), carriage return (<code>\r</code>), or tab (<code>\t</code>).</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="entityrecognizervpcconfig">
Entity<wbr>Recognizer<wbr>Vpc<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Entity<wbr>Recognizer<wbr>Vpc<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
