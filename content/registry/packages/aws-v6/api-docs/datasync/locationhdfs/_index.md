...
<span class="k">def </span><span class="nx">LocationHdfs</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">kerberos_keytab_base64</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 <span class="nx">kerberos_krb5_conf</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 <span class="nx">kerberos_krb5_conf_base64</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewLocationHdfs</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">LocationHdfsArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">LocationHdfs</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:datasync:LocationHdfs</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namenodes_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsnamenode">List&lt;Location<wbr>Hdfs<wbr>Name<wbr>Node&gt;</a></span>
    </dt>
    <dd>The NameNode that manages the HDFS namespace. The NameNode performs operations such as opening, closing, and renaming files and directories. The NameNode contains the information to map blocks of data to the DataNodes. You can use only one NameNode. See configuration below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticationtype_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Type</a>
    ...
    <dd>The type of authentication used to determine the identity of the user. Valid values are <code>SIMPLE</code> and <code>KERBEROS</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blocksize_csharp" style="color: inherit; text-decoration: inherit;">Block<wbr>Size</a>
    ...
    <dd>The size of data blocks to write into the HDFS cluster. The block size must be a multiple of 512 bytes. The default block size is 128 mebibytes (MiB).</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytab_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskeytabbase64_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytabbase64_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Use instead of <code>kerberos_keytab</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab</code>) is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5conf_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskrb5confbase64_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5confbase64_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Use instead of <code>kerberos_krb5_conf</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf</code>) is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberosprincipal_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Principal</a>
    ...
    <dd>The Kerberos principal with access to the files and folders on the HDFS cluster. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyprovideruri_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Provider<wbr>Uri</a>
    ...
    <dd>The URI of the HDFS cluster's Key Management Server (KMS).</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qopconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Qop<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsqopconfiguration">Location<wbr>Hdfs<wbr>Qop<wbr>Configuration</a></span>
    </dt>
    <dd>The Quality of Protection (QOP) configuration specifies the Remote Procedure Call (RPC) and data transfer protection settings configured on the Hadoop Distributed File System (HDFS) cluster. If <code>qop_configuration</code> isn't specified, <code>rpc_protection</code> and <code>data_transfer_protection</code> default to <code>PRIVACY</code>. If you set RpcProtection or DataTransferProtection, the other parameter assumes the same value.  See configuration below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicationfactor_csharp" style="color: inherit; text-decoration: inherit;">Replication<wbr>Factor</a>
    ...
    <dd>The number of DataNodes to replicate the data to when writing to the HDFS cluster. By default, data is replicated to three DataNodes.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#simpleuser_csharp" style="color: inherit; text-decoration: inherit;">Simple<wbr>User</a>
    ...
    <dd>The user name used to identify the client on the host operating system. If <code>SIMPLE</code> is specified for <code>authentication_type</code>, this parameter is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytab_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskeytabbase64_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytabbase64_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5conf_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskrb5confbase64_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5confbase64_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytab_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskeytabbase64_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytabbase64_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5conf_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskrb5confbase64_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5confbase64_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namenodes_nodejs" style="color: inherit; text-decoration: inherit;">name<wbr>Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsnamenode">Location<wbr>Hdfs<wbr>Name<wbr>Node[]</a></span>
    </dt>
    <dd>The NameNode that manages the HDFS namespace. The NameNode performs operations such as opening, closing, and renaming files and directories. The NameNode contains the information to map blocks of data to the DataNodes. You can use only one NameNode. See configuration below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytab_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskeytabbase64_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytabbase64_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5conf_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskrb5confbase64_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5confbase64_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberos_keytab_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberos_keytab_base64_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberos_keytab_base64_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>keytab_<wbr>base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberos_krb5_conf_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>krb5_<wbr>conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberos_krb5_conf_base64_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberos_krb5_conf_base64_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>krb5_<wbr>conf_<wbr>base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytab_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskeytabbase64_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskeytabbase64_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5conf_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="kerberoskrb5confbase64_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kerberoskrb5confbase64_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetLocationHdfs<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">LocationHdfsState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">LocationHdfs</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">LocationHdfs</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">LocationHdfsState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:datasync:LocationHdfs</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytab_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytabbase64_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytabbase64_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5conf_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5confbase64_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5confbase64_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytab_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytabbase64_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytabbase64_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5conf_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5confbase64_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5confbase64_go" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_authenticationtype_java" style="color: inherit; text-decoration: inherit;">authentication<wbr>Type</a>
    ...
    <dd>The type of authentication used to determine the identity of the user. Valid values are <code>SIMPLE</code> and <code>KERBEROS</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_blocksize_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_blocksize_java" style="color: inherit; text-decoration: inherit;">block<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
    <dd>The size of data blocks to write into the HDFS cluster. The block size must be a multiple of 512 bytes. The default block size is 128 mebibytes (MiB).</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytab_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytab_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytabbase64_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytabbase64_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Use instead of <code>kerberos_keytab</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5conf_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5conf_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5confbase64_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5confbase64_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Use instead of <code>kerberos_krb5_conf</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberosprincipal_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberosprincipal_java" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Principal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kerberos principal with access to the files and folders on the HDFS cluster. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kmskeyprovideruri_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kmskeyprovideruri_java" style="color: inherit; text-decoration: inherit;">kms<wbr>Key<wbr>Provider<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The URI of the HDFS cluster's Key Management Server (KMS).</dd><dt class="property-optional"
            title="Optional">
        <span id="state_namenodes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_namenodes_java" style="color: inherit; text-decoration: inherit;">name<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsnamenode">List&lt;Location<wbr>Hdfs<wbr>Name<wbr>Node&gt;</a></span>
    </dt>
    <dd>The NameNode that manages the HDFS namespace. The NameNode performs operations such as opening, closing, and renaming files and directories. The NameNode contains the information to map blocks of data to the DataNodes. You can use only one NameNode. See configuration below.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_qopconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_qopconfiguration_java" style="color: inherit; text-decoration: inherit;">qop<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsqopconfiguration">Location<wbr>Hdfs<wbr>Qop<wbr>Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_replicationfactor_java" style="color: inherit; text-decoration: inherit;">replication<wbr>Factor</a>
    ...
    <dd>The number of DataNodes to replicate the data to when writing to the HDFS cluster. By default, data is replicated to three DataNodes.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_simpleuser_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_simpleuser_java" style="color: inherit; text-decoration: inherit;">simple<wbr>User</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytab_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytabbase64_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytabbase64_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5conf_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5confbase64_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5confbase64_nodejs" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberos_keytab_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>keytab</a>
    ...
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberos_keytab_base64_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberos_keytab_base64_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>keytab_<wbr>base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberos_krb5_conf_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>krb5_<wbr>conf</a>
    ...
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberos_krb5_conf_base64_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberos_krb5_conf_base64_python" style="color: inherit; text-decoration: inherit;">kerberos_<wbr>krb5_<wbr>conf_<wbr>base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_authenticationtype_yaml" style="color: inherit; text-decoration: inherit;">authentication<wbr>Type</a>
    ...
    <dd>The type of authentication used to determine the identity of the user. Valid values are <code>SIMPLE</code> and <code>KERBEROS</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_blocksize_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_blocksize_yaml" style="color: inherit; text-decoration: inherit;">block<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
    <dd>The size of data blocks to write into the HDFS cluster. The block size must be a multiple of 512 bytes. The default block size is 128 mebibytes (MiB).</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytab_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytab_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys. Use <code>kerberos_keytab_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskeytabbase64_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskeytabbase64_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Keytab<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Use instead of <code>kerberos_keytab</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_keytab</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5conf_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5conf_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The krb5.conf file that contains the Kerberos configuration information. Use <code>kerberos_krb5_conf_base64</code> instead whenever the value is not a valid UTF-8 string. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf_base64</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberoskrb5confbase64_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberoskrb5confbase64_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Krb5Conf<wbr>Base64</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Use instead of <code>kerberos_krb5_conf</code> to pass base64-encoded binary data directly. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter (or <code>kerberos_krb5_conf</code>) is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kerberosprincipal_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kerberosprincipal_yaml" style="color: inherit; text-decoration: inherit;">kerberos<wbr>Principal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kerberos principal with access to the files and folders on the HDFS cluster. If <code>KERBEROS</code> is specified for <code>authentication_type</code>, this parameter is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_kmskeyprovideruri_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_kmskeyprovideruri_yaml" style="color: inherit; text-decoration: inherit;">kms<wbr>Key<wbr>Provider<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The URI of the HDFS cluster's Key Management Server (KMS).</dd><dt class="property-optional"
            title="Optional">
        <span id="state_namenodes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_namenodes_yaml" style="color: inherit; text-decoration: inherit;">name<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsnamenode">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The NameNode that manages the HDFS namespace. The NameNode performs operations such as opening, closing, and renaming files and directories. The NameNode contains the information to map blocks of data to the DataNodes. You can use only one NameNode. See configuration below.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_qopconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_qopconfiguration_yaml" style="color: inherit; text-decoration: inherit;">qop<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationhdfsqopconfiguration">Property Map</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_replicationfactor_yaml" style="color: inherit; text-decoration: inherit;">replication<wbr>Factor</a>
    ...
    <dd>The number of DataNodes to replicate the data to when writing to the HDFS cluster. By default, data is replicated to three DataNodes.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_simpleuser_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_simpleuser_yaml" style="color: inherit; text-decoration: inherit;">simple<wbr>User</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="locationhdfsnamenode">
Location<wbr>Hdfs<wbr>Name<wbr>Node<pulumi-choosable type="language" values="python,go" class="inline">, Location<wbr>Hdfs<wbr>Name<wbr>Node<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Hostname</a>
    ...
    <dd>The hostname of the NameNode in the HDFS cluster. This value is the IP address or Domain Name Service (DNS) name of the NameNode. An agent that's installed on-premises uses this hostname to communicate with the NameNode in the network.</dd><dt class="property-required"
            title="Required">
        <span id="port_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>The port that the NameNode uses to listen to client requests.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="locationhdfsqopconfiguration">
Location<wbr>Hdfs<wbr>Qop<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Location<wbr>Hdfs<wbr>Qop<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rpcprotection_csharp" style="color: inherit; text-decoration: inherit;">Rpc<wbr>Protection</a>
    ...
    <dd>The RPC protection setting configured on the HDFS cluster. This setting corresponds to your hadoop.rpc.protection setting in your core-site.xml file on your Hadoop cluster. Valid values are <code>DISABLED</code>, <code>AUTHENTICATION</code>, <code>INTEGRITY</code> and <code>PRIVACY</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="datatransferprotection_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatransferprotection_java" style="color: inherit; text-decoration: inherit;">data<wbr>Transfer<wbr>Protection</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The data transfer protection setting configured on the HDFS cluster. This setting corresponds to your dfs.data.transfer.protection setting in the hdfs-site.xml file on your Hadoop cluster. Valid values are <code>DISABLED</code>, <code>AUTHENTICATION</code>, <code>INTEGRITY</code> and <code>PRIVACY</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="rpcprotection_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rpcprotection_java" style="color: inherit; text-decoration: inherit;">rpc<wbr>Protection</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="datatransferprotection_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatransferprotection_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Transfer<wbr>Protection</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The data transfer protection setting configured on the HDFS cluster. This setting corresponds to your dfs.data.transfer.protection setting in the hdfs-site.xml file on your Hadoop cluster. Valid values are <code>DISABLED</code>, <code>AUTHENTICATION</code>, <code>INTEGRITY</code> and <code>PRIVACY</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="rpcprotection_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rpcprotection_yaml" style="color: inherit; text-decoration: inherit;">rpc<wbr>Protection</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
