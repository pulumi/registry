...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:dms:Certificate</span><span class="p"></span>
...
```java
var examplecertificateResourceResourceFromDmscertificate = new com.pulumi.aws.dms.Certificate("examplecertificateResourceResourceFromDmscertificate", com.pulumi.aws.dms.CertificateArgs.builder()
    .certificateId("string")
    .certificatePem("string")
    .certificateWallet("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificateid_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Id</a>
    ...
    <dd>The certificate identifier.</p>
<ul>
<li>Must contain from 1 to 255 alphanumeric characters and hyphens.</li>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatepem_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Pem</a>
    ...
    <dd>The contents of the .pem X.509 certificate file for the certificate. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatewallet_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Wallet</a>
    ...
    <dd>The contents of the Oracle Wallet certificate for use with SSL, provided as a base64-encoded String. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatearn_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) for the certificate.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:dms:Certificate</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatearn_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) for the certificate.</dd><dt class="property-optional property-replacement"
            title="Optional">
