...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ec2:FlowLog</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#delivercrossaccountrole_csharp" style="color: inherit; text-decoration: inherit;">Deliver<wbr>Cross<wbr>Account<wbr>Role</a>
    ...
    <dd>ARN of the IAM role that allows Amazon EC2 to publish flow logs across accounts.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#destinationoptions_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowlogdestinationoptions">Flow<wbr>Log<wbr>Destination<wbr>Options</a></span>
    </dt>
    <dd>Describes the destination options for a flow log. More details below.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#eniid_csharp" style="color: inherit; text-decoration: inherit;">Eni<wbr>Id</a>
    ...
    <dd>Elastic Network Interface ID to attach to</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#iamrolearn_csharp" style="color: inherit; text-decoration: inherit;">Iam<wbr>Role<wbr>Arn</a>
    ...
    <dd>The ARN for the IAM role that's used to post flow logs to a CloudWatch Logs log group</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logdestination_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Destination</a>
    ...
    <dd>The ARN of the logging destination. Either <code>log_destination</code> or <code>log_group_name</code> must be set.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logdestinationtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Destination<wbr>Type</a>
    ...
    <dd>The type of the logging destination. Valid values: <code>cloud-watch-logs</code>, <code>s3</code>, <code>kinesis-data-firehose</code>. Default: <code>cloud-watch-logs</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logformat_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Format</a>
    ...
    <dd>The fields to include in the flow log record. Accepted format example: <code>&quot;$${interface-id} $${srcaddr} $${dstaddr} $${srcport} $${dstport}&quot;</code>.</dd><dt class="property-optional property-deprecated property-replacement"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggroupname_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Group<wbr>Name</a>
    ...
    <dd><strong>Deprecated:</strong> Use <code>log_destination</code> instead. The name of the CloudWatch log group. Either <code>log_group_name</code> or <code>log_destination</code> must be set.<p class="property-message">Deprecated: log_group_name is deprecated. Use log_destination instead.</p></dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxaggregationinterval_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Aggregation<wbr>Interval</a>
    ...
    <dd>The maximum interval of time
during which a flow of packets is captured and aggregated into a flow
log record. Valid Values: <code>60</code> seconds (1 minute) or <code>600</code> seconds (10
minutes). Default: <code>600</code>. When <code>transit_gateway_id</code> or <code>transit_gateway_attachment_id</code> is specified, <code>max_aggregation_interval</code> <em>must</em> be 60 seconds (1 minute).</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
    ...
    <dd>Subnet ID to attach to</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<blockquote>
<p><strong>NOTE:</strong> One of <code>eni_id</code>, <code>subnet_id</code>, <code>transit_gateway_id</code>, <code>transit_gateway_attachment_id</code>, or <code>vpc_id</code> must be specified.</p>
</blockquote>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#traffictype_csharp" style="color: inherit; text-decoration: inherit;">Traffic<wbr>Type</a>
    ...
    <dd>The type of traffic to capture. Valid values: <code>ACCEPT</code>,<code>REJECT</code>, <code>ALL</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#transitgatewayattachmentid_csharp" style="color: inherit; text-decoration: inherit;">Transit<wbr>Gateway<wbr>Attachment<wbr>Id</a>
    ...
    <dd>Transit Gateway Attachment ID to attach to</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#transitgatewayid_csharp" style="color: inherit; text-decoration: inherit;">Transit<wbr>Gateway<wbr>Id</a>
    ...
    <dd>Transit Gateway ID to attach to</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Flow Log.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetFlowLog<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">FlowLogState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">FlowLog</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:ec2:FlowLog</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Flow Log.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="flowlogdestinationoptions">
Flow<wbr>Log<wbr>Destination<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Flow<wbr>Log<wbr>Destination<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fileformat_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Format</a>
    ...
    <dd>The format for the flow log. Default value: <code>plain-text</code>. Valid values: <code>plain-text</code>, <code>parquet</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hivecompatiblepartitions_csharp" style="color: inherit; text-decoration: inherit;">Hive<wbr>Compatible<wbr>Partitions</a>
    ...
    <dd>Indicates whether to use Hive-compatible prefixes for flow logs stored in Amazon S3. Default value: <code>false</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#perhourpartition_csharp" style="color: inherit; text-decoration: inherit;">Per<wbr>Hour<wbr>Partition</a>
    ...
    <dd>Indicates whether to partition the flow log per hour. This reduces the cost and response time for queries. Default value: <code>false</code>.</dd></dl>
</pulumi-choosable>
</div>
