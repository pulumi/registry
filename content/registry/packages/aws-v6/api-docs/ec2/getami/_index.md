...
---
title: "getAmi"
title_tag: "aws.ec2.getAmi"
meta_desc: "Documentation for the aws.ec2.getAmi function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_ami<span class="p">(</span><span class="nx">executable_users</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">include_deprecated</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
def </span>get_ami_output<span class="p">(</span><span class="nx">executable_users</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">include_deprecated</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">uefi_data</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
><span class="k">func </span>LookupAmi<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAmiArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupAmiResult</a></span>, error)</span
><span class="k">
func </span>LookupAmiOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAmiOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupAmiResultOutput</span
></code></pre></div>
...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetAmiResult</a></span>> </span>getAmi<span class="p">(</span><span class="nx">GetAmiArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> aws:ec2/getAmi:getAmi
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#executableusers_csharp" style="color: inherit; text-decoration: inherit;">Executable<wbr>Users</a>
    ...
    <dd>Limit search to users with <em>explicit</em> launch permission on
the image. Valid items are the numeric account ID or <code>self</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includedeprecated_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Deprecated</a>
    ...
    <dd>If true, all deprecated AMIs are included in the response. If false, no deprecated AMIs are included in the response. If no value is specified, the default value is false.</dd><dt class="property-optional"
            title="Optional">
...
recent AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd><p>Regex string to apply to the AMI list returned
by AWS. This allows more advanced filtering not supported from the AWS API. This
filtering is done locally on what AWS returns, and could have a performance
impact if the result is large. Combine this with other
options to narrow down the list AWS returns.</p>
<blockquote>
<p><strong>NOTE:</strong> If more or less than a single match is returned by the search,
this call will fail. Ensure that your search is specific enough to return
a single AMI ID only, or use <code>most_recent</code> to choose the most recent one. If
you want to match multiple AMIs, use the <code>aws.ec2.getAmiIds</code> data source instead.</p>
</blockquote>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#owners_csharp" style="color: inherit; text-decoration: inherit;">Owners</a>
    ...
    <dd>List of AMI owners to limit search. Valid values: an AWS account ID, <code>self</code> (the current account), or an AWS owner alias (e.g., <code>amazon</code>, <code>aws-marketplace</code>, <code>microsoft</code>).</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Any tags assigned to the image.</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uefidata_csharp" style="color: inherit; text-decoration: inherit;">Uefi<wbr>Data</a>
    ...
    <dd>(Optional) Base64 representation of the non-volatile UEFI variable store.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_csharp" style="color: inherit; text-decoration: inherit;">Architecture</a>
    ...
    <dd>OS architecture of the AMI (ie: <code>i386</code> or <code>x86_64</code>).</dd><dt class="property-"
            title="">
        <span id="arn_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blockdevicemappings_csharp" style="color: inherit; text-decoration: inherit;">Block<wbr>Device<wbr>Mappings</a>
    ...
    <dd>Set of objects with block device mappings of the AMI.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bootmode_csharp" style="color: inherit; text-decoration: inherit;">Boot<wbr>Mode</a>
    ...
    <dd>Boot mode of the image.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#creationdate_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Date</a>
    ...
    <dd>Date and time the image was created.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deprecationtime_csharp" style="color: inherit; text-decoration: inherit;">Deprecation<wbr>Time</a>
    ...
    <dd>Date and time when the image will be deprecated.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description of the AMI that was provided during image
creation.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enasupport_csharp" style="color: inherit; text-decoration: inherit;">Ena<wbr>Support</a>
    ...
    <dd>Whether enhanced networking with ENA is enabled.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imageid_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Id</a>
    ...
    <dd>ID of the AMI. Should be the same as the resource <code>id</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagelocation_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Location</a>
    ...
    <dd>Location of the AMI.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imageowneralias_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Owner<wbr>Alias</a>
    ...
    <dd>AWS account alias (for example, <code>amazon</code>, <code>self</code>) or
the AWS account ID of the AMI owner.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imdssupport_csharp" style="color: inherit; text-decoration: inherit;">Imds<wbr>Support</a>
    ...
    <dd>Instance Metadata Service (IMDS) support mode for the image. Set to <code>v2.0</code> if instances ran from this image enforce IMDSv2.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kernelid_csharp" style="color: inherit; text-decoration: inherit;">Kernel<wbr>Id</a>
    ...
    <dd>Kernel associated with the image, if any. Only applicable
for machine images.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the AMI that was provided during image creation.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#platform_csharp" style="color: inherit; text-decoration: inherit;">Platform</a>
    ...
    <dd>Value is Windows for <code>Windows</code> AMIs; otherwise blank.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#productcodes_csharp" style="color: inherit; text-decoration: inherit;">Product<wbr>Codes</a>
    ...
    <dd>Any product codes associated with the AMI.</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#public_csharp" style="color: inherit; text-decoration: inherit;">Public</a>
    ...
    <dd><code>true</code> if the image has public launch permissions.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ramdiskid_csharp" style="color: inherit; text-decoration: inherit;">Ramdisk<wbr>Id</a>
    ...
    <dd>RAM disk associated with the image, if any. Only applicable
for machine images.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootdevicename_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Device<wbr>Name</a>
    ...
    <dd>Device name of the root device.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootdevicetype_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Device<wbr>Type</a>
    ...
    <dd>Type of root device (ie: <code>ebs</code> or <code>instance-store</code>).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootsnapshotid_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Snapshot<wbr>Id</a>
    ...
    <dd>Snapshot id associated with the root device, if any
(only applies to <code>ebs</code> root devices).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sriovnetsupport_csharp" style="color: inherit; text-decoration: inherit;">Sriov<wbr>Net<wbr>Support</a>
    ...
    <dd>Whether enhanced networking is enabled.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Current state of the AMI. If the state is <code>available</code>, the image
is successfully registered and can be used to launch an instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statereason_csharp" style="color: inherit; text-decoration: inherit;">State<wbr>Reason</a>
    ...
    <dd>Describes a state change. Fields are <code>UNSET</code> if not available.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tpmsupport_csharp" style="color: inherit; text-decoration: inherit;">Tpm<wbr>Support</a>
    ...
    <dd>If the image is configured for NitroTPM support, the value is <code>v2.0</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usageoperation_csharp" style="color: inherit; text-decoration: inherit;">Usage<wbr>Operation</a>
    ...
    <dd>Operation of the Amazon EC2 instance and the billing code that is associated with the AMI.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualizationtype_csharp" style="color: inherit; text-decoration: inherit;">Virtualization<wbr>Type</a>
    ...
    <dd>Type of virtualization of the AMI (ie: <code>hvm</code> or
<code>paravirtual</code>).</dd><dt class="property-"
            title="">
        <span id="executableusers_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#executableusers_csharp" style="color: inherit; text-decoration: inherit;">Executable<wbr>Users</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ebs_csharp" style="color: inherit; text-decoration: inherit;">Ebs</a>
    ...
    <dd>Map containing EBS information, if the device is EBS based. Unlike most object attributes, these are accessed directly (e.g., <code>ebs.volume_size</code> or <code>ebs[&quot;volume_size&quot;]</code>) rather than accessed through the first element of a list (e.g., <code>ebs[0].volume_size</code>).</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodevice_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Device</a>
    ...
    <dd>Suppresses the specified device included in the block device mapping of the AMI.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualname_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Name</a>
    ...
    <dd>Virtual device name (for instance stores).</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the AMI that was provided during image creation.</dd><dt class="property-required"
            title="Required">
