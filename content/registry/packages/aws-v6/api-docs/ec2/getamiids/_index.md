...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetAmiIdsResult</a></span>> </span>getAmiIds<span class="p">(</span><span class="nx">GetAmiIdsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> aws:ec2/getAmiIds:getAmiIds
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includedeprecated_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Deprecated</a>
    ...
    <dd>If true, all deprecated AMIs are included in the response.
If false, no deprecated AMIs are included in the response. If no value is specified, the default value is <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd>Regex string to apply to the AMI list returned
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sortascending_csharp" style="color: inherit; text-decoration: inherit;">Sort<wbr>Ascending</a>
    ...
    <dd>Used to sort AMIs by creation time.
If no value is specified, the default value is <code>false</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ids_csharp" style="color: inherit; text-decoration: inherit;">Ids</a>
    ...
    <dd>is set to the list of AMI IDs, sorted by creation time according to <code>sort_ascending</code>.</dd><dt class="property-"
            title="">
        <span id="owners_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#owners_csharp" style="color: inherit; text-decoration: inherit;">Owners</a>
</span>
