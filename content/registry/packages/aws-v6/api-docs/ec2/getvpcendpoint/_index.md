...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetVpcEndpointResult</a></span>> </span>getVpcEndpoint<span class="p">(</span><span class="nx">GetVpcEndpointArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>ID of the specific VPC Endpoint to retrieve.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#servicename_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Name</a>
    ...
    <dd>Service name of the specific VPC Endpoint to retrieve. For AWS services the service name is usually in the form <code>com.amazonaws.&lt;region&gt;.&lt;service&gt;</code> (the SageMaker AI Notebook service is an exception to this rule, the service name is in the form <code>aws.sagemaker.&lt;region&gt;.notebook</code>).</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>State of the specific VPC Endpoint to retrieve.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
a pair on the specific VPC Endpoint to retrieve.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd><p>ID of the VPC in which the specific VPC Endpoint is used.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the VPC endpoint.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cidrblocks_csharp" style="color: inherit; text-decoration: inherit;">Cidr<wbr>Blocks</a>
    ...
    <dd>List of CIDR blocks for the exposed AWS service. Applicable for endpoints of type <code>Gateway</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsentries_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Entries</a>
    ...
    <dd>DNS entries for the VPC Endpoint. Applicable for endpoints of type <code>Interface</code>. DNS entry blocks are documented below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsoptions_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getvpcendpointdnsoption">List&lt;Get<wbr>Vpc<wbr>Endpoint<wbr>Dns<wbr>Option&gt;</a></span>
    </dt>
    <dd>DNS options for the VPC Endpoint. DNS options blocks are documented below.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ownerid_csharp" style="color: inherit; text-decoration: inherit;">Owner<wbr>Id</a>
    ...
    <dd>ID of the AWS account that owns the VPC endpoint.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
    ...
    <dd>Policy document associated with the VPC Endpoint. Applicable for endpoints of type <code>Gateway</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefixlistid_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>List<wbr>Id</a>
    ...
    <dd>Prefix list ID of the exposed AWS service. Applicable for endpoints of type <code>Gateway</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatednsenabled_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Enabled</a>
    ...
    <dd>Whether or not the VPC is associated with a private hosted zone - <code>true</code> or <code>false</code>. Applicable for endpoints of type <code>Interface</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#routetableids_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Table<wbr>Ids</a>
    ...
    <dd>One or more route tables associated with the VPC Endpoint. Applicable for endpoints of type <code>Gateway</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupids_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Ids</a>
    ...
    <dd>One or more security groups associated with the network interfaces. Applicable for endpoints of type <code>Interface</code>.</dd><dt class="property-"
            title="">
        <span id="servicename_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#servicename_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Name</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>One or more subnets in which the VPC Endpoint is located. Applicable for endpoints of type <code>Interface</code>.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcendpointtype_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Endpoint<wbr>Type</a>
    ...
    <dd>VPC Endpoint type, <code>Gateway</code> or <code>Interface</code>.</dd><dt class="property-"
            title="">
        <span id="vpcid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsoptions_go" style="color: inherit; text-decoration: inherit;">Dns<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getvpcendpointdnsoption">[]Get<wbr>Vpc<wbr>Endpoint<wbr>Dns<wbr>Option</a></span>
    </dt>
    <dd>DNS options for the VPC Endpoint. DNS options blocks are documented below.</dd><dt class="property-"
            title="">
        <span id="id_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dns_options_python" style="color: inherit; text-decoration: inherit;">dns_<wbr>options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getvpcendpointdnsoption">Sequence[Get<wbr>Vpc<wbr>Endpoint<wbr>Dns<wbr>Option]</a></span>
    </dt>
    <dd>DNS options for the VPC Endpoint. DNS options blocks are documented below.</dd><dt class="property-"
            title="">
        <span id="id_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsoptions_yaml" style="color: inherit; text-decoration: inherit;">dns<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getvpcendpointdnsoption">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>DNS options for the VPC Endpoint. DNS options blocks are documented below.</dd><dt class="property-"
            title="">
        <span id="id_yaml">
...
<h4 id="getvpcendpointdnsoption">Get<wbr>Vpc<wbr>Endpoint<wbr>Dns<wbr>Option</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsrecordiptype_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Record<wbr>Ip<wbr>Type</a>
    ...
    <dd>The DNS records created for the endpoint.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatednsonlyforinboundresolverendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Only<wbr>For<wbr>Inbound<wbr>Resolver<wbr>Endpoint</a>
    ...
    <dd>Indicates whether to enable private DNS only for inbound endpoints.</dd></dl>
</pulumi-choosable>
</div>
...
<a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcEndpoints.html">the underlying AWS API</a>.</dd><dt class="property-required"
            title="Required">
...
A VPC Endpoint will be selected if any one of the given values matches.</dd></dl>
</pulumi-choosable>
</div>
