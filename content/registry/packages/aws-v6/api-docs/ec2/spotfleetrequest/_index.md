...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSpotFleetRequest</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SpotFleetRequestArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SpotFleetRequest</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ec2:SpotFleetRequest</span><span class="p"></span>
...
terminateInstancesWithExpiration.</dd><dt class="property-required"
            title="Required">
...
important to your application workload, such as vCPUs, memory, or I/O.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<code>lowestPrice</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
request is decreased below the current size of the Spot fleet.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
capacity or also attempts to maintain it. Default is <code>maintain</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<code>terminate</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancepoolstousecount_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Pools<wbr>To<wbr>Use<wbr>Count</a>
    ...
    <dd>The number of Spot pools across which to allocate your target Spot capacity.
Valid only when <code>allocation_strategy</code> is set to <code>lowestPrice</code>. Spot Fleet selects
the cheapest Spot pools and evenly allocates your target Spot capacity across
the number of Spot pools that you specify.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateconfigs_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Configs</a>
    ...
    <dd>Launch template configuration block. See Launch Template Configs below for more details. Conflicts with <code>launch_specification</code>. At least one of <code>launch_specification</code> or <code>launch_template_config</code> is required.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loadbalancers_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancers</a>
    ...
    <dd>A list of elastic load balancer names to add to the Spot fleet.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ondemandallocationstrategy_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Demand<wbr>Allocation<wbr>Strategy</a>
    ...
    <dd>The order of the launch template overrides to use in fulfilling On-Demand capacity. the possible values are: <code>lowestPrice</code> and <code>prioritized</code>. the default is <code>lowestPrice</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ondemandmaxtotalprice_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Demand<wbr>Max<wbr>Total<wbr>Price</a>
    ...
    <dd>The maximum amount per hour for On-Demand Instances that you're willing to pay. When the maximum amount you're willing to pay is reached, the fleet stops launching instances even if it hasn’t met the target capacity.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ondemandtargetcapacity_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Demand<wbr>Target<wbr>Capacity</a>
    ...
    <dd>The number of On-Demand units to request. If the request type is <code>maintain</code>, you can specify a target capacity of 0 and add capacity later.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replaceunhealthyinstances_csharp" style="color: inherit; text-decoration: inherit;">Replace<wbr>Unhealthy<wbr>Instances</a>
    ...
    <dd>Indicates whether Spot fleet should replace unhealthy instances. Default <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spotprice_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Price</a>
    ...
    <dd>The maximum bid price per unit hour.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetcapacityunittype_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Capacity<wbr>Unit<wbr>Type</a>
    ...
    <dd>The unit for the target capacity. This can only be done with <code>instance_requirements</code> defined</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetgrouparns_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Group<wbr>Arns</a>
    ...
    <dd>A list of <code>aws.alb.TargetGroup</code> ARNs, for use with Application Load Balancing.</dd><dt class="property-optional"
            title="Optional">
...
If no value is specified, the value of the <code>terminate_instances_with_expiration</code> argument is used.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#terminateinstanceswithexpiration_csharp" style="color: inherit; text-decoration: inherit;">Terminate<wbr>Instances<wbr>With<wbr>Expiration</a>
    ...
    <dd>Indicates whether running Spot
instances should be terminated when the Spot fleet request expires.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validuntil_csharp" style="color: inherit; text-decoration: inherit;">Valid<wbr>Until</a>
    ...
    <dd>The end date and time of the request, in UTC <a href="https://tools.ietf.org/html/rfc3339#section-5.8">RFC3339</a> format(for example, YYYY-MM-DDTHH:MM:SSZ). At this point, no new Spot instance requests are placed or enabled to fulfill the request.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spotrequeststate_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Request<wbr>State</a>
    ...
    <dd>The state of the Spot fleet request.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetSpotFleetRequest<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">SpotFleetRequestState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SpotFleetRequest</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">SpotFleetRequest</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">SpotFleetRequestState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:ec2:SpotFleetRequest</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_allocationstrategy_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Strategy</a>
    ...
    <dd>Indicates how to allocate the target capacity across
the Spot pools specified by the Spot fleet request. Valid values: <code>lowestPrice</code>, <code>diversified</code>, <code>capacityOptimized</code>, <code>capacityOptimizedPrioritized</code>, and <code>priceCapacityOptimized</code>. The default is
<code>lowestPrice</code>.</dd><dt class="property-optional"
            title="Optional">
...
Spot instances on your behalf when you cancel its Spot fleet request using
CancelSpotFleetRequests or when the Spot fleet request expires, if you set
terminateInstancesWithExpiration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_spotrequeststate_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Request<wbr>State</a>
    ...
    <dd>The state of the Spot fleet request.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="spotfleetrequestlaunchspecification">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancetype_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Type</a>
    ...
    <dd>The type of instance to request.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzone_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone</a>
    ...
    <dd>The availability zone in which to place the request.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spotprice_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Price</a>
    ...
    <dd>The maximum bid price per unit hour.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
    ...
    <dd>The subnet in which to launch the requested instance.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#weightedcapacity_csharp" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Capacity</a>
    ...
    <dd>The capacity added to the fleet by a fulfilled request.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="spotfleetrequestlaunchspecificationebsblockdevice">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Ebs<wbr>Block<wbr>Device<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Ebs<wbr>Block<wbr>Device<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchspecificationephemeralblockdevice">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Ephemeral<wbr>Block<wbr>Device<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Ephemeral<wbr>Block<wbr>Device<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchspecificationrootblockdevice">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Root<wbr>Block<wbr>Device<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Specification<wbr>Root<wbr>Block<wbr>Device<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfig">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplatespecification_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Specification</a>
    ...
    <dd>Launch template specification. See Launch Template Specification below for more details.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#overrides_csharp" style="color: inherit; text-decoration: inherit;">Overrides</a>
    ...
    <dd>One or more override configurations. See Overrides below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="spotfleetrequestlaunchtemplateconfiglaunchtemplatespecification">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Launch<wbr>Template<wbr>Specification<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Launch<wbr>Template<wbr>Specification<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>The ID of the launch template. Conflicts with <code>name</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The name of the launch template. Conflicts with <code>id</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverride">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzone_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone</a>
    ...
    <dd>The availability zone in which to place the request.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancerequirements_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Requirements</a>
    ...
    <dd>The instance requirements. See below.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="instancetype_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancetype_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Type</a>
</span>
    ...
    <dd>The type of instance to request.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>The priority for the launch template override. The lower the number, the higher the priority. If no number is set, the launch template override has the lowest priority.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="spotprice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spotprice_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Price</a>
</span>
    ...
    <dd>The maximum spot bid for this override request.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="subnetid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
</span>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirements">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#acceleratorcount_csharp" style="color: inherit; text-decoration: inherit;">Accelerator<wbr>Count</a>
    ...
    <dd>Block describing the minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips). Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
* nvidia
* xilinx
</code></pre></dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#acceleratortotalmemorymib_csharp" style="color: inherit; text-decoration: inherit;">Accelerator<wbr>Total<wbr>Memory<wbr>Mib</a>
    ...
    <dd>Block describing the minimum and maximum total memory of the accelerators. Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#baremetal_csharp" style="color: inherit; text-decoration: inherit;">Bare<wbr>Metal</a>
    ...
    <dd>Indicate whether bare metal instace types should be <code>included</code>, <code>excluded</code>, or <code>required</code>. Default is <code>excluded</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#baselineebsbandwidthmbps_csharp" style="color: inherit; text-decoration: inherit;">Baseline<wbr>Ebs<wbr>Bandwidth<wbr>Mbps</a>
    ...
    <dd>Block describing the minimum and maximum baseline EBS bandwidth, in Mbps. Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#burstableperformance_csharp" style="color: inherit; text-decoration: inherit;">Burstable<wbr>Performance</a>
    ...
    <dd>Indicate whether burstable performance instance types should be <code>included</code>, <code>excluded</code>, or <code>required</code>. Default is <code>excluded</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#localstorage_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Storage</a>
    ...
    <dd>Indicate whether instance types with local storage volumes are <code>included</code>, <code>excluded</code>, or <code>required</code>. Default is <code>included</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memorygibpervcpu_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Gib<wbr>Per<wbr>Vcpu</a>
    ...
    <dd>Block describing the minimum and maximum amount of memory (GiB) per vCPU. Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memorymib_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Mib</a>
    ...
    <dd>Block describing the minimum and maximum amount of memory (MiB). Default is no maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networkbandwidthgbps_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Bandwidth<wbr>Gbps</a>
    ...
    <dd>Block describing the minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networkinterfacecount_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface<wbr>Count</a>
    ...
    <dd>Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requirehibernatesupport_csharp" style="color: inherit; text-decoration: inherit;">Require<wbr>Hibernate<wbr>Support</a>
    ...
    <dd>Indicate whether instance types must support On-Demand Instance Hibernation, either <code>true</code> or <code>false</code>. Default is <code>false</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#totallocalstoragegb_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Local<wbr>Storage<wbr>Gb</a>
    ...
    <dd>Block describing the minimum and maximum total local storage (GB). Default is no minimum or maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsacceleratorcount">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Accelerator<wbr>Count<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Accelerator<wbr>Count<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_csharp" style="color: inherit; text-decoration: inherit;">Max</a>
    ...
    <dd>Maximum. Set to <code>0</code> to exclude instance types with accelerators.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="min_csharp">
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsacceleratortotalmemorymib">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Accelerator<wbr>Total<wbr>Memory<wbr>Mib<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Accelerator<wbr>Total<wbr>Memory<wbr>Mib<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_csharp" style="color: inherit; text-decoration: inherit;">Max</a>
    ...
    <dd>Maximum.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="min_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#min_csharp" style="color: inherit; text-decoration: inherit;">Min</a>
</span>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsbaselineebsbandwidthmbps">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Baseline<wbr>Ebs<wbr>Bandwidth<wbr>Mbps<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Baseline<wbr>Ebs<wbr>Bandwidth<wbr>Mbps<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsmemorygibpervcpu">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Memory<wbr>Gib<wbr>Per<wbr>Vcpu<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Memory<wbr>Gib<wbr>Per<wbr>Vcpu<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_csharp" style="color: inherit; text-decoration: inherit;">Max</a>
    ...
    <dd>Maximum. May be a decimal number, e.g. <code>0.5</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="min_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#min_csharp" style="color: inherit; text-decoration: inherit;">Min</a>
</span>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsmemorymib">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Memory<wbr>Mib<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Memory<wbr>Mib<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsnetworkbandwidthgbps">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Network<wbr>Bandwidth<wbr>Gbps<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Network<wbr>Bandwidth<wbr>Gbps<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsnetworkinterfacecount">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Network<wbr>Interface<wbr>Count<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Network<wbr>Interface<wbr>Count<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementstotallocalstoragegb">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Total<wbr>Local<wbr>Storage<wbr>Gb<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Total<wbr>Local<wbr>Storage<wbr>Gb<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestlaunchtemplateconfigoverrideinstancerequirementsvcpucount">
Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Vcpu<wbr>Count<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Launch<wbr>Template<wbr>Config<wbr>Override<wbr>Instance<wbr>Requirements<wbr>Vcpu<wbr>Count<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestspotmaintenancestrategies">
Spot<wbr>Fleet<wbr>Request<wbr>Spot<wbr>Maintenance<wbr>Strategies<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Spot<wbr>Maintenance<wbr>Strategies<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="spotfleetrequestspotmaintenancestrategiescapacityrebalance">
Spot<wbr>Fleet<wbr>Request<wbr>Spot<wbr>Maintenance<wbr>Strategies<wbr>Capacity<wbr>Rebalance<pulumi-choosable type="language" values="python,go" class="inline">, Spot<wbr>Fleet<wbr>Request<wbr>Spot<wbr>Maintenance<wbr>Strategies<wbr>Capacity<wbr>Rebalance<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replacementstrategy_csharp" style="color: inherit; text-decoration: inherit;">Replacement<wbr>Strategy</a>
    ...
    <dd>The replacement strategy to use. Only available for spot fleets with <code>fleet_type</code> set to <code>maintain</code>. Valid values: <code>launch</code>.</dd></dl>
</pulumi-choosable>
</div>
