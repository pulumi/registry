...
<span class="k">def </span><span class="nx">Endpoint</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">disconnect_on_session_timeout</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
             ...
             <span class="nx">client_route_enforcement_options</span><span class="p">:</span> <span class="nx">Optional[EndpointClientRouteEnforcementOptionsArgs]</span> = None<span class="p">,</span>
             ...
             <span class="nx">vpn_port</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ec2clientvpn:Endpoint</span><span class="p"></span>
...
var awsEndpointResource = new Aws.Ec2ClientVpn.Endpoint("awsEndpointResource", new()
{
    ...
    ClientRouteEnforcementOptions = new Aws.Ec2ClientVpn.Inputs.EndpointClientRouteEnforcementOptionsArgs
    {
        Enforced = false,
    },
...
example, err := ec2clientvpn.NewEndpoint(ctx, "awsEndpointResource", &ec2clientvpn.EndpointArgs{
	...
	ClientRouteEnforcementOptions: &ec2clientvpn.EndpointClientRouteEnforcementOptionsArgs{
...
```java
var awsEndpointResource = new com.pulumi.aws.ec2clientvpn.Endpoint("awsEndpointResource", com.pulumi.aws.ec2clientvpn.EndpointArgs.builder()
    .connectionLogOptions(EndpointConnectionLogOptionsArgs.builder()
        .enabled(false)
        .cloudwatchLogGroup("string")
        .cloudwatchLogStream("string")
    ...
    .selfServicePortal("string")
    .clientRouteEnforcementOptions(EndpointClientRouteEnforcementOptionsArgs.builder()
        .enforced(false)
        .build())
    .sessionTimeoutHours(0)
    .splitTunnel(false)
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticationoptions_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Options</a>
    ...
    <dd>Information about the authentication method to be used to authenticate clients.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientcidrblock_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Cidr<wbr>Block</a>
    ...
    <dd>The IPv4 address range, in CIDR notation, from which to assign client IP addresses. The address range cannot overlap with the local CIDR of the VPC in which the associated subnet is located, or the routes that you add manually. The address range cannot be changed after the Client VPN endpoint has been created. The CIDR block should be /22 or greater.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#connectionlogoptions_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Log<wbr>Options</a>
    ...
    <dd>Information about the client connection logging options.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#servercertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Certificate<wbr>Arn</a>
    ...
    <dd>The ARN of the ACM server certificate.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientconnectoptions_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Connect<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientconnectoptions">Endpoint<wbr>Client<wbr>Connect<wbr>Options</a></span>
    </dt>
    <dd>The options for managing connection authorization for new client connections.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientloginbanneroptions_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Login<wbr>Banner<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientloginbanneroptions">Endpoint<wbr>Client<wbr>Login<wbr>Banner<wbr>Options</a></span>
    </dt>
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="clientrouteenforcementoptions_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientrouteenforcementoptions_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
    <dd>Options for enforce administrator defined routes on devices connected through the VPN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnectonsessiontimeout_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnectonsessiontimeout_csharp" style="color: inherit; text-decoration: inherit;">Disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>Indicates whether the client VPN session is disconnected after the maximum <code>session_timeout_hours</code> is reached. If <code>true</code>, users are prompted to reconnect client VPN. If <code>false</code>, client VPN attempts to reconnect automatically. The default value is <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsservers_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Servers</a>
    ...
    <dd>Information about the DNS servers to be used for DNS resolution. A Client VPN endpoint can have up to two DNS servers. If no DNS server is specified, the DNS address of the connecting device is used.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupids_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Ids</a>
    ...
    <dd>The IDs of one or more security groups to apply to the target network. You must also specify the ID of the VPC that contains the security groups.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportal_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sessiontimeouthours_csharp" style="color: inherit; text-decoration: inherit;">Session<wbr>Timeout<wbr>Hours</a>
    ...
    <dd>The maximum session duration is a trigger by which end-users are required to re-authenticate prior to establishing a VPN session. Default value is <code>24</code> - Valid values: <code>8 | 10 | 12 | 24</code></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#splittunnel_csharp" style="color: inherit; text-decoration: inherit;">Split<wbr>Tunnel</a>
    ...
    <dd>Indicates whether split-tunnel is enabled on VPN endpoint. Default value is <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>A mapping of tags to assign to the resource. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#transportprotocol_csharp" style="color: inherit; text-decoration: inherit;">Transport<wbr>Protocol</a>
    ...
    <dd>The transport protocol to be used by the VPN session. Default value is <code>udp</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd>The ID of the VPC to associate with the Client VPN endpoint. If no security group IDs are specified in the request, the default security group for the VPC is applied.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpnport_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Port</a>
    ...
    <dd>The port number for the Client VPN endpoint. Valid values are <code>443</code> and <code>1194</code>. Default value is <code>443</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientloginbanneroptions_go" style="color: inherit; text-decoration: inherit;">Client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="clientrouteenforcementoptions_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientrouteenforcementoptions_go" style="color: inherit; text-decoration: inherit;">Client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<wbr>Args</a></span>
    </dt>
    <dd>Options for enforce administrator defined routes on devices connected through the VPN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_go" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnectonsessiontimeout_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnectonsessiontimeout_go" style="color: inherit; text-decoration: inherit;">Disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientloginbanneroptions_java" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="clientrouteenforcementoptions_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientrouteenforcementoptions_java" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_java" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnectonsessiontimeout_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnectonsessiontimeout_java" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientloginbanneroptions_nodejs" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="clientrouteenforcementoptions_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientrouteenforcementoptions_nodejs" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_nodejs" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnectonsessiontimeout_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnectonsessiontimeout_nodejs" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#client_login_banner_options_python" style="color: inherit; text-decoration: inherit;">client_<wbr>login_<wbr>banner_<wbr>options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="client_route_enforcement_options_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#client_route_enforcement_options_python" style="color: inherit; text-decoration: inherit;">client_<wbr>route_<wbr>enforcement_<wbr>options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_python" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnect_on_session_timeout_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnect_on_session_timeout_python" style="color: inherit; text-decoration: inherit;">disconnect_<wbr>on_<wbr>session_<wbr>timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientloginbanneroptions_yaml" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="clientrouteenforcementoptions_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientrouteenforcementoptions_yaml" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Property Map</a></span>
    </dt>
    <dd>Options for enforce administrator defined routes on devices connected through the VPN.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_yaml" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="disconnectonsessiontimeout_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disconnectonsessiontimeout_yaml" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Client VPN endpoint.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd>The DNS name to be used by clients when establishing their VPN session.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="selfserviceportalurl_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportalurl_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The URL of the self-service portal.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_go" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="selfserviceportalurl_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportalurl_go" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_java" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="selfserviceportalurl_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportalurl_java" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_nodejs" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="selfserviceportalurl_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportalurl_nodejs" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_python" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="self_service_portal_url_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#self_service_portal_url_python" style="color: inherit; text-decoration: inherit;">self_<wbr>service_<wbr>portal_<wbr>url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_yaml" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="selfserviceportalurl_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfserviceportalurl_yaml" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">security_group_ids</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
        <span class="nx">self_service_portal</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">self_service_portal_url</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">server_certificate_arn</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">session_timeout_hours</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">split_tunnel</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">,</span>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:ec2clientvpn:Endpoint</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Client VPN endpoint.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_authenticationoptions_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Options</a>
    ...
    <dd>Information about the authentication method to be used to authenticate clients.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientcidrblock_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Cidr<wbr>Block</a>
    ...
    <dd>The IPv4 address range, in CIDR notation, from which to assign client IP addresses. The address range cannot overlap with the local CIDR of the VPC in which the associated subnet is located, or the routes that you add manually. The address range cannot be changed after the Client VPN endpoint has been created. The CIDR block should be /22 or greater.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientloginbanneroptions_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_clientrouteenforcementoptions_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientrouteenforcementoptions_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionlogoptions_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Log<wbr>Options</a>
    ...
    <dd>Information about the client connection logging options.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnectonsessiontimeout_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnectonsessiontimeout_csharp" style="color: inherit; text-decoration: inherit;">Disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd>The DNS name to be used by clients when establishing their VPN session.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportal_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_selfserviceportalurl_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportalurl_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The URL of the self-service portal.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientloginbanneroptions_go" style="color: inherit; text-decoration: inherit;">Client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_clientrouteenforcementoptions_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientrouteenforcementoptions_go" style="color: inherit; text-decoration: inherit;">Client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_go" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnectonsessiontimeout_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnectonsessiontimeout_go" style="color: inherit; text-decoration: inherit;">Disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportal_go" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_selfserviceportalurl_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportalurl_go" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientloginbanneroptions_java" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_clientrouteenforcementoptions_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientrouteenforcementoptions_java" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_java" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnectonsessiontimeout_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnectonsessiontimeout_java" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportal_java" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_selfserviceportalurl_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportalurl_java" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientloginbanneroptions_nodejs" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_clientrouteenforcementoptions_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientrouteenforcementoptions_nodejs" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_nodejs" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnectonsessiontimeout_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnectonsessiontimeout_nodejs" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportal_nodejs" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_selfserviceportalurl_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportalurl_nodejs" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_client_login_banner_options_python" style="color: inherit; text-decoration: inherit;">client_<wbr>login_<wbr>banner_<wbr>options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_client_route_enforcement_options_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_client_route_enforcement_options_python" style="color: inherit; text-decoration: inherit;">client_<wbr>route_<wbr>enforcement_<wbr>options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_python" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnect_on_session_timeout_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnect_on_session_timeout_python" style="color: inherit; text-decoration: inherit;">disconnect_<wbr>on_<wbr>session_<wbr>timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_self_service_portal_python" style="color: inherit; text-decoration: inherit;">self_<wbr>service_<wbr>portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_self_service_portal_url_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_self_service_portal_url_python" style="color: inherit; text-decoration: inherit;">self_<wbr>service_<wbr>portal_<wbr>url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientloginbanneroptions_yaml" style="color: inherit; text-decoration: inherit;">client<wbr>Login<wbr>Banner<wbr>Options</a>
    ...
    <dd>Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_clientrouteenforcementoptions_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientrouteenforcementoptions_yaml" style="color: inherit; text-decoration: inherit;">client<wbr>Route<wbr>Enforcement<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointclientrouteenforcementoptions">Property Map</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_yaml" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>A brief description of the Client VPN endpoint.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disconnectonsessiontimeout_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_disconnectonsessiontimeout_yaml" style="color: inherit; text-decoration: inherit;">disconnect<wbr>On<wbr>Session<wbr>Timeout</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportal_yaml" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal</a>
    ...
    <dd>Specify whether to enable the self-service portal for the Client VPN endpoint. Values can be <code>enabled</code> or <code>disabled</code>. Default value is <code>disabled</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_selfserviceportalurl_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_selfserviceportalurl_yaml" style="color: inherit; text-decoration: inherit;">self<wbr>Service<wbr>Portal<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="endpointauthenticationoption">
Endpoint<wbr>Authentication<wbr>Option<pulumi-choosable type="language" values="python,go" class="inline">, Endpoint<wbr>Authentication<wbr>Option<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>The type of client authentication to be used. Specify <code>certificate-authentication</code> to use certificate-based authentication, <code>directory-service-authentication</code> to use Active Directory authentication, or <code>federated-authentication</code> to use Federated Authentication via SAML 2.0.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#activedirectoryid_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Directory<wbr>Id</a>
    ...
    <dd>The ID of the Active Directory to be used for authentication if type is <code>directory-service-authentication</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootcertificatechainarn_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Certificate<wbr>Chain<wbr>Arn</a>
    ...
    <dd>The ARN of the client certificate. The certificate must be signed by a certificate authority (CA) and it must be provisioned in AWS Certificate Manager (ACM). Only necessary when type is set to <code>certificate-authentication</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#samlproviderarn_csharp" style="color: inherit; text-decoration: inherit;">Saml<wbr>Provider<wbr>Arn</a>
    ...
    <dd>The ARN of the IAM SAML identity provider if type is <code>federated-authentication</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selfservicesamlproviderarn_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Service<wbr>Saml<wbr>Provider<wbr>Arn</a>
    ...
    <dd>The ARN of the IAM SAML identity provider for the self service portal if type is <code>federated-authentication</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="endpointclientconnectoptions">
Endpoint<wbr>Client<wbr>Connect<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Endpoint<wbr>Client<wbr>Connect<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Indicates whether client connect options are enabled. The default is <code>false</code> (not enabled).</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lambdafunctionarn_csharp" style="color: inherit; text-decoration: inherit;">Lambda<wbr>Function<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the Lambda function used for connection authorization.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="endpointclientloginbanneroptions">
Endpoint<wbr>Client<wbr>Login<wbr>Banner<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Endpoint<wbr>Client<wbr>Login<wbr>Banner<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bannertext_csharp" style="color: inherit; text-decoration: inherit;">Banner<wbr>Text</a>
    ...
    <dd>Customizable text that will be displayed in a banner on AWS provided clients when a VPN session is established. UTF-8 encoded characters only. Maximum of 1400 characters.</dd><dt class="property-optional"
            title="Optional">
        <span id="enabled_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
</span>
    ...
    <dd>Enable or disable a customizable text banner that will be displayed on AWS provided clients when a VPN session is established. The default is <code>false</code> (not enabled).</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="endpointclientrouteenforcementoptions">
Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Endpoint<wbr>Client<wbr>Route<wbr>Enforcement<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_csharp" style="color: inherit; text-decoration: inherit;">Enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>Enable or disable Client Route Enforcement. The default is <code>false</code> (not enabled).</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="enforced_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_go" style="color: inherit; text-decoration: inherit;">Enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="enforced_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_java" style="color: inherit; text-decoration: inherit;">enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_nodejs" style="color: inherit; text-decoration: inherit;">enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_python" style="color: inherit; text-decoration: inherit;">enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="enforced_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enforced_yaml" style="color: inherit; text-decoration: inherit;">enforced</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<h4 id="endpointconnectionlogoptions">
Endpoint<wbr>Connection<wbr>Log<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Endpoint<wbr>Connection<wbr>Log<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Indicates whether connection logging is enabled.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchloggroup_csharp" style="color: inherit; text-decoration: inherit;">Cloudwatch<wbr>Log<wbr>Group</a>
    ...
    <dd>The name of the CloudWatch Logs log group.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchlogstream_csharp" style="color: inherit; text-decoration: inherit;">Cloudwatch<wbr>Log<wbr>Stream</a>
    ...
    <dd>The name of the CloudWatch Logs log stream to which the connection data is published.</dd></dl>
</pulumi-choosable>
</div>
