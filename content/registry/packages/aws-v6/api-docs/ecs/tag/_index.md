...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ecs:Tag</span><span class="p"></span>
...
```csharp
var exampletagResourceResourceFromEcstag = new Aws.Ecs.Tag("exampletagResourceResourceFromEcstag", new()
{
    Key = "string",
    ResourceArn = "string",
    Value = "string",
...
```go
example, err := ecs.NewTag(ctx, "exampletagResourceResourceFromEcstag", &ecs.TagArgs{
...
```java
var exampletagResourceResourceFromEcstag = new com.pulumi.aws.ecs.Tag("exampletagResourceResourceFromEcstag", com.pulumi.aws.ecs.TagArgs.builder()
    .key("string")
    .resourceArn("string")
    .value("string")
    .build());
...
```python
exampletag_resource_resource_from_ecstag = aws.ecs.Tag("exampletagResourceResourceFromEcstag",
    key="string",
    resource_arn="string",
    value="string")
```
...
```typescript
const exampletagResourceResourceFromEcstag = new aws.ecs.Tag("exampletagResourceResourceFromEcstag", {
    key: "string",
    resourceArn: "string",
    value: "string",
});
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the ECS resource to tag.</dd><dt class="property-required"
            title="Required">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:ecs:Tag</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the ECS resource to tag.</dd><dt class="property-optional"
            title="Optional">
