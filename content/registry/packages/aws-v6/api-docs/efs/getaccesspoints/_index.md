...
><span class="k">def </span>get_access_points<span class="p">(</span><span class="nx">file_system_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_access_points_output<span class="p">(</span><span class="nx">file_system_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetAccessPointsResult</a></span>> </span>getAccessPoints<span class="p">(</span><span class="nx">GetAccessPointsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> aws:efs/getAccessPoints:getAccessPoints
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filesystemid_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>System<wbr>Id</a>
    ...
    <dd>EFS File System identifier.</dd></dl>
</pulumi-choosable>
</div>
