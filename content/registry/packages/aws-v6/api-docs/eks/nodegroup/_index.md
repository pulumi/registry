...
## Create NodeGroup Resource {#create}
...
<span class="k">def </span><span class="nx">NodeGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">node_repair_config</span><span class="p">:</span> <span class="nx">Optional[NodeGroupNodeRepairConfigArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewNodeGroup</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">NodeGroupArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">NodeGroup</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:eks:NodeGroup</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderolearn_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Role<wbr>Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the IAM Role that provides permissions for the EKS Node Group.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scalingconfig_csharp" style="color: inherit; text-decoration: inherit;">Scaling<wbr>Config</a>
    ...
    <dd>Configuration block with scaling settings. See <code>scaling_config</code> below for details.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amitype_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Type</a>
    ...
    <dd>Type of Amazon Machine Image (AMI) associated with the EKS Node Group. See the <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_Nodegroup.html#AmazonEKS-Type-Nodegroup-amiType">AWS documentation</a> for valid values. This provider will only perform drift detection if a configuration value is provided.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#capacitytype_csharp" style="color: inherit; text-decoration: inherit;">Capacity<wbr>Type</a>
    ...
    <dd>Type of capacity associated with the EKS Node Group. Valid values: <code>ON_DEMAND</code>, <code>SPOT</code>. This provider will only perform drift detection if a configuration value is provided.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disksize_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size</a>
    ...
    <dd>Disk size in GiB for worker nodes. Defaults to <code>50</code> for Windows, <code>20</code> all other node groups. The provider will only perform drift detection if a configuration value is provided.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#forceupdateversion_csharp" style="color: inherit; text-decoration: inherit;">Force<wbr>Update<wbr>Version</a>
    ...
    <dd>Force version update if existing pods are unable to be drained due to a pod disruption budget issue.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancetypes_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Types</a>
    ...
    <dd>List of instance types associated with the EKS Node Group. Defaults to <code>[&quot;t3.medium&quot;]</code>. The provider will only perform drift detection if a configuration value is provided.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>Key-value map of Kubernetes labels. Only labels that are applied with the EKS API are managed by this argument. Other Kubernetes labels applied to the EKS Node Group will not be managed.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template</a>
    ...
    <dd>Configuration block with Launch Template settings. See <code>launch_template</code> below for details. Conflicts with <code>remote_access</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupname_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Group<wbr>Name</a>
    ...
    <dd>Name of the EKS Node Group. If omitted, the provider will assign a random, unique name. Conflicts with <code>node_group_name_prefix</code>. The node group name can't be longer than 63 characters. It must start with a letter or digit, but can also include hyphens and underscores for the remaining characters.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupnameprefix_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="noderepairconfig_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderepairconfig_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
    <dd>The node auto repair configuration for the node group. See <code>node_repair_config</code> below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#releaseversion_csharp" style="color: inherit; text-decoration: inherit;">Release<wbr>Version</a>
    ...
    <dd>AMI version of the EKS Node Group. Defaults to latest version for Kubernetes version.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#remoteaccess_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Access</a>
    ...
    <dd>Configuration block with remote access settings. See <code>remote_access</code> below for details. Conflicts with <code>launch_template</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#taints_csharp" style="color: inherit; text-decoration: inherit;">Taints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegrouptaint">List&lt;Node<wbr>Group<wbr>Taint&gt;</a></span>
    </dt>
    <dd>The Kubernetes taints to be applied to the nodes in the node group. Maximum of 50 taints per node group. See taint below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#updateconfig_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupupdateconfig">Node<wbr>Group<wbr>Update<wbr>Config</a></span>
    </dt>
    <dd>Configuration block with update settings. See <code>update_config</code> below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>Kubernetes version. Defaults to EKS Cluster Kubernetes version. The provider will only perform drift detection if a configuration value is provided.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupnameprefix_go" style="color: inherit; text-decoration: inherit;">Node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="noderepairconfig_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderepairconfig_go" style="color: inherit; text-decoration: inherit;">Node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<wbr>Args</a></span>
    </dt>
    <dd>The node auto repair configuration for the node group. See <code>node_repair_config</code> below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupnameprefix_java" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="noderepairconfig_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderepairconfig_java" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupnameprefix_nodejs" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="noderepairconfig_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderepairconfig_nodejs" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#node_group_name_prefix_python" style="color: inherit; text-decoration: inherit;">node_<wbr>group_<wbr>name_<wbr>prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="node_repair_config_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#node_repair_config_python" style="color: inherit; text-decoration: inherit;">node_<wbr>repair_<wbr>config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodegroupnameprefix_yaml" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="noderepairconfig_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#noderepairconfig_yaml" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Property Map</a></span>
    </dt>
    <dd>The node auto repair configuration for the node group. See <code>node_repair_config</code> below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the EKS Node Group.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
    ...
    <dd>List of objects containing information about underlying resources.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Status of the EKS Node Group.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
## Look up Existing NodeGroup Resource {#look-up}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetNodeGroup<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">NodeGroupState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">NodeGroup</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">NodeGroup</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">NodeGroupState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:eks:NodeGroup</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_amitype_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Type</a>
    ...
    <dd>Type of Amazon Machine Image (AMI) associated with the EKS Node Group. See the <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_Nodegroup.html#AmazonEKS-Type-Nodegroup-amiType">AWS documentation</a> for valid values. This provider will only perform drift detection if a configuration value is provided.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the EKS Node Group.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodegroupnameprefix_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_noderepairconfig_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderepairconfig_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
    <dd>The node auto repair configuration for the node group. See <code>node_repair_config</code> below for details.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderolearn_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Role<wbr>Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the IAM Role that provides permissions for the EKS Node Group.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
    ...
    <dd>List of objects containing information about underlying resources.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scalingconfig_csharp" style="color: inherit; text-decoration: inherit;">Scaling<wbr>Config</a>
    ...
    <dd>Configuration block with scaling settings. See <code>scaling_config</code> below for details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>Status of the EKS Node Group.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodegroupnameprefix_go" style="color: inherit; text-decoration: inherit;">Node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_noderepairconfig_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderepairconfig_go" style="color: inherit; text-decoration: inherit;">Node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodegroupnameprefix_java" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_noderepairconfig_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderepairconfig_java" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodegroupnameprefix_nodejs" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_noderepairconfig_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderepairconfig_nodejs" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_node_group_name_prefix_python" style="color: inherit; text-decoration: inherit;">node_<wbr>group_<wbr>name_<wbr>prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_node_repair_config_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_node_repair_config_python" style="color: inherit; text-decoration: inherit;">node_<wbr>repair_<wbr>config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_nodegroupnameprefix_yaml" style="color: inherit; text-decoration: inherit;">node<wbr>Group<wbr>Name<wbr>Prefix</a>
    ...
    <dd>Creates a unique name beginning with the specified prefix. Conflicts with <code>node_group_name</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_noderepairconfig_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_noderepairconfig_yaml" style="color: inherit; text-decoration: inherit;">node<wbr>Repair<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupnoderepairconfig">Property Map</a></span>
    </dt>
...
<h4 id="nodegrouplaunchtemplate">
Node<wbr>Group<wbr>Launch<wbr>Template<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Launch<wbr>Template<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>EC2 Launch Template version number. While the API accepts values like <code>$Default</code> and <code>$Latest</code>, the API will convert the value to the associated version number (e.g., <code>1</code>) on read and the provider will show a difference on next plan. Using the <code>default_version</code> or <code>latest_version</code> attribute of the <code>aws.ec2.LaunchTemplate</code> resource or data source is recommended for this argument.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
    ...
    <dd>Identifier of the EC2 Launch Template. Conflicts with <code>name</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the EC2 Launch Template. Conflicts with <code>id</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupnoderepairconfig">
Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Node<wbr>Repair<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Specifies whether to enable node auto repair for the node group. Node auto repair is disabled by default.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupremoteaccess">
Node<wbr>Group<wbr>Remote<wbr>Access<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Remote<wbr>Access<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ec2sshkey_csharp" style="color: inherit; text-decoration: inherit;">Ec2Ssh<wbr>Key</a>
    ...
    <dd>EC2 Key Pair name that provides access for remote communication with the worker nodes in the EKS Node Group. If you specify this configuration, but do not specify <code>source_security_group_ids</code> when you create an EKS Node Group, either port 3389 for Windows, or port 22 for all other operating systems is opened on the worker nodes to the Internet (0.0.0.0/0). For Windows nodes, this will allow you to use RDP, for all others this allows you to SSH into the worker nodes.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcesecuritygroupids_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Security<wbr>Group<wbr>Ids</a>
    ...
    <dd>Set of EC2 Security Group IDs to allow SSH access (port 22) from on the worker nodes. If you specify <code>ec2_ssh_key</code>, but do not specify this configuration when you create an EKS Node Group, port 22 on the worker nodes is opened to the Internet (0.0.0.0/0).</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupresource">
Node<wbr>Group<wbr>Resource<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Resource<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalinggroups_csharp" style="color: inherit; text-decoration: inherit;">Autoscaling<wbr>Groups</a>
    ...
    <dd>List of objects containing information about AutoScaling Groups.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#remoteaccesssecuritygroupid_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Access<wbr>Security<wbr>Group<wbr>Id</a>
    ...
    <dd>Identifier of the remote access EC2 Security Group.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupresourceautoscalinggroup">
Node<wbr>Group<wbr>Resource<wbr>Autoscaling<wbr>Group<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Resource<wbr>Autoscaling<wbr>Group<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the AutoScaling Group.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupscalingconfig">
Node<wbr>Group<wbr>Scaling<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Scaling<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredsize_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>Size</a>
    ...
    <dd>Desired number of worker nodes.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsize_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Size</a>
    ...
    <dd>Maximum number of worker nodes.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minsize_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Size</a>
    ...
    <dd>Minimum number of worker nodes.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegrouptaint">
Node<wbr>Group<wbr>Taint<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Taint<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#effect_csharp" style="color: inherit; text-decoration: inherit;">Effect</a>
    ...
    <dd>The effect of the taint. Valid values: <code>NO_SCHEDULE</code>, <code>NO_EXECUTE</code>, <code>PREFER_NO_SCHEDULE</code>.</dd><dt class="property-required"
            title="Required">
        <span id="key_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>The key of the taint. Maximum length of 63.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>The value of the taint. Maximum length of 63.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="nodegroupupdateconfig">
Node<wbr>Group<wbr>Update<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Node<wbr>Group<wbr>Update<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxunavailable_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Unavailable</a>
    ...
    <dd>Desired max number of unavailable worker nodes during node group update.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxunavailablepercentage_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Unavailable<wbr>Percentage</a>
    ...
    <dd>Desired max percentage of unavailable worker nodes during node group update.</dd></dl>
</pulumi-choosable>
</div>
