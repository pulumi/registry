...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewJobTemplate</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">JobTemplateArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">JobTemplate</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:emrcontainers:JobTemplate</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobtemplatedata_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Template<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobtemplatejobtemplatedata">Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data</a></span>
    </dt>
    <dd>The job template data which holds values of StartJobRun API request.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyarn_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Arn</a>
    ...
    <dd>The KMS key ARN used to encrypt the job template.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The specified name of the job template.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the job template.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetJobTemplate<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">JobTemplateState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">JobTemplate</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">JobTemplate</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">JobTemplateState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:emrcontainers:JobTemplate</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the job template.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value mapping of resource tags. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional property-deprecated property-replacement"
...
<h4 id="jobtemplatejobtemplatedata">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#executionrolearn_csharp" style="color: inherit; text-decoration: inherit;">Execution<wbr>Role<wbr>Arn</a>
    ...
    <dd>The execution role ARN of the job run.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobdriver_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Driver</a>
    ...
    <dd>Specify the driver that the job runs on. Exactly one of the two available job drivers is required, either sparkSqlJobDriver or sparkSubmitJobDriver.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#releaselabel_csharp" style="color: inherit; text-decoration: inherit;">Release<wbr>Label</a>
    ...
    <dd>The release version of Amazon EMR.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configurationoverrides_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Overrides</a>
    ...
    <dd>The configuration settings that are used to override defaults configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#jobtags_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Tags</a>
    ...
    <dd>The tags assigned to jobs started using the job template.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverrides">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applicationconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Configurations</a>
    ...
    <dd>The configurations for the application running by the job run.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#monitoringconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Monitoring<wbr>Configuration</a>
    ...
    <dd>The configurations for monitoring.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverridesapplicationconfiguration">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Application<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Application<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configurations_csharp" style="color: inherit; text-decoration: inherit;">Configurations</a>
    ...
    <dd>A list of additional configurations to apply within a configuration object.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>A set of properties specified within a configuration classification.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverridesapplicationconfigurationconfiguration">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Application<wbr>Configuration<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Application<wbr>Configuration<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#classification_csharp" style="color: inherit; text-decoration: inherit;">Classification</a>
    ...
    <dd>The classification within a configuration.</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverridesmonitoringconfiguration">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchmonitoringconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Watch<wbr>Monitoring<wbr>Configuration</a>
    ...
    <dd>Monitoring configurations for CloudWatch.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#persistentappui_csharp" style="color: inherit; text-decoration: inherit;">Persistent<wbr>App<wbr>Ui</a>
    ...
    <dd>Monitoring configurations for the persistent application UI.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3monitoringconfiguration_csharp" style="color: inherit; text-decoration: inherit;">S3Monitoring<wbr>Configuration</a>
    ...
    <dd>Amazon S3 configuration for monitoring log publishing.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverridesmonitoringconfigurationcloudwatchmonitoringconfiguration">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<wbr>Cloud<wbr>Watch<wbr>Monitoring<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<wbr>Cloud<wbr>Watch<wbr>Monitoring<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggroupname_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the log group for log publishing.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logstreamnameprefix_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Stream<wbr>Name<wbr>Prefix</a>
    ...
    <dd>The specified name prefix for log streams.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedataconfigurationoverridesmonitoringconfigurations3monitoringconfiguration">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<wbr>S3Monitoring<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Configuration<wbr>Overrides<wbr>Monitoring<wbr>Configuration<wbr>S3Monitoring<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loguri_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Uri</a>
    ...
    <dd>Amazon S3 destination URI for log publishing.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedatajobdriver">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sparksqljobdriver_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Sql<wbr>Job<wbr>Driver</a>
    ...
    <dd>The job driver for job type.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sparksubmitjobdriver_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Submit<wbr>Job<wbr>Driver</a>
    ...
    <dd>The job driver parameters specified for spark submit.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedatajobdriversparksqljobdriver">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<wbr>Spark<wbr>Sql<wbr>Job<wbr>Driver<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<wbr>Spark<wbr>Sql<wbr>Job<wbr>Driver<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entrypoint_csharp" style="color: inherit; text-decoration: inherit;">Entry<wbr>Point</a>
    ...
    <dd>The SQL file to be executed.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sparksqlparameters_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Sql<wbr>Parameters</a>
    ...
    <dd>The Spark parameters to be included in the Spark SQL command.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="jobtemplatejobtemplatedatajobdriversparksubmitjobdriver">
Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<wbr>Spark<wbr>Submit<wbr>Job<wbr>Driver<pulumi-choosable type="language" values="python,go" class="inline">, Job<wbr>Template<wbr>Job<wbr>Template<wbr>Data<wbr>Job<wbr>Driver<wbr>Spark<wbr>Submit<wbr>Job<wbr>Driver<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entrypoint_csharp" style="color: inherit; text-decoration: inherit;">Entry<wbr>Point</a>
    ...
    <dd>The entry point of job application.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entrypointarguments_csharp" style="color: inherit; text-decoration: inherit;">Entry<wbr>Point<wbr>Arguments</a>
    ...
    <dd>The arguments for job application.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sparksubmitparameters_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Submit<wbr>Parameters</a>
    ...
    <dd>The Spark submit parameters that are used for job runs.</dd></dl>
</pulumi-choosable>
</div>
