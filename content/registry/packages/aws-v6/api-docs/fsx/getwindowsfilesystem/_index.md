...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetWindowsFileSystemResult</a></span>> </span>getWindowsFileSystem<span class="p">(</span><span class="nx">GetWindowsFileSystemArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>The tags to associate with the file system.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#activedirectoryid_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Directory<wbr>Id</a>
    ...
    <dd>The ID for Microsoft Active Directory instance that the file system is join to.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#aliases_csharp" style="color: inherit; text-decoration: inherit;">Aliases</a>
    ...
    <dd>An array DNS alias names associated with the Amazon FSx file system.</dd><dt class="property-"
            title="">
        <span id="arn_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#auditlogconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Audit<wbr>Log<wbr>Configurations</a>
    ...
    <dd>The configuration that Amazon FSx for Windows File Server uses to audit and log user accesses of files, folders, and file shares on the Amazon FSx for Windows File Server file system.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#copytagstobackups_csharp" style="color: inherit; text-decoration: inherit;">Copy<wbr>Tags<wbr>To<wbr>Backups</a>
    ...
    <dd>A boolean flag indicating whether tags on the file system should be copied to backups.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskiopsconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Iops<wbr>Configurations</a>
    ...
    <dd>The SSD IOPS configuration for the file system.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd>DNS name for the file system (e.g. <code>fs-12345678.corp.example.com</code>).</dd><dt class="property-"
            title="">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>Specifies the IDs of the subnets that the file system is accessible from.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
    ...
    <dd>The tags to associate with the file system.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#throughputcapacity_csharp" style="color: inherit; text-decoration: inherit;">Throughput<wbr>Capacity</a>
    ...
    <dd>Throughput (megabytes per second) of the file system in power of 2 increments. Minimum of <code>8</code> and maximum of <code>2048</code>.</dd><dt class="property-"
            title="">
