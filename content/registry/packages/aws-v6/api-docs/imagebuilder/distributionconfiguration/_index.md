...
## Create DistributionConfiguration Resource {#create}
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">DistributionConfiguration</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DistributionConfigurationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">DistributionConfiguration</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DistributionConfigurationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:imagebuilder:DistributionConfiguration</span><span class="p"></span>
...
var distributionConfigurationResource = new Aws.ImageBuilder.DistributionConfiguration("distributionConfigurationResource", new()
{
    Distributions = new[]
    {
        new Aws.ImageBuilder.Inputs.DistributionConfigurationDistributionArgs
        {
            ...
            SsmParameterConfigurations = new[]
            {
                new Aws.ImageBuilder.Inputs.DistributionConfigurationDistributionSsmParameterConfigurationArgs
                {
...
example, err := imagebuilder.NewDistributionConfiguration(ctx, "distributionConfigurationResource", &imagebuilder.DistributionConfigurationArgs{
	Distributions: imagebuilder.DistributionConfigurationDistributionArray{
		&imagebuilder.DistributionConfigurationDistributionArgs{
			...
			SsmParameterConfigurations: imagebuilder.DistributionConfigurationDistributionSsmParameterConfigurationArray{
				&imagebuilder.DistributionConfigurationDistributionSsmParameterConfigurationArgs{
					ParameterName: pulumi.String("string"),
					AmiAccountId:  pulumi.String("string"),
...
var distributionConfigurationResource = new DistributionConfiguration("distributionConfigurationResource", DistributionConfigurationArgs.builder()
    .distributions(DistributionConfigurationDistributionArgs.builder()
        ...
        .s3ExportConfiguration(DistributionConfigurationDistributionS3ExportConfigurationArgs.builder()
            ...
            .s3Prefix("string")
            .build())
        .ssmParameterConfigurations(DistributionConfigurationDistributionSsmParameterConfigurationArgs.builder()
            .parameterName("string")
            .amiAccountId("string")
            .dataType("string")
            .build())
...
The DistributionConfiguration resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distributions_csharp" style="color: inherit; text-decoration: inherit;">Distributions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistribution">List&lt;Distribution<wbr>Configuration<wbr>Distribution&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description of the distribution configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the distribution configuration.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of resource tags for the distribution configuration. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distributions_yaml" style="color: inherit; text-decoration: inherit;">distributions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistribution">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>One or more configuration blocks with distribution settings. Detailed below.</p>
<p>The following arguments are optional:</p>
</dd><dt class="property-optional"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>(Required) Amazon Resource Name (ARN) of the distribution configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datecreated_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Created</a>
    ...
    <dd>Date the distribution configuration was created.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dateupdated_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Updated</a>
    ...
    <dd>Date the distribution configuration was updated.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
## Look up Existing DistributionConfiguration Resource {#look-up}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetDistributionConfiguration<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">DistributionConfigurationState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">DistributionConfiguration</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">DistributionConfiguration</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">DistributionConfigurationState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:imagebuilder:DistributionConfiguration</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>(Required) Amazon Resource Name (ARN) of the distribution configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_datecreated_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Created</a>
    ...
    <dd>Date the distribution configuration was created.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dateupdated_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Updated</a>
    ...
    <dd>Date the distribution configuration was updated.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description of the distribution configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of resource tags for the distribution configuration. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional property-deprecated"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_java" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>Description of the distribution configuration.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_distributions_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_distributions_java" style="color: inherit; text-decoration: inherit;">distributions</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistribution">List&lt;Distribution<wbr>Configuration<wbr>Distribution&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_description_yaml" style="color: inherit; text-decoration: inherit;">description</a>
    ...
    <dd>Description of the distribution configuration.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_distributions_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_distributions_yaml" style="color: inherit; text-decoration: inherit;">distributions</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistribution">List&lt;Property Map&gt;</a></span>
    </dt>
...
<h4 id="distributionconfigurationdistribution">
Distribution<wbr>Configuration<wbr>Distribution<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amidistributionconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Distribution<wbr>Configuration</a>
    ...
    <dd>Configuration block with Amazon Machine Image (AMI) distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerdistributionconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Distribution<wbr>Configuration</a>
    ...
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fastlaunchconfigurations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fastlaunchconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Fast<wbr>Launch<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">List&lt;Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Configurations</a>
    ...
    <dd>Set of launch template configuration settings that apply to image distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licenseconfigurationarns_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Configuration<wbr>Arns</a>
    ...
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3exportconfiguration_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3exportconfiguration_csharp" style="color: inherit; text-decoration: inherit;">S3Export<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssmparameterconfigurations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssmparameterconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ssm<wbr>Parameter<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">List&lt;Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>Configuration block with SSM parameter configuration to use as AMI id output. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerdistributionconfiguration_go" style="color: inherit; text-decoration: inherit;">Container<wbr>Distribution<wbr>Configuration</a>
    ...
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fastlaunchconfigurations_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fastlaunchconfigurations_go" style="color: inherit; text-decoration: inherit;">Fast<wbr>Launch<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">[]Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration</a></span>
    </dt>
    <dd>Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licenseconfigurationarns_go" style="color: inherit; text-decoration: inherit;">License<wbr>Configuration<wbr>Arns</a>
    ...
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3exportconfiguration_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3exportconfiguration_go" style="color: inherit; text-decoration: inherit;">S3Export<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssmparameterconfigurations_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssmparameterconfigurations_go" style="color: inherit; text-decoration: inherit;">Ssm<wbr>Parameter<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">[]Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with SSM parameter configuration to use as AMI id output. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<p>The following arguments are optional:</p>
            ...
            title="Optional">
        <span id="amidistributionconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amidistributionconfiguration_java" style="color: inherit; text-decoration: inherit;">ami<wbr>Distribution<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionamidistributionconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with Amazon Machine Image (AMI) distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="containerdistributionconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerdistributionconfiguration_java" style="color: inherit; text-decoration: inherit;">container<wbr>Distribution<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributioncontainerdistributionconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Container<wbr>Distribution<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fastlaunchconfigurations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fastlaunchconfigurations_java" style="color: inherit; text-decoration: inherit;">fast<wbr>Launch<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">List&lt;Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="launchtemplateconfigurations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateconfigurations_java" style="color: inherit; text-decoration: inherit;">launch<wbr>Template<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionlaunchtemplateconfiguration">List&lt;Distribution<wbr>Configuration<wbr>Distribution<wbr>Launch<wbr>Template<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>Set of launch template configuration settings that apply to image distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="licenseconfigurationarns_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licenseconfigurationarns_java" style="color: inherit; text-decoration: inherit;">license<wbr>Configuration<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3exportconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3exportconfiguration_java" style="color: inherit; text-decoration: inherit;">s3Export<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssmparameterconfigurations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssmparameterconfigurations_java" style="color: inherit; text-decoration: inherit;">ssm<wbr>Parameter<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">List&lt;Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerdistributionconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">container<wbr>Distribution<wbr>Configuration</a>
    ...
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fastlaunchconfigurations_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fastlaunchconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">fast<wbr>Launch<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licenseconfigurationarns_nodejs" style="color: inherit; text-decoration: inherit;">license<wbr>Configuration<wbr>Arns</a>
    ...
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3exportconfiguration_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3exportconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">s3Export<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssmparameterconfigurations_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssmparameterconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">ssm<wbr>Parameter<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#container_distribution_configuration_python" style="color: inherit; text-decoration: inherit;">container_<wbr>distribution_<wbr>configuration</a>
    ...
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fast_launch_configurations_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fast_launch_configurations_python" style="color: inherit; text-decoration: inherit;">fast_<wbr>launch_<wbr>configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">Sequence[Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration]</a></span>
    </dt>
    <dd>Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#license_configuration_arns_python" style="color: inherit; text-decoration: inherit;">license_<wbr>configuration_<wbr>arns</a>
    ...
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3_export_configuration_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3_export_configuration_python" style="color: inherit; text-decoration: inherit;">s3_<wbr>export_<wbr>configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssm_parameter_configurations_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssm_parameter_configurations_python" style="color: inherit; text-decoration: inherit;">ssm_<wbr>parameter_<wbr>configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">Sequence[Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration]</a></span>
    </dt>
    <dd>Configuration block with SSM parameter configuration to use as AMI id output. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<p>The following arguments are optional:</p>
            ...
            title="Optional">
        <span id="amidistributionconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amidistributionconfiguration_yaml" style="color: inherit; text-decoration: inherit;">ami<wbr>Distribution<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionamidistributionconfiguration">Property Map</a></span>
    </dt>
    <dd>Configuration block with Amazon Machine Image (AMI) distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="containerdistributionconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerdistributionconfiguration_yaml" style="color: inherit; text-decoration: inherit;">container<wbr>Distribution<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributioncontainerdistributionconfiguration">Property Map</a></span>
    </dt>
    <dd>Configuration block with container distribution settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="fastlaunchconfigurations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fastlaunchconfigurations_yaml" style="color: inherit; text-decoration: inherit;">fast<wbr>Launch<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="launchtemplateconfigurations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateconfigurations_yaml" style="color: inherit; text-decoration: inherit;">launch<wbr>Template<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionlaunchtemplateconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Set of launch template configuration settings that apply to image distribution. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="licenseconfigurationarns_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licenseconfigurationarns_yaml" style="color: inherit; text-decoration: inherit;">license<wbr>Configuration<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of Amazon Resource Names (ARNs) of License Manager License Configurations.</dd><dt class="property-optional"
            title="Optional">
        <span id="s3exportconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3exportconfiguration_yaml" style="color: inherit; text-decoration: inherit;">s3Export<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributions3exportconfiguration">Property Map</a></span>
    </dt>
    <dd>Configuration block with S3 export settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="ssmparameterconfigurations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssmparameterconfigurations_yaml" style="color: inherit; text-decoration: inherit;">ssm<wbr>Parameter<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionssmparameterconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Configuration block with SSM parameter configuration to use as AMI id output. Detailed below.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="distributionconfigurationdistributionamidistributionconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amitags_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Tags</a>
    ...
    <dd>Key-value map of tags to apply to the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
    ...
    <dd>Description to apply to the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>Amazon Resource Name (ARN) of the Key Management Service (KMS) Key to encrypt the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchpermission_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Permission</a>
    ...
    <dd>Configuration block of EC2 launch permissions to apply to the distributed AMI. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>Name to apply to the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetaccountids_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Account<wbr>Ids</a>
    ...
    <dd>Set of AWS Account identifiers to distribute the AMI.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="amitags_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amitags_java" style="color: inherit; text-decoration: inherit;">ami<wbr>Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Map&lt;String,String&gt;</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_java" style="color: inherit; text-decoration: inherit;">kms<wbr>Key<wbr>Id</a>
    ...
    <dd>Amazon Resource Name (ARN) of the Key Management Service (KMS) Key to encrypt the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="launchpermission_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchpermission_java" style="color: inherit; text-decoration: inherit;">launch<wbr>Permission</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionamidistributionconfigurationlaunchpermission">Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration<wbr>Launch<wbr>Permission</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_java" style="color: inherit; text-decoration: inherit;">name</a>
    ...
    <dd>Name to apply to the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="targetaccountids_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetaccountids_java" style="color: inherit; text-decoration: inherit;">target<wbr>Account<wbr>Ids</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="amitags_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amitags_yaml" style="color: inherit; text-decoration: inherit;">ami<wbr>Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Map&lt;String&gt;</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_yaml" style="color: inherit; text-decoration: inherit;">kms<wbr>Key<wbr>Id</a>
    ...
    <dd>Amazon Resource Name (ARN) of the Key Management Service (KMS) Key to encrypt the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="launchpermission_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchpermission_yaml" style="color: inherit; text-decoration: inherit;">launch<wbr>Permission</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionamidistributionconfigurationlaunchpermission">Property Map</a></span>
    </dt>
    <dd>Configuration block of EC2 launch permissions to apply to the distributed AMI. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="name_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_yaml" style="color: inherit; text-decoration: inherit;">name</a>
    ...
    <dd>Name to apply to the distributed AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="targetaccountids_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetaccountids_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Account<wbr>Ids</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
...
<h4 id="distributionconfigurationdistributionamidistributionconfigurationlaunchpermission">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration<wbr>Launch<wbr>Permission<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Ami<wbr>Distribution<wbr>Configuration<wbr>Launch<wbr>Permission<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationarns_csharp" style="color: inherit; text-decoration: inherit;">Organization<wbr>Arns</a>
    ...
    <dd>Set of AWS Organization ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationalunitarns_csharp" style="color: inherit; text-decoration: inherit;">Organizational<wbr>Unit<wbr>Arns</a>
    ...
    <dd>Set of AWS Organizational Unit ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usergroups_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Groups</a>
    ...
    <dd>Set of EC2 launch permission user groups to assign. Use <code>all</code> to distribute a public AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userids_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Ids</a>
    ...
    <dd>Set of AWS Account identifiers to assign.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="organizationarns_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationarns_java" style="color: inherit; text-decoration: inherit;">organization<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of AWS Organization ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
        <span id="organizationalunitarns_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationalunitarns_java" style="color: inherit; text-decoration: inherit;">organizational<wbr>Unit<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of AWS Organizational Unit ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
        <span id="usergroups_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usergroups_java" style="color: inherit; text-decoration: inherit;">user<wbr>Groups</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="organizationarns_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationarns_yaml" style="color: inherit; text-decoration: inherit;">organization<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of AWS Organization ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
        <span id="organizationalunitarns_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationalunitarns_yaml" style="color: inherit; text-decoration: inherit;">organizational<wbr>Unit<wbr>Arns</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
    <dd>Set of AWS Organizational Unit ARNs to assign.</dd><dt class="property-optional"
            title="Optional">
        <span id="usergroups_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usergroups_yaml" style="color: inherit; text-decoration: inherit;">user<wbr>Groups</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String&gt;</span>
    </dt>
...
<h4 id="distributionconfigurationdistributioncontainerdistributionconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Container<wbr>Distribution<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Container<wbr>Distribution<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetrepository_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Repository</a>
    ...
    <dd>Configuration block with the destination repository for the container distribution configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containertags_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Tags</a>
    ...
    <dd>Set of tags that are attached to the container distribution configuration.</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
    ...
    <dd>Description of the container distribution configuration.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetrepository_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Repository</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributioncontainerdistributionconfigurationtargetrepository">Property Map</a></span>
    </dt>
    <dd>Configuration block with the destination repository for the container distribution configuration.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="distributionconfigurationdistributioncontainerdistributionconfigurationtargetrepository">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Container<wbr>Distribution<wbr>Configuration<wbr>Target<wbr>Repository<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Container<wbr>Distribution<wbr>Configuration<wbr>Target<wbr>Repository<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryname_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Name</a>
    ...
    <dd>The name of the container repository where the output container image is stored. This name is prefixed by the repository location.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#service_csharp" style="color: inherit; text-decoration: inherit;">Service</a>
    ...
    <dd>The service in which this image is registered. Valid values: <code>ECR</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="distributionconfigurationdistributionfastlaunchconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>The owner account ID for the fast-launch enabled Windows AMI.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>A Boolean that represents the current state of faster launching for the Windows AMI. Set to <code>true</code> to start using Windows faster launching, or <code>false</code> to stop using it.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationlaunchtemplate">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Launch<wbr>Template</a></span>
    </dt>
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxparallellaunches_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxparallellaunches_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Parallel<wbr>Launches</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshotconfiguration_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block for managing the number of snapshots that are created from pre-provisioned instances for the Windows AMI when faster launching is enabled. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_go" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template</a>
    ...
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxparallellaunches_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxparallellaunches_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Parallel<wbr>Launches</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshotconfiguration_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotconfiguration_go" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_java" style="color: inherit; text-decoration: inherit;">launch<wbr>Template</a>
    ...
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxparallellaunches_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxparallellaunches_java" style="color: inherit; text-decoration: inherit;">max<wbr>Parallel<wbr>Launches</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshotconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotconfiguration_java" style="color: inherit; text-decoration: inherit;">snapshot<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_nodejs" style="color: inherit; text-decoration: inherit;">launch<wbr>Template</a>
    ...
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxparallellaunches_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxparallellaunches_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Parallel<wbr>Launches</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshotconfiguration_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">snapshot<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launch_template_python" style="color: inherit; text-decoration: inherit;">launch_<wbr>template</a>
    ...
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="max_parallel_launches_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_parallel_launches_python" style="color: inherit; text-decoration: inherit;">max_<wbr>parallel_<wbr>launches</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshot_configuration_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshot_configuration_python" style="color: inherit; text-decoration: inherit;">snapshot_<wbr>configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplate_yaml" style="color: inherit; text-decoration: inherit;">launch<wbr>Template</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationlaunchtemplate">Property Map</a></span>
    </dt>
    <dd>Configuration block for the launch template that the fast-launch enabled Windows AMI uses when it launches Windows instances to create pre-provisioned snapshots. Detailed below.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxparallellaunches_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxparallellaunches_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Parallel<wbr>Launches</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
    <dd>The maximum number of parallel instances that are launched for creating resources.</dd><dt class="property-optional"
            title="Optional">
        <span id="snapshotconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotconfiguration_yaml" style="color: inherit; text-decoration: inherit;">snapshot<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">Property Map</a></span>
    </dt>
    <dd>Configuration block for managing the number of snapshots that are created from pre-provisioned instances for the Windows AMI when faster launching is enabled. Detailed below.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="distributionconfigurationdistributionfastlaunchconfigurationlaunchtemplate">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Launch<wbr>Template<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Launch<wbr>Template<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateid_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Id</a>
    ...
    <dd>The ID of the launch template to use for faster launching for a Windows AMI.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplatename_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Name</a>
    ...
    <dd>The name of the launch template to use for faster launching for a Windows AMI.</dd><dt class="property-optional"
            title="Optional">
        <span id="launchtemplateversion_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateversion_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The version of the launch template to use for faster launching for a Windows AMI.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="distributionconfigurationdistributionfastlaunchconfigurationsnapshotconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Fast<wbr>Launch<wbr>Configuration<wbr>Snapshot<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="targetresourcecount_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetresourcecount_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Resource<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The number of pre-provisioned snapshots to keep on hand for a fast-launch enabled Windows AMI.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="targetresourcecount_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetresourcecount_go" style="color: inherit; text-decoration: inherit;">Target<wbr>Resource<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="targetresourcecount_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetresourcecount_java" style="color: inherit; text-decoration: inherit;">target<wbr>Resource<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="targetresourcecount_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetresourcecount_nodejs" style="color: inherit; text-decoration: inherit;">target<wbr>Resource<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="target_resource_count_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#target_resource_count_python" style="color: inherit; text-decoration: inherit;">target_<wbr>resource_<wbr>count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="targetresourcecount_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetresourcecount_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Resource<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<h4 id="distributionconfigurationdistributionlaunchtemplateconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Launch<wbr>Template<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Launch<wbr>Template<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtemplateid_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Template<wbr>Id</a>
    ...
    <dd>The ID of the Amazon EC2 launch template to use.</dd><dt class="property-optional"
            title="Optional">
        <span id="accountid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
</span>
    ...
    <dd>The account ID that this configuration applies to.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#default_csharp" style="color: inherit; text-decoration: inherit;">Default</a>
    ...
    <dd>Indicates whether to set the specified Amazon EC2 launch template as the default launch template. Defaults to <code>true</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="distributionconfigurationdistributions3exportconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>S3Export<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="diskimageformat_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskimageformat_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image<wbr>Format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The disk image format of the exported image (<code>RAW</code>, <code>VHD</code>, or <code>VMDK</code>)</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolename_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Name</a>
    ...
    <dd>The name of the IAM role to use for exporting.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3bucket_csharp" style="color: inherit; text-decoration: inherit;">S3Bucket</a>
    ...
    <dd>The name of the S3 bucket to store the exported image in. The bucket needs to exist before the export configuration is created.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3prefix_csharp" style="color: inherit; text-decoration: inherit;">S3Prefix</a>
    ...
    <dd>The prefix for the exported image.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="diskimageformat_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskimageformat_go" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image<wbr>Format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="diskimageformat_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskimageformat_java" style="color: inherit; text-decoration: inherit;">disk<wbr>Image<wbr>Format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="diskimageformat_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskimageformat_nodejs" style="color: inherit; text-decoration: inherit;">disk<wbr>Image<wbr>Format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="disk_image_format_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disk_image_format_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>image_<wbr>format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="diskimageformat_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskimageformat_yaml" style="color: inherit; text-decoration: inherit;">disk<wbr>Image<wbr>Format</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="distributionconfigurationdistributionssmparameterconfiguration">
Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Distribution<wbr>Configuration<wbr>Distribution<wbr>Ssm<wbr>Parameter<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametername_csharp" style="color: inherit; text-decoration: inherit;">Parameter<wbr>Name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="amiaccountid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiaccountid_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Account<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>AWS account ID that will own the parameter in the given region. This account must be specified as a target account in the distribution settings.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatype_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Type</a>
    ...
    <dd>Data type of the SSM parameter. Valid values are <code>text</code> and <code>aws:ec2:image</code>. AWS recommends using <code>aws:ec2:image</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametername_go" style="color: inherit; text-decoration: inherit;">Parameter<wbr>Name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="amiaccountid_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiaccountid_go" style="color: inherit; text-decoration: inherit;">Ami<wbr>Account<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametername_java" style="color: inherit; text-decoration: inherit;">parameter<wbr>Name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="amiaccountid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiaccountid_java" style="color: inherit; text-decoration: inherit;">ami<wbr>Account<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametername_nodejs" style="color: inherit; text-decoration: inherit;">parameter<wbr>Name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="amiaccountid_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiaccountid_nodejs" style="color: inherit; text-decoration: inherit;">ami<wbr>Account<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parameter_name_python" style="color: inherit; text-decoration: inherit;">parameter_<wbr>name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="ami_account_id_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ami_account_id_python" style="color: inherit; text-decoration: inherit;">ami_<wbr>account_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametername_yaml" style="color: inherit; text-decoration: inherit;">parameter<wbr>Name</a>
    ...
    <dd>Name of the SSM parameter that will store the AMI ID after distribution.</dd><dt class="property-optional"
            title="Optional">
        <span id="amiaccountid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiaccountid_yaml" style="color: inherit; text-decoration: inherit;">ami<wbr>Account<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
