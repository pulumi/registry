...
><span class="k">func </span>LookupImage<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupImageArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupImageResult</a></span>, error)</span
><span class="k">
func </span>LookupImageOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupImageOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupImageResultOutput</span
></code></pre></div>
...
<span class="k">&nbsp;&nbsp;function:</span> aws:imagebuilder/getImage:getImage
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the image. The suffix can either be specified with wildcards (<code>x.x.x</code>) to fetch the latest build version or a full build version (e.g., <code>2020.11.26/1</code>) to fetch an exact version.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of resource tags for the image.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildversionarn_csharp" style="color: inherit; text-decoration: inherit;">Build<wbr>Version<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Build version ARN of the image. This will always have the <code>#.#.#/#</code> suffix.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerrecipearn_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Recipe<wbr>Arn</a>
    ...
    <dd>ARN of the container recipe.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distributionconfigurationarn_csharp" style="color: inherit; text-decoration: inherit;">Distribution<wbr>Configuration<wbr>Arn</a>
    ...
    <dd>ARN of the Image Builder Distribution Configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enhancedimagemetadataenabled_csharp" style="color: inherit; text-decoration: inherit;">Enhanced<wbr>Image<wbr>Metadata<wbr>Enabled</a>
    ...
    <dd>Whether additional information about the image being created is collected.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagerecipearn_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Recipe<wbr>Arn</a>
    ...
    <dd>ARN of the image recipe.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagescanningconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Scanning<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfiguration">List&lt;Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>List of an object with image scanning configuration fields.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagetestsconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Tests<wbr>Configurations</a>
    ...
    <dd>List of an object with image tests configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#infrastructureconfigurationarn_csharp" style="color: inherit; text-decoration: inherit;">Infrastructure<wbr>Configuration<wbr>Arn</a>
    ...
    <dd>ARN of the Image Builder Infrastructure Configuration.</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#platform_csharp" style="color: inherit; text-decoration: inherit;">Platform</a>
    ...
    <dd>Platform of the image.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
    ...
    <dd>Key-value map of resource tags for the image.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildversionarn_go" style="color: inherit; text-decoration: inherit;">Build<wbr>Version<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagescanningconfigurations_go" style="color: inherit; text-decoration: inherit;">Image<wbr>Scanning<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfiguration">[]Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration</a></span>
    </dt>
    <dd>List of an object with image scanning configuration fields.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_java" style="color: inherit; text-decoration: inherit;">arn</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="buildversionarn_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildversionarn_java" style="color: inherit; text-decoration: inherit;">build<wbr>Version<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildversionarn_nodejs" style="color: inherit; text-decoration: inherit;">build<wbr>Version<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#build_version_arn_python" style="color: inherit; text-decoration: inherit;">build_<wbr>version_<wbr>arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#image_scanning_configurations_python" style="color: inherit; text-decoration: inherit;">image_<wbr>scanning_<wbr>configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfiguration">Sequence[Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration]</a></span>
    </dt>
    <dd>List of an object with image scanning configuration fields.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_yaml" style="color: inherit; text-decoration: inherit;">arn</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="buildversionarn_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildversionarn_yaml" style="color: inherit; text-decoration: inherit;">build<wbr>Version<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagescanningconfigurations_yaml" style="color: inherit; text-decoration: inherit;">image<wbr>Scanning<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of an object with image scanning configuration fields.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagetestsconfigurations_yaml" style="color: inherit; text-decoration: inherit;">image<wbr>Tests<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagetestsconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of an object with image tests configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outputresources_yaml" style="color: inherit; text-decoration: inherit;">output<wbr>Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresource">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of objects with resources created by the image.</dd><dt class="property-"
            title="">
...
<h4 id="getimageimagescanningconfiguration">Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration</h4>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecrconfigurations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecrconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ecr<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">List&lt;Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration&gt;</a></span>
    </dt>
    <dd>Configuration block with ECR configuration.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagescanningenabled_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Scanning<wbr>Enabled</a>
    ...
    <dd>Indicates whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecrconfigurations_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecrconfigurations_go" style="color: inherit; text-decoration: inherit;">Ecr<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">[]Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration</a></span>
    </dt>
    <dd>Configuration block with ECR configuration.</dd><dt class="property-required"
            title="Required">
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecrconfigurations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecrconfigurations_java" style="color: inherit; text-decoration: inherit;">ecr<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">List&lt;Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration&gt;</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecrconfigurations_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecrconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">ecr<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration[]</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecr_configurations_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecr_configurations_python" style="color: inherit; text-decoration: inherit;">ecr_<wbr>configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">Sequence[Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration]</a></span>
    </dt>
    <dd>Configuration block with ECR configuration.</dd><dt class="property-required"
            title="Required">
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="ecrconfigurations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecrconfigurations_yaml" style="color: inherit; text-decoration: inherit;">ecr<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageimagescanningconfigurationecrconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Configuration block with ECR configuration.</dd><dt class="property-required"
            title="Required">
...
<h4 id="getimageimagescanningconfigurationecrconfiguration">Get<wbr>Image<wbr>Image<wbr>Scanning<wbr>Configuration<wbr>Ecr<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containertags_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Tags</a>
    ...
    <dd>Set of tags for Image Builder to apply to the output container image that that Amazon Inspector scans.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagetestsenabled_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Tests<wbr>Enabled</a>
    ...
    <dd>Whether image tests are enabled.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeoutminutes_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Minutes</a>
    ...
    <dd>Number of minutes before image tests time out.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amis_csharp" style="color: inherit; text-decoration: inherit;">Amis</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourceami">List&lt;Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Ami&gt;</a></span>
    </dt>
    <dd>Set of objects with each Amazon Machine Image (AMI) created.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containers_csharp" style="color: inherit; text-decoration: inherit;">Containers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourcecontainer">List&lt;Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Container&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containers_go" style="color: inherit; text-decoration: inherit;">Containers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourcecontainer">[]Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Container</a></span>
    </dt>
    <dd>Set of objects with each container image created and stored in the output repository.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amis_python" style="color: inherit; text-decoration: inherit;">amis</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourceami">Sequence[Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Ami]</a></span>
    </dt>
    <dd>Set of objects with each Amazon Machine Image (AMI) created.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containers_python" style="color: inherit; text-decoration: inherit;">containers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourcecontainer">Sequence[Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Container]</a></span>
    </dt>
    <dd>Set of objects with each container image created and stored in the output repository.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amis_yaml" style="color: inherit; text-decoration: inherit;">amis</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourceami">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Set of objects with each Amazon Machine Image (AMI) created.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containers_yaml" style="color: inherit; text-decoration: inherit;">containers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimageoutputresourcecontainer">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Set of objects with each container image created and stored in the output repository.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>Account identifier of the AMI.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description of the AMI.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
    ...
    <dd>Identifier of the AMI.</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>Name of the AMI.</dd><dt class="property-required"
            title="Required">
...
<h4 id="getimageoutputresourcecontainer">Get<wbr>Image<wbr>Output<wbr>Resource<wbr>Container</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imageuris_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Uris</a>
    ...
    <dd>Set of URIs for created containers.</dd><dt class="property-required"
            title="Required">
        <span id="region_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
</span>
