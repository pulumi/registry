...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAnalyticsApplication</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">AnalyticsApplicationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AnalyticsApplication</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:kinesis:AnalyticsApplication</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudwatchloggingoptions_csharp" style="color: inherit; text-decoration: inherit;">Cloudwatch<wbr>Logging<wbr>Options</a>
    ...
    <dd>The CloudWatch log stream options to monitor application errors.
See CloudWatch Logging Options below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="code_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#code_csharp" style="color: inherit; text-decoration: inherit;">Code</a>
    ...
    <dd>SQL Code to transform input data, and generate output.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
    ...
    <dd>Input configuration of the application. See Inputs below for more details.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the Kinesis Analytics Application.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outputs_csharp" style="color: inherit; text-decoration: inherit;">Outputs</a>
    ...
    <dd>Output destination configuration of the application. See Outputs below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#referencedatasources_csharp" style="color: inherit; text-decoration: inherit;">Reference<wbr>Data<wbr>Sources</a>
    ...
    <dd>An S3 Reference Data Source for the application.
See Reference Data Sources below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startapplication_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Application</a>
    ...
    <dd>Whether to start or stop the Kinesis Analytics Application. To start an application, an input with a defined <code>starting_position</code> must be configured.
To modify an application's starting position, first stop the application by setting <code>start_application = false</code>, then update <code>starting_position</code> and set <code>start_application = true</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of tags for the Kinesis Analytics Application. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Kinesis Analytics Appliation.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Timestamp</a>
    ...
    <dd>The Timestamp when the application version was created.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastupdatetimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Update<wbr>Timestamp</a>
    ...
    <dd>The Timestamp when the application was last updated.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>The Version of the application.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetAnalyticsApplication<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">AnalyticsApplicationState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AnalyticsApplication</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">AnalyticsApplication</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">AnalyticsApplicationState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:kinesis:AnalyticsApplication</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the Kinesis Analytics Appliation.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_code_csharp" style="color: inherit; text-decoration: inherit;">Code</a>
    ...
    <dd>SQL Code to transform input data, and generate output.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_createtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Timestamp</a>
    ...
    <dd>The Timestamp when the application version was created.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
    ...
    <dd>Input configuration of the application. See Inputs below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_lastupdatetimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Update<wbr>Timestamp</a>
    ...
    <dd>The Timestamp when the application was last updated.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_referencedatasources_csharp" style="color: inherit; text-decoration: inherit;">Reference<wbr>Data<wbr>Sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Key-value map of tags for the Kinesis Analytics Application. If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</dd><dt class="property-optional property-deprecated"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_referencedatasources_go" style="color: inherit; text-decoration: inherit;">Reference<wbr>Data<wbr>Sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_outputs_java" style="color: inherit; text-decoration: inherit;">outputs</a>
    ...
    <dd>Output destination configuration of the application. See Outputs below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_referencedatasources_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_referencedatasources_java" style="color: inherit; text-decoration: inherit;">reference<wbr>Data<wbr>Sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_referencedatasources_nodejs" style="color: inherit; text-decoration: inherit;">reference<wbr>Data<wbr>Sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_reference_data_sources_python" style="color: inherit; text-decoration: inherit;">reference_<wbr>data_<wbr>sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_outputs_yaml" style="color: inherit; text-decoration: inherit;">outputs</a>
    ...
    <dd>Output destination configuration of the application. See Outputs below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_referencedatasources_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_referencedatasources_yaml" style="color: inherit; text-decoration: inherit;">reference<wbr>Data<wbr>Sources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasources">Property Map</a></span>
    </dt>
...
<h4 id="analyticsapplicationcloudwatchloggingoptions">
Analytics<wbr>Application<wbr>Cloudwatch<wbr>Logging<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Cloudwatch<wbr>Logging<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logstreamarn_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Stream<wbr>Arn</a>
    ...
    <dd>The ARN of the CloudWatch Log Stream.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
    ...
    <dd>The ARN of the IAM Role used to send application messages.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
    ...
    <dd>The ARN of the Kinesis Analytics Application.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationinputs">
Analytics<wbr>Application<wbr>Inputs<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameprefix_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Prefix</a>
    ...
    <dd>The Name Prefix to use when creating an in-application stream.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
    ...
    <dd>The Schema format of the data in the streaming source. See Source Schema below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
    ...
    <dd>The ARN of the Kinesis Analytics Application.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisfirehose_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_csharp" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Firehose</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>The Kinesis Firehose configuration for the streaming source. Conflicts with <code>kinesis_stream</code>.
See Kinesis Firehose below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisstream_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_csharp" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Stream</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>The Kinesis Stream configuration for the streaming source. Conflicts with <code>kinesis_firehose</code>.
See Kinesis Stream below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parallelism_csharp" style="color: inherit; text-decoration: inherit;">Parallelism</a>
    ...
    <dd>The number of Parallel in-application streams to create.
See Parallelism below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#processingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Processing<wbr>Configuration</a>
    ...
    <dd>The Processing Configuration to transform records as they are received from the stream.
See Processing Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="startingpositionconfigurations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startingpositionconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Starting<wbr>Position<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>The point at which the application starts processing records from the streaming source.
See Starting Position Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_go" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Firehose</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisfirehose">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_go" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Stream</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisstream">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startingpositionconfigurations_go" style="color: inherit; text-decoration: inherit;">Starting<wbr>Position<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_java" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The ARN of the Kinesis Analytics Application.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisfirehose_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_java" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Firehose</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisfirehose">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose</a></span>
    </dt>
...
See Kinesis Firehose below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisstream_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_java" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Stream</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisstream">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream</a></span>
    </dt>
...
See Processing Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="startingpositionconfigurations_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startingpositionconfigurations_java" style="color: inherit; text-decoration: inherit;">starting<wbr>Position<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsstartingpositionconfiguration">List&lt;Analytics<wbr>Application<wbr>Inputs<wbr>Starting<wbr>Position<wbr>Configuration&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_nodejs" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Firehose</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisfirehose">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_nodejs" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Stream</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisstream">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startingpositionconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">starting<wbr>Position<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsstartingpositionconfiguration">Analytics<wbr>Application<wbr>Inputs<wbr>Starting<wbr>Position<wbr>Configuration[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesis_firehose_python" style="color: inherit; text-decoration: inherit;">kinesis_<wbr>firehose</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisfirehose">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesis_stream_python" style="color: inherit; text-decoration: inherit;">kinesis_<wbr>stream</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisstream">Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#starting_position_configurations_python" style="color: inherit; text-decoration: inherit;">starting_<wbr>position_<wbr>configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsstartingpositionconfiguration">Sequence[Analytics<wbr>Application<wbr>Inputs<wbr>Starting<wbr>Position<wbr>Configuration]</a></span>
    </dt>
    <dd>The point at which the application starts processing records from the streaming source.
See Starting Position Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_yaml" style="color: inherit; text-decoration: inherit;">schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschema">Property Map</a></span>
    </dt>
    <dd>The Schema format of the data in the streaming source. See Source Schema below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_yaml" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The ARN of the Kinesis Analytics Application.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisfirehose_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_yaml" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Firehose</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisfirehose">Property Map</a></span>
    </dt>
    <dd>The Kinesis Firehose configuration for the streaming source. Conflicts with <code>kinesis_stream</code>.
See Kinesis Firehose below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisstream_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_yaml" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Stream</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputskinesisstream">Property Map</a></span>
    </dt>
    <dd>The Kinesis Stream configuration for the streaming source. Conflicts with <code>kinesis_firehose</code>.
See Kinesis Stream below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parallelism_yaml" style="color: inherit; text-decoration: inherit;">parallelism</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsparallelism">Property Map</a></span>
    </dt>
    <dd>The number of Parallel in-application streams to create.
See Parallelism below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#processingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">processing<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsprocessingconfiguration">Property Map</a></span>
    </dt>
    <dd>The Processing Configuration to transform records as they are received from the stream.
See Processing Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="startingpositionconfigurations_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startingpositionconfigurations_yaml" style="color: inherit; text-decoration: inherit;">starting<wbr>Position<wbr>Configurations</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsstartingpositionconfiguration">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The point at which the application starts processing records from the streaming source.
See Starting Position Configuration below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="analyticsapplicationinputskinesisfirehose">
Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Firehose<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>The ARN of the Kinesis Firehose delivery stream.</dd><dt class="property-required"
            title="Required">
        <span id="rolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
</span>
    ...
    <dd>The ARN of the IAM Role used to access the stream.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationinputskinesisstream">
Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Kinesis<wbr>Stream<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>The ARN of the Kinesis Stream.</dd><dt class="property-required"
            title="Required">
        <span id="rolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
</span>
...
<h4 id="analyticsapplicationinputsparallelism">
Analytics<wbr>Application<wbr>Inputs<wbr>Parallelism<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Parallelism<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationinputsprocessingconfiguration">
Analytics<wbr>Application<wbr>Inputs<wbr>Processing<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Processing<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lambda_csharp" style="color: inherit; text-decoration: inherit;">Lambda</a>
    ...
    <dd>The Lambda function configuration. See Lambda below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lambda_yaml" style="color: inherit; text-decoration: inherit;">lambda</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsprocessingconfigurationlambda">Property Map</a></span>
    </dt>
    <dd>The Lambda function configuration. See Lambda below for more details.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="analyticsapplicationinputsprocessingconfigurationlambda">
Analytics<wbr>Application<wbr>Inputs<wbr>Processing<wbr>Configuration<wbr>Lambda<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Processing<wbr>Configuration<wbr>Lambda<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>The ARN of the Lambda function.</dd><dt class="property-required"
            title="Required">
        <span id="rolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
</span>
    ...
    <dd>The ARN of the IAM Role used to access the Lambda function.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationinputsschema">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordcolumns_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Columns</a>
    ...
    <dd>The Record Column mapping for the streaming source data element.
See Record Columns below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordformat_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Format</a>
    ...
    <dd>The Record Format and mapping information to schematize a record.
See Record Format below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordencoding_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Encoding</a>
    ...
    <dd>The Encoding of the record in the streaming source.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#record_columns_python" style="color: inherit; text-decoration: inherit;">record_<wbr>columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordcolumn">Sequence[Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Column]</a></span>
    </dt>
    <dd>The Record Column mapping for the streaming source data element.
See Record Columns below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordcolumns_yaml" style="color: inherit; text-decoration: inherit;">record<wbr>Columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordcolumn">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The Record Column mapping for the streaming source data element.
See Record Columns below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordformat_yaml" style="color: inherit; text-decoration: inherit;">record<wbr>Format</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordformat">Property Map</a></span>
    </dt>
    <dd>The Record Format and mapping information to schematize a record.
See Record Format below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="analyticsapplicationinputsschemarecordcolumn">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Column<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Column<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sqltype_csharp" style="color: inherit; text-decoration: inherit;">Sql<wbr>Type</a>
    ...
    <dd>The SQL Type of the column.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mapping_csharp" style="color: inherit; text-decoration: inherit;">Mapping</a>
    ...
    <dd>The Mapping reference to the data element.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationinputsschemarecordformat">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mappingparameters_csharp" style="color: inherit; text-decoration: inherit;">Mapping<wbr>Parameters</a>
    ...
    <dd>The Mapping Information for the record format.
See Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordformattype_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Format<wbr>Type</a>
    ...
    <dd>The type of Record Format. Can be <code>CSV</code> or <code>JSON</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mappingparameters_yaml" style="color: inherit; text-decoration: inherit;">mapping<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordformatmappingparameters">Property Map</a></span>
    </dt>
    <dd>The Mapping Information for the record format.
See Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="analyticsapplicationinputsschemarecordformatmappingparameters">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csv_csharp" style="color: inherit; text-decoration: inherit;">Csv</a>
    ...
    <dd>Mapping information when the record format uses delimiters.
See CSV Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="json_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#json_csharp" style="color: inherit; text-decoration: inherit;">Json</a>
    ...
    <dd>Mapping information when JSON is the record format on the streaming source.
See JSON Mapping Parameters below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csv_yaml" style="color: inherit; text-decoration: inherit;">csv</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordformatmappingparameterscsv">Property Map</a></span>
    </dt>
    <dd>Mapping information when the record format uses delimiters.
See CSV Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#json_yaml" style="color: inherit; text-decoration: inherit;">json</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationinputsschemarecordformatmappingparametersjson">Property Map</a></span>
    </dt>
    <dd>Mapping information when JSON is the record format on the streaming source.
See JSON Mapping Parameters below for more details.</dd></dl>
</pulumi-choosable>
...
<h4 id="analyticsapplicationinputsschemarecordformatmappingparameterscsv">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Csv<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Csv<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordcolumndelimiter_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Column<wbr>Delimiter</a>
    ...
    <dd>The Column Delimiter.</dd><dt class="property-required"
            title="Required">
...
<h4 id="analyticsapplicationinputsschemarecordformatmappingparametersjson">
Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Json<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Json<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordrowpath_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Row<wbr>Path</a>
    ...
    <dd>Path to the top-level parent that contains the records.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationinputsstartingpositionconfiguration">
Analytics<wbr>Application<wbr>Inputs<wbr>Starting<wbr>Position<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Inputs<wbr>Starting<wbr>Position<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationoutput">
Analytics<wbr>Application<wbr>Output<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Output<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The Name of the in-application stream.</dd><dt class="property-required"
            title="Required">
        <span id="schema_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
</span>
    ...
    <dd>The Schema format of the data written to the destination. See Destination Schema below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_csharp" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Firehose</a>
    ...
    <dd>The Kinesis Firehose configuration for the destination stream. Conflicts with <code>kinesis_stream</code>.
See Kinesis Firehose below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="kinesisstream_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_csharp" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Stream</a>
    ...
    <dd>The Kinesis Stream configuration for the destination stream. Conflicts with <code>kinesis_firehose</code>.
See Kinesis Stream below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="lambda_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lambda_csharp" style="color: inherit; text-decoration: inherit;">Lambda</a>
    ...
    <dd>The Lambda function destination. See Lambda below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_yaml" style="color: inherit; text-decoration: inherit;">schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationoutputschema">Property Map</a></span>
    </dt>
    <dd>The Schema format of the data written to the destination. See Destination Schema below for more details.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisfirehose_yaml" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Firehose</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationoutputkinesisfirehose">Property Map</a></span>
    </dt>
    <dd>The Kinesis Firehose configuration for the destination stream. Conflicts with <code>kinesis_stream</code>.
See Kinesis Firehose below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisstream_yaml" style="color: inherit; text-decoration: inherit;">kinesis<wbr>Stream</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationoutputkinesisstream">Property Map</a></span>
    </dt>
    <dd>The Kinesis Stream configuration for the destination stream. Conflicts with <code>kinesis_firehose</code>.
See Kinesis Stream below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lambda_yaml" style="color: inherit; text-decoration: inherit;">lambda</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationoutputlambda">Property Map</a></span>
    </dt>
    <dd>The Lambda function destination. See Lambda below for more details.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="analyticsapplicationoutputkinesisfirehose">
Analytics<wbr>Application<wbr>Output<wbr>Kinesis<wbr>Firehose<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Output<wbr>Kinesis<wbr>Firehose<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationoutputkinesisstream">
Analytics<wbr>Application<wbr>Output<wbr>Kinesis<wbr>Stream<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Output<wbr>Kinesis<wbr>Stream<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationoutputlambda">
Analytics<wbr>Application<wbr>Output<wbr>Lambda<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Output<wbr>Lambda<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationoutputschema">
Analytics<wbr>Application<wbr>Output<wbr>Schema<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Output<wbr>Schema<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordformattype_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Format<wbr>Type</a>
    ...
    <dd>The Format Type of the records on the output stream. Can be <code>CSV</code> or <code>JSON</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationreferencedatasources">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3_csharp" style="color: inherit; text-decoration: inherit;">S3</a>
    ...
    <dd>The S3 configuration for the reference data source. See S3 Reference below for more details.</dd><dt class="property-required"
            title="Required">
        <span id="schema_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
</span>
    ...
    <dd>The Schema format of the data in the streaming source. See Source Schema below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tablename_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Name</a>
    ...
    <dd>The in-application Table Name.</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3_yaml" style="color: inherit; text-decoration: inherit;">s3</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcess3">Property Map</a></span>
    </dt>
    <dd>The S3 configuration for the reference data source. See S3 Reference below for more details.</dd><dt class="property-required"
            title="Required">
        <span id="schema_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_yaml" style="color: inherit; text-decoration: inherit;">schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschema">Property Map</a></span>
    </dt>
    <dd>The Schema format of the data in the streaming source. See Source Schema below for more details.</dd><dt class="property-required"
            title="Required">
...
<h4 id="analyticsapplicationreferencedatasourcess3">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>S3<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>S3<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucketarn_csharp" style="color: inherit; text-decoration: inherit;">Bucket<wbr>Arn</a>
    ...
    <dd>The S3 Bucket ARN.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filekey_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Key</a>
    ...
    <dd>The File Key name containing reference data.</dd><dt class="property-required"
            title="Required">
        <span id="rolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
</span>
    ...
    <dd>The IAM Role ARN to read the data.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="analyticsapplicationreferencedatasourcesschema">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#record_columns_python" style="color: inherit; text-decoration: inherit;">record_<wbr>columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordcolumn">Sequence[Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Column]</a></span>
    </dt>
    <dd>The Record Column mapping for the streaming source data element.
See Record Columns below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordcolumns_yaml" style="color: inherit; text-decoration: inherit;">record<wbr>Columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordcolumn">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The Record Column mapping for the streaming source data element.
See Record Columns below for more details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#recordformat_yaml" style="color: inherit; text-decoration: inherit;">record<wbr>Format</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordformat">Property Map</a></span>
    </dt>
    <dd>The Record Format and mapping information to schematize a record.
See Record Format below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="analyticsapplicationreferencedatasourcesschemarecordcolumn">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Column<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Column<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationreferencedatasourcesschemarecordformat">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mappingparameters_yaml" style="color: inherit; text-decoration: inherit;">mapping<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordformatmappingparameters">Property Map</a></span>
    </dt>
    <dd>The Mapping Information for the record format.
See Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="analyticsapplicationreferencedatasourcesschemarecordformatmappingparameters">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csv_yaml" style="color: inherit; text-decoration: inherit;">csv</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordformatmappingparameterscsv">Property Map</a></span>
    </dt>
    <dd>Mapping information when the record format uses delimiters.
See CSV Mapping Parameters below for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#json_yaml" style="color: inherit; text-decoration: inherit;">json</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#analyticsapplicationreferencedatasourcesschemarecordformatmappingparametersjson">Property Map</a></span>
    </dt>
    <dd>Mapping information when JSON is the record format on the streaming source.
See JSON Mapping Parameters below for more details.</dd></dl>
</pulumi-choosable>
...
<h4 id="analyticsapplicationreferencedatasourcesschemarecordformatmappingparameterscsv">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Csv<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Csv<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="analyticsapplicationreferencedatasourcesschemarecordformatmappingparametersjson">
Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Json<pulumi-choosable type="language" values="python,go" class="inline">, Analytics<wbr>Application<wbr>Reference<wbr>Data<wbr>Sources<wbr>Schema<wbr>Record<wbr>Format<wbr>Mapping<wbr>Parameters<wbr>Json<wbr>Args</pulumi-choosable>
</h4>
