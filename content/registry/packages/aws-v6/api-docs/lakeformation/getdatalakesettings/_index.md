...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetDataLakeSettingsResult</a></span>> </span>getDataLakeSettings<span class="p">(</span><span class="nx">GetDataLakeSettingsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogid_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Id</a>
    ...
    <dd>Identifier for the Data Catalog. By default, the account ID.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#admins_csharp" style="color: inherit; text-decoration: inherit;">Admins</a>
    ...
    <dd>List of ARNs of AWS Lake Formation principals (IAM users or roles).</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowexternaldatafiltering_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>External<wbr>Data<wbr>Filtering</a>
    ...
    <dd>Whether to allow Amazon EMR clusters to access data managed by Lake Formation.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowfulltableexternaldataaccess_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Full<wbr>Table<wbr>External<wbr>Data<wbr>Access</a>
    ...
    <dd>Whether to allow a third-party query engine to get data access credentials without session tags when a caller has full data access permissions.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authorizedsessiontagvaluelists_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Session<wbr>Tag<wbr>Value<wbr>Lists</a>
    ...
    <dd>Lake Formation relies on a privileged process secured by Amazon EMR or the third party integrator to tag the user's role while assuming it.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdatabasedefaultpermissions_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Database<wbr>Default<wbr>Permissions</a>
    ...
    <dd>Up to three configuration blocks of principal permissions for default create database permissions. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createtabledefaultpermissions_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Table<wbr>Default<wbr>Permissions</a>
    ...
    <dd>Up to three configuration blocks of principal permissions for default create table permissions. Detailed below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#externaldatafilteringallowlists_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Data<wbr>Filtering<wbr>Allow<wbr>Lists</a>
    ...
    <dd>A list of the account IDs of Amazon Web Services accounts with Amazon EMR clusters that are to perform data filtering.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
    ...
    <dd>Key-value map of additional configuration. <code>CROSS_ACCOUNT_VERSION</code> will be set to values <code>&quot;1&quot;</code>, <code>&quot;2&quot;</code>, <code>&quot;3&quot;</code>, or <code>&quot;4&quot;</code>. <code>SET_CONTEXT</code> will also be returned with a value of <code>TRUE</code>. In a fresh account, prior to configuring, <code>CROSS_ACCOUNT_VERSION</code> is <code>&quot;1&quot;</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readonlyadmins_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Only<wbr>Admins</a>
    ...
    <dd>List of ARNs of AWS Lake Formation principals (IAM users or roles) with only view access to the resources.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#trustedresourceowners_csharp" style="color: inherit; text-decoration: inherit;">Trusted<wbr>Resource<wbr>Owners</a>
    ...
    <dd>List of the resource-owning account IDs that the caller's account can use to share their user access details (user ARNs).</dd><dt class="property-"
            title="">
        <span id="catalogid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogid_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Id</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#permissions_csharp" style="color: inherit; text-decoration: inherit;">Permissions</a>
    ...
    <dd>List of permissions granted to the principal.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#principal_csharp" style="color: inherit; text-decoration: inherit;">Principal</a>
    ...
    <dd>Principal who is granted permissions.</dd></dl>
</pulumi-choosable>
</div>
