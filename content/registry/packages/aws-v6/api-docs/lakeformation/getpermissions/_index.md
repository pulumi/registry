...
><span class="k">def </span>get_permissions<span class="p">(</span><span class="nx">catalog_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    ...
                    <span class="nx">data_cells_filter</span><span class="p">:</span> <span class="nx">Optional[GetPermissionsDataCellsFilter]</span> = None<span class="p">,</span>
...
def </span>get_permissions_output<span class="p">(</span><span class="nx">catalog_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                    ...
                    <span class="nx">data_cells_filter</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[GetPermissionsDataCellsFilterArgs]]</span> = None<span class="p">,</span>
...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetPermissionsResult</a></span>> </span>getPermissions<span class="p">(</span><span class="nx">GetPermissionsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogresource_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Resource</a>
    ...
    <dd>Whether the permissions are to be granted for the Data Catalog. Defaults to <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datacellsfilter_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Cells<wbr>Filter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionsdatacellsfilter">Get<wbr>Permissions<wbr>Data<wbr>Cells<wbr>Filter</a></span>
    </dt>
    <dd>Configuration block for a data cells filter resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datalocation_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Location</a>
    ...
    <dd>Configuration block for a data location resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#database_csharp" style="color: inherit; text-decoration: inherit;">Database</a>
    ...
    <dd>Configuration block for a database resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lftag_csharp" style="color: inherit; text-decoration: inherit;">Lf<wbr>Tag</a>
    ...
    <dd>Configuration block for an LF-tag resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lftagpolicy_csharp" style="color: inherit; text-decoration: inherit;">Lf<wbr>Tag<wbr>Policy</a>
    ...
    <dd>Configuration block for an LF-tag policy resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#table_csharp" style="color: inherit; text-decoration: inherit;">Table</a>
    ...
    <dd>Configuration block for a table resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datacellsfilter_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Cells<wbr>Filter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionsdatacellsfilter">Property Map</a></span>
    </dt>
    <dd>Configuration block for a data cells filter resource. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#permissions_csharp" style="color: inherit; text-decoration: inherit;">Permissions</a>
    ...
    <dd>List of permissions granted to the principal. For details on permissions, see <a href="https://docs.aws.amazon.com/lake-formation/latest/dg/lf-permissions-reference.html">Lake Formation Permissions Reference</a>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#permissionswithgrantoptions_csharp" style="color: inherit; text-decoration: inherit;">Permissions<wbr>With<wbr>Grant<wbr>Options</a>
    ...
    <dd>Subset of <code>permissions</code> which the principal can pass.</dd><dt class="property-"
            title="">
        <span id="principal_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#principal_csharp" style="color: inherit; text-decoration: inherit;">Principal</a>
</span>
...
<h4 id="getpermissionsdatacellsfilter">Get<wbr>Permissions<wbr>Data<wbr>Cells<wbr>Filter</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogid_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Id</a>
    ...
    <dd>Identifier for the Data Catalog. By default, it is the account ID of the caller.</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<h4 id="getpermissionslftag">Get<wbr>Permissions<wbr>Lf<wbr>Tag</h4>
...
<h4 id="getpermissionslftagpolicy">Get<wbr>Permissions<wbr>Lf<wbr>Tag<wbr>Policy</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expressions_csharp" style="color: inherit; text-decoration: inherit;">Expressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionslftagpolicyexpression">List&lt;Get<wbr>Permissions<wbr>Lf<wbr>Tag<wbr>Policy<wbr>Expression&gt;</a></span>
    </dt>
    <dd><p>List of tag conditions that apply to the resource's tag policy. Configuration block for tag conditions that apply to the policy. See <code>expression</code> below.</p>
<p>The following argument is optional:</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcetype_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Type</a>
    ...
    <dd>Resource type for which the tag policy applies. Valid values are <code>DATABASE</code> and <code>TABLE</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expressions_go" style="color: inherit; text-decoration: inherit;">Expressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionslftagpolicyexpression">[]Get<wbr>Permissions<wbr>Lf<wbr>Tag<wbr>Policy<wbr>Expression</a></span>
    </dt>
    <dd><p>List of tag conditions that apply to the resource's tag policy. Configuration block for tag conditions that apply to the policy. See <code>expression</code> below.</p>
<p>The following argument is optional:</p>
</dd><dt class="property-required"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expressions_python" style="color: inherit; text-decoration: inherit;">expressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionslftagpolicyexpression">Sequence[Get<wbr>Permissions<wbr>Lf<wbr>Tag<wbr>Policy<wbr>Expression]</a></span>
    </dt>
    <dd><p>List of tag conditions that apply to the resource's tag policy. Configuration block for tag conditions that apply to the policy. See <code>expression</code> below.</p>
<p>The following argument is optional:</p>
</dd><dt class="property-required"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expressions_yaml" style="color: inherit; text-decoration: inherit;">expressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getpermissionslftagpolicyexpression">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>List of tag conditions that apply to the resource's tag policy. Configuration block for tag conditions that apply to the policy. See <code>expression</code> below.</p>
<p>The following argument is optional:</p>
</dd><dt class="property-required"
...
<h4 id="getpermissionslftagpolicyexpression">Get<wbr>Permissions<wbr>Lf<wbr>Tag<wbr>Policy<wbr>Expression</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>Key-name of an LF-Tag.</dd><dt class="property-required"
            title="Required">
        <span id="values_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#values_csharp" style="color: inherit; text-decoration: inherit;">Values</a>
</span>
    ...
    <dd>List of possible values of an LF-Tag.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the table. At least one of <code>name</code> or <code>wildcard</code> is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#wildcard_csharp" style="color: inherit; text-decoration: inherit;">Wildcard</a>
    ...
    <dd>Whether to use a wildcard representing every table under a database. At least one of <code>name</code> or <code>wildcard</code> is required. Defaults to <code>false</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#columnnames_csharp" style="color: inherit; text-decoration: inherit;">Column<wbr>Names</a>
    ...
    <dd>Set of column names for the table. At least one of <code>column_names</code> or <code>excluded_column_names</code> is required.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#excludedcolumnnames_csharp" style="color: inherit; text-decoration: inherit;">Excluded<wbr>Column<wbr>Names</a>
    ...
    <dd>Set of column names for the table to exclude. At least one of <code>column_names</code> or <code>excluded_column_names</code> is required.</dd><dt class="property-optional"
            title="Optional">
        <span id="wildcard_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#wildcard_csharp" style="color: inherit; text-decoration: inherit;">Wildcard</a>
</span>
