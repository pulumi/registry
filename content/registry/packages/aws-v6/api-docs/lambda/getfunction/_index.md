...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qualifier_csharp" style="color: inherit; text-decoration: inherit;">Qualifier</a>
    ...
    <dd>Alias name or version number of the lambda functionE.g., <code>$LATEST</code>, <code>my-alias</code>, or <code>1</code>. When not included: the data source resolves to the most recent published version; if no published version exists: it resolves to the most recent unpublished version.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architectures_csharp" style="color: inherit; text-decoration: inherit;">Architectures</a>
    ...
    <dd>Instruction set architecture for the Lambda function.</dd><dt class="property-"
            title="">
        <span id="arn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Unqualified (no <code>:QUALIFIER</code> or <code>:VERSION</code> suffix) ARN identifying your Lambda Function. See also <code>qualified_arn</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#codesigningconfigarn_csharp" style="color: inherit; text-decoration: inherit;">Code<wbr>Signing<wbr>Config<wbr>Arn</a>
    ...
    <dd>ARN for a Code Signing Configuration.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deadletterconfig_csharp" style="color: inherit; text-decoration: inherit;">Dead<wbr>Letter<wbr>Config</a>
    ...
    <dd>Configure the function's <em>dead letter queue</em>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description of what your Lambda Function does.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#environment_csharp" style="color: inherit; text-decoration: inherit;">Environment</a>
    ...
    <dd>Lambda environment's configuration settings.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ephemeralstorages_csharp" style="color: inherit; text-decoration: inherit;">Ephemeral<wbr>Storages</a>
    ...
    <dd>Amount of Ephemeral storage(<code>/tmp</code>) allocated for the Lambda Function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filesystemconfigs_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>System<wbr>Configs</a>
    ...
    <dd>Connection settings for an Amazon EFS file system.</dd><dt class="property-"
            title="">
        <span id="functionname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#functionname_csharp" style="color: inherit; text-decoration: inherit;">Function<wbr>Name</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#handler_csharp" style="color: inherit; text-decoration: inherit;">Handler</a>
    ...
    <dd>Function entrypoint in your code.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imageuri_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Uri</a>
    ...
    <dd>URI of the container image.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#invokearn_csharp" style="color: inherit; text-decoration: inherit;">Invoke<wbr>Arn</a>
    ...
    <dd>ARN to be used for invoking Lambda Function from API Gateway. <strong>NOTE:</strong> Starting with <code>v4.51.0</code> of the provider, this will <em>not</em> include the qualifier.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyarn_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Arn</a>
    ...
    <dd>ARN for the KMS encryption key.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layers_csharp" style="color: inherit; text-decoration: inherit;">Layers</a>
    ...
    <dd>List of Lambda Layer ARNs attached to your Lambda Function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfigs_csharp" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionloggingconfig">List&lt;Get<wbr>Function<wbr>Logging<wbr>Config&gt;</a></span>
    </dt>
    <dd>Advanced logging settings.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memorysize_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Size</a>
    ...
    <dd>Amount of memory in MB your Lambda Function can use at runtime.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qualifiedarn_csharp" style="color: inherit; text-decoration: inherit;">Qualified<wbr>Arn</a>
    ...
    <dd>Qualified (<code>:QUALIFIER</code> or <code>:VERSION</code> suffix) ARN identifying your Lambda Function. See also <code>arn</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qualifiedinvokearn_csharp" style="color: inherit; text-decoration: inherit;">Qualified<wbr>Invoke<wbr>Arn</a>
    ...
    <dd>Qualified (<code>:QUALIFIER</code> or <code>:VERSION</code> suffix) ARN to be used for invoking Lambda Function from API Gateway. See also <code>invoke_arn</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedconcurrentexecutions_csharp" style="color: inherit; text-decoration: inherit;">Reserved<wbr>Concurrent<wbr>Executions</a>
    ...
    <dd>The amount of reserved concurrent executions for this lambda function or <code>-1</code> if unreserved.</dd><dt class="property-"
            title="">
        <span id="role_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#role_csharp" style="color: inherit; text-decoration: inherit;">Role</a>
    ...
    <dd>IAM role attached to the Lambda Function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runtime_csharp" style="color: inherit; text-decoration: inherit;">Runtime</a>
    ...
    <dd>Runtime environment for the Lambda function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#signingjobarn_csharp" style="color: inherit; text-decoration: inherit;">Signing<wbr>Job<wbr>Arn</a>
    ...
    <dd>ARN of a signing job.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#signingprofileversionarn_csharp" style="color: inherit; text-decoration: inherit;">Signing<wbr>Profile<wbr>Version<wbr>Arn</a>
    ...
    <dd>The ARN for a signing profile version.</dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcecodehash_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Code<wbr>Hash</a>
    ...
    <dd>(<strong>Deprecated</strong> use <code>code_sha256</code> instead) Base64-encoded representation of raw SHA-256 sum of the zip file.<p class="property-message">Deprecated: source_code_hash is deprecated. Use code_sha256 instead.</p></dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcecodesize_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Code<wbr>Size</a>
    ...
    <dd>Size in bytes of the function .zip file.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeout_csharp" style="color: inherit; text-decoration: inherit;">Timeout</a>
    ...
    <dd>Function execution time at which Lambda should terminate the function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tracingconfig_csharp" style="color: inherit; text-decoration: inherit;">Tracing<wbr>Config</a>
    ...
    <dd>Tracing settings of the function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>The version of the Lambda function returned. If <code>qualifier</code> is not set, this will resolve to the most recent published version. If no published version of the function exists, <code>version</code> will resolve to <code>$LATEST</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcconfig_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Config</a>
    ...
    <dd>VPC configuration associated with your Lambda function.</dd><dt class="property-"
            title="">
        <span id="qualifier_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#qualifier_csharp" style="color: inherit; text-decoration: inherit;">Qualifier</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfigs_go" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionloggingconfig">[]Get<wbr>Function<wbr>Logging<wbr>Config</a></span>
    </dt>
    <dd>Advanced logging settings.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ephemeral_storages_python" style="color: inherit; text-decoration: inherit;">ephemeral_<wbr>storages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionephemeralstorage">Sequence[Get<wbr>Function<wbr>Ephemeral<wbr>Storage]</a></span>
    </dt>
    <dd>Amount of Ephemeral storage(<code>/tmp</code>) allocated for the Lambda Function.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#file_system_configs_python" style="color: inherit; text-decoration: inherit;">file_<wbr>system_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionfilesystemconfig">Sequence[Get<wbr>Function<wbr>File<wbr>System<wbr>Config]</a></span>
    </dt>
    <dd>Connection settings for an Amazon EFS file system.</dd><dt class="property-"
            title="">
        <span id="function_name_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logging_configs_python" style="color: inherit; text-decoration: inherit;">logging_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionloggingconfig">Sequence[Get<wbr>Function<wbr>Logging<wbr>Config]</a></span>
    </dt>
    <dd>Advanced logging settings.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfigs_yaml" style="color: inherit; text-decoration: inherit;">logging<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getfunctionloggingconfig">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Advanced logging settings.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Unqualified (no <code>:QUALIFIER</code> or <code>:VERSION</code> suffix) ARN identifying your Lambda Function. See also <code>qualified_arn</code>.</dd><dt class="property-required"
            title="Required">
...
<h4 id="getfunctionloggingconfig">Get<wbr>Function<wbr>Logging<wbr>Config</h4>
