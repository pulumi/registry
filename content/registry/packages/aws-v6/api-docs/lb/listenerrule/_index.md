...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:lb:ListenerRule</span><span class="p"></span>
...
```csharp
var awsListenerRuleResource = new Aws.LB.ListenerRule("awsListenerRuleResource", new()
{
    Actions = new[]
    {
        new Aws.LB.Inputs.ListenerRuleActionArgs
    ...
    Conditions = new[]
    {
        new Aws.LB.Inputs.ListenerRuleConditionArgs
        {
            ...
            HttpRequestMethod = new Aws.LB.Inputs.ListenerRuleConditionHttpRequestMethodArgs
            {
                Values = new[]
                {
                    "string",
            ...
            SourceIp = new Aws.LB.Inputs.ListenerRuleConditionSourceIpArgs
            {
                Values = new[]
                {
                    "string",
...
```go
example, err := lb.NewListenerRule(ctx, "awsListenerRuleResource", &lb.ListenerRuleArgs{
	Actions: lb.ListenerRuleActionArray{
		&lb.ListenerRuleActionArgs{
	...
	Conditions: lb.ListenerRuleConditionArray{
		&lb.ListenerRuleConditionArgs{
			...
			HttpRequestMethod: &lb.ListenerRuleConditionHttpRequestMethodArgs{
				Values: pulumi.StringArray{
					pulumi.String("string"),
				},
			},
...
```java
var awsListenerRuleResource = new com.pulumi.aws.lb.ListenerRule("awsListenerRuleResource", com.pulumi.aws.lb.ListenerRuleArgs.builder()
    .actions(ListenerRuleActionArgs.builder()
        .type("string")
        .authenticateCognito(ListenerRuleActionAuthenticateCognitoArgs.builder()
            .userPoolArn("string")
...
```python
aws_listener_rule_resource = aws.lb.ListenerRule("awsListenerRuleResource",
    actions=[{
        "type": "string",
        "authenticate_cognito": {
...
```typescript
const awsListenerRuleResource = new aws.lb.ListenerRule("awsListenerRuleResource", {
    actions: [{
        type: "string",
        authenticateCognito: {
            userPoolArn: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#actions_csharp" style="color: inherit; text-decoration: inherit;">Actions</a>
    ...
    <dd>An Action block. Action blocks are documented below.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
    ...
    <dd>A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#listenerarn_csharp" style="color: inherit; text-decoration: inherit;">Listener<wbr>Arn</a>
    ...
    <dd>The ARN of the listener to which to attach the rule.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>The priority for the rule between <code>1</code> and <code>50000</code>. Leaving it unset will automatically set the rule with next available priority after currently existing highest rule. A listener can't have multiple rules with the same priority.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the rule (matches <code>id</code>)</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:lb:ListenerRule</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_actions_csharp" style="color: inherit; text-decoration: inherit;">Actions</a>
    ...
    <dd>An Action block. Action blocks are documented below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the rule (matches <code>id</code>)</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
    ...
    <dd>A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>The type of routing action. Valid values are <code>forward</code>, <code>redirect</code>, <code>fixed-response</code>, <code>authenticate-cognito</code> and <code>authenticate-oidc</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticatecognito_csharp" style="color: inherit; text-decoration: inherit;">Authenticate<wbr>Cognito</a>
    ...
    <dd>Information for creating an authenticate action using Cognito. Required if <code>type</code> is <code>authenticate-cognito</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticateoidc_csharp" style="color: inherit; text-decoration: inherit;">Authenticate<wbr>Oidc</a>
    ...
    <dd>Information for creating an authenticate action using OIDC. Required if <code>type</code> is <code>authenticate-oidc</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#forward_csharp" style="color: inherit; text-decoration: inherit;">Forward</a>
    ...
    <dd>Configuration block for creating an action that distributes requests among one or more target groups.
Specify only if <code>type</code> is <code>forward</code>.
Cannot be specified with <code>target_group_arn</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#order_csharp" style="color: inherit; text-decoration: inherit;">Order</a>
    ...
    <dd>Order for the action.
The action with the lowest value for order is performed first.
Valid values are between <code>1</code> and <code>50000</code>.
Defaults to the position in the list of actions.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#redirect_csharp" style="color: inherit; text-decoration: inherit;">Redirect</a>
    ...
    <dd>Information for creating a redirect action. Required if <code>type</code> is <code>redirect</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetgrouparn_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Group<wbr>Arn</a>
    ...
    <dd>ARN of the Target Group to which to route traffic.
...
Cannot be specified with <code>forward</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleactionauthenticatecognito">
Listener<wbr>Rule<wbr>Action<wbr>Authenticate<wbr>Cognito<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Action<wbr>Authenticate<wbr>Cognito<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userpoolarn_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Pool<wbr>Arn</a>
    ...
    <dd>The ARN of the Cognito user pool.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userpoolclientid_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Pool<wbr>Client<wbr>Id</a>
    ...
    <dd>The ID of the Cognito user pool client.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userpooldomain_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Pool<wbr>Domain</a>
    ...
    <dd>The domain prefix or fully-qualified domain name of the Cognito user pool.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticationrequestextraparams_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Request<wbr>Extra<wbr>Params</a>
    ...
    <dd>The query parameters to include in the redirect request to the authorization endpoint. Max: 10.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#onunauthenticatedrequest_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Unauthenticated<wbr>Request</a>
    ...
    <dd>The behavior if the user is not authenticated. Valid values: <code>deny</code>, <code>allow</code> and <code>authenticate</code></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scope_csharp" style="color: inherit; text-decoration: inherit;">Scope</a>
    ...
    <dd>The set of user claims to be requested from the IdP.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sessioncookiename_csharp" style="color: inherit; text-decoration: inherit;">Session<wbr>Cookie<wbr>Name</a>
    ...
    <dd>The name of the cookie used to maintain session information.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sessiontimeout_csharp" style="color: inherit; text-decoration: inherit;">Session<wbr>Timeout</a>
    ...
    <dd>The maximum duration of the authentication session, in seconds.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleactionauthenticateoidc">
Listener<wbr>Rule<wbr>Action<wbr>Authenticate<wbr>Oidc<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Action<wbr>Authenticate<wbr>Oidc<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
    ...
    <dd>The OAuth 2.0 client identifier.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientsecret_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Secret</a>
    ...
    <dd>The OAuth 2.0 client secret.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#issuer_csharp" style="color: inherit; text-decoration: inherit;">Issuer</a>
    ...
    <dd>The OIDC issuer identifier of the IdP.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userinfoendpoint_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Info<wbr>Endpoint</a>
    ...
    <dd>The user info endpoint of the IdP.</dd><dt class="property-optional"
            title="Optional">
        <span id="authenticationrequestextraparams_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authenticationrequestextraparams_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Request<wbr>Extra<wbr>Params</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contenttype_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Type</a>
    ...
    <dd>The content type. Valid values are <code>text/plain</code>, <code>text/css</code>, <code>text/html</code>, <code>application/javascript</code> and <code>application/json</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messagebody_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Body</a>
    ...
    <dd>The message body.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statuscode_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Code</a>
    ...
    <dd>The HTTP response code. Valid values are <code>2XX</code>, <code>4XX</code>, or <code>5XX</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetgroups_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Groups</a>
    ...
    <dd>One or more target group blocks.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stickiness_csharp" style="color: inherit; text-decoration: inherit;">Stickiness</a>
    ...
    <dd>The target group stickiness for the rule.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleactionforwardstickiness">
Listener<wbr>Rule<wbr>Action<wbr>Forward<wbr>Stickiness<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Action<wbr>Forward<wbr>Stickiness<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="listenerruleactionredirect">
Listener<wbr>Rule<wbr>Action<wbr>Redirect<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Action<wbr>Redirect<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statuscode_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Code</a>
    ...
    <dd>The HTTP redirect code. The redirect is either permanent (<code>HTTP_301</code>) or temporary (<code>HTTP_302</code>).</dd><dt class="property-optional"
            title="Optional">
        <span id="host_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#host_csharp" style="color: inherit; text-decoration: inherit;">Host</a>
    ...
    <dd>The hostname. This component is not percent-encoded. The hostname can contain <code>#{host}</code>. Defaults to <code>#{host}</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="path_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd>The absolute path, starting with the leading &quot;/&quot;. This component is not percent-encoded. The path can contain #{host}, #{path}, and #{port}. Defaults to <code>/#{path}</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="port_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>The port. Specify a value from <code>1</code> to <code>65535</code> or <code>#{port}</code>. Defaults to <code>#{port}</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd>The protocol. Valid values are <code>HTTP</code>, <code>HTTPS</code>, or <code>#{protocol}</code>. Defaults to <code>#{protocol}</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#query_csharp" style="color: inherit; text-decoration: inherit;">Query</a>
    ...
    <dd>The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading &quot;?&quot;. Defaults to <code>#{query}</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerrulecondition">
Listener<wbr>Rule<wbr>Condition<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostheader_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Header</a>
    ...
    <dd>Contains a single <code>values</code> item which is a list of host header patterns to match. The maximum size of each pattern is 128 characters. Comparison is case insensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpheader_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Header</a>
    ...
    <dd>HTTP headers to match. HTTP Header block fields documented below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httprequestmethod_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Request<wbr>Method</a>
    ...
    <dd>Contains a single <code>values</code> item which is a list of HTTP request methods or verbs to match. Maximum size is 40 characters. Only allowed characters are A-Z, hyphen (-) and underscore (_). Comparison is case sensitive. Wildcards are not supported. Only one needs to match for the condition to be satisfied. AWS recommends that GET and HEAD requests are routed in the same way because the response to a HEAD request may be cached.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pathpattern_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Pattern</a>
    ...
    <dd>Contains a single <code>values</code> item which is a list of path patterns to match against the request URL. Maximum size of each pattern is 128 characters. Comparison is case sensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). Only one pattern needs to match for the condition to be satisfied. Path pattern is compared only to the path of the URL, not to its query string. To compare against the query string, use a <code>query_string</code> condition.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#querystrings_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>Strings</a>
    ...
    <dd>Query strings to match. Query String block fields documented below.</dd><dt class="property-optional"
            title="Optional">
...
<blockquote>
<p><strong>NOTE::</strong> Exactly one of <code>host_header</code>, <code>http_header</code>, <code>http_request_method</code>, <code>path_pattern</code>, <code>query_string</code> or <code>source_ip</code> must be set per condition.</p>
</blockquote>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleconditionhostheader">
Listener<wbr>Rule<wbr>Condition<wbr>Host<wbr>Header<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Host<wbr>Header<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="listenerruleconditionhttpheader">
Listener<wbr>Rule<wbr>Condition<wbr>Http<wbr>Header<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Http<wbr>Header<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#values_csharp" style="color: inherit; text-decoration: inherit;">Values</a>
    ...
    <dd>List of header value patterns to match. Maximum size of each pattern is 128 characters. Comparison is case insensitive. Wildcard characters supported: * (matches 0 or more characters) and ? (matches exactly 1 character). If the same header appears multiple times in the request they will be searched in order until a match is found. Only one pattern needs to match for the condition to be satisfied. To require that all of the strings are a match, create one condition block per string.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleconditionhttprequestmethod">
Listener<wbr>Rule<wbr>Condition<wbr>Http<wbr>Request<wbr>Method<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Http<wbr>Request<wbr>Method<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="listenerruleconditionpathpattern">
Listener<wbr>Rule<wbr>Condition<wbr>Path<wbr>Pattern<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Path<wbr>Pattern<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="listenerruleconditionquerystring">
Listener<wbr>Rule<wbr>Condition<wbr>Query<wbr>String<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Query<wbr>String<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>Query string value pattern to match.</dd><dt class="property-optional"
            title="Optional">
        <span id="key_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>Query string key pattern to match.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="listenerruleconditionsourceip">
Listener<wbr>Rule<wbr>Condition<wbr>Source<wbr>Ip<pulumi-choosable type="language" values="python,go" class="inline">, Listener<wbr>Rule<wbr>Condition<wbr>Source<wbr>Ip<wbr>Args</pulumi-choosable>
</h4>
