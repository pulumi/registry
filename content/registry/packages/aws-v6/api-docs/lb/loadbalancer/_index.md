...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:lb:LoadBalancer</span><span class="p"></span>
...
var exampleloadBalancerResourceResourceFromLbloadBalancer = new Aws.LB.LoadBalancer("exampleloadBalancerResourceResourceFromLbloadBalancer", new()
{
    ...
    IpamPools = new Aws.LB.Inputs.LoadBalancerIpamPoolsArgs
    {
        Ipv4IpamPoolId = "string",
    },
    LoadBalancerType = "string",
    MinimumLoadBalancerCapacity = new Aws.LB.Inputs.LoadBalancerMinimumLoadBalancerCapacityArgs
    {
        CapacityUnits = 0,
    },
    Name = "string",
...
example, err := lb.NewLoadBalancer(ctx, "exampleloadBalancerResourceResourceFromLbloadBalancer", &lb.LoadBalancerArgs{
	...
	IpamPools: &lb.LoadBalancerIpamPoolsArgs{
		Ipv4IpamPoolId: pulumi.String("string"),
	},
	LoadBalancerType: pulumi.String("string"),
	MinimumLoadBalancerCapacity: &lb.LoadBalancerMinimumLoadBalancerCapacityArgs{
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:lb:LoadBalancer</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
