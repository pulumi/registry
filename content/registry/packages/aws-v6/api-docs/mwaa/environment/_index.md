...
<span class="k">def </span><span class="nx">Environment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">max_webservers</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
                <span class="nx">max_workers</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
                <span class="nx">min_webservers</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:mwaa:Environment</span><span class="p"></span>
...
```java
var exampleenvironmentResourceResourceFromMwaaenvironment = new com.pulumi.aws.mwaa.Environment("exampleenvironmentResourceResourceFromMwaaenvironment", com.pulumi.aws.mwaa.EnvironmentArgs.builder()
    .executionRoleArn("string")
    .sourceBucketArn("string")
    .dagS3Path("string")
    .networkConfiguration(EnvironmentNetworkConfigurationArgs.builder()
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networkconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Configuration</a>
    ...
    <dd>Specifies the network configuration for your Apache Airflow Environment. This includes two private subnets as well as security groups for the Airflow environment. Each subnet requires internet connection, otherwise the deployment will fail. See <code>network_configuration</code> Block for details.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxwebservers_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxwebservers_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The maximum number of web servers that you want to run in your environment. Value need to be between <code>2</code> and <code>5</code> if <code>environment_class</code> is not <code>mw1.micro</code>, <code>1</code> otherwise.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxworkers_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="minwebservers_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minwebservers_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>The minimum number of web servers that you want to run in your environment. Value need to be between <code>2</code> and <code>5</code> if <code>environment_class</code> is not <code>mw1.micro</code>, <code>1</code> otherwise.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_go" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxwebservers_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxwebservers_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxworkers_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="minwebservers_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minwebservers_go" style="color: inherit; text-decoration: inherit;">Min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_java" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxwebservers_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxwebservers_java" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxworkers_java" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="minwebservers_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minwebservers_java" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxwebservers_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxwebservers_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxworkers_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="minwebservers_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minwebservers_nodejs" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logging_configuration_python" style="color: inherit; text-decoration: inherit;">logging_<wbr>configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="max_webservers_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_webservers_python" style="color: inherit; text-decoration: inherit;">max_<wbr>webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_workers_python" style="color: inherit; text-decoration: inherit;">max_<wbr>workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="min_webservers_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#min_webservers_python" style="color: inherit; text-decoration: inherit;">min_<wbr>webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="maxwebservers_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxwebservers_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxworkers_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="minwebservers_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minwebservers_yaml" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="databasevpcendpointservice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasevpcendpointservice_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The VPC endpoint for the environment's Amazon RDS database</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserverurl_csharp" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webservervpcendpointservice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webservervpcendpointservice_csharp" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The VPC endpoint for the environment's web server</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_go" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="databasevpcendpointservice_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasevpcendpointservice_go" style="color: inherit; text-decoration: inherit;">Database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserverurl_go" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webservervpcendpointservice_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webservervpcendpointservice_go" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_java" style="color: inherit; text-decoration: inherit;">created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="databasevpcendpointservice_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasevpcendpointservice_java" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserverurl_java" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webservervpcendpointservice_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webservervpcendpointservice_java" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_nodejs" style="color: inherit; text-decoration: inherit;">created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="databasevpcendpointservice_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasevpcendpointservice_nodejs" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserverurl_nodejs" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webservervpcendpointservice_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webservervpcendpointservice_nodejs" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#created_at_python" style="color: inherit; text-decoration: inherit;">created_<wbr>at</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="database_vpc_endpoint_service_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#database_vpc_endpoint_service_python" style="color: inherit; text-decoration: inherit;">database_<wbr>vpc_<wbr>endpoint_<wbr>service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserver_url_python" style="color: inherit; text-decoration: inherit;">webserver_<wbr>url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webserver_vpc_endpoint_service_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserver_vpc_endpoint_service_python" style="color: inherit; text-decoration: inherit;">webserver_<wbr>vpc_<wbr>endpoint_<wbr>service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_yaml" style="color: inherit; text-decoration: inherit;">created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="databasevpcendpointservice_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasevpcendpointservice_yaml" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webserverurl_yaml" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-"
            title="">
        <span id="webservervpcendpointservice_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webservervpcendpointservice_yaml" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">dag_s3_path</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">database_vpc_endpoint_service</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">endpoint_management</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">environment_class</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">execution_role_arn</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">kms_key</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        ...
        <span class="nx">webserver_vpc_endpoint_service</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:mwaa:Environment</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>The Created At date of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dags3path_csharp" style="color: inherit; text-decoration: inherit;">Dag<wbr>S3Path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_databasevpcendpointservice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_databasevpcendpointservice_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_loggingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_maxwebservers_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxwebservers_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxworkers_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minwebservers_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minwebservers_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserverurl_csharp" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webservervpcendpointservice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webservervpcendpointservice_csharp" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The VPC endpoint for the environment's web server</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dags3path_go" style="color: inherit; text-decoration: inherit;">Dag<wbr>S3Path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_databasevpcendpointservice_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_databasevpcendpointservice_go" style="color: inherit; text-decoration: inherit;">Database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_loggingconfiguration_go" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_maxwebservers_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxwebservers_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxworkers_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minwebservers_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minwebservers_go" style="color: inherit; text-decoration: inherit;">Min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserverurl_go" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webservervpcendpointservice_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webservervpcendpointservice_go" style="color: inherit; text-decoration: inherit;">Webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dags3path_java" style="color: inherit; text-decoration: inherit;">dag<wbr>S3Path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_databasevpcendpointservice_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_databasevpcendpointservice_java" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_loggingconfiguration_java" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_maxwebservers_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxwebservers_java" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxworkers_java" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minwebservers_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minwebservers_java" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserverurl_java" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webservervpcendpointservice_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webservervpcendpointservice_java" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dags3path_nodejs" style="color: inherit; text-decoration: inherit;">dag<wbr>S3Path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_databasevpcendpointservice_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_databasevpcendpointservice_nodejs" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_loggingconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_maxwebservers_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxwebservers_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxworkers_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minwebservers_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minwebservers_nodejs" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserverurl_nodejs" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webservervpcendpointservice_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webservervpcendpointservice_nodejs" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dag_s3_path_python" style="color: inherit; text-decoration: inherit;">dag_<wbr>s3_<wbr>path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_database_vpc_endpoint_service_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_database_vpc_endpoint_service_python" style="color: inherit; text-decoration: inherit;">database_<wbr>vpc_<wbr>endpoint_<wbr>service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_logging_configuration_python" style="color: inherit; text-decoration: inherit;">logging_<wbr>configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_max_webservers_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_max_webservers_python" style="color: inherit; text-decoration: inherit;">max_<wbr>webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_max_workers_python" style="color: inherit; text-decoration: inherit;">max_<wbr>workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_min_webservers_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_min_webservers_python" style="color: inherit; text-decoration: inherit;">min_<wbr>webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserver_url_python" style="color: inherit; text-decoration: inherit;">webserver_<wbr>url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webserver_vpc_endpoint_service_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserver_vpc_endpoint_service_python" style="color: inherit; text-decoration: inherit;">webserver_<wbr>vpc_<wbr>endpoint_<wbr>service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dags3path_yaml" style="color: inherit; text-decoration: inherit;">dag<wbr>S3Path</a>
    ...
    <dd>The relative path to the DAG folder on your Amazon S3 storage bucket. For example, dags. For more information, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import.html">Importing DAGs on Amazon MWAA</a>.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_databasevpcendpointservice_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_databasevpcendpointservice_yaml" style="color: inherit; text-decoration: inherit;">database<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_loggingconfiguration_yaml" style="color: inherit; text-decoration: inherit;">logging<wbr>Configuration</a>
    ...
    <dd>The Apache Airflow logs you want to send to Amazon CloudWatch Logs. See <code>logging_configuration</code> Block for details.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_maxwebservers_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxwebservers_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_maxworkers_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Workers</a>
    ...
    <dd>The maximum number of workers that can be automatically scaled up. Value need to be between <code>1</code> and <code>25</code>. Will be <code>10</code> by default.</dd><dt class="property-optional"
            title="Optional">
        <span id="state_minwebservers_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_minwebservers_yaml" style="color: inherit; text-decoration: inherit;">min<wbr>Webservers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webserverurl_yaml" style="color: inherit; text-decoration: inherit;">webserver<wbr>Url</a>
    ...
    <dd>The webserver URL of the MWAA Environment</dd><dt class="property-optional"
            title="Optional">
        <span id="state_webservervpcendpointservice_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_webservervpcendpointservice_yaml" style="color: inherit; text-decoration: inherit;">webserver<wbr>Vpc<wbr>Endpoint<wbr>Service</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
