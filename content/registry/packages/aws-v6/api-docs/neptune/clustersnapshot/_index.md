...
<span class="k">def </span><span class="nx">ClusterSnapshot</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">db_cluster_snapshot_identifier</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:neptune:ClusterSnapshot</span><span class="p"></span>
...
```csharp
var awsClusterSnapshotResource = new Aws.Neptune.ClusterSnapshot("awsClusterSnapshotResource", new()
{
...
```go
example, err := neptune.NewClusterSnapshot(ctx, "awsClusterSnapshotResource", &neptune.ClusterSnapshotArgs{
...
```java
var awsClusterSnapshotResource = new com.pulumi.aws.neptune.ClusterSnapshot("awsClusterSnapshotResource", com.pulumi.aws.neptune.ClusterSnapshotArgs.builder()
    .dbClusterIdentifier("string")
    .dbClusterSnapshotIdentifier("string")
    .build());
```
...
```python
aws_cluster_snapshot_resource = aws.neptune.ClusterSnapshot("awsClusterSnapshotResource",
...
```typescript
const awsClusterSnapshotResource = new aws.neptune.ClusterSnapshot("awsClusterSnapshotResource", {
    dbClusterIdentifier: "string",
    dbClusterSnapshotIdentifier: "string",
});
```
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbclustersnapshotidentifier_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Snapshot<wbr>Identifier</a>
    ...
    <dd>The Identifier for the snapshot.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:neptune:ClusterSnapshot</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
