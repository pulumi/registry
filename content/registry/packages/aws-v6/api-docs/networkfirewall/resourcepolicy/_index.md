...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:networkfirewall:ResourcePolicy</span><span class="p"></span>
...
```csharp
var exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy = new Aws.NetworkFirewall.ResourcePolicy("exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy", new()
{
    Policy = "string",
    ResourceArn = "string",
});
...
```go
example, err := networkfirewall.NewResourcePolicy(ctx, "exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy", &networkfirewall.ResourcePolicyArgs{
...
```java
var exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy = new com.pulumi.aws.networkfirewall.ResourcePolicy("exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy", com.pulumi.aws.networkfirewall.ResourcePolicyArgs.builder()
    .policy("string")
    .resourceArn("string")
    .build());
```
...
```python
exampleresource_policy_resource_resource_from_networkfirewallresource_policy = aws.networkfirewall.ResourcePolicy("exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy",
    policy="string",
    resource_arn="string")
```
...
```typescript
const exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy = new aws.networkfirewall.ResourcePolicy("exampleresourcePolicyResourceResourceFromNetworkfirewallresourcePolicy", {
    policy: "string",
    resourceArn: "string",
});
```
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
    ...
    <dd>JSON formatted policy document that controls access to the Network Firewall resource. The policy must be provided <strong>without whitespaces</strong>.  We recommend using jsonencode for formatting as seen in the examples above. For more details, including available policy statement Actions, see the <a href="https://docs.aws.amazon.com/network-firewall/latest/APIReference/API_PutResourcePolicy.html#API_PutResourcePolicy_RequestSyntax">Policy</a> parameter in the AWS API documentation.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the rule group or firewall policy.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:networkfirewall:ResourcePolicy</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
    ...
    <dd>JSON formatted policy document that controls access to the Network Firewall resource. The policy must be provided <strong>without whitespaces</strong>.  We recommend using jsonencode for formatting as seen in the examples above. For more details, including available policy statement Actions, see the <a href="https://docs.aws.amazon.com/network-firewall/latest/APIReference/API_PutResourcePolicy.html#API_PutResourcePolicy_RequestSyntax">Policy</a> parameter in the AWS API documentation.</dd><dt class="property-optional property-replacement"
            title="Optional">
