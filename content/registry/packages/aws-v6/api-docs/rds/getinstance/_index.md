...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstanceidentifier_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Identifier</a>
    ...
    <dd>Name of the RDS instance.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>Map of tags, each pair of which must exactly match a pair on the desired instance.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#address_csharp" style="color: inherit; text-decoration: inherit;">Address</a>
    ...
    <dd>Hostname of the RDS instance. See also <code>endpoint</code> and <code>port</code>.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocatedstorage_csharp" style="color: inherit; text-decoration: inherit;">Allocated<wbr>Storage</a>
    ...
    <dd>Allocated storage size specified in gigabytes.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autominorversionupgrade_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Minor<wbr>Version<wbr>Upgrade</a>
    ...
    <dd>Indicates that minor version patches are applied automatically.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzone_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone</a>
    ...
    <dd>Name of the Availability Zone the DB instance is located in.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#backupretentionperiod_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Retention<wbr>Period</a>
    ...
    <dd>Specifies the number of days for which automatic DB snapshots are retained.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cacertidentifier_csharp" style="color: inherit; text-decoration: inherit;">Ca<wbr>Cert<wbr>Identifier</a>
    ...
    <dd>Identifier of the CA certificate for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databaseinsightsmode_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Insights<wbr>Mode</a>
    ...
    <dd>The mode of Database Insights that is enabled for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbclusteridentifier_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Identifier</a>
    ...
    <dd>If the DB instance is a member of a DB cluster, contains the name of the DB cluster that the DB instance is a member of.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstancearn_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Arn</a>
    ...
    <dd>ARN for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstanceclass_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Class</a>
    ...
    <dd>Contains the name of the compute and memory capacity class of the DB instance.</dd><dt class="property-"
            title="">
        <span id="dbinstanceidentifier_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstanceidentifier_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Identifier</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstanceport_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Port</a>
    ...
    <dd>Port that the DB instance listens on.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbname_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Name</a>
    ...
    <dd>Contains the name of the initial database of this instance that was provided at create time, if one was specified when the DB instance was created. This same name is returned for the life of the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbparametergroups_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Parameter<wbr>Groups</a>
    ...
    <dd>Provides the list of DB parameter groups applied to this DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsubnetgroup_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Subnet<wbr>Group</a>
    ...
    <dd>Name of the subnet group associated with the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabledcloudwatchlogsexports_csharp" style="color: inherit; text-decoration: inherit;">Enabled<wbr>Cloudwatch<wbr>Logs<wbr>Exports</a>
    ...
    <dd>List of log types to export to cloudwatch.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#endpoint_csharp" style="color: inherit; text-decoration: inherit;">Endpoint</a>
    ...
    <dd>Connection endpoint in <code>address:port</code> format.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engine_csharp" style="color: inherit; text-decoration: inherit;">Engine</a>
    ...
    <dd>Provides the name of the database engine to be used for this DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostedzoneid_csharp" style="color: inherit; text-decoration: inherit;">Hosted<wbr>Zone<wbr>Id</a>
    ...
    <dd>Canonical hosted zone ID of the DB instance (to be used in a Route 53 Alias record).</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#iops_csharp" style="color: inherit; text-decoration: inherit;">Iops</a>
    ...
    <dd>Provisioned IOPS (I/O operations per second) value.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>The Amazon Web Services KMS key identifier that is used to encrypt the secret.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licensemodel_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Model</a>
    ...
    <dd>License model information for this DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusersecrets_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancemasterusersecret">List&lt;Get<wbr>Instance<wbr>Master<wbr>User<wbr>Secret&gt;</a></span>
    </dt>
    <dd>Provides the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusername_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Username</a>
    ...
    <dd>Contains the master username for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxallocatedstorage_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Allocated<wbr>Storage</a>
    ...
    <dd>The upper limit to which Amazon RDS can automatically scale the storage of the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#monitoringinterval_csharp" style="color: inherit; text-decoration: inherit;">Monitoring<wbr>Interval</a>
    ...
    <dd>Interval, in seconds, between points when Enhanced Monitoring metrics are collected for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#monitoringrolearn_csharp" style="color: inherit; text-decoration: inherit;">Monitoring<wbr>Role<wbr>Arn</a>
    ...
    <dd>ARN for the IAM role that permits RDS to send Enhanced Monitoring metrics to CloudWatch Logs.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#multiaz_csharp" style="color: inherit; text-decoration: inherit;">Multi<wbr>Az</a>
    ...
    <dd>If the DB instance is a Multi-AZ deployment.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#optiongroupmemberships_csharp" style="color: inherit; text-decoration: inherit;">Option<wbr>Group<wbr>Memberships</a>
    ...
    <dd>Provides the list of option group memberships for this DB instance.</dd><dt class="property-"
            title="">
        <span id="port_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>Database endpoint port, primarily used by an Aurora DB cluster. For a conventional RDS DB instance, the <code>db_instance_port</code> is typically the preferred choice.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#preferredbackupwindow_csharp" style="color: inherit; text-decoration: inherit;">Preferred<wbr>Backup<wbr>Window</a>
    ...
    <dd>Specifies the daily time range during which automated backups are created.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#preferredmaintenancewindow_csharp" style="color: inherit; text-decoration: inherit;">Preferred<wbr>Maintenance<wbr>Window</a>
    ...
    <dd>Specifies the weekly time range during which system maintenance can occur in UTC.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publiclyaccessible_csharp" style="color: inherit; text-decoration: inherit;">Publicly<wbr>Accessible</a>
    ...
    <dd>Accessibility options for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicatesourcedb_csharp" style="color: inherit; text-decoration: inherit;">Replicate<wbr>Source<wbr>Db</a>
    ...
    <dd>Identifier of the source DB that this is a replica of.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Id</a>
    ...
    <dd>RDS Resource ID of this instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storageencrypted_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Encrypted</a>
    ...
    <dd>Whether the DB instance is encrypted.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storagethroughput_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Throughput</a>
    ...
    <dd>Storage throughput value for the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storagetype_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Type</a>
    ...
    <dd>Storage type associated with DB instance.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timezone_csharp" style="color: inherit; text-decoration: inherit;">Timezone</a>
    ...
    <dd>Time zone of the DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcsecuritygroups_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Security<wbr>Groups</a>
    ...
    <dd>Provides a list of VPC security group elements that the DB instance belongs to.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusersecrets_go" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancemasterusersecret">[]Get<wbr>Instance<wbr>Master<wbr>User<wbr>Secret</a></span>
    </dt>
    <dd>Provides the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#master_user_secrets_python" style="color: inherit; text-decoration: inherit;">master_<wbr>user_<wbr>secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancemasterusersecret">Sequence[Get<wbr>Instance<wbr>Master<wbr>User<wbr>Secret]</a></span>
    </dt>
    <dd>Provides the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusersecrets_yaml" style="color: inherit; text-decoration: inherit;">master<wbr>User<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancemasterusersecret">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Provides the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</dd><dt class="property-"
            title="">
...
<h4 id="getinstancemasterusersecret">Get<wbr>Instance<wbr>Master<wbr>User<wbr>Secret</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>The Amazon Web Services KMS key identifier that is used to encrypt the secret.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretarn_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the secret.</dd><dt class="property-required"
            title="Required">
