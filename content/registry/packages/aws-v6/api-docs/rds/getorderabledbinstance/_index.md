...
><span class="k">def </span>get_orderable_db_instance<span class="p">(</span><span class="nx">availability_zone_group</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">engine_latest_version</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">read_replica_capable</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                              <span class="nx">storage_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                              <span class="nx">supported_engine_modes</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">supports_clusters</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">supports_multi_az</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
def </span>get_orderable_db_instance_output<span class="p">(</span><span class="nx">availability_zone_group</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">engine_latest_version</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">read_replica_capable</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                              <span class="nx">storage_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                              <span class="nx">supported_engine_modes</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                              <span class="nx">supported_network_types</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                              <span class="nx">supports_clusters</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                              ...
                              <span class="nx">supports_multi_az</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetOrderableDbInstanceResult</a></span>> </span>getOrderableDbInstance<span class="p">(</span><span class="nx">GetOrderableDbInstanceArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzonegroup_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone<wbr>Group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="enginelatestversion_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginelatestversion_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Latest<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>When set to <code>true</code>, the data source attempts to return the most recent version matching the other criteria you provide. You must use <code>engine_latest_version</code> with <code>preferred_instance_classes</code> and/or <code>preferred_engine_versions</code>. Using <code>engine_latest_version</code> will avoid <code>multiple RDS DB Instance Classes</code> errors. If you use <code>engine_latest_version</code> with <code>preferred_instance_classes</code>, the data source returns the latest version for the <em>first</em> matching instance class (instance class priority). <strong>Note:</strong> The data source uses a best-effort approach at selecting the latest version but due to the complexity of version identifiers across engines, using <code>engine_latest_version</code> may <em>not</em> return the latest version in every situation.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engineversion_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Version</a>
    ...
    <dd>Version of the DB engine. If none is provided, the data source tries to use the AWS-defined default version that matches any other criteria.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceclass_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Class</a>
    ...
    <dd>DB instance class. Examples of classes are <code>db.m3.2xlarge</code>, <code>db.t2.small</code>, and <code>db.m3.medium</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#licensemodel_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Model</a>
    ...
    <dd>License model. Examples of license models are <code>general-public-license</code>, <code>bring-your-own-license</code>, and <code>amazon-license</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readreplicacapable_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Replica<wbr>Capable</a>
    ...
    <dd>Whether a DB instance can have a read replica.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storagetype_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Type</a>
    ...
    <dd>Storage types. Examples of storage types are <code>standard</code>, <code>io1</code>, <code>gp2</code>, and <code>aurora</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportedenginemodes_csharp" style="color: inherit; text-decoration: inherit;">Supported<wbr>Engine<wbr>Modes</a>
    ...
    <dd>Use to limit results to engine modes such as <code>provisioned</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportednetworktypes_csharp" style="color: inherit; text-decoration: inherit;">Supported<wbr>Network<wbr>Types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsclusters_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsclusters_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>Whether to limit results to instances that support clusters.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsenhancedmonitoring_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Enhanced<wbr>Monitoring</a>
    ...
    <dd>Enable this to ensure a DB instance supports Enhanced Monitoring at intervals from 1 to 60 seconds.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsglobaldatabases_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Global<wbr>Databases</a>
    ...
    <dd>Enable this to ensure a DB instance supports Aurora global databases with a specific combination of other DB engine attributes.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsiamdatabaseauthentication_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Iam<wbr>Database<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports IAM database authentication.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsiops_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Iops</a>
    ...
    <dd>Enable this to ensure a DB instance supports provisioned IOPS.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportskerberosauthentication_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Kerberos<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsmultiaz_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsmultiaz_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Multi<wbr>Az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>Whether to limit results to instances that are multi-AZ capable.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsperformanceinsights_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Performance<wbr>Insights</a>
    ...
    <dd>Enable this to ensure a DB instance supports Performance Insights.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsstorageautoscaling_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Storage<wbr>Autoscaling</a>
    ...
    <dd>Enable this to ensure Amazon RDS can automatically scale storage for DB instances that use the specified DB instance class.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsstorageencryption_csharp" style="color: inherit; text-decoration: inherit;">Supports<wbr>Storage<wbr>Encryption</a>
    ...
    <dd>Enable this to ensure a DB instance supports encrypted storage.</dd><dt class="property-optional"
            title="Optional">
        <span id="vpc_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpc_csharp" style="color: inherit; text-decoration: inherit;">Vpc</a>
    ...
    <dd>Boolean that indicates whether to show only VPC or non-VPC offerings.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzonegroup_go" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone<wbr>Group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="enginelatestversion_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginelatestversion_go" style="color: inherit; text-decoration: inherit;">Engine<wbr>Latest<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportednetworktypes_go" style="color: inherit; text-decoration: inherit;">Supported<wbr>Network<wbr>Types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsclusters_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsclusters_go" style="color: inherit; text-decoration: inherit;">Supports<wbr>Clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportskerberosauthentication_go" style="color: inherit; text-decoration: inherit;">Supports<wbr>Kerberos<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsmultiaz_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsmultiaz_go" style="color: inherit; text-decoration: inherit;">Supports<wbr>Multi<wbr>Az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzonegroup_java" style="color: inherit; text-decoration: inherit;">availability<wbr>Zone<wbr>Group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="enginelatestversion_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginelatestversion_java" style="color: inherit; text-decoration: inherit;">engine<wbr>Latest<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportednetworktypes_java" style="color: inherit; text-decoration: inherit;">supported<wbr>Network<wbr>Types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsclusters_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsclusters_java" style="color: inherit; text-decoration: inherit;">supports<wbr>Clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportskerberosauthentication_java" style="color: inherit; text-decoration: inherit;">supports<wbr>Kerberos<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsmultiaz_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsmultiaz_java" style="color: inherit; text-decoration: inherit;">supports<wbr>Multi<wbr>Az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzonegroup_nodejs" style="color: inherit; text-decoration: inherit;">availability<wbr>Zone<wbr>Group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="enginelatestversion_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginelatestversion_nodejs" style="color: inherit; text-decoration: inherit;">engine<wbr>Latest<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportednetworktypes_nodejs" style="color: inherit; text-decoration: inherit;">supported<wbr>Network<wbr>Types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsclusters_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsclusters_nodejs" style="color: inherit; text-decoration: inherit;">supports<wbr>Clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportskerberosauthentication_nodejs" style="color: inherit; text-decoration: inherit;">supports<wbr>Kerberos<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsmultiaz_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsmultiaz_nodejs" style="color: inherit; text-decoration: inherit;">supports<wbr>Multi<wbr>Az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availability_zone_group_python" style="color: inherit; text-decoration: inherit;">availability_<wbr>zone_<wbr>group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="engine_latest_version_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engine_latest_version_python" style="color: inherit; text-decoration: inherit;">engine_<wbr>latest_<wbr>version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supported_network_types_python" style="color: inherit; text-decoration: inherit;">supported_<wbr>network_<wbr>types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supports_clusters_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supports_clusters_python" style="color: inherit; text-decoration: inherit;">supports_<wbr>clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supports_kerberos_authentication_python" style="color: inherit; text-decoration: inherit;">supports_<wbr>kerberos_<wbr>authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supports_multi_az_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supports_multi_az_python" style="color: inherit; text-decoration: inherit;">supports_<wbr>multi_<wbr>az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzonegroup_yaml" style="color: inherit; text-decoration: inherit;">availability<wbr>Zone<wbr>Group</a>
    ...
    <dd>Availability zone group.</dd><dt class="property-optional"
            title="Optional">
        <span id="enginelatestversion_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginelatestversion_yaml" style="color: inherit; text-decoration: inherit;">engine<wbr>Latest<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportednetworktypes_yaml" style="color: inherit; text-decoration: inherit;">supported<wbr>Network<wbr>Types</a>
    ...
    <dd>Use to limit results to network types <code>IPV4</code> or <code>DUAL</code>.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsclusters_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsclusters_yaml" style="color: inherit; text-decoration: inherit;">supports<wbr>Clusters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportskerberosauthentication_yaml" style="color: inherit; text-decoration: inherit;">supports<wbr>Kerberos<wbr>Authentication</a>
    ...
    <dd>Enable this to ensure a DB instance supports Kerberos Authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="supportsmultiaz_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supportsmultiaz_yaml" style="color: inherit; text-decoration: inherit;">supports<wbr>Multi<wbr>Az</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzones_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zones</a>
    ...
    <dd>Availability zones where the instance is available.</dd><dt class="property-"
            title="">
        <span id="engine_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engine_csharp" style="color: inherit; text-decoration: inherit;">Engine</a>
</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxiopsperdbinstance_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Iops<wbr>Per<wbr>Db<wbr>Instance</a>
    ...
    <dd>Maximum total provisioned IOPS for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxiopspergib_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Iops<wbr>Per<wbr>Gib</a>
    ...
    <dd>Maximum provisioned IOPS per GiB for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxstoragesize_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Storage<wbr>Size</a>
    ...
    <dd>Maximum storage size for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#miniopsperdbinstance_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Iops<wbr>Per<wbr>Db<wbr>Instance</a>
    ...
    <dd>Minimum total provisioned IOPS for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#miniopspergib_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Iops<wbr>Per<wbr>Gib</a>
    ...
    <dd>Minimum provisioned IOPS per GiB for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minstoragesize_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Storage<wbr>Size</a>
    ...
    <dd>Minimum storage size for a DB instance.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#multiazcapable_csharp" style="color: inherit; text-decoration: inherit;">Multi<wbr>Az<wbr>Capable</a>
    ...
    <dd>Whether a DB instance is Multi-AZ capable.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outpostcapable_csharp" style="color: inherit; text-decoration: inherit;">Outpost<wbr>Capable</a>
    ...
    <dd>Whether a DB instance supports RDS on Outposts.</dd><dt class="property-"
            title="">
        <span id="readreplicacapable_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#readreplicacapable_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Replica<wbr>Capable</a>
</span>
