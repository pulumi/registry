...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:scheduler:Schedule</span><span class="p"></span>
...
```java
var awsScheduleResource = new com.pulumi.aws.scheduler.Schedule("awsScheduleResource", com.pulumi.aws.scheduler.ScheduleArgs.builder()
    .flexibleTimeWindow(ScheduleFlexibleTimeWindowArgs.builder()
        .mode("string")
        .maximumWindowInMinutes(0)
        .build())
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#flexibletimewindow_csharp" style="color: inherit; text-decoration: inherit;">Flexible<wbr>Time<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduleflexibletimewindow">Schedule<wbr>Flexible<wbr>Time<wbr>Window</a></span>
    </dt>
    <dd>Configures a time window during which EventBridge Scheduler invokes the schedule. Detailed below.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scheduleexpression_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Expression</a>
    ...
    <dd>Defines when the schedule runs. Read more in <a href="https://docs.aws.amazon.com/scheduler/latest/UserGuide/schedule-types.html">Schedule types on EventBridge Scheduler</a>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduletarget">Schedule<wbr>Target</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Brief description of the schedule.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enddate_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Date</a>
    ...
    <dd>The date, in UTC, before which the schedule can invoke its target. Depending on the schedule's recurrence expression, invocations might stop on, or before, the end date you specify. EventBridge Scheduler ignores the end date for one-time schedules. Example: <code>2030-01-01T01:00:00Z</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupname_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Name</a>
    ...
    <dd>Name of the schedule group to associate with this schedule. When omitted, the <code>default</code> schedule group is used.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyarn_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Arn</a>
    ...
    <dd>ARN for the customer managed KMS key that EventBridge Scheduler will use to encrypt and decrypt your data.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the schedule. If omitted, the provider will assign a random, unique name. Conflicts with <code>name_prefix</code>.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scheduleexpressiontimezone_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Expression<wbr>Timezone</a>
    ...
    <dd>Timezone in which the scheduling expression is evaluated. Defaults to <code>UTC</code>. Example: <code>Australia/Sydney</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#startdate_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Date</a>
    ...
    <dd>The date, in UTC, after which the schedule can begin invoking its target. Depending on the schedule's recurrence expression, invocations might occur on, or after, the start date you specify. EventBridge Scheduler ignores the start date for one-time schedules. Example: <code>2030-01-01T01:00:00Z</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Specifies whether the schedule is enabled or disabled. One of: <code>ENABLED</code> (default), <code>DISABLED</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the schedule.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetSchedule<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">ScheduleState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Schedule</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">Schedule</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">ScheduleState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:scheduler:Schedule</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the schedule.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_enddate_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Date</a>
    ...
    <dd>The date, in UTC, before which the schedule can invoke its target. Depending on the schedule's recurrence expression, invocations might stop on, or before, the end date you specify. EventBridge Scheduler ignores the end date for one-time schedules. Example: <code>2030-01-01T01:00:00Z</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_flexibletimewindow_csharp" style="color: inherit; text-decoration: inherit;">Flexible<wbr>Time<wbr>Window</a>
    ...
    <dd>Configures a time window during which EventBridge Scheduler invokes the schedule. Detailed below.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scheduleexpression_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Expression</a>
    ...
    <dd>Defines when the schedule runs. Read more in <a href="https://docs.aws.amazon.com/scheduler/latest/UserGuide/schedule-types.html">Schedule types on EventBridge Scheduler</a>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Specifies whether the schedule is enabled or disabled. One of: <code>ENABLED</code> (default), <code>DISABLED</code>.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="scheduleflexibletimewindow">
Schedule<wbr>Flexible<wbr>Time<wbr>Window<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Flexible<wbr>Time<wbr>Window<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>Determines whether the schedule is invoked within a flexible time window. One of: <code>OFF</code>, <code>FLEXIBLE</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maximumwindowinminutes_csharp" style="color: inherit; text-decoration: inherit;">Maximum<wbr>Window<wbr>In<wbr>Minutes</a>
    ...
    <dd>Maximum time window during which a schedule can be invoked. Ranges from <code>1</code> to <code>1440</code> minutes.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletarget">
Schedule<wbr>Target<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the target of this schedule, such as a SQS queue or ECS cluster. For universal targets, this is a <a href="https://docs.aws.amazon.com/scheduler/latest/UserGuide/managing-targets-universal.html#supported-universal-targets">Service ARN specific to the target service</a>.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deadletterconfig_csharp" style="color: inherit; text-decoration: inherit;">Dead<wbr>Letter<wbr>Config</a>
    ...
    <dd>Information about an Amazon SQS queue that EventBridge Scheduler uses as a dead-letter queue for your schedule. If specified, EventBridge Scheduler delivers failed events that could not be successfully delivered to a target to the queue. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecsparameters_csharp" style="color: inherit; text-decoration: inherit;">Ecs<wbr>Parameters</a>
    ...
    <dd>Templated target type for the Amazon ECS <a href="https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_RunTask.html"><code>RunTask</code></a> API operation. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#eventbridgeparameters_csharp" style="color: inherit; text-decoration: inherit;">Eventbridge<wbr>Parameters</a>
    ...
    <dd>Templated target type for the EventBridge <a href="https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_PutEvents.html"><code>PutEvents</code></a> API operation. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_csharp" style="color: inherit; text-decoration: inherit;">Input</a>
    ...
    <dd>Text, or well-formed JSON, passed to the target. Read more in <a href="https://docs.aws.amazon.com/scheduler/latest/UserGuide/managing-targets-universal.html">Universal target</a>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kinesisparameters_csharp" style="color: inherit; text-decoration: inherit;">Kinesis<wbr>Parameters</a>
    ...
    <dd>Templated target type for the Amazon Kinesis <a href="https://docs.aws.amazon.com/kinesis/latest/APIReference/API_PutRecord.html"><code>PutRecord</code></a> API operation. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retrypolicy_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Policy</a>
    ...
    <dd>Information about the retry policy settings. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sagemakerpipelineparameters_csharp" style="color: inherit; text-decoration: inherit;">Sagemaker<wbr>Pipeline<wbr>Parameters</a>
    ...
    <dd>Templated target type for the Amazon SageMaker AI <a href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_StartPipelineExecution.html"><code>StartPipelineExecution</code></a> API operation. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sqsparameters_csharp" style="color: inherit; text-decoration: inherit;">Sqs<wbr>Parameters</a>
    ...
    <dd>The templated target type for the Amazon SQS <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_SendMessage.html"><code>SendMessage</code></a> API operation. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetdeadletterconfig">
Schedule<wbr>Target<wbr>Dead<wbr>Letter<wbr>Config<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Dead<wbr>Letter<wbr>Config<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>ARN of the SQS queue specified as the destination for the dead-letter queue.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetecsparameters">
Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#capacityproviderstrategies_csharp" style="color: inherit; text-decoration: inherit;">Capacity<wbr>Provider<wbr>Strategies</a>
    ...
    <dd>Up to <code>6</code> capacity provider strategies to use for the task. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enableecsmanagedtags_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Ecs<wbr>Managed<wbr>Tags</a>
    ...
    <dd>Specifies whether to enable Amazon ECS managed tags for the task. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html">Tagging Your Amazon ECS Resources</a> in the Amazon ECS Developer Guide.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enableexecutecommand_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Execute<wbr>Command</a>
    ...
    <dd>Specifies whether to enable the execute command functionality for the containers in this task.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#group_csharp" style="color: inherit; text-decoration: inherit;">Group</a>
    ...
    <dd>Specifies an ECS task group for the task. At most 255 characters.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#launchtype_csharp" style="color: inherit; text-decoration: inherit;">Launch<wbr>Type</a>
    ...
    <dd>Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. One of: <code>EC2</code>, <code>FARGATE</code>, <code>EXTERNAL</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networkconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Configuration</a>
    ...
    <dd>Configures the networking associated with the task. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#placementconstraints_csharp" style="color: inherit; text-decoration: inherit;">Placement<wbr>Constraints</a>
    ...
    <dd>A set of up to 10 placement constraints to use for the task. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#placementstrategies_csharp" style="color: inherit; text-decoration: inherit;">Placement<wbr>Strategies</a>
    ...
    <dd>A set of up to 5 placement strategies. Detailed below.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#platformversion_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Version</a>
    ...
    <dd>Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as <code>1.1.0</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#propagatetags_csharp" style="color: inherit; text-decoration: inherit;">Propagate<wbr>Tags</a>
    ...
    <dd>Specifies whether to propagate the tags from the task definition to the task. One of: <code>TASK_DEFINITION</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#referenceid_csharp" style="color: inherit; text-decoration: inherit;">Reference<wbr>Id</a>
    ...
    <dd>Reference ID to use for the task.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>The metadata that you apply to the task. Each tag consists of a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_RunTask.html"><code>RunTask</code></a> in the Amazon ECS API Reference.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#taskcount_csharp" style="color: inherit; text-decoration: inherit;">Task<wbr>Count</a>
    ...
    <dd>The number of tasks to create. Ranges from <code>1</code> (default) to <code>10</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetecsparameterscapacityproviderstrategy">
Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Capacity<wbr>Provider<wbr>Strategy<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Capacity<wbr>Provider<wbr>Strategy<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#base_csharp" style="color: inherit; text-decoration: inherit;">Base</a>
    ...
    <dd>How many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. Ranges from <code>0</code> (default) to <code>100000</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#weight_csharp" style="color: inherit; text-decoration: inherit;">Weight</a>
    ...
    <dd>Designates the relative percentage of the total number of tasks launched that should use the specified capacity provider. The weight value is taken into consideration after the base value, if defined, is satisfied. Ranges from from <code>0</code> to <code>1000</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetecsparametersnetworkconfiguration">
Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Network<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Network<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnets_csharp" style="color: inherit; text-decoration: inherit;">Subnets</a>
    ...
    <dd>Set of 1 to 16 subnets to be associated with the task. These subnets must all be in the same VPC.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignpublicip_csharp" style="color: inherit; text-decoration: inherit;">Assign<wbr>Public<wbr>Ip</a>
    ...
    <dd>Specifies whether the task's elastic network interface receives a public IP address. This attribute is a boolean type, where <code>true</code> maps to <code>ENABLED</code> and <code>false</code> to <code>DISABLED</code>. You can specify <code>true</code> only when the <code>launch_type</code> is set to <code>FARGATE</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroups_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Groups</a>
    ...
    <dd>Set of 1 to 5 Security Group ID-s to be associated with the task. These security groups must all be in the same VPC.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetecsparametersplacementconstraint">
Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Placement<wbr>Constraint<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Placement<wbr>Constraint<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>The type of constraint. One of: <code>distinctInstance</code>, <code>memberOf</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expression_csharp" style="color: inherit; text-decoration: inherit;">Expression</a>
    ...
    <dd>A cluster query language expression to apply to the constraint. You cannot specify an expression if the constraint type is <code>distinctInstance</code>. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/cluster-query-language.html">Cluster query language</a> in the Amazon ECS Developer Guide.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetecsparametersplacementstrategy">
Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Placement<wbr>Strategy<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Ecs<wbr>Parameters<wbr>Placement<wbr>Strategy<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>The type of placement strategy. One of: <code>random</code>, <code>spread</code>, <code>binpack</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#field_csharp" style="color: inherit; text-decoration: inherit;">Field</a>
    ...
    <dd>The field to apply the placement strategy against.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargeteventbridgeparameters">
Schedule<wbr>Target<wbr>Eventbridge<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Eventbridge<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#detailtype_csharp" style="color: inherit; text-decoration: inherit;">Detail<wbr>Type</a>
    ...
    <dd>Free-form string used to decide what fields to expect in the event detail. Up to 128 characters.</dd><dt class="property-required"
            title="Required">
...
<h4 id="scheduletargetkinesisparameters">
Schedule<wbr>Target<wbr>Kinesis<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Kinesis<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#partitionkey_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Key</a>
    ...
    <dd>Specifies the shard to which EventBridge Scheduler sends the event. Up to 256 characters.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetretrypolicy">
Schedule<wbr>Target<wbr>Retry<wbr>Policy<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Retry<wbr>Policy<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maximumeventageinseconds_csharp" style="color: inherit; text-decoration: inherit;">Maximum<wbr>Event<wbr>Age<wbr>In<wbr>Seconds</a>
    ...
    <dd>Maximum amount of time, in seconds, to continue to make retry attempts. Ranges from <code>60</code> to <code>86400</code> (default).</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maximumretryattempts_csharp" style="color: inherit; text-decoration: inherit;">Maximum<wbr>Retry<wbr>Attempts</a>
    ...
    <dd>Maximum number of retry attempts to make before the request fails. Ranges from <code>0</code> to <code>185</code> (default).</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetsagemakerpipelineparameters">
Schedule<wbr>Target<wbr>Sagemaker<wbr>Pipeline<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Sagemaker<wbr>Pipeline<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pipelineparameters_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Parameters</a>
    ...
    <dd>Set of up to 200 parameter names and values to use when executing the SageMaker AI Model Building Pipeline. Detailed below.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="scheduletargetsagemakerpipelineparameterspipelineparameter">
Schedule<wbr>Target<wbr>Sagemaker<wbr>Pipeline<wbr>Parameters<wbr>Pipeline<wbr>Parameter<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Sagemaker<wbr>Pipeline<wbr>Parameters<wbr>Pipeline<wbr>Parameter<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="scheduletargetsqsparameters">
Schedule<wbr>Target<wbr>Sqs<wbr>Parameters<pulumi-choosable type="language" values="python,go" class="inline">, Schedule<wbr>Target<wbr>Sqs<wbr>Parameters<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messagegroupid_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Group<wbr>Id</a>
    ...
    <dd>FIFO message group ID to use as the target.</dd></dl>
</pulumi-choosable>
</div>
