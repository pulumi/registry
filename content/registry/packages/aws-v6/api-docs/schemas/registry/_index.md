...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:schemas:Registry</span><span class="p"></span>
...
```csharp
var awsRegistryResource = new Aws.Schemas.Registry("awsRegistryResource", new()
{
    Description = "string",
    Name = "string",
    Tags = 
...
```go
example, err := schemas.NewRegistry(ctx, "awsRegistryResource", &schemas.RegistryArgs{
...
```java
var awsRegistryResource = new com.pulumi.aws.schemas.Registry("awsRegistryResource", com.pulumi.aws.schemas.RegistryArgs.builder()
    .description("string")
    .name("string")
...
```python
aws_registry_resource = aws.schemas.Registry("awsRegistryResource",
    description="string",
    name="string",
    tags={
        "string": "string",
...
```typescript
const awsRegistryResource = new aws.schemas.Registry("awsRegistryResource", {
    description: "string",
    name: "string",
    tags: {
        string: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The name of the custom event schema registry. Maximum of 64 characters consisting of lower case letters, upper case letters, 0-9, ., -, _.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:schemas:Registry</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
