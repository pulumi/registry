...
<span class="k">def </span><span class="nx">Member</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">invite</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:securityhub:Member</span><span class="p"></span>
...
```java
var examplememberResourceResourceFromSecurityhubmember = new com.pulumi.aws.securityhub.Member("examplememberResourceResourceFromSecurityhubmember", com.pulumi.aws.securityhub.MemberArgs.builder()
    .accountId("string")
    .email("string")
    .invite(false)
    .build());
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>The ID of the member AWS account.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#email_csharp" style="color: inherit; text-decoration: inherit;">Email</a>
    ...
    <dd>The email of the member AWS account.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#invite_csharp" style="color: inherit; text-decoration: inherit;">Invite</a>
    ...
    <dd>Boolean whether to invite the account to Security Hub as a member. Defaults to <code>false</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterid_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Id</a>
    ...
    <dd>The ID of the master Security Hub AWS account.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#memberstatus_csharp" style="color: inherit; text-decoration: inherit;">Member<wbr>Status</a>
    ...
    <dd>The status of the member account relationship.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:securityhub:Member</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_invite_csharp" style="color: inherit; text-decoration: inherit;">Invite</a>
    ...
    <dd>Boolean whether to invite the account to Security Hub as a member. Defaults to <code>false</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_masterid_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Id</a>
    ...
    <dd>The ID of the master Security Hub AWS account.</dd><dt class="property-optional"
            title="Optional">
