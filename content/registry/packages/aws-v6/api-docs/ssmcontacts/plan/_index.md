...
<span class="k">def </span><span class="nx">Plan</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">stages</span><span class="p">:</span> <span class="nx">Optional[Sequence[PlanStageArgs]]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ssmcontacts:Plan</span><span class="p"></span>
...
```java
var awsPlanResource = new com.pulumi.aws.ssmcontacts.Plan("awsPlanResource", com.pulumi.aws.ssmcontacts.PlanArgs.builder()
    .contactId("string")
    .stages(PlanStageArgs.builder()
        .durationInMinutes(0)
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contactid_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Id</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the contact or escalation plan.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_csharp" style="color: inherit; text-decoration: inherit;">Stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#planstage">List&lt;Plan<wbr>Stage&gt;</a></span>
    </dt>
    <dd>One or more configuration blocks for specifying a list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods. See Stage below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_nodejs" style="color: inherit; text-decoration: inherit;">stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#planstage">Plan<wbr>Stage[]</a></span>
    </dt>
    <dd>One or more configuration blocks for specifying a list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods. See Stage below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:ssmcontacts:Plan</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_contactid_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Id</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the contact or escalation plan.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="planstage">
Plan<wbr>Stage<pulumi-choosable type="language" values="python,go" class="inline">, Plan<wbr>Stage<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#durationinminutes_csharp" style="color: inherit; text-decoration: inherit;">Duration<wbr>In<wbr>Minutes</a>
    ...
    <dd>The time to wait until beginning the next stage. The duration can only be set to 0 if a target is specified.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targets_csharp" style="color: inherit; text-decoration: inherit;">Targets</a>
    ...
    <dd>One or more configuration blocks for specifying the contacts or contact methods that the escalation plan or engagement plan is engaging. See Target below for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="planstagetarget">
Plan<wbr>Stage<wbr>Target<pulumi-choosable type="language" values="python,go" class="inline">, Plan<wbr>Stage<wbr>Target<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#channeltargetinfo_csharp" style="color: inherit; text-decoration: inherit;">Channel<wbr>Target<wbr>Info</a>
    ...
    <dd>A configuration block for specifying information about the contact channel that Incident Manager engages. See Channel Target Info for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contacttargetinfo_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Target<wbr>Info</a>
    ...
    <dd>A configuration block for specifying information about the contact that Incident Manager engages. See Contact Target Info for more details.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="planstagetargetchanneltargetinfo">
Plan<wbr>Stage<wbr>Target<wbr>Channel<wbr>Target<wbr>Info<pulumi-choosable type="language" values="python,go" class="inline">, Plan<wbr>Stage<wbr>Target<wbr>Channel<wbr>Target<wbr>Info<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contactchannelid_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Channel<wbr>Id</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the contact channel.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retryintervalinminutes_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Interval<wbr>In<wbr>Minutes</a>
    ...
    <dd>The number of minutes to wait before retrying to send engagement if the engagement initially failed.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="planstagetargetcontacttargetinfo">
Plan<wbr>Stage<wbr>Target<wbr>Contact<wbr>Target<wbr>Info<pulumi-choosable type="language" values="python,go" class="inline">, Plan<wbr>Stage<wbr>Target<wbr>Contact<wbr>Target<wbr>Info<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#isessential_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Essential</a>
    ...
    <dd>A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.</dd><dt class="property-optional"
            title="Optional">
        <span id="contactid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contactid_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Id</a>
</span>
    ...
    <dd>The Amazon Resource Name (ARN) of the contact.</dd></dl>
</pulumi-choosable>
</div>
