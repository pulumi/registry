...
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetLocalDiskResult</a></span>> </span>getLocalDisk<span class="p">(</span><span class="nx">GetLocalDiskArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewayarn_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Arn</a>
    ...
    <dd>ARN of the gateway.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disknode_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Node</a>
    ...
    <dd>Device node of the local disk to retrieve. For example, <code>/dev/sdb</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskpath_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Path</a>
    ...
    <dd>Device path of the local disk to retrieve. For example, <code>/dev/xvdb</code> or <code>/dev/nvme1n1</code>.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#diskid_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Id</a>
    ...
    <dd>Disk identifierE.g., <code>pci-0000:03:00.0-scsi-0:0:0:0</code></dd><dt class="property-"
            title="">
        <span id="disknode_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disknode_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Node</a>
</span>
