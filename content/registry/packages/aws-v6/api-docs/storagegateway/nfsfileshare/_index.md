...
## Create NfsFileShare Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewNfsFileShare</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">NfsFileShareArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">NfsFileShare</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:storagegateway:NfsFileShare</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientlists_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Lists</a>
    ...
    <dd>The list of clients that are allowed to access the file gateway. The list must contain either valid IP addresses or valid CIDR blocks. Set to <code>[&quot;0.0.0.0/0&quot;]</code> to not limit access. Minimum 1 item. Maximum 100 items.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#auditdestinationarn_csharp" style="color: inherit; text-decoration: inherit;">Audit<wbr>Destination<wbr>Arn</a>
    ...
    <dd>The Amazon Resource Name (ARN) of the storage used for audit logs.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucketregion_csharp" style="color: inherit; text-decoration: inherit;">Bucket<wbr>Region</a>
    ...
    <dd>The region of the S3 bucket used by the file share. Required when specifying <code>vpc_endpoint_dns_name</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nfsfilesharedefaults_csharp" style="color: inherit; text-decoration: inherit;">Nfs<wbr>File<wbr>Share<wbr>Defaults</a>
    ...
    <dd>Nested argument with file share default values. More information below. see NFS File Share Defaults for more details.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#squash_csharp" style="color: inherit; text-decoration: inherit;">Squash</a>
    ...
    <dd>Maps a user to anonymous user. Defaults to <code>RootSquash</code>. Valid values: <code>RootSquash</code> (only root is mapped to anonymous user), <code>NoSquash</code> (no one is mapped to anonymous user), <code>AllSquash</code> (everyone is mapped to anonymous user)</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcendpointdnsname_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Endpoint<wbr>Dns<wbr>Name</a>
    ...
    <dd>The DNS name of the VPC endpoint for S3 PrivateLink.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the NFS File Share.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fileshareid_csharp" style="color: inherit; text-decoration: inherit;">Fileshare<wbr>Id</a>
    ...
    <dd>ID of the NFS File Share.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
## Look up Existing NfsFileShare Resource {#look-up}
...
<div>
<pulumi-choosable type="language" values="java">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">NfsFileShare</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">NfsFileShareState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:storagegateway:NfsFileShare</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>Amazon Resource Name (ARN) of the NFS File Share.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clientlists_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Lists</a>
    ...
    <dd>The list of clients that are allowed to access the file gateway. The list must contain either valid IP addresses or valid CIDR blocks. Set to <code>[&quot;0.0.0.0/0&quot;]</code> to not limit access. Minimum 1 item. Maximum 100 items.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_fileshareid_csharp" style="color: inherit; text-decoration: inherit;">Fileshare<wbr>Id</a>
    ...
    <dd>ID of the NFS File Share.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="nfsfilesharecacheattributes">
Nfs<wbr>File<wbr>Share<wbr>Cache<wbr>Attributes<pulumi-choosable type="language" values="python,go" class="inline">, Nfs<wbr>File<wbr>Share<wbr>Cache<wbr>Attributes<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="nfsfilesharenfsfilesharedefaults">
Nfs<wbr>File<wbr>Share<wbr>Nfs<wbr>File<wbr>Share<wbr>Defaults<pulumi-choosable type="language" values="python,go" class="inline">, Nfs<wbr>File<wbr>Share<wbr>Nfs<wbr>File<wbr>Share<wbr>Defaults<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#directorymode_csharp" style="color: inherit; text-decoration: inherit;">Directory<wbr>Mode</a>
    ...
    <dd>The Unix directory mode in the string form &quot;nnnn&quot;. Defaults to <code>&quot;0777&quot;</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filemode_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Mode</a>
    ...
    <dd>The Unix file mode in the string form &quot;nnnn&quot;. Defaults to <code>&quot;0666&quot;</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupid_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Id</a>
    ...
    <dd>The default group ID for the file share (unless the files have another group ID specified). Defaults to <code>65534</code> (<code>nfsnobody</code>). Valid values: <code>0</code> through <code>4294967294</code>.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ownerid_csharp" style="color: inherit; text-decoration: inherit;">Owner<wbr>Id</a>
    ...
    <dd>The default owner ID for the file share (unless the files have another owner ID specified). Defaults to <code>65534</code> (<code>nfsnobody</code>). Valid values: <code>0</code> through <code>4294967294</code>.</dd></dl>
</pulumi-choosable>
</div>
