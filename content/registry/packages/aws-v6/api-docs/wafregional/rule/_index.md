...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:wafregional:Rule</span><span class="p"></span>
...
```csharp
var exampleruleResourceResourceFromWafregionalrule = new Aws.WafRegional.Rule("exampleruleResourceResourceFromWafregionalrule", new()
{
    MetricName = "string",
    Name = "string",
    Predicates = new[]
...
```go
example, err := wafregional.NewRule(ctx, "exampleruleResourceResourceFromWafregionalrule", &wafregional.RuleArgs{
...
```java
var exampleruleResourceResourceFromWafregionalrule = new com.pulumi.aws.wafregional.Rule("exampleruleResourceResourceFromWafregionalrule", com.pulumi.aws.wafregional.RuleArgs.builder()
    .metricName("string")
    .name("string")
    .predicates(RulePredicateArgs.builder()
        .dataId("string")
...
```python
examplerule_resource_resource_from_wafregionalrule = aws.wafregional.Rule("exampleruleResourceResourceFromWafregionalrule",
    metric_name="string",
    name="string",
    predicates=[{
        "data_id": "string",
...
```typescript
const exampleruleResourceResourceFromWafregionalrule = new aws.wafregional.Rule("exampleruleResourceResourceFromWafregionalrule", {
    metricName: "string",
    name: "string",
    predicates: [{
        dataId: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the WAF Regional Rule.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<div>
  <pulumi-choosable type="language" values="yaml">
    <div class="no-copy">
      <div class="highlight">
        <pre tabindex="0" class="chroma"><code class="language-yaml" data-lang="yaml"><span class="line"><span class="cl"><span class="nt">resources</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">_</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l"><span class="nx">aws:wafregional:Rule</span></span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">get</span><span class="p">:</span><span class="w"></span></span></span><span class="line"><span class="cl"><span class="w">      </span><span class="nt">id</span><span class="p">:</span><span class="w"> </span><span class="l">${id}</span><span class="w"></span></span></span></code></pre>
      </div>
    </div>
  </pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>The ARN of the WAF Regional Rule.</dd><dt class="property-optional property-replacement"
            title="Optional">
