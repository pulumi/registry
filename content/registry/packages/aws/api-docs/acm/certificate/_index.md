...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#validationmethod_csharp" style="color: inherit; text-decoration: inherit;">Validation<wbr>Method</a>
    ...
    <dd><p>Which method to use for validation. <code>DNS</code> or <code>EMAIL</code> are valid, <code>NONE</code> can be used for certificates that were imported into ACM and then into the provider.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
