...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Logging<wbr>Configuration</a>
    ...
    <dd><p>Logging configuration for the workspace. See Logging Configuration below for details.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<h4 id="workspaceloggingconfiguration">Workspace<wbr>Logging<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggrouparn_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Group<wbr>Arn</a>
    ...
    <dd><p>The ARN of the CloudWatch log group to which the vended log data will be published. This log group must exist.</p>
</dd></dl>
</pulumi-choosable>
</div>
