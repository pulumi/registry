...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minadjustmentmagnitude_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Adjustment<wbr>Magnitude</a>
    ...
    <dd><p>Minimum number to adjust your scalable dimension as a result of a scaling activity. If the adjustment type is PercentChangeInCapacity, the scaling policy changes the scalable dimension of the scalable target by this amount.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stepadjustments_csharp" style="color: inherit; text-decoration: inherit;">Step<wbr>Adjustments</a>
    ...
    <dd><p>Set of adjustments that manage scaling. These have the following structure:</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scalingadjustment_csharp" style="color: inherit; text-decoration: inherit;">Scaling<wbr>Adjustment</a>
    ...
    <dd><p>Number of members by which to scale, when the adjustment bounds are breached. A positive value scales up. A negative value scales down.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricintervallowerbound_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Interval<wbr>Lower<wbr>Bound</a>
    ...
    <dd><p>Lower bound for the difference between the alarm threshold and the CloudWatch metric. Without a value, AWS will treat this bound as negative infinity.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricintervalupperbound_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Interval<wbr>Upper<wbr>Bound</a>
    ...
    <dd><p>Upper bound for the difference between the alarm threshold and the CloudWatch metric. Without a value, AWS will treat this bound as infinity. The upper bound must be greater than the lower bound.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customizedmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Customized<wbr>Metric<wbr>Specification</a>
    ...
    <dd><p>Custom CloudWatch metric. Documentation can be found  at: <a href="https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_CustomizedMetricSpecification.html">AWS Customized Metric Specification</a>. See supported fields below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#predefinedmetricspecification_csharp" style="color: inherit; text-decoration: inherit;">Predefined<wbr>Metric<wbr>Specification</a>
    ...
    <dd><p>Predefined metric. See supported fields below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaleincooldown_csharp" style="color: inherit; text-decoration: inherit;">Scale<wbr>In<wbr>Cooldown</a>
    ...
    <dd><p>Amount of time, in seconds, after a scale in activity completes before another scale in activity can start.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaleoutcooldown_csharp" style="color: inherit; text-decoration: inherit;">Scale<wbr>Out<wbr>Cooldown</a>
    ...
    <dd><p>Amount of time, in seconds, after a scale out activity completes before another scale out activity can start.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statistic_csharp" style="color: inherit; text-decoration: inherit;">Statistic</a>
    ...
    <dd><p>Statistic of the metric. Valid values: <code>Average</code>, <code>Minimum</code>, <code>Maximum</code>, <code>SampleCount</code>, and <code>Sum</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="unit_csharp">
...
<h4 id="policytargettrackingscalingpolicyconfigurationcustomizedmetricspecificationmetric">Policy<wbr>Target<wbr>Tracking<wbr>Scaling<wbr>Policy<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric</h4>
...
<h4 id="policytargettrackingscalingpolicyconfigurationcustomizedmetricspecificationmetricmetricstat">Policy<wbr>Target<wbr>Tracking<wbr>Scaling<wbr>Policy<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat</h4>
...
<h4 id="policytargettrackingscalingpolicyconfigurationcustomizedmetricspecificationmetricmetricstatmetric">Policy<wbr>Target<wbr>Tracking<wbr>Scaling<wbr>Policy<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric</h4>
...
<h4 id="policytargettrackingscalingpolicyconfigurationcustomizedmetricspecificationmetricmetricstatmetricdimension">Policy<wbr>Target<wbr>Tracking<wbr>Scaling<wbr>Policy<wbr>Configuration<wbr>Customized<wbr>Metric<wbr>Specification<wbr>Metric<wbr>Metric<wbr>Stat<wbr>Metric<wbr>Dimension</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcelabel_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Label</a>
    ...
    <dd><p>Reserved for future use if the <code>predefined_metric_type</code> is not <code>ALBRequestCountPerTarget</code>. If the <code>predefined_metric_type</code> is <code>ALBRequestCountPerTarget</code>, you must specify this argument. Documentation can be found at: <a href="https://docs.aws.amazon.com/autoscaling/plans/APIReference/API_PredefinedScalingMetricSpecification.html">AWS Predefined Scaling Metric Specification</a>. Must be less than or equal to 1023 characters in length.</p>
</dd></dl>
</pulumi-choosable>
</div>
