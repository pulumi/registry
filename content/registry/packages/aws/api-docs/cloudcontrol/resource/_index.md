...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:cloudcontrol:Resource</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredstate_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>State</a>
    ...
    <dd><p>JSON string matching the CloudFormation resource type schema with desired configuration.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd><p>JSON string matching the CloudFormation resource type schema with current configuration. Underlying attributes can be referenced via the <code>jsondecode()</code> function, for example, <code>jsondecode(data.aws_cloudcontrolapi_resource.example.properties)[&quot;example&quot;]</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
