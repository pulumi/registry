...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:cloudhsmv2:Cluster</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcebackupidentifier_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Backup<wbr>Identifier</a>
    ...
    <dd><p>ID of Cloud HSM v2 cluster backup to be restored.</p>
