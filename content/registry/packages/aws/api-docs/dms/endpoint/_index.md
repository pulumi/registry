...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enginename_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Name</a>
    ...
    <dd><p>Type of engine for the endpoint. Valid values are <code>aurora</code>, <code>aurora-postgresql</code>, <code>azuredb</code>, <code>azure-sql-managed-instance</code>, <code>db2</code>, <code>db2-zos</code>, <code>docdb</code>, <code>dynamodb</code>, <code>elasticsearch</code>, <code>kafka</code>, <code>kinesis</code>, <code>mariadb</code>, <code>mongodb</code>, <code>mysql</code>, <code>opensearch</code>, <code>oracle</code>, <code>postgres</code>, <code>redshift</code>, <code>s3</code>, <code>sqlserver</code>, <code>sybase</code>. Please note that some of engine names are available only for <code>target</code> endpoint type (e.g. <code>redshift</code>).</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#redshiftsettings_csharp" style="color: inherit; text-decoration: inherit;">Redshift<wbr>Settings</a>
    ...
    <dd><p>Configuration block for Redshift settings. See below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#s3settings_csharp" style="color: inherit; text-decoration: inherit;">S3Settings</a>
    ...
    <dd><p>(<strong>Deprecated</strong>, use the <code>aws.dms.S3Endpoint</code> resource instead) Configuration block for S3 settings. See below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretsmanagerarn_csharp" style="color: inherit; text-decoration: inherit;">Secrets<wbr>Manager<wbr>Arn</a>
    ...
    <dd><p>Full ARN, partial ARN, or friendly name of the SecretsManagerSecret that contains the endpoint connection details. Supported only when <code>engine_name</code> is <code>aurora</code>, <code>aurora-postgresql</code>, <code>mariadb</code>, <code>mongodb</code>, <code>mysql</code>, <code>oracle</code>, <code>postgres</code>, <code>redshift</code>, or <code>sqlserver</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#endpointuri_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Uri</a>
    ...
    <dd><p>Endpoint for the OpenSearch cluster.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>ARN of the IAM Role with permissions to write to the OpenSearch cluster.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#errorretryduration_csharp" style="color: inherit; text-decoration: inherit;">Error<wbr>Retry<wbr>Duration</a>
    ...
    <dd><p>Maximum number of seconds for which DMS retries failed API requests to the OpenSearch cluster. Default is <code>300</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fullloaderrorpercentage_csharp" style="color: inherit; text-decoration: inherit;">Full<wbr>Load<wbr>Error<wbr>Percentage</a>
    ...
    <dd><p>Maximum percentage of records that can fail to be written before a full load operation stops. Default is <code>10</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#broker_csharp" style="color: inherit; text-decoration: inherit;">Broker</a>
    ...
    <dd><p>Kafka broker location. Specify in the form broker-hostname-or-ip:port.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includecontroldetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Control<wbr>Details</a>
    ...
    <dd><p>Shows detailed control information for table definition, column definition, and table and column changes in the Kafka message output. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includenullandempty_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Null<wbr>And<wbr>Empty</a>
    ...
    <dd><p>Include NULL and empty columns for records migrated to the endpoint. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includepartitionvalue_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Partition<wbr>Value</a>
    ...
    <dd><p>Shows the partition value within the Kafka message output unless the partition type is <code>schema-table-type</code>. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetablealteroperations_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Table<wbr>Alter<wbr>Operations</a>
    ...
    <dd><p>Includes any data definition language (DDL) operations that change the table in the control data, such as <code>rename-table</code>, <code>drop-table</code>, <code>add-column</code>, <code>drop-column</code>, and <code>rename-column</code>. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetransactiondetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Transaction<wbr>Details</a>
    ...
    <dd><p>Provides detailed transaction information from the source database. This information includes a commit timestamp, a log position, and values for <code>transaction_id</code>, previous <code>transaction_id</code>, and <code>transaction_record_id</code> (the record offset within a transaction). Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messageformat_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Format</a>
    ...
    <dd><p>Output format for the records created on the endpoint. Message format is <code>JSON</code> (default) or <code>JSON_UNFORMATTED</code> (a single line with no tab).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messagemaxbytes_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Max<wbr>Bytes</a>
    ...
    <dd><p>Maximum size in bytes for records created on the endpoint Default is <code>1,000,000</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nohexprefix_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Hex<wbr>Prefix</a>
    ...
    <dd><p>Set this optional parameter to true to avoid adding a '0x' prefix to raw data in hexadecimal format. For example, by default, AWS DMS adds a '0x' prefix to the LOB column type in hexadecimal format moving from an Oracle source to a Kafka target. Use the <code>no_hex_prefix</code> endpoint setting to enable migration of RAW data type columns without adding the <code>'0x'</code> prefix.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#partitionincludeschematable_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Include<wbr>Schema<wbr>Table</a>
    ...
    <dd><p>Prefixes schema and table names to partition values, when the partition type is <code>primary-key-type</code>. Doing this increases data distribution among Kafka partitions. For example, suppose that a SysBench schema has thousands of tables and each table has only limited range for a primary key. In this case, the same primary key is sent from thousands of tables to the same partition, which causes throttling. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#saslpassword_csharp" style="color: inherit; text-decoration: inherit;">Sasl<wbr>Password</a>
    ...
    <dd><p>Secure password you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#saslusername_csharp" style="color: inherit; text-decoration: inherit;">Sasl<wbr>Username</a>
    ...
    <dd><p>Secure user name you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securityprotocol_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Protocol</a>
    ...
    <dd><p>Set secure connection to a Kafka target endpoint using Transport Layer Security (TLS). Options include <code>ssl-encryption</code>, <code>ssl-authentication</code>, and <code>sasl-ssl</code>. <code>sasl-ssl</code> requires <code>sasl_username</code> and <code>sasl_password</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslcacertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Ca<wbr>Certificate<wbr>Arn</a>
    ...
    <dd><p>ARN for the private certificate authority (CA) cert that AWS DMS uses to securely connect to your Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientcertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Certificate<wbr>Arn</a>
    ...
    <dd><p>ARN of the client certificate used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientkeyarn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Key<wbr>Arn</a>
    ...
    <dd><p>ARN for the client private key used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslclientkeypassword_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Client<wbr>Key<wbr>Password</a>
    ...
    <dd><p>Password for the client private key used to securely connect to a Kafka target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#topic_csharp" style="color: inherit; text-decoration: inherit;">Topic</a>
    ...
    <dd><p>Kafka topic for migration. Default is <code>kafka-default-topic</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includecontroldetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Control<wbr>Details</a>
    ...
    <dd><p>Shows detailed control information for table definition, column definition, and table and column changes in the Kinesis message output. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includenullandempty_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includenullandempty_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Null<wbr>And<wbr>Empty</a>
    ...
    <dd><p>Include NULL and empty columns in the target. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includepartitionvalue_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includepartitionvalue_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Partition<wbr>Value</a>
    ...
    <dd><p>Shows the partition value within the Kinesis message output, unless the partition type is schema-table-type. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includetablealteroperations_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetablealteroperations_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Table<wbr>Alter<wbr>Operations</a>
    ...
    <dd><p>Includes any data definition language (DDL) operations that change the table in the control data. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="includetransactiondetails_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includetransactiondetails_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Transaction<wbr>Details</a>
    ...
    <dd><p>Provides detailed transaction information from the source database. Default is <code>false</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="messageformat_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messageformat_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Format</a>
    ...
    <dd><p>Output format for the records created. Default is <code>json</code>. Valid values are <code>json</code> and <code>json-unformatted</code> (a single line with no tab).</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="partitionincludeschematable_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#partitionincludeschematable_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Include<wbr>Schema<wbr>Table</a>
    ...
    <dd><p>Prefixes schema and table names to partition values, when the partition type is primary-key-type. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="serviceaccessrolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>ARN of the IAM Role with permissions to write to the Kinesis data stream.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#streamarn_csharp" style="color: inherit; text-decoration: inherit;">Stream<wbr>Arn</a>
    ...
    <dd><p>ARN of the Kinesis data stream.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmechanism_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mechanism</a>
    ...
    <dd><p>Authentication mechanism to access the MongoDB source endpoint. Default is <code>default</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authsource_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Source</a>
    ...
    <dd><p>Authentication database name. Not used when <code>auth_type</code> is <code>no</code>. Default is <code>admin</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authtype_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Type</a>
    ...
    <dd><p>Authentication type to access the MongoDB source endpoint. Default is <code>password</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#docstoinvestigate_csharp" style="color: inherit; text-decoration: inherit;">Docs<wbr>To<wbr>Investigate</a>
    ...
    <dd><p>Number of documents to preview to determine the document organization. Use this setting when <code>nesting_level</code> is set to <code>one</code>. Default is <code>1000</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extractdocid_csharp" style="color: inherit; text-decoration: inherit;">Extract<wbr>Doc<wbr>Id</a>
    ...
    <dd><p>Document ID. Use this setting when <code>nesting_level</code> is set to <code>none</code>. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nestinglevel_csharp" style="color: inherit; text-decoration: inherit;">Nesting<wbr>Level</a>
    ...
    <dd><p>Specifies either document or table mode. Default is <code>none</code>. Valid values are <code>one</code> (table mode) and <code>none</code> (document mode).</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="endpointredissettings">Endpoint<wbr>Redis<wbr>Settings</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd><p>Transmission Control Protocol (TCP) port for the endpoint.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="servername_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#servername_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Name</a>
    ...
    <dd><p>Fully qualified domain name of the endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authpassword_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Password</a>
    ...
    <dd><p>The password provided with the auth-role and auth-token options of the AuthType setting for a Redis target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authusername_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>User<wbr>Name</a>
    ...
    <dd><p>The username provided with the <code>auth-role</code> option of the AuthType setting for a Redis target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="sslcacertificatearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslcacertificatearn_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Ca<wbr>Certificate<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) for the certificate authority (CA) that DMS uses to connect to your Redis target endpoint.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslsecurityprotocol_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Security<wbr>Protocol</a>
    ...
    <dd><p>The plaintext option doesn't provide Transport Layer Security (TLS) encryption for traffic between endpoint and database. Options include <code>plaintext</code>, <code>ssl-encryption</code>. The default is <code>ssl-encryption</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="endpointredshiftsettings">Endpoint<wbr>Redshift<wbr>Settings</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucketfolder_csharp" style="color: inherit; text-decoration: inherit;">Bucket<wbr>Folder</a>
    ...
    <dd><p>Custom S3 Bucket Object prefix for intermediate storage.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucketname_csharp" style="color: inherit; text-decoration: inherit;">Bucket<wbr>Name</a>
    ...
    <dd><p>Custom S3 Bucket name for intermediate storage.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#encryptionmode_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Mode</a>
    ...
    <dd><p>The server-side encryption mode that you want to encrypt your intermediate .csv object files copied to S3. Defaults to <code>SSE_S3</code>. Valid values are <code>SSE_S3</code> and <code>SSE_KMS</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serversideencryptionkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Side<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
    ...
    <dd><p>ARN or Id of KMS Key to use when <code>encryption_mode</code> is <code>SSE_KMS</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="serviceaccessrolearn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccessrolearn_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Access<wbr>Role<wbr>Arn</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of the IAM Role with permissions to read from or write to the S3 Bucket for intermediate storage.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cdcmaxbatchinterval_csharp" style="color: inherit; text-decoration: inherit;">Cdc<wbr>Max<wbr>Batch<wbr>Interval</a>
    ...
    <dd><p>Maximum length of the interval, defined in seconds, after which to output a file to Amazon S3. Default is <code>60</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cdcminfilesize_csharp" style="color: inherit; text-decoration: inherit;">Cdc<wbr>Min<wbr>File<wbr>Size</a>
    ...
    <dd><p>Minimum file size condition as defined in kilobytes to output a file to Amazon S3. Default is <code>32000</code>. <strong>NOTE:</strong> Previously, this setting was measured in megabytes but now represents kilobytes. Update configurations accordingly.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cdcpath_csharp" style="color: inherit; text-decoration: inherit;">Cdc<wbr>Path</a>
    ...
    <dd><p>Folder path of CDC files. For an S3 source, this setting is required if a task captures change data; otherwise, it's optional. If <code>cdc_path</code> is set, AWS DMS reads CDC files from this path and replicates the data changes to the target endpoint. Supported in AWS DMS versions 3.4.2 and later.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#compressiontype_csharp" style="color: inherit; text-decoration: inherit;">Compression<wbr>Type</a>
    ...
    <dd><p>Set to compress target files. Default is <code>NONE</code>. Valid values are <code>GZIP</code> and <code>NONE</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csvnosupvalue_csharp" style="color: inherit; text-decoration: inherit;">Csv<wbr>No<wbr>Sup<wbr>Value</a>
    ...
    <dd><p>String to use for all columns not included in the supplemental log.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csvnullvalue_csharp" style="color: inherit; text-decoration: inherit;">Csv<wbr>Null<wbr>Value</a>
    ...
    <dd><p>String to as null when writing to the target.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#csvrowdelimiter_csharp" style="color: inherit; text-decoration: inherit;">Csv<wbr>Row<wbr>Delimiter</a>
    ...
    <dd><p>Delimiter used to separate rows in the source files. Default is <code>\n</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dataformat_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Format</a>
    ...
    <dd><p>Output format for the files that AWS DMS uses to create S3 objects. Valid values are <code>csv</code> and <code>parquet</code>. Default is <code>csv</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapagesize_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Page<wbr>Size</a>
    ...
    <dd><p>Size of one data page in bytes. Default is <code>1048576</code> (1 MiB).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datepartitiondelimiter_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Partition<wbr>Delimiter</a>
    ...
    <dd><p>Date separating delimiter to use during folder partitioning. Valid values are <code>SLASH</code>, <code>UNDERSCORE</code>, <code>DASH</code>, and <code>NONE</code>. Default is <code>SLASH</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datepartitionenabled_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Partition<wbr>Enabled</a>
    ...
    <dd><p>Partition S3 bucket folders based on transaction commit dates. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datepartitionsequence_csharp" style="color: inherit; text-decoration: inherit;">Date<wbr>Partition<wbr>Sequence</a>
    ...
    <dd><p>Date format to use during folder partitioning. Use this parameter when <code>date_partition_enabled</code> is set to true. Valid values are <code>YYYYMMDD</code>, <code>YYYYMMDDHH</code>, <code>YYYYMM</code>, <code>MMYYYYDD</code>, and <code>DDMMYYYY</code>. Default is <code>YYYYMMDD</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dictpagesizelimit_csharp" style="color: inherit; text-decoration: inherit;">Dict<wbr>Page<wbr>Size<wbr>Limit</a>
    ...
    <dd><p>Maximum size in bytes of an encoded dictionary page of a column. Default is <code>1048576</code> (1 MiB).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#encodingtype_csharp" style="color: inherit; text-decoration: inherit;">Encoding<wbr>Type</a>
    ...
    <dd><p>Type of encoding to use. Value values are <code>rle_dictionary</code>, <code>plain</code>, and <code>plain_dictionary</code>. Default is <code>rle_dictionary</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="encryptionmode_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#encryptionmode_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Mode</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ignoreheaderrows_csharp" style="color: inherit; text-decoration: inherit;">Ignore<wbr>Header<wbr>Rows</a>
    ...
    <dd><p>When this value is set to <code>1</code>, DMS ignores the first row header in a .csv file. Default is <code>0</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ignoreheadersrow_csharp" style="color: inherit; text-decoration: inherit;">Ignore<wbr>Headers<wbr>Row</a>
    ...
    <dd><p>Deprecated. This setting has no effect. Will be removed in a future version.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxfilesize_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>File<wbr>Size</a>
    ...
    <dd><p>Maximum size (in KB) of any .csv file to be created while migrating to an S3 target during full load. Valid values are from <code>1</code> to <code>1048576</code>. Default is <code>1048576</code> (1 GB).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parquettimestampinmillisecond_csharp" style="color: inherit; text-decoration: inherit;">Parquet<wbr>Timestamp<wbr>In<wbr>Millisecond</a>
    ...
    <dd><p>Specifies the precision of any TIMESTAMP column values written to an S3 object file in .parquet format. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parquetversion_csharp" style="color: inherit; text-decoration: inherit;">Parquet<wbr>Version</a>
    ...
    <dd><p>Version of the .parquet file format. Default is <code>parquet-1-0</code>. Valid values are <code>parquet-1-0</code> and <code>parquet-2-0</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#preservetransactions_csharp" style="color: inherit; text-decoration: inherit;">Preserve<wbr>Transactions</a>
    ...
    <dd><p>Whether DMS saves the transaction order for a CDC load on the S3 target specified by <code>cdc_path</code>. Default is <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rowgrouplength_csharp" style="color: inherit; text-decoration: inherit;">Row<wbr>Group<wbr>Length</a>
    ...
    <dd><p>Number of rows in a row group. Default is <code>10000</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="serversideencryptionkmskeyid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serversideencryptionkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Side<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usecsvnosupvalue_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Csv<wbr>No<wbr>Sup<wbr>Value</a>
    ...
    <dd><p>Whether to use <code>csv_no_sup_value</code> for columns not included in the supplemental log.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usetaskstarttimeforfullloadtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Task<wbr>Start<wbr>Time<wbr>For<wbr>Full<wbr>Load<wbr>Timestamp</a>
    ...
    <dd><p>When set to true, uses the task start time as the timestamp column value instead of the time data is written to target. For full load, when set to true, each row of the timestamp column contains the task start time. For CDC loads, each row of the timestamp column contains the transaction commit time. When set to false, the full load timestamp in the timestamp column increments with the time data arrives at the target. Default is <code>false</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
