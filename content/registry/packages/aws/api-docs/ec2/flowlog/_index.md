...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#destinationoptions_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowlogdestinationoptions">Pulumi.<wbr>Aws.<wbr>Ec2.<wbr>Inputs.<wbr>Flow<wbr>Log<wbr>Destination<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loggroupname_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Group<wbr>Name</a>
    ...
    <dd><p><em>Deprecated:</em> Use <code>log_destination</code> instead. The name of the CloudWatch log group. Either <code>log_group_name</code> or <code>log_destination</code> must be set.</p>
