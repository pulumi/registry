...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:ec2:RouteTable</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#routes_csharp" style="color: inherit; text-decoration: inherit;">Routes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routetableroute">List&lt;Pulumi.<wbr>Aws.<wbr>Ec2.<wbr>Inputs.<wbr>Route<wbr>Table<wbr>Route<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>A list of route objects. Their keys are documented below.
This means that omitting this argument is interpreted as ignoring any existing routes. To remove all managed routes an empty list should be specified. See the example above.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
