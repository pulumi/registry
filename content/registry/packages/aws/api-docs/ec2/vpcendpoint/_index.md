...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_dnsentries_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Entries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpcendpointdnsentry">List&lt;Pulumi.<wbr>Aws.<wbr>Ec2.<wbr>Inputs.<wbr>Vpc<wbr>Endpoint<wbr>Dns<wbr>Entry<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>The DNS entries for the VPC Endpoint. Applicable for endpoints of type <code>Interface</code>. DNS blocks are documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="vpcendpointdnsoptions">Vpc<wbr>Endpoint<wbr>Dns<wbr>Options</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsrecordiptype_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Record<wbr>Ip<wbr>Type</a>
    ...
    <dd><p>The DNS records created for the endpoint. Valid values are <code>ipv4</code>, <code>dualstack</code>, <code>service-defined</code>, and <code>ipv6</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
