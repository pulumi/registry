...
<h4 id="servicealarms">Service<wbr>Alarms</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#alarmnames_csharp" style="color: inherit; text-decoration: inherit;">Alarm<wbr>Names</a>
    ...
    <dd><p>One or more CloudWatch alarm names.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enable_csharp" style="color: inherit; text-decoration: inherit;">Enable</a>
    ...
    <dd><p>Determines whether to use the CloudWatch alarm option in the service deployment process.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rollback_csharp" style="color: inherit; text-decoration: inherit;">Rollback</a>
    ...
    <dd><p>Determines whether to configure Amazon ECS to roll back the service if a service deployment fails. If rollback is used, when a service deployment fails, the service is rolled back to the last deployment that completed successfully.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serviceserviceconnectconfiguration">Service<wbr>Service<wbr>Connect<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Specifies whether to use Service Connect with this service.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Configuration</a>
    ...
    <dd><p>The log configuration for the container. See below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd><p>The namespace name or ARN of the <code>aws.servicediscovery.HttpNamespace</code> for use with Service Connect.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#services_csharp" style="color: inherit; text-decoration: inherit;">Services</a>
    ...
    <dd><p>The list of Service Connect service objects. See below.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serviceserviceconnectconfigurationlogconfiguration">Service<wbr>Service<wbr>Connect<wbr>Configuration<wbr>Log<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logdriver_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Driver</a>
    ...
    <dd><p>The log driver to use for the container.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
    ...
    <dd><p>The configuration options to send to the log driver.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretoptions_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Options</a>
    ...
    <dd><p>The secrets to pass to the log configuration. See below.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serviceserviceconnectconfigurationlogconfigurationsecretoption">Service<wbr>Service<wbr>Connect<wbr>Configuration<wbr>Log<wbr>Configuration<wbr>Secret<wbr>Option</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#valuefrom_csharp" style="color: inherit; text-decoration: inherit;">Value<wbr>From</a>
    ...
    <dd><p>The secret to expose to the container. The supported values are either the full ARN of the AWS Secrets Manager secret or the full ARN of the parameter in the SSM Parameter Store.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serviceserviceconnectconfigurationservice">Service<wbr>Service<wbr>Connect<wbr>Configuration<wbr>Service</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#portname_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Name</a>
    ...
    <dd><p>The name of one of the <code>portMappings</code> from all the containers in the task definition of this Amazon ECS service.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientalias_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Alias</a>
    ...
    <dd><p>The list of client aliases for this Service Connect service. You use these to assign names that can be used by client applications. The maximum number of client aliases that you can have in this list is 1. See below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoveryname_csharp" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Name</a>
    ...
    <dd><p>The name of the new AWS Cloud Map service that Amazon ECS creates for this Amazon ECS service.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ingressportoverride_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Port<wbr>Override</a>
    ...
    <dd><p>The port number for the Service Connect proxy to listen on.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serviceserviceconnectconfigurationserviceclientalias">Service<wbr>Service<wbr>Connect<wbr>Configuration<wbr>Service<wbr>Client<wbr>Alias</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd><p>The listening port number for the Service Connect proxy. This port is available inside of all of the tasks within the same namespace.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd><p>The name that you use in the applications of client tasks to connect to this service.</p>
</dd></dl>
</pulumi-choosable>
</div>
