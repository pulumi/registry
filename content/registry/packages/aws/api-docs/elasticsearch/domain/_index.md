...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#advancedoptions_csharp" style="color: inherit; text-decoration: inherit;">Advanced<wbr>Options</a>
    ...
    <dd><p>Key-value string pairs to specify advanced configuration options. Note that the values for these configuration options must be strings (wrapped in quotes) or they may be wrong and cause a perpetual diff, causing the provider to want to recreate your Elasticsearch domain on every apply.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#internaluserdatabaseenabled_csharp" style="color: inherit; text-decoration: inherit;">Internal<wbr>User<wbr>Database<wbr>Enabled</a>
    ...
    <dd><p>Whether the internal user database is enabled. If not set, defaults to <code>false</code> by the AWS API.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusername_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Name</a>
    ...
    <dd><p>Main user's username, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if <code>internal_user_database_enabled</code> is set to <code>true</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masteruserpassword_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Password</a>
    ...
    <dd><p>Main user's password, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if <code>internal_user_database_enabled</code> is set to <code>true</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredstate_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>State</a>
    ...
    <dd><p>The Auto-Tune desired state for the domain. Valid values: <code>ENABLED</code> or <code>DISABLED</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
    ...
    <dd><p>The unit of time specifying the duration of an Auto-Tune maintenance window. Valid values: <code>HOURS</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Boolean to enable cold storage for an Elasticsearch domain. Defaults to <code>false</code>. Master and ultrawarm nodes must be enabled for cold storage.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
    ...
    <dd><p>ARN of the IAM role that has the AmazonESCognitoAccess policy attached.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Whether Amazon Cognito authentication with Kibana is enabled or not.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customendpointenabled_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Endpoint<wbr>Enabled</a>
    ...
    <dd><p>Whether to enable custom endpoint for the Elasticsearch domain.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Whether to enable encryption at rest. If the <code>encrypt_at_rest</code> block is not provided then this defaults to <code>false</code>. Enabling encryption on new domains requires <code>elasticsearch_version</code> 5.1 or greater.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Type</a>
    ...
    <dd><p>Type of Elasticsearch log. Valid values: <code>INDEX_SLOW_LOGS</code>, <code>SEARCH_SLOW_LOGS</code>, <code>ES_APPLICATION_LOGS</code>, <code>AUDIT_LOGS</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="enabled_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Whether to enable node-to-node encryption. If the <code>node_to_node_encryption</code> block is not provided then this defaults to <code>false</code>. Enabling node-to-node encryption of a new domain requires an <code>elasticsearch_version</code> of <code>6.0</code> or greater.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupids_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Ids</a>
    ...
    <dd><p>List of VPC Security Group IDs to be applied to the Elasticsearch domain endpoints. If omitted, the default Security Group for the VPC will be used.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd><p>List of VPC Subnet IDs for the Elasticsearch domain endpoints to be created in.</p>
</dd><dt class="property-optional"
            title="Optional">
