...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:globalaccelerator:Accelerator</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipaddresstype_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address<wbr>Type</a>
    ...
    <dd><p>The value for the address type. Defaults to <code>IPV4</code>. Valid values: <code>IPV4</code>, <code>DUAL_STACK</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dualstackdnsname_csharp" style="color: inherit; text-decoration: inherit;">Dual<wbr>Stack<wbr>Dns<wbr>Name</a>
    ...
    <dd><p>The Domain Name System (DNS) name that Global Accelerator creates that points to a dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. For example, <code>a1234567890abcdef.dualstack.awsglobalaccelerator.com</code>.</p>
</dd><dt class="property-"
            title="">
