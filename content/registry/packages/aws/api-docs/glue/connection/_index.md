...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:glue:Connection</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#connectiontype_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Type</a>
    ...
    <dd><p>The type of the connection. Supported are: <code>CUSTOM</code>, <code>JDBC</code>, <code>KAFKA</code>, <code>MARKETPLACE</code>, <code>MONGODB</code>, and <code>NETWORK</code>. Defaults to <code>JBDC</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
