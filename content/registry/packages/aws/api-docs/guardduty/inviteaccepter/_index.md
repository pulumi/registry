...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:guardduty:InviteAccepter</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masteraccountid_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Account<wbr>Id</a>
    ...
    <dd><p>AWS account ID for primary account.</p>
</dd></dl>
</pulumi-choosable>
</div>
