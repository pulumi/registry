...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd><p>A description of the intent. Must be less than or equal to 200 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>The name of the intent, not case sensitive. Must be less than or equal to 100 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rejectionstatement_csharp" style="color: inherit; text-decoration: inherit;">Rejection<wbr>Statement</a>
    ...
    <dd><p>When the user answers &quot;no&quot; to the question defined in
...
Attributes are documented under statement.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sampleutterances_csharp" style="color: inherit; text-decoration: inherit;">Sample<wbr>Utterances</a>
    ...
    <dd><p>An array of utterances (strings) that a user might say to signal
the intent. For example, &quot;I want {PizzaSize} pizza&quot;, &quot;Order {Quantity} {PizzaSize} pizzas&quot;.
In each utterance, a slot name is enclosed in curly braces. Must have between 1 and 10 items in the list, and each item must be less than or equal to 200 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#responsecard_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Card</a>
    ...
    <dd><p>The response card. Amazon Lex will substitute session attributes and
slot values into the response card. For more information, see
<a href="https://docs.aws.amazon.com/lex/latest/dg/ex-resp-card.html">Example: Using a Response Card</a>. Must be less than or equal to 50000 characters in length.
slot values into the response card. For more information, see
<a href="https://docs.aws.amazon.com/lex/latest/dg/ex-resp-card.html">Example: Using a Response Card</a>. Must be less than or equal to 50000 characters in length.
slot values into the response card. For more information, see
<a href="https://docs.aws.amazon.com/lex/latest/dg/ex-resp-card.html">Example: Using a Response Card</a>. Must be less than or equal to 50000 characters in length.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#content_csharp" style="color: inherit; text-decoration: inherit;">Content</a>
    ...
    <dd><p>The text of the message. Must be less than or equal to 1000 characters in length.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contenttype_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Type</a>
    ...
    <dd><p>The content type of the message string.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupnumber_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Number</a>
    ...
    <dd><p>Identifies the message group that the message belongs to. When a group
is assigned to a message, Amazon Lex returns one message from each group in the response. Must be a number between 1 and 5 (inclusive).</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxattempts_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Attempts</a>
    ...
    <dd><p>The number of times to prompt the user for information. Must be a number between 1 and 5 (inclusive).</p>
</dd><dt class="property-required"
            title="Required">
        <span id="messages_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_csharp" style="color: inherit; text-decoration: inherit;">Messages</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messageversion_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Version</a>
    ...
    <dd><p>The version of the request-response that you want Amazon Lex to use
to invoke your Lambda function. For more information, see
<a href="https://docs.aws.amazon.com/lex/latest/dg/using-lambda.html">Using Lambda Functions</a>. Must be less than or equal to 5 characters in length.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="uri_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uri_csharp" style="color: inherit; text-decoration: inherit;">Uri</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) of the Lambda function.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prompt_csharp" style="color: inherit; text-decoration: inherit;">Prompt</a>
    ...
    <dd><p>Prompts for information from the user. Attributes are documented under prompt.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="rejectionstatement_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rejectionstatement_csharp" style="color: inherit; text-decoration: inherit;">Rejection<wbr>Statement</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_csharp" style="color: inherit; text-decoration: inherit;">Messages</a>
    ...
    <dd><p>A set of messages, each of which provides a message string and its type.
You can specify the message string in plain text or in Speech Synthesis Markup Language (SSML).
Attributes are documented under message. Must contain between 1 and 15 messages.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="responsecard_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#responsecard_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Card</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>How the intent should be fulfilled, either by running a Lambda function or by
returning the slot data to the client application. Type can be either <code>ReturnIntent</code> or <code>CodeHook</code>, as documented <a href="https://docs.aws.amazon.com/lex/latest/dg/API_FulfillmentActivity.html">here</a>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#codehook_csharp" style="color: inherit; text-decoration: inherit;">Code<wbr>Hook</a>
    ...
    <dd><p>A description of the Lambda function that is run to fulfill the intent.
Required if type is CodeHook. Attributes are documented under code_hook.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#slotconstraint_csharp" style="color: inherit; text-decoration: inherit;">Slot<wbr>Constraint</a>
    ...
    <dd><p>Specifies whether the slot is required or optional.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#slottype_csharp" style="color: inherit; text-decoration: inherit;">Slot<wbr>Type</a>
    ...
    <dd><p>The type of the slot, either a custom slot type that you defined or one of
the built-in slot types. Must be less than or equal to 100 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd><p>Directs Lex the order in which to elicit this slot value from the user.
For example, if the intent has two slots with priorities 1 and 2, AWS Lex first elicits a value for
the slot with priority 1. If multiple slots share the same priority, the order in which Lex elicits
values is arbitrary. Must be between 1 and 100.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="responsecard_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#responsecard_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Card</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#slottypeversion_csharp" style="color: inherit; text-decoration: inherit;">Slot<wbr>Type<wbr>Version</a>
    ...
    <dd><p>The version of the slot type. Must be less than or equal to 64 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#valueelicitationprompt_csharp" style="color: inherit; text-decoration: inherit;">Value<wbr>Elicitation<wbr>Prompt</a>
    ...
    <dd><p>The prompt that Amazon Lex uses to elicit the slot value
from the user. Attributes are documented under prompt.</p>
</dd></dl>
</pulumi-choosable>
</div>
