...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:lightsail:KeyPair</span><span class="p"></span>
...
encrypted with the given <code>pgp_key</code>. This is only populated when creating a new
key and <code>pgp_key</code> is supplied</p>
</dd><dt class="property-"
            title="">
...
when creating a new key, and when no <code>pgp_key</code> is provided</p>
</dd></dl>
</pulumi-choosable>
</div>
