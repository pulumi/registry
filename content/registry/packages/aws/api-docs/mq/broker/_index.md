...
<div>
<pulumi-choosable type="language" values="java">
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">Broker</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">BrokerState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#revision_csharp" style="color: inherit; text-decoration: inherit;">Revision</a>
    ...
    <dd><p>Revision of the Configuration.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd><p>Amazon Resource Name (ARN) of Key Management Service (KMS) Customer Master Key (CMK) to use for encryption at rest. Requires setting <code>use_aws_owned_key</code> to <code>false</code>. To perform drift detection when AWS-managed CMKs or customer-managed CMKs are in use, this value must be configured.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useawsownedkey_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Aws<wbr>Owned<wbr>Key</a>
    ...
    <dd><p>Whether to enable an AWS-owned KMS CMK that is not in your account. Defaults to <code>true</code>. Setting to <code>false</code> without configuring <code>kms_key_id</code> will create an AWS-managed CMK aliased to <code>aws/mq</code> in your account.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hosts_csharp" style="color: inherit; text-decoration: inherit;">Hosts</a>
    ...
    <dd><p>List of a fully qualified domain name of the LDAP server and an optional failover server.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolebase_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Base</a>
    ...
    <dd><p>Fully qualified name of the directory to search for a user’s groups.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolename_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Name</a>
    ...
    <dd><p>Specifies the LDAP attribute that identifies the group name attribute in the object returned from the group membership query.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolesearchmatching_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Search<wbr>Matching</a>
    ...
    <dd><p>Search criteria for groups.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolesearchsubtree_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Search<wbr>Subtree</a>
    ...
    <dd><p>Whether the directory search scope is the entire sub-tree.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccountpassword_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account<wbr>Password</a>
    ...
    <dd><p>Service account password.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccountusername_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account<wbr>Username</a>
    ...
    <dd><p>Service account username.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userbase_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Base</a>
    ...
    <dd><p>Fully qualified name of the directory where you want to search for users.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userrolename_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Role<wbr>Name</a>
    ...
    <dd><p>Specifies the name of the LDAP attribute for the user group membership.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#usersearchmatching_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Search<wbr>Matching</a>
    ...
    <dd><p>Search criteria for users.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#audit_csharp" style="color: inherit; text-decoration: inherit;">Audit</a>
    ...
    <dd><p>Enables audit logging. Auditing is only possible for <code>engine_type</code> of <code>ActiveMQ</code>. User management action made using JMX or the ActiveMQ Web Console is logged. Defaults to <code>false</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#general_csharp" style="color: inherit; text-decoration: inherit;">General</a>
    ...
    <dd><p>Enables general logging via CloudWatch. Defaults to <code>false</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dayofweek_csharp" style="color: inherit; text-decoration: inherit;">Day<wbr>Of<wbr>Week</a>
    ...
    <dd><p>Day of the week, e.g., <code>MONDAY</code>, <code>TUESDAY</code>, or <code>WEDNESDAY</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeofday_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Of<wbr>Day</a>
    ...
    <dd><p>Time, in 24-hour format, e.g., <code>02:00</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timezone_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Zone</a>
    ...
    <dd><p>Time zone in either the Country/City format or the UTC offset format, e.g., <code>CET</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd><p>Password of the user. It must be 12 to 250 characters long, at least 4 unique characters, and must not contain commas.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#consoleaccess_csharp" style="color: inherit; text-decoration: inherit;">Console<wbr>Access</a>
    ...
    <dd><p>Whether to enable access to the <a href="http://activemq.apache.org/web-console.html">ActiveMQ Web Console</a> for the user. Applies to <code>engine_type</code> of <code>ActiveMQ</code> only.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_csharp" style="color: inherit; text-decoration: inherit;">Groups</a>
    ...
    <dd><p>List of groups (20 maximum) to which the ActiveMQ user belongs. Applies to <code>engine_type</code> of <code>ActiveMQ</code> only.</p>
</dd></dl>
</pulumi-choosable>
</div>
