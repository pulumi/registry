...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:opsworks:Instance</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layerids_csharp" style="color: inherit; text-decoration: inherit;">Layer<wbr>Ids</a>
    ...
    <dd><p>List of the layers the instance will belong to.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#agentversion_csharp" style="color: inherit; text-decoration: inherit;">Agent<wbr>Version</a>
    ...
    <dd><p>OpsWorks agent to install. Default is <code>INHERIT</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#amiid_csharp" style="color: inherit; text-decoration: inherit;">Ami<wbr>Id</a>
    ...
    <dd><p>AMI to use for the instance.  If an AMI is specified, <code>os</code> must be <code>Custom</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_csharp" style="color: inherit; text-decoration: inherit;">Architecture</a>
    ...
    <dd><p>Machine architecture for created instances.  Valid values are <code>x86_64</code> or <code>i386</code>. The default is <code>x86_64</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalingtype_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Scaling<wbr>Type</a>
    ...
    <dd><p>Creates load-based or time-based instances.  Valid values are <code>load</code>, <code>timer</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityzone_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone</a>
    ...
    <dd><p>Name of the availability zone where instances will be created by default.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd><p>Time that the instance was created.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deleteebs_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Ebs</a>
    ...
    <dd><p>Whether to delete EBS volume on deletion. Default is <code>true</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deleteeip_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Eip</a>
    ...
    <dd><p>Whether to delete the Elastic IP on deletion.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ebsblockdevices_csharp" style="color: inherit; text-decoration: inherit;">Ebs<wbr>Block<wbr>Devices</a>
    ...
    <dd><p>Configuration block for additional EBS block devices to attach to the instance. See Block Devices below.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecsclusterarn_csharp" style="color: inherit; text-decoration: inherit;">Ecs<wbr>Cluster<wbr>Arn</a>
    ...
    <dd><p>ECS cluster's ARN for container instances.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#elasticip_csharp" style="color: inherit; text-decoration: inherit;">Elastic<wbr>Ip</a>
    ...
    <dd><p>Instance Elastic IP address.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ephemeralblockdevices_csharp" style="color: inherit; text-decoration: inherit;">Ephemeral<wbr>Block<wbr>Devices</a>
    ...
    <dd><p>Configuration block for ephemeral (also known as &quot;Instance Store&quot;) volumes on the instance. See Block Devices below.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#infrastructureclass_csharp" style="color: inherit; text-decoration: inherit;">Infrastructure<wbr>Class</a>
    ...
    <dd><p>For registered instances, infrastructure class: ec2 or on-premises.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#installupdatesonboot_csharp" style="color: inherit; text-decoration: inherit;">Install<wbr>Updates<wbr>On<wbr>Boot</a>
    ...
    <dd><p>Controls where to install OS and package updates when the instance boots.  Default is <code>true</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceprofilearn_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Profile<wbr>Arn</a>
    ...
    <dd><p>ARN of the instance's IAM profile.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancetype_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Type</a>
    ...
    <dd><p>Type of instance to start.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="os_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootblockdevices_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Block<wbr>Devices</a>
    ...
    <dd><p>Configuration block for the root block device of the instance. See Block Devices below.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootdevicetype_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Device<wbr>Type</a>
    ...
    <dd><p>Name of the type of root device instances will have by default. Valid values are <code>ebs</code> or <code>instance-store</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupids_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Ids</a>
    ...
    <dd><p>Associated security groups.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd><p>Desired state of the instance. Valid values are <code>running</code> or <code>stopped</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd><p>Instance status. Will be one of <code>booting</code>, <code>connection_lost</code>, <code>online</code>, <code>pending</code>, <code>rebooting</code>, <code>requested</code>, <code>running_setup</code>, <code>setup_failed</code>, <code>shutting_down</code>, <code>start_failed</code>, <code>stop_failed</code>, <code>stopped</code>, <code>stopping</code>, <code>terminated</code>, or <code>terminating</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenancy_csharp" style="color: inherit; text-decoration: inherit;">Tenancy</a>
    ...
    <dd><p>Instance tenancy to use. Valid values are <code>default</code>, <code>dedicated</code> or <code>host</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualizationtype_csharp" style="color: inherit; text-decoration: inherit;">Virtualization<wbr>Type</a>
    ...
    <dd><p>Keyword to choose what virtualization mode created instances will use. Valid values are <code>paravirtual</code> or <code>hvm</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastserviceerrorid_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Service<wbr>Error<wbr>Id</a>
    ...
    <dd><p>ID of the last service error.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateip_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Ip</a>
    ...
    <dd><p>Private IP address assigned to the instance.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publicip_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Ip</a>
    ...
    <dd><p>Public IP address assigned to the instance, if applicable.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registeredby_csharp" style="color: inherit; text-decoration: inherit;">Registered<wbr>By</a>
    ...
    <dd><p>For registered instances, who performed the registration.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reportedagentversion_csharp" style="color: inherit; text-decoration: inherit;">Reported<wbr>Agent<wbr>Version</a>
    ...
    <dd><p>Instance's reported AWS OpsWorks Stacks agent version.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reportedosfamily_csharp" style="color: inherit; text-decoration: inherit;">Reported<wbr>Os<wbr>Family</a>
    ...
    <dd><p>For registered instances, the reported operating system family.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reportedosname_csharp" style="color: inherit; text-decoration: inherit;">Reported<wbr>Os<wbr>Name</a>
    ...
    <dd><p>For registered instances, the reported operating system name.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reportedosversion_csharp" style="color: inherit; text-decoration: inherit;">Reported<wbr>Os<wbr>Version</a>
    ...
    <dd><p>For registered instances, the reported operating system version.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sshhostdsakeyfingerprint_csharp" style="color: inherit; text-decoration: inherit;">Ssh<wbr>Host<wbr>Dsa<wbr>Key<wbr>Fingerprint</a>
    ...
    <dd><p>SSH key's Deep Security Agent (DSA) fingerprint.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sshhostrsakeyfingerprint_csharp" style="color: inherit; text-decoration: inherit;">Ssh<wbr>Host<wbr>Rsa<wbr>Key<wbr>Fingerprint</a>
    ...
    <dd><p>SSH key's RSA fingerprint.</p>
</dd></dl>
</pulumi-choosable>
</div>
