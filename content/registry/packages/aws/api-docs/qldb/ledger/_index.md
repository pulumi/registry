...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:qldb:Ledger</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#permissionsmode_csharp" style="color: inherit; text-decoration: inherit;">Permissions<wbr>Mode</a>
    ...
    <dd><p>The permissions mode for the QLDB ledger instance. Specify either <code>ALLOW_ALL</code> or <code>STANDARD</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deletionprotection_csharp" style="color: inherit; text-decoration: inherit;">Deletion<wbr>Protection</a>
    ...
    <dd><p>The deletion protection for the QLDB Ledger instance. By default it is <code>true</code>. To delete this resource via the provider, this value must be configured to <code>false</code> and applied first before attempting deletion.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>The friendly name for the QLDB Ledger instance. By default generated by the provider.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<div>
<pulumi-choosable type="language" values="java">
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static </span><span class="nx">Ledger</span><span class="nf"> get</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx">Output&lt;String&gt;</span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">LedgerState</span><span class="p"> </span><span class="nx">state<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
