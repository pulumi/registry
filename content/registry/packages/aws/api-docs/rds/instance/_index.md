...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#engineversion_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Version</a>
    ...
    <dd><p>The engine version to use. If <code>auto_minor_version_upgrade</code> is enabled, you can provide a prefix of the version such as <code>5.7</code> (for <code>5.7.10</code>). The actual engine version used is returned in the attribute <code>engine_version_actual</code>, see Attributes Reference below. For supported values, see the EngineVersion parameter in <a href="https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html">API action CreateDBInstance</a>. Note that for Amazon Aurora instances the engine version must match the DB cluster's engine version'.</p>
</dd><dt class="property-optional"
            title="Optional">
...
if omitted, this provider will assign a random, unique identifier. Required if <code>restore_to_point_in_time</code> is specified.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
storage_type of &quot;io1&quot;. Can only be set when <code>storage_type</code> is <code>&quot;io1&quot;</code> or <code>&quot;gp3&quot;</code>.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#address_csharp" style="color: inherit; text-decoration: inherit;">Address</a>
    ...
    <dd><p>Specifies the DNS address of the DB instance.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostedzoneid_csharp" style="color: inherit; text-decoration: inherit;">Hosted<wbr>Zone<wbr>Id</a>
    ...
    <dd><p>Specifies the ID that Amazon Route 53 assigns when you create a hosted zone.</p>
</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#listenerendpoints_csharp" style="color: inherit; text-decoration: inherit;">Listener<wbr>Endpoints</a>
    ...
    <dd><p>Specifies the listener connection endpoint for SQL Server Always On. See endpoint below.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#masterusersecrets_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Secrets</a>
    ...
    <dd><p>A block that specifies the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_listenerendpoints_csharp" style="color: inherit; text-decoration: inherit;">Listener<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancelistenerendpoint">List&lt;Instance<wbr>Listener<wbr>Endpoint<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>Specifies the listener connection endpoint for SQL Server Always On. See endpoint below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_masterusersecrets_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancemasterusersecret">List&lt;Instance<wbr>Master<wbr>User<wbr>Secret<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>A block that specifies the master user secret. Only available when <code>manage_master_user_password</code> is set to true. Documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="instancebluegreenupdate">Instance<wbr>Blue<wbr>Green<wbr>Update</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd><p>Enables low-downtime updates when <code>true</code>.
...
<h4 id="instancelistenerendpoint">Instance<wbr>Listener<wbr>Endpoint</h4>
...
<h4 id="instancemasterusersecret">Instance<wbr>Master<wbr>User<wbr>Secret</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretstatus_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Status</a>
    ...
    <dd><p>The status of the secret. Valid Values: <code>creating</code> | <code>active</code> | <code>rotating</code> | <code>impaired</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
