...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:rds:Proxy</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientpasswordauthtype_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Password<wbr>Auth<wbr>Type</a>
    ...
    <dd><p>The type of authentication the proxy uses for connections from clients. Valid values are <code>MYSQL_NATIVE_PASSWORD</code>, <code>POSTGRES_SCRAM_SHA_256</code>, <code>POSTGRES_MD5</code>, and <code>SQL_SERVER_AUTHENTICATION</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
