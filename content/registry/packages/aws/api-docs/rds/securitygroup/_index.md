...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:rds:SecurityGroup</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cidr_csharp" style="color: inherit; text-decoration: inherit;">Cidr</a>
    ...
    <dd><p>The CIDR block to accept</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupid_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Id</a>
    ...
    <dd><p>The ID of the security group to authorize</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupname_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Name</a>
    ...
    <dd><p>The name of the security group to authorize</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="securitygroupownerid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupownerid_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Owner<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>The owner Id of the security group provided
by <code>security_group_name</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupownerid_go" style="color: inherit; text-decoration: inherit;">Security<wbr>Group<wbr>Owner<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupname_java" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Name</a>
    ...
    <dd><p>The name of the security group to authorize</p>
            ...
            title="Optional">
        <span id="securitygroupownerid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupownerid_java" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Owner<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupownerid_nodejs" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Owner<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#security_group_owner_id_python" style="color: inherit; text-decoration: inherit;">security_<wbr>group_<wbr>owner_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupname_yaml" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Name</a>
    ...
    <dd><p>The name of the security group to authorize</p>
            ...
            title="Optional">
        <span id="securitygroupownerid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitygroupownerid_yaml" style="color: inherit; text-decoration: inherit;">security<wbr>Group<wbr>Owner<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
