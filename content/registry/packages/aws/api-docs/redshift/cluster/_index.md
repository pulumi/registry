...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#aquaconfigurationstatus_csharp" style="color: inherit; text-decoration: inherit;">Aqua<wbr>Configuration<wbr>Status</a>
    ...
    <dd><p>The value represents how the cluster is configured to use AQUA (Advanced Query Accelerator) after the cluster is restored. Possible values are <code>enabled</code>, <code>disabled</code>, and <code>auto</code>. Requires Cluster reboot.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<p class="property-message">Deprecated:<p>With the retirement of EC2-Classic the cluster_security_groups attribute has been deprecated and will be removed in a future version.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logging_csharp" style="color: inherit; text-decoration: inherit;">Logging</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterlogging">Pulumi.<wbr>Aws.<wbr>Red<wbr>Shift.<wbr>Inputs.<wbr>Cluster<wbr>Logging<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotcopy_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Copy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustersnapshotcopy">Pulumi.<wbr>Aws.<wbr>Red<wbr>Shift.<wbr>Inputs.<wbr>Cluster<wbr>Snapshot<wbr>Copy<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusternodes_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclusternode">List&lt;Pulumi.<wbr>Aws.<wbr>Red<wbr>Shift.<wbr>Outputs.<wbr>Cluster<wbr>Cluster<wbr>Node&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_clusternodes_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterclusternode">List&lt;Pulumi.<wbr>Aws.<wbr>Red<wbr>Shift.<wbr>Inputs.<wbr>Cluster<wbr>Cluster<wbr>Node<wbr>Args&gt;</a></span>
    </dt>
    <dd><p>The nodes in the cluster. Cluster node blocks are documented below</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logdestinationtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Destination<wbr>Type</a>
    ...
    <dd><p>The log destination type. An enum with possible values of <code>s3</code> and <code>cloudwatch</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logexports_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Exports</a>
    ...
    <dd><p>The collection of exported log types. Log types include the connection log, user log and user activity log. Required when <code>log_destination_type</code> is <code>cloudwatch</code>. Valid log types are <code>connectionlog</code>, <code>userlog</code>, and <code>useractivitylog</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
