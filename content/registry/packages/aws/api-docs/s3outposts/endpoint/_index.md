...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accesstype_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Type</a>
    ...
    <dd><p>Type of access for the network connectivity. Valid values are <code>Private</code> or <code>CustomerOwnedIp</code>.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customerownedipv4pool_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Owned<wbr>Ipv4Pool</a>
    ...
    <dd><p>The ID of a Customer Owned IP Pool. For more on customer owned IP addresses see the <a href="https://docs.aws.amazon.com/outposts/latest/userguide/local-rack.html#local-gateway-subnet">User Guide</a>.</p>
</dd></dl>
</pulumi-choosable>
</div>
