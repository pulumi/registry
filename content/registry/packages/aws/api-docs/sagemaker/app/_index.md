...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:sagemaker:App</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apptype_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Type</a>
    ...
    <dd><p>The type of app. Valid values are <code>JupyterServer</code>, <code>KernelGateway</code>, <code>RStudioServerPro</code>, <code>RSessionGateway</code> and <code>TensorBoard</code>.</p>
</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcespec_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appresourcespec">Pulumi.<wbr>Aws.<wbr>Sagemaker.<wbr>Inputs.<wbr>App<wbr>Resource<wbr>Spec<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spacename_csharp" style="color: inherit; text-decoration: inherit;">Space<wbr>Name</a>
    ...
    <dd><p>The name of the space. At least one of <code>user_profile_name</code> or <code>space_name</code> required.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userprofilename_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Profile<wbr>Name</a>
    ...
    <dd><p>The user profile name. At least one of <code>user_profile_name</code> or <code>space_name</code> required.</p>
</dd></dl>
</pulumi-choosable>
</div>
