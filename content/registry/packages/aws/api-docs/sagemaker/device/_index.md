...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:sagemaker:Device</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#devicedetails_csharp" style="color: inherit; text-decoration: inherit;">Device<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#devicedevice">Pulumi.<wbr>Aws.<wbr>Sagemaker.<wbr>Inputs.<wbr>Device<wbr>Device<wbr>Args</a></span>
    </dt>
