...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancemetadataserviceconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Metadata<wbr>Service<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#notebookinstanceinstancemetadataserviceconfiguration">Pulumi.<wbr>Aws.<wbr>Sagemaker.<wbr>Inputs.<wbr>Notebook<wbr>Instance<wbr>Instance<wbr>Metadata<wbr>Service<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<h4 id="notebookinstanceinstancemetadataserviceconfiguration">Notebook<wbr>Instance<wbr>Instance<wbr>Metadata<wbr>Service<wbr>Configuration</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minimuminstancemetadataserviceversion_csharp" style="color: inherit; text-decoration: inherit;">Minimum<wbr>Instance<wbr>Metadata<wbr>Service<wbr>Version</a>
    ...
    <dd><p>Indicates the minimum IMDS version that the notebook instance supports. When passed &quot;1&quot; is passed. This means that both IMDSv1 and IMDSv2 are supported. Valid values are <code>1</code> and <code>2</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
