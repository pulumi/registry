...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultdimensionvalue_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Dimension<wbr>Value</a>
    ...
    <dd><p>The default value of the dimension that is published to Amazon CloudWatch if you don't provide the value of the dimension when you send an email.
( <code>dimension_name</code> - (Required) The name of an Amazon CloudWatch dimension associated with an email sending metric.</p>
</dd><dt class="property-required"
            title="Required">
