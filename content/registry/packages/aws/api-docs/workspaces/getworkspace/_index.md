...
<span class="k">&nbsp;&nbsp;function:</span> aws:workspaces/getWorkspace:getWorkspace
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#directoryid_csharp" style="color: inherit; text-decoration: inherit;">Directory<wbr>Id</a>
    ...
    <dd><p>ID of the directory for the WorkSpace. You have to specify <code>user_name</code> along with <code>directory_id</code>. You cannot combine this parameter with <code>workspace_id</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd><p>User name of the user for the WorkSpace. This user name must exist in the directory for the WorkSpace. You cannot combine this parameter with <code>workspace_id</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#workspaceid_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Id</a>
    ...
    <dd><p>ID of the WorkSpace. You cannot combine this parameter with <code>directory_id</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#computername_csharp" style="color: inherit; text-decoration: inherit;">Computer<wbr>Name</a>
    ...
    <dd><p>Name of the WorkSpace, as seen by the operating system.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipaddress_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address</a>
    ...
    <dd><p>IP address of the WorkSpace.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd><p>Operational state of the WorkSpace.</p>
</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#workspaceproperties_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getworkspaceworkspaceproperty">List&lt;Pulumi.<wbr>Aws.<wbr>Workspaces.<wbr>Outputs.<wbr>Get<wbr>Workspace<wbr>Workspace<wbr>Property&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#workspaceproperties_yaml" style="color: inherit; text-decoration: inherit;">workspace<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getworkspaceworkspaceproperty">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#computetypename_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Type<wbr>Name</a>
    ...
    <dd><p>Compute type. For more information, see <a href="http://aws.amazon.com/workspaces/details/#Amazon_WorkSpaces_Bundles">Amazon WorkSpaces Bundles</a>. Valid values are <code>VALUE</code>, <code>STANDARD</code>, <code>PERFORMANCE</code>, <code>POWER</code>, <code>GRAPHICS</code>, <code>POWERPRO</code> and <code>GRAPHICSPRO</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rootvolumesizegib_csharp" style="color: inherit; text-decoration: inherit;">Root<wbr>Volume<wbr>Size<wbr>Gib</a>
    ...
    <dd><p>Size of the root volume.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runningmode_csharp" style="color: inherit; text-decoration: inherit;">Running<wbr>Mode</a>
    ...
    <dd><p>Running mode. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/running-mode.html">Manage the WorkSpace Running Mode</a>. Valid values are <code>AUTO_STOP</code> and <code>ALWAYS_ON</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runningmodeautostoptimeoutinminutes_csharp" style="color: inherit; text-decoration: inherit;">Running<wbr>Mode<wbr>Auto<wbr>Stop<wbr>Timeout<wbr>In<wbr>Minutes</a>
    ...
    <dd><p>Time after a user logs off when WorkSpaces are automatically stopped. Configured in 60-minute intervals.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uservolumesizegib_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Volume<wbr>Size<wbr>Gib</a>
    ...
    <dd><p>Size of the user storage.</p>
</dd></dl>
</pulumi-choosable>
</div>
