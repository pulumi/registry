...
title_tag: "kubernetes.apiregistration.k8s.io/v1.APIServicePatch"
meta_desc: "Documentation for the kubernetes.apiregistration.k8s.io/v1.APIServicePatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">APIServicePatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_apiregistration_k8s_io.v1.APIServiceSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apiregistration.k8s.io/v1:APIServicePatch</span><span class="p"></span>
