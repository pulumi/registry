...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apiregistration.k8s.io/v1beta1:APIServiceList</span><span class="p"></span>
