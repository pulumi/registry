...
## Create ControllerRevision Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apps/v1beta1:ControllerRevision</span><span class="p"></span>
