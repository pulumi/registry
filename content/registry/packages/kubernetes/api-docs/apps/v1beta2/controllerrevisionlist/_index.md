...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apps/v1beta2:ControllerRevisionList</span><span class="p"></span>
