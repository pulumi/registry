...
title_tag: "kubernetes.apps/v1beta2.ControllerRevisionPatch"
meta_desc: "Documentation for the kubernetes.apps/v1beta2.ControllerRevisionPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apps/v1beta2:ControllerRevisionPatch</span><span class="p"></span>
