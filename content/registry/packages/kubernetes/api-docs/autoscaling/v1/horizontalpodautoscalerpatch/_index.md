...
title_tag: "kubernetes.autoscaling/v1.HorizontalPodAutoscalerPatch"
meta_desc: "Documentation for the kubernetes.autoscaling/v1.HorizontalPodAutoscalerPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:autoscaling/v1:HorizontalPodAutoscalerPatch</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd><p>spec defines the behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxreplicas_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Replicas</a>
    ...
    <dd><p>maxReplicas is the upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetcpuutilizationpercentage_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>CPUUtilization<wbr>Percentage</a>
    ...
    <dd><p>targetCPUUtilizationPercentage is the target average CPU utilization (represented as a percentage of requested CPU) over all the pods; if not specified the default autoscaling policy will be used.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentcpuutilizationpercentage_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>CPUUtilization<wbr>Percentage</a>
    ...
    <dd><p>currentCPUUtilizationPercentage is the current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Replicas</a>
    ...
    <dd><p>currentReplicas is the current number of replicas of pods managed by this autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>Replicas</a>
    ...
    <dd><p>desiredReplicas is the  desired number of replicas of pods managed by this autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
