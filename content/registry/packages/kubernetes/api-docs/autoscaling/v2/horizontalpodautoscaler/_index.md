...
title_tag: "kubernetes.autoscaling/v2.HorizontalPodAutoscaler"
meta_desc: "Documentation for the kubernetes.autoscaling/v2.HorizontalPodAutoscaler resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create HorizontalPodAutoscaler Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:autoscaling/v2:HorizontalPodAutoscaler</span><span class="p"></span>
