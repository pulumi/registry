...
title_tag: "kubernetes.autoscaling/v2beta1.HorizontalPodAutoscalerPatch"
meta_desc: "Documentation for the kubernetes.autoscaling/v2beta1.HorizontalPodAutoscalerPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:autoscaling/v2beta1:HorizontalPodAutoscalerPatch</span><span class="p"></span>
