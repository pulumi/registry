...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:events.k8s.io/v1beta1:EventList</span><span class="p"></span>
