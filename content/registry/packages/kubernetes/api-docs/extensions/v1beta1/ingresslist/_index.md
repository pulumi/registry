...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:extensions/v1beta1:IngressList</span><span class="p"></span>
