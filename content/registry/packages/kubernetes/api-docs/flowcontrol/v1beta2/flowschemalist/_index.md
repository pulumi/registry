...
title_tag: "kubernetes.flowcontrol.apiserver.k8s.io/v1beta2.FlowSchemaList"
meta_desc: "Documentation for the kubernetes.flowcontrol.apiserver.k8s.io/v1beta2.FlowSchemaList resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">FlowSchemaList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_flowcontrol_apiserver_k8s_io.v1beta2.FlowSchemaArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList</span><span class="p"></span>
