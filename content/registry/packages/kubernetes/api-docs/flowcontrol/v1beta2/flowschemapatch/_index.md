...
title_tag: "kubernetes.flowcontrol.apiserver.k8s.io/v1beta2.FlowSchemaPatch"
meta_desc: "Documentation for the kubernetes.flowcontrol.apiserver.k8s.io/v1beta2.FlowSchemaPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">FlowSchemaPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_flowcontrol_apiserver_k8s_io.v1beta2.FlowSchemaSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaPatch</span><span class="p"></span>
