...
## Create IngressClass Resource {#create}
<div>
...
<span class="k">def </span><span class="nx">IngressClass</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_networking_k8s_io.v1.IngressClassSpecArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:networking.k8s.io/v1:IngressClass</span><span class="p"></span>
