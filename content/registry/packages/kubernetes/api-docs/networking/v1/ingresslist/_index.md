...
## Create IngressList Resource {#create}
<div>
...
<span class="k">def </span><span class="nx">IngressList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_networking_k8s_io.v1.IngressArgs]]</span> = None<span class="p">,</span>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">IngressList</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">IngressListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">IngressList</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">IngressListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:networking.k8s.io/v1:IngressList</span><span class="p"></span>
...
The IngressList resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#items_yaml" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingress">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>items is the list of Ingress.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="ingressloadbalanceringress">Ingress<wbr>Load<wbr>Balancer<wbr>Ingress</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ports_csharp" style="color: inherit; text-decoration: inherit;">Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressportstatus">List&lt;Ingress<wbr>Port<wbr>Status&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ports_go" style="color: inherit; text-decoration: inherit;">Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressportstatus">[]Ingress<wbr>Port<wbr>Status</a></span>
    </dt>
    <dd><p>ports provides information about the ports exposed by this LoadBalancer.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ports_yaml" style="color: inherit; text-decoration: inherit;">ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressportstatus">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>ports provides information about the ports exposed by this LoadBalancer.</p>
</dd></dl>
</pulumi-choosable>
...
<h4 id="ingressloadbalancerstatus">Ingress<wbr>Load<wbr>Balancer<wbr>Status</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ingress_csharp" style="color: inherit; text-decoration: inherit;">Ingress</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressloadbalanceringress">List&lt;Ingress<wbr>Load<wbr>Balancer<wbr>Ingress&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ingress_go" style="color: inherit; text-decoration: inherit;">Ingress</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressloadbalanceringress">[]Ingress<wbr>Load<wbr>Balancer<wbr>Ingress</a></span>
    </dt>
    <dd><p>ingress is a list containing ingress points for the load-balancer.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ingress_yaml" style="color: inherit; text-decoration: inherit;">ingress</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressloadbalanceringress">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>ingress is a list containing ingress points for the load-balancer.</p>
</dd></dl>
</pulumi-choosable>
...
<h4 id="ingressportstatus">Ingress<wbr>Port<wbr>Status</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loadbalancer_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancer</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressloadbalancerstatus">Ingress<wbr>Load<wbr>Balancer<wbr>Status</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#loadbalancer_yaml" style="color: inherit; text-decoration: inherit;">load<wbr>Balancer</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressloadbalancerstatus">Property Map</a></span>
    </dt>
    <dd><p>loadBalancer contains the current status of the load-balancer.</p>
</dd></dl>
</pulumi-choosable>
