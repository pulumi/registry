...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:networking.k8s.io/v1beta1:Ingress</span><span class="p"></span>
