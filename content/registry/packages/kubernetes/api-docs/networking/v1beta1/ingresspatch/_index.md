...
---
title: "IngressPatch"
title_tag: "kubernetes.networking.k8s.io/v1beta1.IngressPatch"
meta_desc: "Documentation for the kubernetes.networking.k8s.io/v1beta1.IngressPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">IngressPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_networking_k8s_io.v1beta1.IngressSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:networking.k8s.io/v1beta1:IngressPatch</span><span class="p"></span>
