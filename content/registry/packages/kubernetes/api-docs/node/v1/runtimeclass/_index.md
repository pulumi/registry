...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:node.k8s.io/v1:RuntimeClass</span><span class="p"></span>
