...
title_tag: "kubernetes.node.k8s.io/v1beta1.RuntimeClassPatch"
meta_desc: "Documentation for the kubernetes.node.k8s.io/v1beta1.RuntimeClassPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">RuntimeClassPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">overhead</span><span class="p">:</span> <span class="nx">Optional[_node_k8s_io.v1beta1.OverheadPatchArgs]</span> = None<span class="p">,</span>
                      <span class="nx">scheduling</span><span class="p">:</span> <span class="nx">Optional[_node_k8s_io.v1beta1.SchedulingPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:node.k8s.io/v1beta1:RuntimeClassPatch</span><span class="p"></span>
