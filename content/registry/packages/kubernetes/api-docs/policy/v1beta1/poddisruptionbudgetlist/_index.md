...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:policy/v1beta1:PodDisruptionBudgetList</span><span class="p"></span>
