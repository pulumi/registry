...
---
title: "PodSecurityPolicyPatch"
title_tag: "kubernetes.policy/v1beta1.PodSecurityPolicyPatch"
meta_desc: "Documentation for the kubernetes.policy/v1beta1.PodSecurityPolicyPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create PodSecurityPolicyPatch Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">PodSecurityPolicyPatch</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[PodSecurityPolicySpecPatchArgs]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[PodSecurityPolicyPatchArgs]</a></span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">PodSecurityPolicyPatchArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PodSecurityPolicyPatch</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PodSecurityPolicyPatchArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PodSecurityPolicyPatchArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">PodSecurityPolicyPatch</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PodSecurityPolicyPatchArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:policy/v1beta1:PodSecurityPolicyPatch</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">PodSecurityPolicyPatch</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">PodSecurityPolicyPatchArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
## PodSecurityPolicyPatch Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs](/docs/intro/concepts/inputs-outputs) in the Architecture and Concepts docs.

### Inputs

The PodSecurityPolicyPatch resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsecuritypolicyspecpatch">Pod<wbr>Security<wbr>Policy<wbr>Spec<wbr>Patch<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_yaml" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsecuritypolicyspecpatch">Property Map</a></span>
    </dt>
    <dd><p>spec defines the policy enforced.</p>
</dd></dl>
</pulumi-choosable>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the PodSecurityPolicyPatch resource produces the following output properties:
...
<h4 id="allowedcsidriverpatch">Allowed<wbr>CSIDriver<wbr>Patch</h4>
...
<h4 id="allowedflexvolumepatch">Allowed<wbr>Flex<wbr>Volume<wbr>Patch</h4>
...
<h4 id="allowedhostpathpatch">Allowed<wbr>Host<wbr>Path<wbr>Patch</h4>
...
<h4 id="fsgroupstrategyoptionspatch">FSGroup<wbr>Strategy<wbr>Options<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ranges_csharp" style="color: inherit; text-decoration: inherit;">Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#idrangepatch">List&lt;IDRange<wbr>Patch&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ranges_go" style="color: inherit; text-decoration: inherit;">Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#idrangepatch">[]IDRange<wbr>Patch</a></span>
    </dt>
    <dd><p>ranges are the allowed ranges of fs groups.  If you would like to force a single fs group then supply a single range with the same start and end. Required for MustRunAs.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ranges_python" style="color: inherit; text-decoration: inherit;">ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#idrangepatch">Sequence[IDRange<wbr>Patch]</a></span>
    </dt>
    <dd><p>ranges are the allowed ranges of fs groups.  If you would like to force a single fs group then supply a single range with the same start and end. Required for MustRunAs.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ranges_yaml" style="color: inherit; text-decoration: inherit;">ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#idrangepatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>ranges are the allowed ranges of fs groups.  If you would like to force a single fs group then supply a single range with the same start and end. Required for MustRunAs.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="hostportrangepatch">Host<wbr>Port<wbr>Range<wbr>Patch</h4>
...
<h4 id="idrangepatch">IDRange<wbr>Patch</h4>
...
<h4 id="podsecuritypolicyspecpatch">Pod<wbr>Security<wbr>Policy<wbr>Spec<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedcsidrivers_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>CSIDrivers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedcsidriverpatch">List&lt;Allowed<wbr>CSIDriver<wbr>Patch&gt;</a></span>
    </dt>
    <dd><p>AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedflexvolumes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Flex<wbr>Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedflexvolumepatch">List&lt;Allowed<wbr>Flex<wbr>Volume<wbr>Patch&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedhostpaths_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Host<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedhostpathpatch">List&lt;Allowed<wbr>Host<wbr>Path<wbr>Patch&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fsgroup_csharp" style="color: inherit; text-decoration: inherit;">Fs<wbr>Group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fsgroupstrategyoptionspatch">FSGroup<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostports_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostportrangepatch">List&lt;Host<wbr>Port<wbr>Range<wbr>Patch&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runasgroup_csharp" style="color: inherit; text-decoration: inherit;">Run<wbr>As<wbr>Group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runasgroupstrategyoptionspatch">Run<wbr>As<wbr>Group<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runasuser_csharp" style="color: inherit; text-decoration: inherit;">Run<wbr>As<wbr>User</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runasuserstrategyoptionspatch">Run<wbr>As<wbr>User<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runtimeclass_csharp" style="color: inherit; text-decoration: inherit;">Runtime<wbr>Class</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runtimeclassstrategyoptionspatch">Runtime<wbr>Class<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinux_csharp" style="color: inherit; text-decoration: inherit;">Se<wbr>Linux</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxstrategyoptionspatch">SELinux<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supplementalgroups_csharp" style="color: inherit; text-decoration: inherit;">Supplemental<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#supplementalgroupsstrategyoptionspatch">Supplemental<wbr>Groups<wbr>Strategy<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedcsidrivers_go" style="color: inherit; text-decoration: inherit;">Allowed<wbr>CSIDrivers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedcsidriverpatch">[]Allowed<wbr>CSIDriver<wbr>Patch</a></span>
    </dt>
    <dd><p>AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedflexvolumes_go" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Flex<wbr>Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedflexvolumepatch">[]Allowed<wbr>Flex<wbr>Volume<wbr>Patch</a></span>
    </dt>
    <dd><p>allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the &quot;volumes&quot; field.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedhostpaths_go" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Host<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedhostpathpatch">[]Allowed<wbr>Host<wbr>Path<wbr>Patch</a></span>
    </dt>
    <dd><p>allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostports_go" style="color: inherit; text-decoration: inherit;">Host<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostportrangepatch">[]Host<wbr>Port<wbr>Range<wbr>Patch</a></span>
    </dt>
    <dd><p>hostPorts determines which host port ranges are allowed to be exposed.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_csi_drivers_python" style="color: inherit; text-decoration: inherit;">allowed_<wbr>csi_<wbr>drivers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedcsidriverpatch">Sequence[Allowed<wbr>CSIDriver<wbr>Patch]</a></span>
    </dt>
    <dd><p>AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_flex_volumes_python" style="color: inherit; text-decoration: inherit;">allowed_<wbr>flex_<wbr>volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedflexvolumepatch">Sequence[Allowed<wbr>Flex<wbr>Volume<wbr>Patch]</a></span>
    </dt>
    <dd><p>allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the &quot;volumes&quot; field.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_host_paths_python" style="color: inherit; text-decoration: inherit;">allowed_<wbr>host_<wbr>paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedhostpathpatch">Sequence[Allowed<wbr>Host<wbr>Path<wbr>Patch]</a></span>
    </dt>
    <dd><p>allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#host_ports_python" style="color: inherit; text-decoration: inherit;">host_<wbr>ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostportrangepatch">Sequence[Host<wbr>Port<wbr>Range<wbr>Patch]</a></span>
    </dt>
    <dd><p>hostPorts determines which host port ranges are allowed to be exposed.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedcsidrivers_yaml" style="color: inherit; text-decoration: inherit;">allowed<wbr>CSIDrivers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedcsidriverpatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedflexvolumes_yaml" style="color: inherit; text-decoration: inherit;">allowed<wbr>Flex<wbr>Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedflexvolumepatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the &quot;volumes&quot; field.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedhostpaths_yaml" style="color: inherit; text-decoration: inherit;">allowed<wbr>Host<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowedhostpathpatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fsgroup_yaml" style="color: inherit; text-decoration: inherit;">fs<wbr>Group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fsgroupstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostports_yaml" style="color: inherit; text-decoration: inherit;">host<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostportrangepatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>hostPorts determines which host port ranges are allowed to be exposed.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runasgroup_yaml" style="color: inherit; text-decoration: inherit;">run<wbr>As<wbr>Group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runasgroupstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runasuser_yaml" style="color: inherit; text-decoration: inherit;">run<wbr>As<wbr>User</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runasuserstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#runtimeclass_yaml" style="color: inherit; text-decoration: inherit;">runtime<wbr>Class</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runtimeclassstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinux_yaml" style="color: inherit; text-decoration: inherit;">se<wbr>Linux</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>seLinux is the strategy that will dictate the allowable labels that may be set.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#supplementalgroups_yaml" style="color: inherit; text-decoration: inherit;">supplemental<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#supplementalgroupsstrategyoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="runasgroupstrategyoptionspatch">Run<wbr>As<wbr>Group<wbr>Strategy<wbr>Options<wbr>Patch</h4>
...
<h4 id="runasuserstrategyoptionspatch">Run<wbr>As<wbr>User<wbr>Strategy<wbr>Options<wbr>Patch</h4>
...
<h4 id="runtimeclassstrategyoptionspatch">Runtime<wbr>Class<wbr>Strategy<wbr>Options<wbr>Patch</h4>
...
<h4 id="selinuxoptionspatch">SELinux<wbr>Options<wbr>Patch</h4>
...
<h4 id="selinuxstrategyoptionspatch">SELinux<wbr>Strategy<wbr>Options<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinuxoptions_csharp" style="color: inherit; text-decoration: inherit;">Se<wbr>Linux<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxoptionspatch">Pulumi.<wbr>Kubernetes.<wbr>Core.<wbr>V1.<wbr>Inputs.<wbr>SELinux<wbr>Options<wbr>Patch</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinuxoptions_go" style="color: inherit; text-decoration: inherit;">Se<wbr>Linux<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxoptionspatch">SELinux<wbr>Options<wbr>Patch</a></span>
    </dt>
    <dd><p>seLinuxOptions required to run as; required for MustRunAs More info: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinuxoptions_nodejs" style="color: inherit; text-decoration: inherit;">se<wbr>Linux<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxoptionspatch">core.v1.<wbr>SELinux<wbr>Options<wbr>Patch</a></span>
    </dt>
    <dd><p>seLinuxOptions required to run as; required for MustRunAs More info: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selinuxoptions_yaml" style="color: inherit; text-decoration: inherit;">se<wbr>Linux<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selinuxoptionspatch">Property Map</a></span>
    </dt>
    <dd><p>seLinuxOptions required to run as; required for MustRunAs More info: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/</p>
</dd></dl>
</pulumi-choosable>
...
<h4 id="supplementalgroupsstrategyoptionspatch">Supplemental<wbr>Groups<wbr>Strategy<wbr>Options<wbr>Patch</h4>
