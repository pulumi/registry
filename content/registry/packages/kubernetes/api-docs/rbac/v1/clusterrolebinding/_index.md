...
<span class="k">def </span><span class="nx">ClusterRoleBinding</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">role_ref</span><span class="p">:</span> <span class="nx">Optional[_rbac_authorization_k8s_io.v1.RoleRefArgs]</span> = None<span class="p">,</span>
                       <span class="nx">subjects</span><span class="p">:</span> <span class="nx">Optional[Sequence[_rbac_authorization_k8s_io.v1.SubjectArgs]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBinding</span><span class="p"></span>
