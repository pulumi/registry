...
title_tag: "kubernetes.rbac.authorization.k8s.io/v1.ClusterRoleBindingPatch"
meta_desc: "Documentation for the kubernetes.rbac.authorization.k8s.io/v1.ClusterRoleBindingPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">ClusterRoleBindingPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                            ...
                            <span class="nx">role_ref</span><span class="p">:</span> <span class="nx">Optional[_rbac_authorization_k8s_io.v1.RoleRefPatchArgs]</span> = None<span class="p">,</span>
                            <span class="nx">subjects</span><span class="p">:</span> <span class="nx">Optional[Sequence[_rbac_authorization_k8s_io.v1.SubjectPatchArgs]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBindingPatch</span><span class="p"></span>
