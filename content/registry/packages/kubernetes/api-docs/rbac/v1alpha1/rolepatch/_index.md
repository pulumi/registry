...
---
title: "RolePatch"
title_tag: "kubernetes.rbac.authorization.k8s.io/v1alpha1.RolePatch"
meta_desc: "Documentation for the kubernetes.rbac.authorization.k8s.io/v1alpha1.RolePatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1alpha1:RolePatch</span><span class="p"></span>
