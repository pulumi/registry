...
title_tag: "kubernetes.rbac.authorization.k8s.io/v1beta1.ClusterRolePatch"
meta_desc: "Documentation for the kubernetes.rbac.authorization.k8s.io/v1beta1.ClusterRolePatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">ClusterRolePatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">aggregation_rule</span><span class="p">:</span> <span class="nx">Optional[_rbac_authorization_k8s_io.v1beta1.AggregationRulePatchArgs]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">rules</span><span class="p">:</span> <span class="nx">Optional[Sequence[_rbac_authorization_k8s_io.v1beta1.PolicyRulePatchArgs]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRolePatch</span><span class="p"></span>
