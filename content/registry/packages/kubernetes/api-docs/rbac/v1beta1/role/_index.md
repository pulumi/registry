...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1beta1:Role</span><span class="p"></span>
