...
title_tag: "kubernetes.rbac.authorization.k8s.io/v1beta1.RoleBindingPatch"
meta_desc: "Documentation for the kubernetes.rbac.authorization.k8s.io/v1beta1.RoleBindingPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingPatch</span><span class="p"></span>
