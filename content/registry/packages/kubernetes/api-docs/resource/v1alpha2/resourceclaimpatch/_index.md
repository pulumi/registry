...
---
title: "ResourceClaimPatch"
title_tag: "kubernetes.resource.k8s.io/v1alpha2.ResourceClaimPatch"
meta_desc: "Documentation for the kubernetes.resource.k8s.io/v1alpha2.ResourceClaimPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ResourceClaimPatch Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">ResourceClaimPatch</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_resource_k8s_io.v1alpha2.ResourceClaimSpecPatchArgs]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[ResourceClaimPatchArgs]</a></span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewResourceClaimPatch</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">ResourceClaimPatchArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ResourceClaimPatch</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ResourceClaimPatchArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ResourceClaimPatchArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ResourceClaimPatch</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ResourceClaimPatchArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:resource.k8s.io/v1alpha2:ResourceClaimPatch</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ResourceClaimPatch</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ResourceClaimPatchArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
## ResourceClaimPatch Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs](/docs/intro/concepts/inputs-outputs) in the Architecture and Concepts docs.

### Inputs

The ResourceClaimPatch resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimspecpatch">Resource<wbr>Claim<wbr>Spec<wbr>Patch<wbr>Args</a></span>
    </dt>
    <dd><p>Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_yaml" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimspecpatch">Property Map</a></span>
    </dt>
    <dd><p>Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim.</p>
</dd></dl>
</pulumi-choosable>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ResourceClaimPatch resource produces the following output properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimstatuspatch">Resource<wbr>Claim<wbr>Status<wbr>Patch</a></span>
    </dt>
    <dd><p>Status describes whether the resource is available and with which attributes.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_yaml" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimstatuspatch">Property Map</a></span>
    </dt>
    <dd><p>Status describes whether the resource is available and with which attributes.</p>
</dd></dl>
</pulumi-choosable>
...
<h4 id="allocationresultpatch">Allocation<wbr>Result<wbr>Patch</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="availableonnodes_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availableonnodes_csharp" style="color: inherit; text-decoration: inherit;">Available<wbr>On<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd><p>This field will get set by the resource driver after it has allocated the resource to inform the scheduler where it can schedule Pods using the ResourceClaim.</p>
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="resourcehandles_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcehandles_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">List&lt;Resource<wbr>Handle<wbr>Patch&gt;</a></span>
    </dt>
    <dd><p>ResourceHandles contain the state associated with an allocation that should be maintained throughout the lifetime of a claim. Each ResourceHandle contains data that should be passed to a specific kubelet plugin once it lands on a node. This data is returned by the driver after a successful allocation and is opaque to Kubernetes. Driver documentation may explain to users how to interpret this data if needed.</p>
<p>Setting this field is optional. It has a maximum size of 32 entries. If null (or empty), it is assumed this allocation will be processed by a single kubelet plugin with no ResourceHandle data attached. The name of the kubelet plugin invoked will match the DriverName set in the ResourceClaimStatus this AllocationResult is embedded in.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#shareable_csharp" style="color: inherit; text-decoration: inherit;">Shareable</a>
    ...
    <dd><p>Shareable determines whether the resource supports more than one consumer at a time.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="availableonnodes_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availableonnodes_go" style="color: inherit; text-decoration: inherit;">Available<wbr>On<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
...
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
            ...
            title="Optional">
        <span id="resourcehandles_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcehandles_go" style="color: inherit; text-decoration: inherit;">Resource<wbr>Handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">[]Resource<wbr>Handle<wbr>Patch</a></span>
    </dt>
    <dd><p>ResourceHandles contain the state associated with an allocation that should be maintained throughout the lifetime of a claim. Each ResourceHandle contains data that should be passed to a specific kubelet plugin once it lands on a node. This data is returned by the driver after a successful allocation and is opaque to Kubernetes. Driver documentation may explain to users how to interpret this data if needed.</p>
<p>Setting this field is optional. It has a maximum size of 32 entries. If null (or empty), it is assumed this allocation will be processed by a single kubelet plugin with no ResourceHandle data attached. The name of the kubelet plugin invoked will match the DriverName set in the ResourceClaimStatus this AllocationResult is embedded in.</p>
</dd><dt class="property-optional"
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="availableonnodes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availableonnodes_java" style="color: inherit; text-decoration: inherit;">available<wbr>On<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodeselectorpatch">Node<wbr>Selector<wbr>Patch</a></span>
    </dt>
...
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
            ...
            title="Optional">
        <span id="resourcehandles_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcehandles_java" style="color: inherit; text-decoration: inherit;">resource<wbr>Handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">List&lt;Resource<wbr>Handle<wbr>Patch&gt;</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="availableonnodes_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availableonnodes_nodejs" style="color: inherit; text-decoration: inherit;">available<wbr>On<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
...
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
            ...
            title="Optional">
        <span id="resourcehandles_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcehandles_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">Resource<wbr>Handle<wbr>Patch[]</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="available_on_nodes_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#available_on_nodes_python" style="color: inherit; text-decoration: inherit;">available_<wbr>on_<wbr>nodes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodeselectorpatch">Node<wbr>Selector<wbr>Patch</a></span>
    </dt>
...
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
            ...
            title="Optional">
        <span id="resource_handles_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_handles_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">Resource<wbr>Handle<wbr>Patch]</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="availableonnodes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availableonnodes_yaml" style="color: inherit; text-decoration: inherit;">available<wbr>On<wbr>Nodes</a>
</span>
        <span class="property-indicator"></span>
...
<p>Setting this field is optional. If null, the resource is available everywhere.</p>
            ...
            title="Optional">
        <span id="resourcehandles_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcehandles_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Handles</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcehandlepatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>ResourceHandles contain the state associated with an allocation that should be maintained throughout the lifetime of a claim. Each ResourceHandle contains data that should be passed to a specific kubelet plugin once it lands on a node. This data is returned by the driver after a successful allocation and is opaque to Kubernetes. Driver documentation may explain to users how to interpret this data if needed.</p>
<p>Setting this field is optional. It has a maximum size of 32 entries. If null (or empty), it is assumed this allocation will be processed by a single kubelet plugin with no ResourceHandle data attached. The name of the kubelet plugin invoked will match the DriverName set in the ResourceClaimStatus this AllocationResult is embedded in.</p>
</dd><dt class="property-optional"
...
<h4 id="resourceclaimconsumerreferencepatch">Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apigroup_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Group</a>
    ...
    <dd><p>APIGroup is the group for the resource being referenced. It is empty for the core API. This matches the group in the APIVersion that is used when creating the resources.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
    ...
    <dd><p>Resource is the type of resource being referenced, for example &quot;pods&quot;.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="uid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uid_csharp" style="color: inherit; text-decoration: inherit;">Uid</a>
    ...
    <dd><p>UID identifies exactly one incarnation of the resource.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd><p>Kind is the type of resource being referenced. This is the same value as in the parameter object's metadata, for example &quot;ConfigMap&quot;.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<h4 id="resourceclaimspecpatch">Resource<wbr>Claim<wbr>Spec<wbr>Patch</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocationmode_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationmode_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="parametersref_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametersref_csharp" style="color: inherit; text-decoration: inherit;">Parameters<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</a></span>
    </dt>
    <dd><p>ParametersRef references a separate object with arbitrary parameters that will be used by the driver when allocating a resource for the claim.</p>
<p>The object must be in the same namespace as the ResourceClaim.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="resourceclassname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceclassname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Class<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>ResourceClassName references the driver and additional parameters via the name of a ResourceClass that was created as part of the driver deployment.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocationmode_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationmode_go" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
            ...
            title="Optional">
        <span id="parametersref_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametersref_go" style="color: inherit; text-decoration: inherit;">Parameters<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</a></span>
    </dt>
...
<p>The object must be in the same namespace as the ResourceClaim.</p>
            ...
            title="Optional">
        <span id="resourceclassname_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceclassname_go" style="color: inherit; text-decoration: inherit;">Resource<wbr>Class<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocationmode_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationmode_java" style="color: inherit; text-decoration: inherit;">allocation<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
            ...
            title="Optional">
        <span id="parametersref_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametersref_java" style="color: inherit; text-decoration: inherit;">parameters<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</a></span>
    </dt>
...
<p>The object must be in the same namespace as the ResourceClaim.</p>
            ...
            title="Optional">
        <span id="resourceclassname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceclassname_java" style="color: inherit; text-decoration: inherit;">resource<wbr>Class<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocationmode_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationmode_nodejs" style="color: inherit; text-decoration: inherit;">allocation<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
            ...
            title="Optional">
        <span id="parametersref_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametersref_nodejs" style="color: inherit; text-decoration: inherit;">parameters<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</a></span>
    </dt>
...
<p>The object must be in the same namespace as the ResourceClaim.</p>
            ...
            title="Optional">
        <span id="resourceclassname_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceclassname_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Class<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocation_mode_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_mode_python" style="color: inherit; text-decoration: inherit;">allocation_<wbr>mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
            ...
            title="Optional">
        <span id="parameters_ref_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parameters_ref_python" style="color: inherit; text-decoration: inherit;">parameters_<wbr>ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Resource<wbr>Claim<wbr>Parameters<wbr>Reference<wbr>Patch</a></span>
    </dt>
...
<p>The object must be in the same namespace as the ResourceClaim.</p>
            ...
            title="Optional">
        <span id="resource_class_name_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_class_name_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>class_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="allocationmode_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationmode_yaml" style="color: inherit; text-decoration: inherit;">allocation<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd><p>Allocation can start immediately or when a Pod wants to use the resource. &quot;WaitForFirstConsumer&quot; is the default.</p>
            ...
            title="Optional">
        <span id="parametersref_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#parametersref_yaml" style="color: inherit; text-decoration: inherit;">parameters<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimparametersreferencepatch">Property Map</a></span>
    </dt>
    <dd><p>ParametersRef references a separate object with arbitrary parameters that will be used by the driver when allocating a resource for the claim.</p>
<p>The object must be in the same namespace as the ResourceClaim.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="resourceclassname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceclassname_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Class<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="resourceclaimstatuspatch">Resource<wbr>Claim<wbr>Status<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_csharp" style="color: inherit; text-decoration: inherit;">Allocation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationresultpatch">Allocation<wbr>Result<wbr>Patch</a></span>
    </dt>
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="deallocationrequested_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocationrequested_csharp" style="color: inherit; text-decoration: inherit;">Deallocation<wbr>Requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd><p>DeallocationRequested indicates that a ResourceClaim is to be deallocated.</p>
<p>The driver then must deallocate this claim and reset the field together with clearing the Allocation field.</p>
<p>While DeallocationRequested is set, no new consumers may be added to ReservedFor.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_csharp" style="color: inherit; text-decoration: inherit;">Driver<wbr>Name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="reservedfor_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedfor_csharp" style="color: inherit; text-decoration: inherit;">Reserved<wbr>For</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">List&lt;Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch&gt;</a></span>
    </dt>
    <dd><p>ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_go" style="color: inherit; text-decoration: inherit;">Allocation</a>
    ...
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
            ...
            title="Optional">
        <span id="deallocationrequested_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocationrequested_go" style="color: inherit; text-decoration: inherit;">Deallocation<wbr>Requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_go" style="color: inherit; text-decoration: inherit;">Driver<wbr>Name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
            ...
            title="Optional">
        <span id="reservedfor_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedfor_go" style="color: inherit; text-decoration: inherit;">Reserved<wbr>For</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">[]Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch</a></span>
    </dt>
    <dd><p>ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started.</p>
<p>There can be at most 32 such reservations. This may get increased in the future, but not reduced.</p>
</dd></dl>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_java" style="color: inherit; text-decoration: inherit;">allocation</a>
    ...
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
            ...
            title="Optional">
        <span id="deallocationrequested_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocationrequested_java" style="color: inherit; text-decoration: inherit;">deallocation<wbr>Requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_java" style="color: inherit; text-decoration: inherit;">driver<wbr>Name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
            ...
            title="Optional">
        <span id="reservedfor_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedfor_java" style="color: inherit; text-decoration: inherit;">reserved<wbr>For</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">List&lt;Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_nodejs" style="color: inherit; text-decoration: inherit;">allocation</a>
    ...
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
            ...
            title="Optional">
        <span id="deallocationrequested_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocationrequested_nodejs" style="color: inherit; text-decoration: inherit;">deallocation<wbr>Requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_nodejs" style="color: inherit; text-decoration: inherit;">driver<wbr>Name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
            ...
            title="Optional">
        <span id="reservedfor_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedfor_nodejs" style="color: inherit; text-decoration: inherit;">reserved<wbr>For</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_python" style="color: inherit; text-decoration: inherit;">allocation</a>
    ...
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
            ...
            title="Optional">
        <span id="deallocation_requested_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocation_requested_python" style="color: inherit; text-decoration: inherit;">deallocation_<wbr>requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#driver_name_python" style="color: inherit; text-decoration: inherit;">driver_<wbr>name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
            ...
            title="Optional">
        <span id="reserved_for_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reserved_for_python" style="color: inherit; text-decoration: inherit;">reserved_<wbr>for</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">Resource<wbr>Claim<wbr>Consumer<wbr>Reference<wbr>Patch]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocation_yaml" style="color: inherit; text-decoration: inherit;">allocation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationresultpatch">Property Map</a></span>
    </dt>
    <dd><p>Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="deallocationrequested_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deallocationrequested_yaml" style="color: inherit; text-decoration: inherit;">deallocation<wbr>Requested</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_yaml" style="color: inherit; text-decoration: inherit;">driver<wbr>Name</a>
    ...
    <dd><p>DriverName is a copy of the driver name from the ResourceClass at the time when allocation started.</p>
            ...
            title="Optional">
        <span id="reservedfor_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reservedfor_yaml" style="color: inherit; text-decoration: inherit;">reserved<wbr>For</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceclaimconsumerreferencepatch">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started.</p>
<p>There can be at most 32 such reservations. This may get increased in the future, but not reduced.</p>
</dd></dl>
...
<h4 id="resourcehandlepatch">Resource<wbr>Handle<wbr>Patch</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#data_csharp" style="color: inherit; text-decoration: inherit;">Data</a>
    ...
    <dd><p>Data contains the opaque data associated with this ResourceHandle. It is set by the controller component of the resource driver whose name matches the DriverName set in the ResourceClaimStatus this ResourceHandle is embedded in. It is set at allocation time and is intended for processing by the kubelet plugin whose name matches the DriverName set in this ResourceHandle.</p>
<p>The maximum size of this field is 16KiB. This may get increased in the future, but not reduced.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="drivername_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#drivername_csharp" style="color: inherit; text-decoration: inherit;">Driver<wbr>Name</a>
    ...
    <dd><p>DriverName specifies the name of the resource driver whose kubelet plugin should be invoked to process this ResourceHandle's data once it lands on a node. This may differ from the DriverName set in ResourceClaimStatus this ResourceHandle is embedded in.</p>
</dd></dl>
</pulumi-choosable>
</div>
