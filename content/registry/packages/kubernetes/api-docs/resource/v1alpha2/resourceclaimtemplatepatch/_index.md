...
title_tag: "kubernetes.resource.k8s.io/v1alpha2.ResourceClaimTemplatePatch"
meta_desc: "Documentation for the kubernetes.resource.k8s.io/v1alpha2.ResourceClaimTemplatePatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">ResourceClaimTemplatePatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_resource_k8s_io.v1alpha2.ResourceClaimTemplateSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch</span><span class="p"></span>
