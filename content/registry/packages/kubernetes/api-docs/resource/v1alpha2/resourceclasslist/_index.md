...
title_tag: "kubernetes.resource.k8s.io/v1alpha2.ResourceClassList"
meta_desc: "Documentation for the kubernetes.resource.k8s.io/v1alpha2.ResourceClassList resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">ResourceClassList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_resource_k8s_io.v1alpha2.ResourceClassArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:resource.k8s.io/v1alpha2:ResourceClassList</span><span class="p"></span>
