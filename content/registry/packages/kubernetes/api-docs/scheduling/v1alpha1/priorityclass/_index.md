...
## Create PriorityClass Resource {#create}
<div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass</span><span class="p"></span>
