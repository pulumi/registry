...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:scheduling.k8s.io/v1beta1:PriorityClassList</span><span class="p"></span>
