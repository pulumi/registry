...
title_tag: "kubernetes.scheduling.k8s.io/v1beta1.PriorityClassPatch"
meta_desc: "Documentation for the kubernetes.scheduling.k8s.io/v1beta1.PriorityClassPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:scheduling.k8s.io/v1beta1:PriorityClassPatch</span><span class="p"></span>
