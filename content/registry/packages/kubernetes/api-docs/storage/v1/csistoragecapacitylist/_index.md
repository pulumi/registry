...
title_tag: "kubernetes.storage.k8s.io/v1.CSIStorageCapacityList"
meta_desc: "Documentation for the kubernetes.storage.k8s.io/v1.CSIStorageCapacityList resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create CSIStorageCapacityList Resource {#create}
<div>
...
<span class="k">def </span><span class="nx">CSIStorageCapacityList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_storage_k8s_io.v1.CSIStorageCapacityArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:storage.k8s.io/v1:CSIStorageCapacityList</span><span class="p"></span>
