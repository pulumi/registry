...
title_tag: "kubernetes.storage.k8s.io/v1beta1.CSIDriverPatch"
meta_desc: "Documentation for the kubernetes.storage.k8s.io/v1beta1.CSIDriverPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">CSIDriverPatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_storage_k8s_io.v1beta1.CSIDriverSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:storage.k8s.io/v1beta1:CSIDriverPatch</span><span class="p"></span>
