...
---
title: "CSINodePatch"
title_tag: "kubernetes.storage.k8s.io/v1beta1.CSINodePatch"
meta_desc: "Documentation for the kubernetes.storage.k8s.io/v1beta1.CSINodePatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">CSINodePatch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_storage_k8s_io.v1beta1.CSINodeSpecPatchArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:storage.k8s.io/v1beta1:CSINodePatch</span><span class="p"></span>
