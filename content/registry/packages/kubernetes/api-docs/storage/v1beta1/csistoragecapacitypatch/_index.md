...
title_tag: "kubernetes.storage.k8s.io/v1beta1.CSIStorageCapacityPatch"
meta_desc: "Documentation for the kubernetes.storage.k8s.io/v1beta1.CSIStorageCapacityPatch resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityPatch</span><span class="p"></span>
