...
glob.sync("themes/default/content/registry/packages/**/_index.md").forEach(
    (path) => {
        /**
        ...
        if (
            path ===
            "themes/default/content/registry/packages/rancher2/api-docs/nodetemplate/_index.md"
        ) {
            ...
            const fenceCount = lines.map((line) =>
                line.startsWith("```"),
            ).length;
            if (
                precedingLine &&
                maybeBadLine &&
                lines[maybeBadLine].trim() === "```" &&
                fenceCount % 2 !== 0
            ) {
