...
post_github_pr_comment \
    "Your site preview for commit $(git_sha_short) is ready! :tada:\n\n${s3_website_url}/registry.\n\nRegistry site previews only include API docs for the AWS and Aiven packages by default.  You will not be able to navigate to other docs from the preview link. How-to guides for all packages are also incomplete." \
