---
title: "AWS Go LangServe Example | Go"
h1: "AWS Go LangServe Example"
linktitle: "AWS Go LangServe Example"
meta_desc: "AWS Go LangServe Example How-to Guide using Go"
...
<p class="mb-4 flex">
    <a class="flex flex-wrap items-center rounded-md font-display text-lg text-white bg-blue-600 border-2 border-blue-600 px-2 mr-2 whitespace-no-wrap hover:text-white" style="height: 45px;" href="https://github.com/pulumi/examples/tree/master/aws-go-langserve" target="_blank">
