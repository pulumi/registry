---
title: "EKS GPU Dynamic Resource Allocation (DRA) Demo | TypeScript"
h1: "EKS GPU Dynamic Resource Allocation (DRA) Demo"
linktitle: "EKS GPU Dynamic Resource Allocation (DRA) Demo"
meta_desc: "EKS GPU Dynamic Resource Allocation (DRA) Demo How-to Guide using TypeScript"
...
<p class="mb-4 inline-flex items-center">
    <a class="rounded-md font-display text-lg text-white bg-white border-2 border-blue-600 px-3 mr-2 whitespace-no-wrap hover:text-white" style="height: 45px; line-height: 41px;" href="https://github.com/pulumi/examples/tree/master/aws-ts-eks-gpu-dra" target="_blank">
