...
<p class="mb-4 inline-flex items-center">
    <a class="btn btn-primary no-underline mr-2 h-[46px] gap-2" href="https://github.com/pulumi/examples/tree/master/aws-ts-esc-external-adapter-lambda" target="_blank">
