...
## Migrating with `pulumi up`

If you have reliable backups or test account scenarios where deleting and re-creating buckets is acceptable, a simpler
form of migration path is to rewrite the deprecated inputs to the new form and perform a `pulumi up`.
