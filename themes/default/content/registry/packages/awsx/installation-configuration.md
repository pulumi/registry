...
Use `pulumi config set aws:<option>` or pass options to the [constructor of `new awsz.Provider`]({{< relref "/registry/packages/awsx/api-docs/provider" >}}).
