...
title_tag: "azure-native.apicenter.MetadataSchema"
meta_desc: "Documentation for the azure-native.apicenter.MetadataSchema resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create MetadataSchema Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">assigned_to</span><span class="p">:</span> <span class="nx">Optional[Sequence[MetadataAssignmentArgs]]</span> = None<span class="p">,</span>
                   <span class="nx">metadata_schema_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewMetadataSchema</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">MetadataSchema</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">MetadataSchema</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">MetadataSchemaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:apicenter:MetadataSchema</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">MetadataSchemaArgs</a></span>
    </dt>
...
## MetadataSchema Resource Properties {#properties}
...
The MetadataSchema resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
    ...
    <dd>The schema defining the type.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#servicename_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Name</a>
    ...
    <dd>The name of Azure API Center service.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignedto_csharp" style="color: inherit; text-decoration: inherit;">Assigned<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Center.<wbr>Inputs.<wbr>Metadata<wbr>Assignment&gt;</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadataschemaname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataschemaname_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Schema<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of the metadata schema.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignedto_go" style="color: inherit; text-decoration: inherit;">Assigned<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">[]Metadata<wbr>Assignment<wbr>Args</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadataschemaname_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataschemaname_go" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Schema<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignedto_java" style="color: inherit; text-decoration: inherit;">assigned<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">List&lt;Metadata<wbr>Assignment&gt;</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadataschemaname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataschemaname_java" style="color: inherit; text-decoration: inherit;">metadata<wbr>Schema<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignedto_nodejs" style="color: inherit; text-decoration: inherit;">assigned<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">Metadata<wbr>Assignment[]</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadataschemaname_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataschemaname_nodejs" style="color: inherit; text-decoration: inherit;">metadata<wbr>Schema<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assigned_to_python" style="color: inherit; text-decoration: inherit;">assigned_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">Sequence[Metadata<wbr>Assignment<wbr>Args]</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadata_schema_name_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadata_schema_name_python" style="color: inherit; text-decoration: inherit;">metadata_<wbr>schema_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assignedto_yaml" style="color: inherit; text-decoration: inherit;">assigned<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataassignment">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>The assignees</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="metadataschemaname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataschemaname_yaml" style="color: inherit; text-decoration: inherit;">metadata<wbr>Schema<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the MetadataSchema resource produces the following output properties:
...
<h4 id="metadataassignment">
Metadata<wbr>Assignment<pulumi-choosable type="language" values="python,go" class="inline">, Metadata<wbr>Assignment<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deprecated_csharp" style="color: inherit; text-decoration: inherit;">Deprecated</a>
    ...
    <dd>Deprecated assignment</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entity_csharp" style="color: inherit; text-decoration: inherit;">Entity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#metadataassignmententity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Center.<wbr>Metadata<wbr>Assignment<wbr>Entity</a></span>
    </dt>
    <dd>The entities this metadata schema component gets applied to.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entity_go" style="color: inherit; text-decoration: inherit;">Entity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#metadataassignmententity">Metadata<wbr>Assignment<wbr>Entity</a></span>
    </dt>
    <dd>The entities this metadata schema component gets applied to.</dd><dt class="property-optional"
            title="Optional">
        <span id="required_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entity_python" style="color: inherit; text-decoration: inherit;">entity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#metadataassignmententity">Metadata<wbr>Assignment<wbr>Entity</a></span>
    </dt>
    <dd>The entities this metadata schema component gets applied to.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#entity_yaml" style="color: inherit; text-decoration: inherit;">entity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#metadataassignmententity">&#34;api&#34; | &#34;environment&#34; | &#34;deployment&#34;</a></span>
    </dt>
    <dd>The entities this metadata schema component gets applied to.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="metadataassignmententity">
Metadata<wbr>Assignment<wbr>Entity<pulumi-choosable type="language" values="python,go" class="inline">, Metadata<wbr>Assignment<wbr>Entity<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Api</dt>
    <dd>apiAssigned to API</dd><dt>Environment</dt>
    <dd>environmentAssigned to Environment</dd><dt>Deployment</dt>
    <dd>deploymentAssigned to Deployment</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Metadata<wbr>Assignment<wbr>Entity<wbr>Api</dt>
    <dd>apiAssigned to API</dd><dt>Metadata<wbr>Assignment<wbr>Entity<wbr>Environment</dt>
    <dd>environmentAssigned to Environment</dd><dt>Metadata<wbr>Assignment<wbr>Entity<wbr>Deployment</dt>
    <dd>deploymentAssigned to Deployment</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="metadataassignmentresponse">
Metadata<wbr>Assignment<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Metadata<wbr>Assignment<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
