...
---
title: "Gateway"
title_tag: "azure-native.apimanagement.Gateway"
meta_desc: "Documentation for the azure-native.apimanagement.Gateway resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Gateway</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">location_data</span><span class="p">:</span> <span class="nx">Optional[ResourceLocationDataContractArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:apimanagement:Gateway</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Gateway description</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewayid_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Id</a>
    ...
    <dd>Gateway entity identifier. Must be unique in the current API Management service instance. Must not have value 'managed'</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#locationdata_csharp" style="color: inherit; text-decoration: inherit;">Location<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcelocationdatacontract">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Resource<wbr>Location<wbr>Data<wbr>Contract</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#locationdata_yaml" style="color: inherit; text-decoration: inherit;">location<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcelocationdatacontract">Property Map</a></span>
    </dt>
    <dd>Gateway location.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="resourcelocationdatacontract">
Resource<wbr>Location<wbr>Data<wbr>Contract<pulumi-choosable type="language" values="python,go" class="inline">, Resource<wbr>Location<wbr>Data<wbr>Contract<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="resourcelocationdatacontractresponse">
Resource<wbr>Location<wbr>Data<wbr>Contract<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Resource<wbr>Location<wbr>Data<wbr>Contract<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
