...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:apimanagement:Tag</span><span class="p"></span>
...
```csharp
var tagResource = new AzureNative.ApiManagement.Tag("tagResource", new()
{
    DisplayName = "string",
...
```python
tag_resource = azure_native.apimanagement.Tag("tagResource",
    display_name="string",
...
```typescript
const tagResource = new azure_native.apimanagement.Tag("tagResource", {
    displayName: "string",
    resourceGroupName: "string",
    serviceName: "string",
    tagId: "string",
