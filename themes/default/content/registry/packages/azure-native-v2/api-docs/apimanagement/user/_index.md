...
---
title: "User"
title_tag: "azure-native.apimanagement.User"
meta_desc: "Documentation for the azure-native.apimanagement.User resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">User</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">confirmation</span><span class="p">:</span> <span class="nx">Optional[Union[str, Confirmation]]</span> = None<span class="p">,</span>
         <span class="nx">identities</span><span class="p">:</span> <span class="nx">Optional[Sequence[UserIdentityContractArgs]]</span> = None<span class="p">,</span>
         ...
         <span class="nx">app_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, AppType]]</span> = None<span class="p">,</span>
         <span class="nx">state</span><span class="p">:</span> <span class="nx">Optional[Union[str, UserState]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:apimanagement:User</span><span class="p"></span>
...
var userResource = new AzureNative.ApiManagement.User("userResource", new()
{
    ...
    Identities = new[]
    {
        new AzureNative.ApiManagement.Inputs.UserIdentityContractArgs
        {
            Id = "string",
            Provider = "string",
        },
...
example, err := apimanagement.NewUser(ctx, "userResource", &apimanagement.UserArgs{
	...
	Identities: apimanagement.UserIdentityContractArray{
		&apimanagement.UserIdentityContractArgs{
...
var userResource = new User("userResource", UserArgs.builder()
    ...
    .serviceName("string")
    .confirmation("string")
    .identities(UserIdentityContractArgs.builder()
        .id("string")
        .provider("string")
        .build())
    .note("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#email_csharp" style="color: inherit; text-decoration: inherit;">Email</a>
    ...
    <dd>Email address. Must not be empty and must be unique within the service instance.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastname_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Name</a>
    ...
    <dd>Last name.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apptype_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Type</a>
    ...
    <dd>Determines the type of application which send the create user request. Default is legacy portal.</dd><dt class="property-optional"
            title="Optional">
        <span id="confirmation_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_csharp" style="color: inherit; text-decoration: inherit;">Confirmation</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>Determines the type of confirmation e-mail that will be sent to the newly created user.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#identities_csharp" style="color: inherit; text-decoration: inherit;">Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridentitycontract">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>User<wbr>Identity<wbr>Contract&gt;</a></span>
    </dt>
    <dd>Collection of user identities.</dd><dt class="property-optional"
            title="Optional">
        <span id="note_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#note_csharp" style="color: inherit; text-decoration: inherit;">Note</a>
    ...
    <dd>Optional note about a user set by the administrator.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#notify_csharp" style="color: inherit; text-decoration: inherit;">Notify</a>
    ...
    <dd>Send an Email notification to the User.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd>User Password. If no value is provided, a default password is generated.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_go" style="color: inherit; text-decoration: inherit;">Confirmation</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apptype_java" style="color: inherit; text-decoration: inherit;">app<wbr>Type</a>
    ...
    <dd>Determines the type of application which send the create user request. Default is legacy portal.</dd><dt class="property-optional"
            title="Optional">
        <span id="confirmation_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_java" style="color: inherit; text-decoration: inherit;">confirmation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#confirmation">Confirmation</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_nodejs" style="color: inherit; text-decoration: inherit;">confirmation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#confirmation">Confirmation</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_python" style="color: inherit; text-decoration: inherit;">confirmation</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apptype_yaml" style="color: inherit; text-decoration: inherit;">app<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#apptype">&#34;portal&#34; | &#34;developer<wbr>Portal&#34;</a></span>
    </dt>
    <dd>Determines the type of application which send the create user request. Default is legacy portal.</dd><dt class="property-optional"
            title="Optional">
        <span id="confirmation_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#confirmation_yaml" style="color: inherit; text-decoration: inherit;">confirmation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#confirmation">&#34;signup&#34; | &#34;invite&#34;</a></span>
    </dt>
    <dd>Determines the type of confirmation e-mail that will be sent to the newly created user.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#identities_yaml" style="color: inherit; text-decoration: inherit;">identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridentitycontract">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Collection of user identities.</dd><dt class="property-optional"
            title="Optional">
        <span id="note_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_yaml" style="color: inherit; text-decoration: inherit;">state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#userstate">&#34;active&#34; | &#34;blocked&#34; | &#34;pending&#34; | &#34;deleted&#34;</a></span>
    </dt>
    <dd>Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="userid_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registrationdate_csharp" style="color: inherit; text-decoration: inherit;">Registration<wbr>Date</a>
    ...
    <dd>Date of user registration. The date conforms to the following format: <code>yyyy-MM-ddTHH:mm:ssZ</code> as specified by the ISO 8601 standard.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>Portal</dt>
    <dd>portalUser create request was sent by legacy developer portal.</dd><dt>Developer<wbr>Portal</dt>
    <dd>developerPortalUser create request was sent by new developer portal.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>App<wbr>Type<wbr>Portal</dt>
    <dd>portalUser create request was sent by legacy developer portal.</dd><dt>App<wbr>Type<wbr>Developer<wbr>Portal</dt>
    <dd>developerPortalUser create request was sent by new developer portal.</dd></dl>
</pulumi-choosable>
</div>
...
<pulumi-choosable type="language" values="python">
<dl class="tabular"><dt>PORTAL</dt>
    <dd>portalUser create request was sent by legacy developer portal.</dd><dt>DEVELOPER_PORTAL</dt>
    <dd>developerPortalUser create request was sent by new developer portal.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="confirmation">
Confirmation<pulumi-choosable type="language" values="python,go" class="inline">, Confirmation<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Signup</dt>
    <dd>signupSend an e-mail to the user confirming they have successfully signed up.</dd><dt>Invite</dt>
    <dd>inviteSend an e-mail inviting the user to sign-up and complete registration.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>Confirmation<wbr>Signup</dt>
    <dd>signupSend an e-mail to the user confirming they have successfully signed up.</dd><dt>Confirmation<wbr>Invite</dt>
    <dd>inviteSend an e-mail inviting the user to sign-up and complete registration.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="useridentitycontract">
User<wbr>Identity<wbr>Contract<pulumi-choosable type="language" values="python,go" class="inline">, User<wbr>Identity<wbr>Contract<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="userstate">
User<wbr>State<pulumi-choosable type="language" values="python,go" class="inline">, User<wbr>State<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Active</dt>
    <dd>activeUser state is active.</dd><dt>Blocked</dt>
    <dd>blockedUser is blocked. Blocked users cannot authenticate at developer portal or call API.</dd><dt>Pending</dt>
    <dd>pendingUser account is pending. Requires identity confirmation before it can be made active.</dd><dt>Deleted</dt>
    <dd>deletedUser account is closed. All identities and related entities are removed.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>User<wbr>State<wbr>Active</dt>
    <dd>activeUser state is active.</dd><dt>User<wbr>State<wbr>Blocked</dt>
    <dd>blockedUser is blocked. Blocked users cannot authenticate at developer portal or call API.</dd><dt>User<wbr>State<wbr>Pending</dt>
    <dd>pendingUser account is pending. Requires identity confirmation before it can be made active.</dd><dt>User<wbr>State<wbr>Deleted</dt>
    <dd>deletedUser account is closed. All identities and related entities are removed.</dd></dl>
</pulumi-choosable>
</div>
