...
---
title: "WorkspaceApiDiagnostic"
title_tag: "azure-native.apimanagement.WorkspaceApiDiagnostic"
meta_desc: "Documentation for the azure-native.apimanagement.WorkspaceApiDiagnostic resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create WorkspaceApiDiagnostic Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">large_language_model</span><span class="p">:</span> <span class="nx">Optional[LLMDiagnosticSettingsArgs]</span> = None<span class="p">,</span>
                           ...
                           <span class="nx">backend</span><span class="p">:</span> <span class="nx">Optional[PipelineDiagnosticSettingsArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WorkspaceApiDiagnostic</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">WorkspaceApiDiagnostic</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:apimanagement:WorkspaceApiDiagnostic</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">WorkspaceApiDiagnosticArgs</a></span>
    </dt>
...
var workspaceApiDiagnosticResource = new AzureNative.ApiManagement.WorkspaceApiDiagnostic("workspaceApiDiagnosticResource", new()
{
    ...
    LargeLanguageModel = new AzureNative.ApiManagement.Inputs.LLMDiagnosticSettingsArgs
    {
        Logs = "string",
        Requests = new AzureNative.ApiManagement.Inputs.LLMMessageDiagnosticSettingsArgs
        {
            MaxSizeInBytes = 0,
            Messages = "string",
        },
        Responses = new AzureNative.ApiManagement.Inputs.LLMMessageDiagnosticSettingsArgs
        {
            MaxSizeInBytes = 0,
            Messages = "string",
        },
...
example, err := apimanagement.NewWorkspaceApiDiagnostic(ctx, "workspaceApiDiagnosticResource", &apimanagement.WorkspaceApiDiagnosticArgs{
	...
	LargeLanguageModel: &apimanagement.LLMDiagnosticSettingsArgs{
		Logs: pulumi.String("string"),
		Requests: &apimanagement.LLMMessageDiagnosticSettingsArgs{
			MaxSizeInBytes: pulumi.Int(0),
			Messages:       pulumi.String("string"),
		},
		Responses: &apimanagement.LLMMessageDiagnosticSettingsArgs{
			MaxSizeInBytes: pulumi.Int(0),
			Messages:       pulumi.String("string"),
		},
	},
...
var workspaceApiDiagnosticResource = new WorkspaceApiDiagnostic("workspaceApiDiagnosticResource", WorkspaceApiDiagnosticArgs.builder()
    ...
    .frontend(PipelineDiagnosticSettingsArgs.builder()
        ...
        .response(HttpMessageDiagnosticArgs.builder()
            ...
            .build())
        .build())
    .largeLanguageModel(LLMDiagnosticSettingsArgs.builder()
        .logs("string")
        .requests(LLMMessageDiagnosticSettingsArgs.builder()
            .maxSizeInBytes(0)
            .messages("string")
            .build())
        .responses(LLMMessageDiagnosticSettingsArgs.builder()
            .maxSizeInBytes(0)
            .messages("string")
            .build())
        .build())
...
## WorkspaceApiDiagnostic Resource Properties {#properties}
...
The WorkspaceApiDiagnostic resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpcorrelationprotocol_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Correlation<wbr>Protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="largelanguagemodel_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#largelanguagemodel_csharp" style="color: inherit; text-decoration: inherit;">Large<wbr>Language<wbr>Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>LLMDiagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Large Language Models diagnostic settings</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpcorrelationprotocol_go" style="color: inherit; text-decoration: inherit;">Http<wbr>Correlation<wbr>Protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="largelanguagemodel_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#largelanguagemodel_go" style="color: inherit; text-decoration: inherit;">Large<wbr>Language<wbr>Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">LLMDiagnostic<wbr>Settings<wbr>Args</a></span>
    </dt>
    <dd>Large Language Models diagnostic settings</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpcorrelationprotocol_java" style="color: inherit; text-decoration: inherit;">http<wbr>Correlation<wbr>Protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="largelanguagemodel_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#largelanguagemodel_java" style="color: inherit; text-decoration: inherit;">large<wbr>Language<wbr>Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">LLMDiagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Large Language Models diagnostic settings</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpcorrelationprotocol_nodejs" style="color: inherit; text-decoration: inherit;">http<wbr>Correlation<wbr>Protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="largelanguagemodel_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#largelanguagemodel_nodejs" style="color: inherit; text-decoration: inherit;">large<wbr>Language<wbr>Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">LLMDiagnostic<wbr>Settings</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#http_correlation_protocol_python" style="color: inherit; text-decoration: inherit;">http_<wbr>correlation_<wbr>protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="large_language_model_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#large_language_model_python" style="color: inherit; text-decoration: inherit;">large_<wbr>language_<wbr>model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">LLMDiagnostic<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpcorrelationprotocol_yaml" style="color: inherit; text-decoration: inherit;">http<wbr>Correlation<wbr>Protocol</a>
    ...
    <dd>Sets correlation protocol to use for Application Insights diagnostics.</dd><dt class="property-optional"
            title="Optional">
        <span id="largelanguagemodel_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#largelanguagemodel_yaml" style="color: inherit; text-decoration: inherit;">large<wbr>Language<wbr>Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmdiagnosticsettings">Property Map</a></span>
    </dt>
    <dd>Large Language Models diagnostic settings</dd><dt class="property-optional"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the WorkspaceApiDiagnostic resource produces the following output properties:
...
<h4 id="llmdiagnosticsettings">
LLMDiagnostic<wbr>Settings<pulumi-choosable type="language" values="python,go" class="inline">, LLMDiagnostic<wbr>Settings<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logs_csharp" style="color: inherit; text-decoration: inherit;">Logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#llmdiagnosticsettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Llm<wbr>Diagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Specifies whether default diagnostic should be enabled for Large Language Models or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_csharp" style="color: inherit; text-decoration: inherit;">Requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>LLMMessage<wbr>Diagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#responses_csharp" style="color: inherit; text-decoration: inherit;">Responses</a>
    ...
    <dd>Diagnostic settings for Large Language Models responses.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logs_go" style="color: inherit; text-decoration: inherit;">Logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#llmdiagnosticsettings">Llm<wbr>Diagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Specifies whether default diagnostic should be enabled for Large Language Models or not.</dd><dt class="property-optional"
            title="Optional">
        <span id="requests_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_go" style="color: inherit; text-decoration: inherit;">Requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettings">LLMMessage<wbr>Diagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logs_python" style="color: inherit; text-decoration: inherit;">logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#llmdiagnosticsettings">Llm<wbr>Diagnostic<wbr>Settings</a></span>
    </dt>
    <dd>Specifies whether default diagnostic should be enabled for Large Language Models or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#logs_yaml" style="color: inherit; text-decoration: inherit;">logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#llmdiagnosticsettings">&#34;enabled&#34; | &#34;disabled&#34;</a></span>
    </dt>
    <dd>Specifies whether default diagnostic should be enabled for Large Language Models or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_yaml" style="color: inherit; text-decoration: inherit;">requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettings">Property Map</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="llmdiagnosticsettingsresponse">
LLMDiagnostic<wbr>Settings<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, LLMDiagnostic<wbr>Settings<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_csharp" style="color: inherit; text-decoration: inherit;">Requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettingsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>LLMMessage<wbr>Diagnostic<wbr>Settings<wbr>Response</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
        <span id="responses_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_go" style="color: inherit; text-decoration: inherit;">Requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettingsresponse">LLMMessage<wbr>Diagnostic<wbr>Settings<wbr>Response</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
        <span id="responses_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requests_yaml" style="color: inherit; text-decoration: inherit;">requests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#llmmessagediagnosticsettingsresponse">Property Map</a></span>
    </dt>
    <dd>Diagnostic settings for Large Language Models requests.</dd><dt class="property-optional"
            title="Optional">
        <span id="responses_yaml">
...
<h4 id="llmmessagediagnosticsettings">
LLMMessage<wbr>Diagnostic<wbr>Settings<pulumi-choosable type="language" values="python,go" class="inline">, LLMMessage<wbr>Diagnostic<wbr>Settings<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="maxsizeinbytes_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsizeinbytes_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Size<wbr>In<wbr>Bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>Maximum size of message to logs in bytes. The default size is 32KB.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_csharp" style="color: inherit; text-decoration: inherit;">Messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#llmmessagelogtypes">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Llm<wbr>Message<wbr>Log<wbr>Types</a></span>
    </dt>
    <dd>Specifies which message should be logged. Currently there is only 'all' option.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="maxsizeinbytes_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsizeinbytes_go" style="color: inherit; text-decoration: inherit;">Max<wbr>Size<wbr>In<wbr>Bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_go" style="color: inherit; text-decoration: inherit;">Messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#llmmessagelogtypes">Llm<wbr>Message<wbr>Log<wbr>Types</a></span>
    </dt>
    <dd>Specifies which message should be logged. Currently there is only 'all' option.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="maxsizeinbytes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsizeinbytes_java" style="color: inherit; text-decoration: inherit;">max<wbr>Size<wbr>In<wbr>Bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="maxsizeinbytes_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsizeinbytes_nodejs" style="color: inherit; text-decoration: inherit;">max<wbr>Size<wbr>In<wbr>Bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="max_size_in_bytes_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#max_size_in_bytes_python" style="color: inherit; text-decoration: inherit;">max_<wbr>size_<wbr>in_<wbr>bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_python" style="color: inherit; text-decoration: inherit;">messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#llmmessagelogtypes">Llm<wbr>Message<wbr>Log<wbr>Types</a></span>
    </dt>
    <dd>Specifies which message should be logged. Currently there is only 'all' option.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="maxsizeinbytes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxsizeinbytes_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Size<wbr>In<wbr>Bytes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#messages_yaml" style="color: inherit; text-decoration: inherit;">messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#llmmessagelogtypes">&#34;all&#34;</a></span>
    </dt>
    <dd>Specifies which message should be logged. Currently there is only 'all' option.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="llmmessagediagnosticsettingsresponse">
LLMMessage<wbr>Diagnostic<wbr>Settings<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, LLMMessage<wbr>Diagnostic<wbr>Settings<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="llmdiagnosticsettings">
Llm<wbr>Diagnostic<wbr>Settings<pulumi-choosable type="language" values="python,go" class="inline">, Llm<wbr>Diagnostic<wbr>Settings<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Enabled</dt>
    <dd>enabledDefault LLM logs are enabled.</dd><dt>Disabled</dt>
    <dd>disabledDefault LLM logs are disabled.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Llm<wbr>Diagnostic<wbr>Settings<wbr>Enabled</dt>
    <dd>enabledDefault LLM logs are enabled.</dd><dt>Llm<wbr>Diagnostic<wbr>Settings<wbr>Disabled</dt>
    <dd>disabledDefault LLM logs are disabled.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="llmmessagelogtypes">
Llm<wbr>Message<wbr>Log<wbr>Types<pulumi-choosable type="language" values="python,go" class="inline">, Llm<wbr>Message<wbr>Log<wbr>Types<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>All</dt>
    <dd>allLog all messages.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Llm<wbr>Message<wbr>Log<wbr>Types<wbr>All</dt>
    <dd>allLog all messages.</dd></dl>
</pulumi-choosable>
</div>
