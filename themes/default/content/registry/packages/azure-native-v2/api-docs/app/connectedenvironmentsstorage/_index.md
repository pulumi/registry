...
---
title: "ConnectedEnvironmentsStorage"
title_tag: "azure-native.app.ConnectedEnvironmentsStorage"
meta_desc: "Documentation for the azure-native.app.ConnectedEnvironmentsStorage resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ConnectedEnvironmentsStorage Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 ...
                                 <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[ConnectedEnvironmentStoragePropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ConnectedEnvironmentsStorage</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ConnectedEnvironmentsStorage</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:app:ConnectedEnvironmentsStorage</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ConnectedEnvironmentsStorageArgs</a></span>
    </dt>
...
```csharp
var connectedEnvironmentsStorageResource = new AzureNative.App.ConnectedEnvironmentsStorage("connectedEnvironmentsStorageResource", new()
{
...
```go
example, err := app.NewConnectedEnvironmentsStorage(ctx, "connectedEnvironmentsStorageResource", &app.ConnectedEnvironmentsStorageArgs{
...
```java
var connectedEnvironmentsStorageResource = new ConnectedEnvironmentsStorage("connectedEnvironmentsStorageResource", ConnectedEnvironmentsStorageArgs.builder()
    .connectedEnvironmentName("string")
    .resourceGroupName("string")
    .properties(ConnectedEnvironmentStoragePropertiesArgs.builder()
        .azureFile(AzureFilePropertiesArgs.builder()
...
```python
connected_environments_storage_resource = azure_native.app.ConnectedEnvironmentsStorage("connectedEnvironmentsStorageResource",
...
```typescript
const connectedEnvironmentsStorageResource = new azure_native.app.ConnectedEnvironmentsStorage("connectedEnvironmentsStorageResource", {
    connectedEnvironmentName: "string",
    resourceGroupName: "string",
    properties: {
        azureFile: {
...
## ConnectedEnvironmentsStorage Resource Properties {#properties}
...
The ConnectedEnvironmentsStorage resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectedenvironmentstorageproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>App.<wbr>Inputs.<wbr>Connected<wbr>Environment<wbr>Storage<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectedenvironmentstorageproperties">Connected<wbr>Environment<wbr>Storage<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>Storage properties</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectedenvironmentstorageproperties">Connected<wbr>Environment<wbr>Storage<wbr>Properties</a></span>
    </dt>
    <dd>Storage properties</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectedenvironmentstorageproperties">Property Map</a></span>
    </dt>
    <dd>Storage properties</dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ConnectedEnvironmentsStorage resource produces the following output properties:
...
<h4 id="connectedenvironmentstorageproperties">
Connected<wbr>Environment<wbr>Storage<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Connected<wbr>Environment<wbr>Storage<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="connectedenvironmentstorageresponseproperties">
Connected<wbr>Environment<wbr>Storage<wbr>Response<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Connected<wbr>Environment<wbr>Storage<wbr>Response<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
