...
---
title: "getConnectedEnvironmentsDaprComponent"
title_tag: "azure-native.app.getConnectedEnvironmentsDaprComponent"
meta_desc: "Documentation for the azure-native.app.getConnectedEnvironmentsDaprComponent function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getConnectedEnvironmentsDaprComponent {#using}
...
><span class="k">function </span>getConnectedEnvironmentsDaprComponent<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetConnectedEnvironmentsDaprComponentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>></span
><span class="k">
function </span>getConnectedEnvironmentsDaprComponentOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetConnectedEnvironmentsDaprComponentOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_connected_environments_dapr_component<span class="p">(</span><span class="nx">component_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                              ...
                                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetConnectedEnvironmentsDaprComponentResult</span
><span class="k">
def </span>get_connected_environments_dapr_component_output<span class="p">(</span><span class="nx">component_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                              <span class="nx">connected_environment_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                              <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetConnectedEnvironmentsDaprComponentResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>LookupConnectedEnvironmentsDaprComponent<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupConnectedEnvironmentsDaprComponentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupConnectedEnvironmentsDaprComponentResult</a></span>, error)</span
><span class="k">
func </span>LookupConnectedEnvironmentsDaprComponentOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupConnectedEnvironmentsDaprComponentOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupConnectedEnvironmentsDaprComponentResultOutput</span
></code></pre></div>

&gt; Note: This function is named `LookupConnectedEnvironmentsDaprComponent` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetConnectedEnvironmentsDaprComponent </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetConnectedEnvironmentsDaprComponentArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetConnectedEnvironmentsDaprComponentInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>> </span>getConnectedEnvironmentsDaprComponent<span class="p">(</span><span class="nx">GetConnectedEnvironmentsDaprComponentArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetConnectedEnvironmentsDaprComponentResult</a></span>> </span>getConnectedEnvironmentsDaprComponent<span class="p">(</span><span class="nx">GetConnectedEnvironmentsDaprComponentArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:app:getConnectedEnvironmentsDaprComponent
...
## getConnectedEnvironmentsDaprComponent Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componenttype_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Type</a>
    ...
    <dd>Component type</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ignoreerrors_csharp" style="color: inherit; text-decoration: inherit;">Ignore<wbr>Errors</a>
    ...
    <dd>Boolean describing if the component errors are ignores</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inittimeout_csharp" style="color: inherit; text-decoration: inherit;">Init<wbr>Timeout</a>
    ...
    <dd>Initialization timeout</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#daprmetadataresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>App.<wbr>Outputs.<wbr>Dapr<wbr>Metadata<wbr>Response&gt;</a></span>
    </dt>
    <dd>Component metadata</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scopes_csharp" style="color: inherit; text-decoration: inherit;">Scopes</a>
    ...
    <dd>Names of container apps that can use this Dapr component</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secretstorecomponent_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Store<wbr>Component</a>
    ...
    <dd>Name of a Dapr component to retrieve component secrets from</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#secrets_csharp" style="color: inherit; text-decoration: inherit;">Secrets</a>
    ...
    <dd>Collection of secrets used by a Dapr component</dd><dt class="property-"
            title="">
