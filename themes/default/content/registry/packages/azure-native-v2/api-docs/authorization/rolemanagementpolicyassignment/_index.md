...
## Create RoleManagementPolicyAssignment Resource {#create}
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">RoleManagementPolicyAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RoleManagementPolicyAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">RoleManagementPolicyAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RoleManagementPolicyAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:authorization:RoleManagementPolicyAssignment</span><span class="p"></span>
...
The RoleManagementPolicyAssignment resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policyid_csharp" style="color: inherit; text-decoration: inherit;">Policy<wbr>Id</a>
    ...
    <dd>The policy id role management policy assignment.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#roledefinitionid_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Definition<wbr>Id</a>
    ...
    <dd>The role definition of management policy assignment.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rolemanagementpolicyassignmentname_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Management<wbr>Policy<wbr>Assignment<wbr>Name</a>
    ...
    <dd>The name of format {guid_guid} the role management policy assignment to upsert.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="policyassignmentpropertiesresponse">
Policy<wbr>Assignment<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policyassignmentpropertiesresponsepolicy">
Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Policy<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Policy<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policyassignmentpropertiesresponseroledefinition">
Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Role<wbr>Definition<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Role<wbr>Definition<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="policyassignmentpropertiesresponsescope">
Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Scope<pulumi-choosable type="language" values="python,go" class="inline">, Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Scope<wbr>Args</pulumi-choosable>
</h4>
