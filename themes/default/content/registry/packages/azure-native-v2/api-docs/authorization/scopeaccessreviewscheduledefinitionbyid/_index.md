...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ScopeAccessReviewScheduleDefinitionById resource produces the following output properties:
