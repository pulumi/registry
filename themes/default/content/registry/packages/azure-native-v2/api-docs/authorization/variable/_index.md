...
---
title: "Variable"
title_tag: "azure-native.authorization.Variable"
meta_desc: "Documentation for the azure-native.authorization.Variable resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:authorization:Variable</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#columns_csharp" style="color: inherit; text-decoration: inherit;">Columns</a>
    ...
    <dd>Variable column definitions.</dd><dt class="property-optional property-replacement"
            title="Optional">
