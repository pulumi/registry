...
title_tag: "azure-native.automanage.ConfigurationProfile"
meta_desc: "Documentation for the azure-native.automanage.ConfigurationProfile resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:automanage:ConfigurationProfile</span><span class="p"></span>
...
```csharp
var configurationProfileResource = new AzureNative.Automanage.ConfigurationProfile("configurationProfileResource", new()
{
...
```go
example, err := automanage.NewConfigurationProfile(ctx, "configurationProfileResource", &automanage.ConfigurationProfileArgs{
...
```python
configuration_profile_resource = azure_native.automanage.ConfigurationProfile("configurationProfileResource",
...
```typescript
const configurationProfileResource = new azure_native.automanage.ConfigurationProfile("configurationProfileResource", {
    resourceGroupName: "string",
    configurationProfileName: "string",
    location: "string",
    properties: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configurationprofilename_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Profile<wbr>Name</a>
    ...
    <dd>Name of the configuration profile.</dd><dt class="property-optional property-replacement"
            title="Optional">
