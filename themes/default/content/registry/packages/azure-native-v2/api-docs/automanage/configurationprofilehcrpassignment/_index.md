...
---
title: "ConfigurationProfileHCRPAssignment"
title_tag: "azure-native.automanage.ConfigurationProfileHCRPAssignment"
meta_desc: "Documentation for the azure-native.automanage.ConfigurationProfileHCRPAssignment resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ConfigurationProfileHCRPAssignment Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                       <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                       ...
                                       <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[ConfigurationProfileAssignmentPropertiesArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ConfigurationProfileHCRPAssignment</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ConfigurationProfileHCRPAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:automanage:ConfigurationProfileHCRPAssignment</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ConfigurationProfileHCRPAssignmentArgs</a></span>
    </dt>
...
```csharp
var configurationProfileHCRPAssignmentResource = new AzureNative.Automanage.ConfigurationProfileHCRPAssignment("configurationProfileHCRPAssignmentResource", new()
{
    MachineName = "string",
...
```go
example, err := automanage.NewConfigurationProfileHCRPAssignment(ctx, "configurationProfileHCRPAssignmentResource", &automanage.ConfigurationProfileHCRPAssignmentArgs{
	MachineName:                        pulumi.String("string"),
	ResourceGroupName:                  pulumi.String("string"),
	ConfigurationProfileAssignmentName: pulumi.String("string"),
	Properties: &automanage.ConfigurationProfileAssignmentPropertiesArgs{
...
```java
var configurationProfileHCRPAssignmentResource = new ConfigurationProfileHCRPAssignment("configurationProfileHCRPAssignmentResource", ConfigurationProfileHCRPAssignmentArgs.builder()
    .machineName("string")
    .resourceGroupName("string")
    .configurationProfileAssignmentName("string")
    .properties(ConfigurationProfileAssignmentPropertiesArgs.builder()
...
```python
configuration_profile_hcrpassignment_resource = azure_native.automanage.ConfigurationProfileHCRPAssignment("configurationProfileHCRPAssignmentResource",
    machine_name="string",
...
```typescript
const configurationProfileHCRPAssignmentResource = new azure_native.automanage.ConfigurationProfileHCRPAssignment("configurationProfileHCRPAssignmentResource", {
    machineName: "string",
    resourceGroupName: "string",
    configurationProfileAssignmentName: "string",
    properties: {
...
## ConfigurationProfileHCRPAssignment Resource Properties {#properties}
...
The ConfigurationProfileHCRPAssignment resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configurationprofileassignmentname_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Profile<wbr>Assignment<wbr>Name</a>
    ...
    <dd>Name of the configuration profile assignment. Only default is supported.</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationprofileassignmentproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Automanage.<wbr>Inputs.<wbr>Configuration<wbr>Profile<wbr>Assignment<wbr>Properties</a></span>
    </dt>
    <dd>Properties of the configuration profile assignment.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationprofileassignmentproperties">Property Map</a></span>
    </dt>
    <dd>Properties of the configuration profile assignment.</dd></dl>
</pulumi-choosable>
</div>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ConfigurationProfileHCRPAssignment resource produces the following output properties:
...
<h4 id="configurationprofileassignmentproperties">
Configuration<wbr>Profile<wbr>Assignment<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Configuration<wbr>Profile<wbr>Assignment<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="configurationprofileassignmentpropertiesresponse">
Configuration<wbr>Profile<wbr>Assignment<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Configuration<wbr>Profile<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
