...
## Create CloudLink Resource {#create}
...
<span class="k">def </span><span class="nx">CloudLink</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">linked_cloud</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewCloudLink</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">CloudLinkArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">CloudLink</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">CloudLink</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CloudLinkArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">CloudLink</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CloudLinkArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:avs:CloudLink</span><span class="p"></span>
...
```csharp
var cloudLinkResource = new AzureNative.AVS.CloudLink("cloudLinkResource", new()
{
...
```go
example, err := avs.NewCloudLink(ctx, "cloudLinkResource", &avs.CloudLinkArgs{
	PrivateCloudName:  pulumi.String("string"),
	ResourceGroupName: pulumi.String("string"),
	CloudLinkName:     pulumi.String("string"),
	LinkedCloud:       pulumi.String("string"),
})
```
...
```java
var cloudLinkResource = new CloudLink("cloudLinkResource", CloudLinkArgs.builder()
    .privateCloudName("string")
    .resourceGroupName("string")
    .cloudLinkName("string")
    .linkedCloud("string")
...
```python
cloud_link_resource = azure_native.avs.CloudLink("cloudLinkResource",
...
```typescript
const cloudLinkResource = new azure_native.avs.CloudLink("cloudLinkResource", {
    privateCloudName: "string",
    resourceGroupName: "string",
    cloudLinkName: "string",
    linkedCloud: "string",
...
The CloudLink resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudlinkname_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Link<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Name of the cloud link.</dd><dt class="property-optional"
            title="Optional">
        <span id="linkedcloud_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linkedcloud_csharp" style="color: inherit; text-decoration: inherit;">Linked<wbr>Cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Identifier of the other private cloud participating in the link.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudlinkname_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Link<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linkedcloud_go" style="color: inherit; text-decoration: inherit;">Linked<wbr>Cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcegroupname_java" style="color: inherit; text-decoration: inherit;">resource<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the resource group. The name is case insensitive.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="cloudlinkname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudlinkname_java" style="color: inherit; text-decoration: inherit;">cloud<wbr>Link<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Name of the cloud link.</dd><dt class="property-optional"
            title="Optional">
        <span id="linkedcloud_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linkedcloud_java" style="color: inherit; text-decoration: inherit;">linked<wbr>Cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudlinkname_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Link<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linkedcloud_nodejs" style="color: inherit; text-decoration: inherit;">linked<wbr>Cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloud_link_name_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>link_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linked_cloud_python" style="color: inherit; text-decoration: inherit;">linked_<wbr>cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcegroupname_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the resource group. The name is case insensitive.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="cloudlinkname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudlinkname_yaml" style="color: inherit; text-decoration: inherit;">cloud<wbr>Link<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>Name of the cloud link.</dd><dt class="property-optional"
            title="Optional">
        <span id="linkedcloud_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#linkedcloud_yaml" style="color: inherit; text-decoration: inherit;">linked<wbr>Cloud</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>The state of the cloud link.</dd><dt class="property-"
            title="">
