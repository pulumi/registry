...
---
title: "ConfigServiceDeliveryChannel"
title_tag: "azure-native.awsconnector.ConfigServiceDeliveryChannel"
meta_desc: "Documentation for the azure-native.awsconnector.ConfigServiceDeliveryChannel resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ConfigServiceDeliveryChannel Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 ...
                                 <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[ConfigServiceDeliveryChannelPropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ConfigServiceDeliveryChannel</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ConfigServiceDeliveryChannel</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:awsconnector:ConfigServiceDeliveryChannel</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ConfigServiceDeliveryChannelArgs</a></span>
    </dt>
...
```csharp
var configServiceDeliveryChannelResource = new AzureNative.AwsConnector.ConfigServiceDeliveryChannel("configServiceDeliveryChannelResource", new()
{
...
```go
example, err := awsconnector.NewConfigServiceDeliveryChannel(ctx, "configServiceDeliveryChannelResource", &awsconnector.ConfigServiceDeliveryChannelArgs{
...
```java
var configServiceDeliveryChannelResource = new ConfigServiceDeliveryChannel("configServiceDeliveryChannelResource", ConfigServiceDeliveryChannelArgs.builder()
    .resourceGroupName("string")
    .location("string")
    .name("string")
    .properties(ConfigServiceDeliveryChannelPropertiesArgs.builder()
...
```python
config_service_delivery_channel_resource = azure_native.awsconnector.ConfigServiceDeliveryChannel("configServiceDeliveryChannelResource",
...
```typescript
const configServiceDeliveryChannelResource = new azure_native.awsconnector.ConfigServiceDeliveryChannel("configServiceDeliveryChannelResource", {
    resourceGroupName: "string",
    location: "string",
    name: "string",
    properties: {
...
## ConfigServiceDeliveryChannel Resource Properties {#properties}
...
The ConfigServiceDeliveryChannel resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of ConfigServiceDeliveryChannel</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configservicedeliverychannelproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configservicedeliverychannelproperties">Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configservicedeliverychannelproperties">Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configservicedeliverychannelproperties">Property Map</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ConfigServiceDeliveryChannel resource produces the following output properties:
...
<h4 id="awsconfigservicedeliverychannelproperties">
Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="configsnapshotdeliveryproperties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_csharp" style="color: inherit; text-decoration: inherit;">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="configsnapshotdeliveryproperties_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_go" style="color: inherit; text-decoration: inherit;">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="name_go">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="configsnapshotdeliveryproperties_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_java" style="color: inherit; text-decoration: inherit;">config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="configsnapshotdeliveryproperties_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_nodejs" style="color: inherit; text-decoration: inherit;">config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="config_snapshot_delivery_properties_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#config_snapshot_delivery_properties_python" style="color: inherit; text-decoration: inherit;">config_<wbr>snapshot_<wbr>delivery_<wbr>properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="configsnapshotdeliveryproperties_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_yaml" style="color: inherit; text-decoration: inherit;">config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliveryproperties">Property Map</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="name_yaml">
...
<h4 id="awsconfigservicedeliverychannelpropertiesresponse">
Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_csharp" style="color: inherit; text-decoration: inherit;">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliverypropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_go" style="color: inherit; text-decoration: inherit;">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliverypropertiesresponse">Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="name_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#configsnapshotdeliveryproperties_yaml" style="color: inherit; text-decoration: inherit;">config<wbr>Snapshot<wbr>Delivery<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configsnapshotdeliverypropertiesresponse">Property Map</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="name_yaml">
...
<h4 id="configservicedeliverychannelproperties">
Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelproperties">Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelproperties">Property Map</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="configservicedeliverychannelpropertiesresponse">
Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelpropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelpropertiesresponse">Aws<wbr>Config<wbr>Service<wbr>Delivery<wbr>Channel<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsconfigservicedeliverychannelpropertiesresponse">Property Map</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_yaml">
...
<h4 id="configsnapshotdeliveryproperties">
Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_csharp" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalue">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_go" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalue">Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_yaml" style="color: inherit; text-decoration: inherit;">delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalue">Property Map</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>

<h4 id="configsnapshotdeliverypropertiesresponse">
Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Config<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_csharp" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalueresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Response</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_go" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalueresponse">Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Response</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deliveryfrequency_yaml" style="color: inherit; text-decoration: inherit;">delivery<wbr>Frequency</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maximumexecutionfrequencyenumvalueresponse">Property Map</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>

<h4 id="maximumexecutionfrequency">
Maximum<wbr>Execution<wbr>Frequency<pulumi-choosable type="language" values="python,go" class="inline">, Maximum<wbr>Execution<wbr>Frequency<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>One_Hour</dt>
    <dd>One_HourMaximumExecutionFrequency enum One_Hour</dd><dt>Six_Hours</dt>
    <dd>Six_HoursMaximumExecutionFrequency enum Six_Hours</dd><dt>Three_Hours</dt>
    <dd>Three_HoursMaximumExecutionFrequency enum Three_Hours</dd><dt>Twelve_Hours</dt>
    <dd>Twelve_HoursMaximumExecutionFrequency enum Twelve_Hours</dd><dt>Twenty<wbr>Four_Hours</dt>
    <dd>TwentyFour_HoursMaximumExecutionFrequency enum TwentyFour_Hours</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Maximum<wbr>Execution<wbr>Frequency_One_Hour</dt>
    <dd>One_HourMaximumExecutionFrequency enum One_Hour</dd><dt>Maximum<wbr>Execution<wbr>Frequency_Six_Hours</dt>
    <dd>Six_HoursMaximumExecutionFrequency enum Six_Hours</dd><dt>Maximum<wbr>Execution<wbr>Frequency_Three_Hours</dt>
    <dd>Three_HoursMaximumExecutionFrequency enum Three_Hours</dd><dt>Maximum<wbr>Execution<wbr>Frequency_Twelve_Hours</dt>
    <dd>Twelve_HoursMaximumExecutionFrequency enum Twelve_Hours</dd><dt>Maximum<wbr>Execution<wbr>Frequency_Twenty<wbr>Four_Hours</dt>
    <dd>TwentyFour_HoursMaximumExecutionFrequency enum TwentyFour_Hours</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>ONE_HOUR</dt>
    ...
    <dd>Six_HoursMaximumExecutionFrequency enum Six_Hours</dd><dt>THREE_HOURS</dt>
    <dd>Three_HoursMaximumExecutionFrequency enum Three_Hours</dd><dt>TWELVE_HOURS</dt>
    <dd>Twelve_HoursMaximumExecutionFrequency enum Twelve_Hours</dd><dt>TWENTY_FOUR_HOURS</dt>
    <dd>TwentyFour_HoursMaximumExecutionFrequency enum TwentyFour_Hours</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="maximumexecutionfrequencyenumvalue">
Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<pulumi-choosable type="language" values="python,go" class="inline">, Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#maximumexecutionfrequency">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Maximum<wbr>Execution<wbr>Frequency</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_go" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#maximumexecutionfrequency">Maximum<wbr>Execution<wbr>Frequency</a></span>
    </dt>
    <dd>Property value</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_python" style="color: inherit; text-decoration: inherit;">value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#maximumexecutionfrequency">Maximum<wbr>Execution<wbr>Frequency</a></span>
    </dt>
    <dd>Property value</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#value_yaml" style="color: inherit; text-decoration: inherit;">value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#maximumexecutionfrequency">&#34;One_Hour&#34; | &#34;Six_Hours&#34; | &#34;Three_Hours&#34; | &#34;Twelve_Hours&#34; | &#34;Twenty<wbr>Four_Hours&#34;</a></span>
    </dt>
    <dd>Property value</dd></dl>
</pulumi-choosable>
</div>

<h4 id="maximumexecutionfrequencyenumvalueresponse">
Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Maximum<wbr>Execution<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
