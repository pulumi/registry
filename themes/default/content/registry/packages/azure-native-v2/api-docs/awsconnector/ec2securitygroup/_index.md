...
title_tag: "azure-native.awsconnector.Ec2SecurityGroup"
meta_desc: "Documentation for the azure-native.awsconnector.Ec2SecurityGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create Ec2SecurityGroup Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[Ec2SecurityGroupPropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEc2SecurityGroup</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Ec2SecurityGroup</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">Ec2SecurityGroup</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">Ec2SecurityGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:awsconnector:Ec2SecurityGroup</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">Ec2SecurityGroupArgs</a></span>
    </dt>
...
```csharp
var ec2SecurityGroupResource = new AzureNative.AwsConnector.Ec2SecurityGroup("ec2SecurityGroupResource", new()
{
...
```go
example, err := awsconnector.NewEc2SecurityGroup(ctx, "ec2SecurityGroupResource", &awsconnector.Ec2SecurityGroupArgs{
				...
				&awsconnector.IpPermissionArgs{
					...
					UserIdGroupPairs: awsconnector.UserIdGroupPairArray{
						&awsconnector.UserIdGroupPairArgs{
							...
							GroupId:                pulumi.String("string"),
							GroupName:              pulumi.String("string"),
							PeeringStatus:          pulumi.String("string"),
...
```java
var ec2SecurityGroupResource = new Ec2SecurityGroup("ec2SecurityGroupResource", Ec2SecurityGroupArgs.builder()
    .resourceGroupName("string")
    .location("string")
    .name("string")
    .properties(Ec2SecurityGroupPropertiesArgs.builder()
...
```python
ec2_security_group_resource = azure_native.awsconnector.Ec2SecurityGroup("ec2SecurityGroupResource",
...
```typescript
const ec2SecurityGroupResource = new azure_native.awsconnector.Ec2SecurityGroup("ec2SecurityGroupResource", {
    resourceGroupName: "string",
    location: "string",
    name: "string",
    properties: {
...
## Ec2SecurityGroup Resource Properties {#properties}
...
The Ec2SecurityGroup resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of Ec2SecurityGroup</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ec2securitygroupproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Ec2Security<wbr>Group<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ec2securitygroupproperties">Ec2Security<wbr>Group<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ec2securitygroupproperties">Ec2Security<wbr>Group<wbr>Properties</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ec2securitygroupproperties">Property Map</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the Ec2SecurityGroup resource produces the following output properties:
...
<h4 id="awsec2securitygroupproperties">
Aws<wbr>Ec2Security<wbr>Group<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Ec2Security<wbr>Group<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ippermissions_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Permissions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ippermission">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Ip<wbr>Permission&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ippermissions_go" style="color: inherit; text-decoration: inherit;">Ip<wbr>Permissions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ippermission">[]Ip<wbr>Permission</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ippermissions_java" style="color: inherit; text-decoration: inherit;">ip<wbr>Permissions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ippermission">List&lt;Ip<wbr>Permission&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ip_permissions_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>permissions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ippermission">Sequence[Ip<wbr>Permission]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ippermissions_yaml" style="color: inherit; text-decoration: inherit;">ip<wbr>Permissions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ippermission">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<h4 id="awsec2securitygrouppropertiesresponse">
Aws<wbr>Ec2Security<wbr>Group<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Ec2Security<wbr>Group<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="ec2securitygroupproperties">
Ec2Security<wbr>Group<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Ec2Security<wbr>Group<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsec2securitygroupproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Aws<wbr>Ec2Security<wbr>Group<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsec2securitygroupproperties">Aws<wbr>Ec2Security<wbr>Group<wbr>Properties</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsec2securitygroupproperties">Property Map</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="ec2securitygrouppropertiesresponse">
Ec2Security<wbr>Group<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Ec2Security<wbr>Group<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="ippermission">
Ip<wbr>Permission<pulumi-choosable type="language" values="python,go" class="inline">, Ip<wbr>Permission<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipranges_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprange">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Ip<wbr>Range&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipv6ranges_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6range">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Ipv6Range&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefixlistids_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>List<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prefixlistid">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Prefix<wbr>List<wbr>Id&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useridgrouppairs_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Id<wbr>Group<wbr>Pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridgrouppair">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>User<wbr>Id<wbr>Group<wbr>Pair&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipranges_go" style="color: inherit; text-decoration: inherit;">Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprange">[]Ip<wbr>Range</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipv6ranges_go" style="color: inherit; text-decoration: inherit;">Ipv6Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6range">[]Ipv6Range</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefixlistids_go" style="color: inherit; text-decoration: inherit;">Prefix<wbr>List<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prefixlistid">[]Prefix<wbr>List<wbr>Id</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="toport_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useridgrouppairs_go" style="color: inherit; text-decoration: inherit;">User<wbr>Id<wbr>Group<wbr>Pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridgrouppair">[]User<wbr>Id<wbr>Group<wbr>Pair</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipranges_java" style="color: inherit; text-decoration: inherit;">ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprange">List&lt;Ip<wbr>Range&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipv6ranges_java" style="color: inherit; text-decoration: inherit;">ipv6Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6range">List&lt;Ipv6Range&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefixlistids_java" style="color: inherit; text-decoration: inherit;">prefix<wbr>List<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prefixlistid">List&lt;Prefix<wbr>List<wbr>Id&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="toport_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useridgrouppairs_java" style="color: inherit; text-decoration: inherit;">user<wbr>Id<wbr>Group<wbr>Pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridgrouppair">List&lt;User<wbr>Id<wbr>Group<wbr>Pair&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ip_ranges_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprange">Sequence[Ip<wbr>Range]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipv6_ranges_python" style="color: inherit; text-decoration: inherit;">ipv6_<wbr>ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6range">Sequence[Ipv6Range]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefix_list_ids_python" style="color: inherit; text-decoration: inherit;">prefix_<wbr>list_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prefixlistid">Sequence[Prefix<wbr>List<wbr>Id]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_id_group_pairs_python" style="color: inherit; text-decoration: inherit;">user_<wbr>id_<wbr>group_<wbr>pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridgrouppair">Sequence[User<wbr>Id<wbr>Group<wbr>Pair]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipv6ranges_yaml" style="color: inherit; text-decoration: inherit;">ipv6Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6range">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefixlistids_yaml" style="color: inherit; text-decoration: inherit;">prefix<wbr>List<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prefixlistid">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="toport_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useridgrouppairs_yaml" style="color: inherit; text-decoration: inherit;">user<wbr>Id<wbr>Group<wbr>Pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useridgrouppair">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd></dl>
</pulumi-choosable>
</div>

<h4 id="ippermissionresponse">
Ip<wbr>Permission<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Ip<wbr>Permission<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="iprange">
Ip<wbr>Range<pulumi-choosable type="language" values="python,go" class="inline">, Ip<wbr>Range<wbr>Args</pulumi-choosable>
</h4>
...
Ip<wbr>Range<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Ip<wbr>Range<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="ipv6range">
Ipv6Range<pulumi-choosable type="language" values="python,go" class="inline">, Ipv6Range<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="ipv6rangeresponse">
Ipv6Range<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Ipv6Range<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="prefixlistid">
Prefix<wbr>List<wbr>Id<pulumi-choosable type="language" values="python,go" class="inline">, Prefix<wbr>List<wbr>Id<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="prefixlistidresponse">
Prefix<wbr>List<wbr>Id<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Prefix<wbr>List<wbr>Id<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="useridgrouppair">
User<wbr>Id<wbr>Group<wbr>Pair<pulumi-choosable type="language" values="python,go" class="inline">, User<wbr>Id<wbr>Group<wbr>Pair<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="useridgrouppairresponse">
User<wbr>Id<wbr>Group<wbr>Pair<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, User<wbr>Id<wbr>Group<wbr>Pair<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
