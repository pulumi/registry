...
---
title: "getConfigServiceConfigurationRecorder"
title_tag: "azure-native.awsconnector.getConfigServiceConfigurationRecorder"
meta_desc: "Documentation for the azure-native.awsconnector.getConfigServiceConfigurationRecorder function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getConfigServiceConfigurationRecorder {#using}
...
><span class="k">function </span>getConfigServiceConfigurationRecorder<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetConfigServiceConfigurationRecorderArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>></span
><span class="k">
function </span>getConfigServiceConfigurationRecorderOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetConfigServiceConfigurationRecorderOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_config_service_configuration_recorder<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                              <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetConfigServiceConfigurationRecorderResult</span
><span class="k">
def </span>get_config_service_configuration_recorder_output<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                              <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetConfigServiceConfigurationRecorderResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>LookupConfigServiceConfigurationRecorder<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupConfigServiceConfigurationRecorderArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupConfigServiceConfigurationRecorderResult</a></span>, error)</span
><span class="k">
func </span>LookupConfigServiceConfigurationRecorderOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupConfigServiceConfigurationRecorderOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupConfigServiceConfigurationRecorderResultOutput</span
></code></pre></div>

&gt; Note: This function is named `LookupConfigServiceConfigurationRecorder` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetConfigServiceConfigurationRecorder </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetConfigServiceConfigurationRecorderArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetConfigServiceConfigurationRecorderInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>> </span>getConfigServiceConfigurationRecorder<span class="p">(</span><span class="nx">GetConfigServiceConfigurationRecorderArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetConfigServiceConfigurationRecorderResult</a></span>> </span>getConfigServiceConfigurationRecorder<span class="p">(</span><span class="nx">GetConfigServiceConfigurationRecorderArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:awsconnector:getConfigServiceConfigurationRecorder
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of ConfigServiceConfigurationRecorder</dd><dt class="property-required property-replacement"
            title="Required">
...
## getConfigServiceConfigurationRecorder Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configserviceconfigurationrecorderpropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Outputs.<wbr>Config<wbr>Service<wbr>Configuration<wbr>Recorder<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configserviceconfigurationrecorderpropertiesresponse">Config<wbr>Service<wbr>Configuration<wbr>Recorder<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configserviceconfigurationrecorderpropertiesresponse">Property Map</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-"
            title="">
...
<h4 id="awsconfigserviceconfigurationrecorderpropertiesresponse">Aws<wbr>Config<wbr>Service<wbr>Configuration<wbr>Recorder<wbr>Properties<wbr>Response</h4>
...
<h4 id="configserviceconfigurationrecorderpropertiesresponse">Config<wbr>Service<wbr>Configuration<wbr>Recorder<wbr>Properties<wbr>Response</h4>
...
<h4 id="exclusionbyresourcetypesresponse">Exclusion<wbr>By<wbr>Resource<wbr>Types<wbr>Response</h4>
...
<h4 id="recordingfrequencyenumvalueresponse">Recording<wbr>Frequency<wbr>Enum<wbr>Value<wbr>Response</h4>
...
<h4 id="recordinggroupresponse">Recording<wbr>Group<wbr>Response</h4>
...
<h4 id="recordingmodeoverrideresponse">Recording<wbr>Mode<wbr>Override<wbr>Response</h4>
...
<h4 id="recordingmoderesponse">Recording<wbr>Mode<wbr>Response</h4>
...
<h4 id="recordingstrategyresponse">Recording<wbr>Strategy<wbr>Response</h4>
...
<h4 id="recordingstrategytypeenumvalueresponse">Recording<wbr>Strategy<wbr>Type<wbr>Enum<wbr>Value<wbr>Response</h4>
