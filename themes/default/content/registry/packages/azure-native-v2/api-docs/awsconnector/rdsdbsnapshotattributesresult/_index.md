...
---
title: "RdsDbSnapshotAttributesResult"
title_tag: "azure-native.awsconnector.RdsDbSnapshotAttributesResult"
meta_desc: "Documentation for the azure-native.awsconnector.RdsDbSnapshotAttributesResult resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create RdsDbSnapshotAttributesResult Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  ...
                                  <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[RdsDBSnapshotAttributesResultPropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RdsDbSnapshotAttributesResult</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">RdsDbSnapshotAttributesResult</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:awsconnector:RdsDbSnapshotAttributesResult</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">RdsDbSnapshotAttributesResultArgs</a></span>
    </dt>
...
```csharp
var rdsDbSnapshotAttributesResultResource = new AzureNative.AwsConnector.RdsDbSnapshotAttributesResult("rdsDbSnapshotAttributesResultResource", new()
{
...
```go
example, err := awsconnector.NewRdsDbSnapshotAttributesResult(ctx, "rdsDbSnapshotAttributesResultResource", &awsconnector.RdsDbSnapshotAttributesResultArgs{
...
```java
var rdsDbSnapshotAttributesResultResource = new RdsDbSnapshotAttributesResult("rdsDbSnapshotAttributesResultResource", RdsDbSnapshotAttributesResultArgs.builder()
    .resourceGroupName("string")
    .location("string")
    .name("string")
    .properties(RdsDBSnapshotAttributesResultPropertiesArgs.builder()
...
```python
rds_db_snapshot_attributes_result_resource = azure_native.awsconnector.RdsDbSnapshotAttributesResult("rdsDbSnapshotAttributesResultResource",
...
```typescript
const rdsDbSnapshotAttributesResultResource = new azure_native.awsconnector.RdsDbSnapshotAttributesResult("rdsDbSnapshotAttributesResultResource", {
    resourceGroupName: "string",
    location: "string",
    name: "string",
    properties: {
...
## RdsDbSnapshotAttributesResult Resource Properties {#properties}
...
The RdsDbSnapshotAttributesResult resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of RdsDBSnapshotAttributesResult</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rdsdbsnapshotattributesresultproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rdsdbsnapshotattributesresultproperties">Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rdsdbsnapshotattributesresultproperties">Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rdsdbsnapshotattributesresultproperties">Property Map</a></span>
    </dt>
    <dd>The resource-specific properties for this resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RdsDbSnapshotAttributesResult resource produces the following output properties:
...
<h4 id="awsrdsdbsnapshotattributesresultproperties">
Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotattributes_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Snapshot<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>DBSnapshot<wbr>Attribute&gt;</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotattributes_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_go" style="color: inherit; text-decoration: inherit;">Db<wbr>Snapshot<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">[]DBSnapshot<wbr>Attribute</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotattributes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_java" style="color: inherit; text-decoration: inherit;">db<wbr>Snapshot<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">List&lt;DBSnapshot<wbr>Attribute&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotattributes_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_nodejs" style="color: inherit; text-decoration: inherit;">db<wbr>Snapshot<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">DBSnapshot<wbr>Attribute[]</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="db_snapshot_attributes_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#db_snapshot_attributes_python" style="color: inherit; text-decoration: inherit;">db_<wbr>snapshot_<wbr>attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">Sequence[DBSnapshot<wbr>Attribute]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotattributes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_yaml" style="color: inherit; text-decoration: inherit;">db<wbr>Snapshot<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattribute">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
...
<h4 id="awsrdsdbsnapshotattributesresultpropertiesresponse">
Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Snapshot<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattributeresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>DBSnapshot<wbr>Attribute<wbr>Response&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotidentifier_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_go" style="color: inherit; text-decoration: inherit;">Db<wbr>Snapshot<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattributeresponse">[]DBSnapshot<wbr>Attribute<wbr>Response</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotidentifier_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_java" style="color: inherit; text-decoration: inherit;">db<wbr>Snapshot<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattributeresponse">List&lt;DBSnapshot<wbr>Attribute<wbr>Response&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotidentifier_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#db_snapshot_attributes_python" style="color: inherit; text-decoration: inherit;">db_<wbr>snapshot_<wbr>attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattributeresponse">Sequence[DBSnapshot<wbr>Attribute<wbr>Response]</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="db_snapshot_identifier_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbsnapshotattributes_yaml" style="color: inherit; text-decoration: inherit;">db<wbr>Snapshot<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dbsnapshotattributeresponse">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><!-- raw HTML omitted --></dd><dt class="property-optional"
            title="Optional">
        <span id="dbsnapshotidentifier_yaml">
...
<h4 id="dbsnapshotattribute">
DBSnapshot<wbr>Attribute<pulumi-choosable type="language" values="python,go" class="inline">, DBSnapshot<wbr>Attribute<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="dbsnapshotattributeresponse">
DBSnapshot<wbr>Attribute<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, DBSnapshot<wbr>Attribute<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="rdsdbsnapshotattributesresultproperties">
Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultproperties">Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultproperties">Property Map</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="rdsdbsnapshotattributesresultpropertiesresponse">
Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultpropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aws<wbr>Connector.<wbr>Inputs.<wbr>Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultpropertiesresponse">Aws<wbr>Rds<wbr>DBSnapshot<wbr>Attributes<wbr>Result<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#awsproperties_yaml" style="color: inherit; text-decoration: inherit;">aws<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awsrdsdbsnapshotattributesresultpropertiesresponse">Property Map</a></span>
    </dt>
    <dd>AWS Properties</dd><dt class="property-optional"
            title="Optional">
        <span id="awsregion_yaml">
