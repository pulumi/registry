...
---
title: "Catalog"
title_tag: "azure-native.azuresphere.Catalog"
meta_desc: "Documentation for the azure-native.azuresphere.Catalog resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:azuresphere:Catalog</span><span class="p"></span>
...
```csharp
var catalogResource = new AzureNative.AzureSphere.Catalog("catalogResource", new()
{
...
```go
example, err := azuresphere.NewCatalog(ctx, "catalogResource", &azuresphere.CatalogArgs{
...
```python
catalog_resource = azure_native.azuresphere.Catalog("catalogResource",
...
```typescript
const catalogResource = new azure_native.azuresphere.Catalog("catalogResource", {
    resourceGroupName: "string",
    catalogName: "string",
    location: "string",
    tags: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogname_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Name</a>
    ...
    <dd>Name of catalog</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenantid_csharp" style="color: inherit; text-decoration: inherit;">Tenant<wbr>Id</a>
    ...
    <dd>The Azure Sphere tenant ID associated with the catalog.</dd><dt class="property-"
            title="">
        <span id="type_csharp">
