...
---
title: "Deployment"
title_tag: "azure-native.azuresphere.Deployment"
meta_desc: "Documentation for the azure-native.azuresphere.Deployment resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Deployment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">deployed_images</span><span class="p">:</span> <span class="nx">Optional[Sequence[ImageArgs]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:azuresphere:Deployment</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deployedimages_csharp" style="color: inherit; text-decoration: inherit;">Deployed<wbr>Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Azure<wbr>Sphere.<wbr>Inputs.<wbr>Image&gt;</a></span>
    </dt>
    <dd>Images deployed</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deploymentid_csharp" style="color: inherit; text-decoration: inherit;">Deployment<wbr>Id</a>
    ...
    <dd>Deployment ID</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deploymentname_csharp" style="color: inherit; text-decoration: inherit;">Deployment<wbr>Name</a>
    ...
    <dd>Deployment name. Use .default for deployment creation and to get the current deployment for the associated device group.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deployedimages_go" style="color: inherit; text-decoration: inherit;">Deployed<wbr>Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">[]Image<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>Images deployed</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deployedimages_java" style="color: inherit; text-decoration: inherit;">deployed<wbr>Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">List&lt;Image&gt;</a></span>
    </dt>
    <dd>Images deployed</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deployedimages_yaml" style="color: inherit; text-decoration: inherit;">deployed<wbr>Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Images deployed</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="image">
Image<pulumi-choosable type="language" values="python,go" class="inline">, Image<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="imageresponse">
Image<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Image<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
