...
---
title: "KeyGroup"
title_tag: "azure-native.cdn.KeyGroup"
meta_desc: "Documentation for the azure-native.cdn.KeyGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">KeyGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">key_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">key_references</span><span class="p">:</span> <span class="nx">Optional[Sequence[ResourceReferenceArgs]]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:cdn:KeyGroup</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#keygroupname_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Group<wbr>Name</a>
    ...
    <dd>Name of the KeyGroup under the profile.</dd><dt class="property-optional"
            title="Optional">
