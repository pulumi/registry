...
---
title: "CommitmentPlanAssociation"
title_tag: "azure-native.cognitiveservices.CommitmentPlanAssociation"
meta_desc: "Documentation for the azure-native.cognitiveservices.CommitmentPlanAssociation resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create CommitmentPlanAssociation Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                              <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                              ...
                              <span class="nx">commitment_plan_association_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewCommitmentPlanAssociation</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">CommitmentPlanAssociation</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">CommitmentPlanAssociation</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CommitmentPlanAssociationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:cognitiveservices:CommitmentPlanAssociation</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">CommitmentPlanAssociationArgs</a></span>
    </dt>
...
```csharp
var commitmentPlanAssociationResource = new AzureNative.CognitiveServices.CommitmentPlanAssociation("commitmentPlanAssociationResource", new()
{
...
```go
example, err := cognitiveservices.NewCommitmentPlanAssociation(ctx, "commitmentPlanAssociationResource", &cognitiveservices.CommitmentPlanAssociationArgs{
	CommitmentPlanName:            pulumi.String("string"),
	ResourceGroupName:             pulumi.String("string"),
	AccountId:                     pulumi.String("string"),
	CommitmentPlanAssociationName: pulumi.String("string"),
...
```java
var commitmentPlanAssociationResource = new CommitmentPlanAssociation("commitmentPlanAssociationResource", CommitmentPlanAssociationArgs.builder()
    .commitmentPlanName("string")
    .resourceGroupName("string")
    .accountId("string")
    .commitmentPlanAssociationName("string")
...
```python
commitment_plan_association_resource = azure_native.cognitiveservices.CommitmentPlanAssociation("commitmentPlanAssociationResource",
    commitment_plan_name="string",
    resource_group_name="string",
    account_id="string",
    commitment_plan_association_name="string",
    tags={
        "string": "string",
    })
```
...
```typescript
const commitmentPlanAssociationResource = new azure_native.cognitiveservices.CommitmentPlanAssociation("commitmentPlanAssociationResource", {
    commitmentPlanName: "string",
    resourceGroupName: "string",
    accountId: "string",
    commitmentPlanAssociationName: "string",
...
## CommitmentPlanAssociation Resource Properties {#properties}
...
The CommitmentPlanAssociation resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>The Azure resource id of the account.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#commitmentplanassociationname_csharp" style="color: inherit; text-decoration: inherit;">Commitment<wbr>Plan<wbr>Association<wbr>Name</a>
    ...
    <dd>The name of the commitment plan association with the Cognitive Services Account</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the CommitmentPlanAssociation resource produces the following output properties:
