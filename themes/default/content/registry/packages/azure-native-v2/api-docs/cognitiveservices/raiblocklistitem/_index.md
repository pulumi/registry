...
---
title: "RaiBlocklistItem"
title_tag: "azure-native.cognitiveservices.RaiBlocklistItem"
meta_desc: "Documentation for the azure-native.cognitiveservices.RaiBlocklistItem resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create RaiBlocklistItem Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[RaiBlocklistItemPropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRaiBlocklistItem</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RaiBlocklistItem</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">RaiBlocklistItem</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RaiBlocklistItemArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:cognitiveservices:RaiBlocklistItem</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">RaiBlocklistItemArgs</a></span>
    </dt>
...
```csharp
var raiBlocklistItemResource = new AzureNative.CognitiveServices.RaiBlocklistItem("raiBlocklistItemResource", new()
{
    AccountName = "string",
...
```go
example, err := cognitiveservices.NewRaiBlocklistItem(ctx, "raiBlocklistItemResource", &cognitiveservices.RaiBlocklistItemArgs{
	...
	RaiBlocklistItemName: pulumi.String("string"),
...
```java
var raiBlocklistItemResource = new RaiBlocklistItem("raiBlocklistItemResource", RaiBlocklistItemArgs.builder()
    .accountName("string")
    .raiBlocklistName("string")
    .resourceGroupName("string")
    .properties(RaiBlocklistItemPropertiesArgs.builder()
...
```python
rai_blocklist_item_resource = azure_native.cognitiveservices.RaiBlocklistItem("raiBlocklistItemResource",
    account_name="string",
    ...
    rai_blocklist_item_name="string",
    tags={
        "string": "string",
    })
```
...
```typescript
const raiBlocklistItemResource = new azure_native.cognitiveservices.RaiBlocklistItem("raiBlocklistItemResource", {
    accountName: "string",
    raiBlocklistName: "string",
    resourceGroupName: "string",
    properties: {
...
## RaiBlocklistItem Resource Properties {#properties}
...
The RaiBlocklistItem resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#raiblocklistname_csharp" style="color: inherit; text-decoration: inherit;">Rai<wbr>Blocklist<wbr>Name</a>
    ...
    <dd>The name of the RaiBlocklist associated with the Cognitive Services Account</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#raiblocklistitemproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cognitive<wbr>Services.<wbr>Inputs.<wbr>Rai<wbr>Blocklist<wbr>Item<wbr>Properties</a></span>
    </dt>
    <dd>Properties of Cognitive Services RaiBlocklist Item.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#raiblocklistitemname_csharp" style="color: inherit; text-decoration: inherit;">Rai<wbr>Blocklist<wbr>Item<wbr>Name</a>
    ...
    <dd>The name of the RaiBlocklist Item associated with the custom blocklist</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#raiblocklistitemproperties">Rai<wbr>Blocklist<wbr>Item<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>Properties of Cognitive Services RaiBlocklist Item.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#raiblocklistitemproperties">Rai<wbr>Blocklist<wbr>Item<wbr>Properties</a></span>
    </dt>
    <dd>Properties of Cognitive Services RaiBlocklist Item.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#raiblocklistitemproperties">Property Map</a></span>
    </dt>
    <dd>Properties of Cognitive Services RaiBlocklist Item.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RaiBlocklistItem resource produces the following output properties:
...
<h4 id="raiblocklistitemproperties">
Rai<wbr>Blocklist<wbr>Item<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Rai<wbr>Blocklist<wbr>Item<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="raiblocklistitempropertiesresponse">
Rai<wbr>Blocklist<wbr>Item<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Rai<wbr>Blocklist<wbr>Item<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
