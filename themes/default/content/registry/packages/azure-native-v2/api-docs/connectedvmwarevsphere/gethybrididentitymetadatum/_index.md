...
title_tag: "azure-native.connectedvmwarevsphere.getHybridIdentityMetadatum"
meta_desc: "Documentation for the azure-native.connectedvmwarevsphere.getHybridIdentityMetadatum function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_hybrid_identity_metadatum<span class="p">(</span><span class="nx">metadata_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_hybrid_identity_metadatum_output<span class="p">(</span><span class="nx">metadata_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:connectedvmwarevsphere:getHybridIdentityMetadatum
