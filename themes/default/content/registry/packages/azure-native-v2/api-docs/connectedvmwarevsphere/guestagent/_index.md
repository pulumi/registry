...
---
title: "GuestAgent"
title_tag: "azure-native.connectedvmwarevsphere.GuestAgent"
meta_desc: "Documentation for the azure-native.connectedvmwarevsphere.GuestAgent resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:connectedvmwarevsphere:GuestAgent</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#httpproxyconfig_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Proxy<wbr>Config</a>
    ...
    <dd>HTTP Proxy configuration for the VM.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
