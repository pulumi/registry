...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:connectedvmwarevsphere:Host</span><span class="p"></span>
...
```csharp
var hostResource = new AzureNative.ConnectedVMwarevSphere.Host("hostResource", new()
{
...
```go
example, err := connectedvmwarevsphere.NewHost(ctx, "hostResource", &connectedvmwarevsphere.HostArgs{
...
```python
host_resource = azure_native.connectedvmwarevsphere.Host("hostResource",
...
```typescript
const hostResource = new azure_native.connectedvmwarevsphere.Host("hostResource", {
    resourceGroupName: "string",
    extendedLocation: {
        name: "string",
        type: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
    ...
    <dd>Gets or sets the extended location.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>Name of the host.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>Gets or sets the inventory Item ID for the host.</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#morefid_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Ref<wbr>Id</a>
    ...
    <dd>Gets or sets the vCenter MoRef (Managed Object Reference) ID for the host.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
