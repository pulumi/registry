...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:connectedvmwarevsphere:HybridIdentityMetadatum</span><span class="p"></span>
...
```csharp
var azure_nativeHybridIdentityMetadatumResource = new AzureNative.ConnectedVMwarevSphere.HybridIdentityMetadatum("azure-nativeHybridIdentityMetadatumResource", new()
{
...
```go
example, err := connectedvmwarevsphere.NewHybridIdentityMetadatum(ctx, "azure-nativeHybridIdentityMetadatumResource", &connectedvmwarevsphere.HybridIdentityMetadatumArgs{
...
```java
var azure_nativeHybridIdentityMetadatumResource = new HybridIdentityMetadatum("azure-nativeHybridIdentityMetadatumResource", HybridIdentityMetadatumArgs.builder()
    .resourceGroupName("string")
    .virtualMachineName("string")
    .metadataName("string")
    .publicKey("string")
...
```python
azure_native_hybrid_identity_metadatum_resource = azure_native.connectedvmwarevsphere.HybridIdentityMetadatum("azure-nativeHybridIdentityMetadatumResource",
...
```typescript
const azure_nativeHybridIdentityMetadatumResource = new azure_native.connectedvmwarevsphere.HybridIdentityMetadatum("azure-nativeHybridIdentityMetadatumResource", {
    resourceGroupName: "string",
    virtualMachineName: "string",
    metadataName: "string",
    publicKey: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualmachinename_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine<wbr>Name</a>
    ...
    <dd>Name of the vm.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadataname_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Name</a>
    ...
    <dd>Name of the hybridIdentityMetadata.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publickey_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Key</a>
    ...
    <dd>Gets or sets the Public Key.</dd><dt class="property-optional"
            title="Optional">
        <span id="vmid_csharp">
