...
title_tag: "azure-native.connectedvmwarevsphere.MachineExtension"
meta_desc: "Documentation for the azure-native.connectedvmwarevsphere.MachineExtension resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:connectedvmwarevsphere:MachineExtension</span><span class="p"></span>
...
```csharp
var azure_nativeMachineExtensionResource = new AzureNative.ConnectedVMwarevSphere.MachineExtension("azure-nativeMachineExtensionResource", new()
{
...
```go
example, err := connectedvmwarevsphere.NewMachineExtension(ctx, "azure-nativeMachineExtensionResource", &connectedvmwarevsphere.MachineExtensionArgs{
...
```python
azure_native_machine_extension_resource = azure_native.connectedvmwarevsphere.MachineExtension("azure-nativeMachineExtensionResource",
...
```typescript
const azure_nativeMachineExtensionResource = new azure_native.connectedvmwarevsphere.MachineExtension("azure-nativeMachineExtensionResource", {
    resourceGroupName: "string",
    virtualMachineName: "string",
    publisher: "string",
    forceUpdateTag: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualmachinename_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine<wbr>Name</a>
    ...
    <dd>The name of the machine where the extension should be created or updated.</dd><dt class="property-optional"
            title="Optional">
