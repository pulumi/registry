...
---
title: "Archife"
title_tag: "azure-native.containerregistry.Archife"
meta_desc: "Documentation for the azure-native.containerregistry.Archife resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create Archife Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">archive_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">package_source</span><span class="p">:</span> <span class="nx">Optional[ArchivePackageSourcePropertiesArgs]</span> = None<span class="p">,</span>
            <span class="nx">published_version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">repository_endpoint_prefix</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewArchife</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Archife</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">Archife</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ArchifeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:containerregistry:Archife</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ArchifeArgs</a></span>
    </dt>
...
## Archife Resource Properties {#properties}
...
The Archife resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagetype_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Type</a>
    ...
    <dd>The type of the package resource.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archivename_csharp" style="color: inherit; text-decoration: inherit;">Archive<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of the archive resource.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagesource_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#archivepackagesourceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Container<wbr>Registry.<wbr>Inputs.<wbr>Archive<wbr>Package<wbr>Source<wbr>Properties</a></span>
    </dt>
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="publishedversion_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publishedversion_csharp" style="color: inherit; text-decoration: inherit;">Published<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repositoryendpointprefix_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryendpointprefix_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Endpoint<wbr>Prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archivename_go" style="color: inherit; text-decoration: inherit;">Archive<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagesource_go" style="color: inherit; text-decoration: inherit;">Package<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#archivepackagesourceproperties">Archive<wbr>Package<wbr>Source<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="publishedversion_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publishedversion_go" style="color: inherit; text-decoration: inherit;">Published<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repositoryendpointprefix_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryendpointprefix_go" style="color: inherit; text-decoration: inherit;">Repository<wbr>Endpoint<wbr>Prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcegroupname_java" style="color: inherit; text-decoration: inherit;">resource<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the resource group. The name is case insensitive.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="archivename_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archivename_java" style="color: inherit; text-decoration: inherit;">archive<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagesource_java" style="color: inherit; text-decoration: inherit;">package<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#archivepackagesourceproperties">Archive<wbr>Package<wbr>Source<wbr>Properties</a></span>
    </dt>
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="publishedversion_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publishedversion_java" style="color: inherit; text-decoration: inherit;">published<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repositoryendpointprefix_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryendpointprefix_java" style="color: inherit; text-decoration: inherit;">repository<wbr>Endpoint<wbr>Prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archivename_nodejs" style="color: inherit; text-decoration: inherit;">archive<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagesource_nodejs" style="color: inherit; text-decoration: inherit;">package<wbr>Source</a>
    ...
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="publishedversion_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publishedversion_nodejs" style="color: inherit; text-decoration: inherit;">published<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repositoryendpointprefix_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryendpointprefix_nodejs" style="color: inherit; text-decoration: inherit;">repository<wbr>Endpoint<wbr>Prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archive_name_python" style="color: inherit; text-decoration: inherit;">archive_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#package_source_python" style="color: inherit; text-decoration: inherit;">package_<wbr>source</a>
    ...
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="published_version_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#published_version_python" style="color: inherit; text-decoration: inherit;">published_<wbr>version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repository_endpoint_prefix_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repository_endpoint_prefix_python" style="color: inherit; text-decoration: inherit;">repository_<wbr>endpoint_<wbr>prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcegroupname_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the resource group. The name is case insensitive.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="archivename_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#archivename_yaml" style="color: inherit; text-decoration: inherit;">archive<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#packagesource_yaml" style="color: inherit; text-decoration: inherit;">package<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#archivepackagesourceproperties">Property Map</a></span>
    </dt>
    <dd>The package source of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="publishedversion_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publishedversion_yaml" style="color: inherit; text-decoration: inherit;">published<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The published version of the archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="repositoryendpointprefix_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryendpointprefix_yaml" style="color: inherit; text-decoration: inherit;">repository<wbr>Endpoint<wbr>Prefix</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the Archife resource produces the following output properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>The provisioning state of the archive at the time the operation was called.</dd><dt class="property-"
            title="">
...
<h4 id="archivepackagesourceproperties">
Archive<wbr>Package<wbr>Source<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Archive<wbr>Package<wbr>Source<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#packagesourcetype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Container<wbr>Registry.<wbr>Package<wbr>Source<wbr>Type</a></span>
    </dt>
    <dd>The type of package source for a archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="url_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#url_csharp" style="color: inherit; text-decoration: inherit;">Url</a>
    ...
    <dd>The external repository url.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_go" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#packagesourcetype">Package<wbr>Source<wbr>Type</a></span>
    </dt>
    <dd>The type of package source for a archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="url_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_python" style="color: inherit; text-decoration: inherit;">type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#packagesourcetype">Package<wbr>Source<wbr>Type</a></span>
    </dt>
    <dd>The type of package source for a archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="url_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_yaml" style="color: inherit; text-decoration: inherit;">type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#packagesourcetype">&#34;remote&#34;</a></span>
    </dt>
    <dd>The type of package source for a archive.</dd><dt class="property-optional"
            title="Optional">
        <span id="url_yaml">
...
<h4 id="archivepackagesourcepropertiesresponse">
Archive<wbr>Package<wbr>Source<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Archive<wbr>Package<wbr>Source<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="packagesourcetype">
Package<wbr>Source<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Package<wbr>Source<wbr>Type<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Remote</dt>
    <dd>remote</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Package<wbr>Source<wbr>Type<wbr>Remote</dt>
    <dd>remote</dd></dl>
</pulumi-choosable>
</div>
