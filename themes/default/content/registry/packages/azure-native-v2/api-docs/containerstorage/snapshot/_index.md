...
---
title: "Snapshot"
title_tag: "azure-native.containerstorage.Snapshot"
meta_desc: "Documentation for the azure-native.containerstorage.Snapshot resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:containerstorage:Snapshot</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>Reference to the source volume</dd><dt class="property-optional property-replacement"
            title="Optional">
