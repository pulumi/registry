...
title_tag: "azure-native.dashboard.getManagedPrivateEndpoint"
meta_desc: "Documentation for the azure-native.dashboard.getManagedPrivateEndpoint function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_managed_private_endpoint<span class="p">(</span><span class="nx">managed_private_endpoint_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_managed_private_endpoint_output<span class="p">(</span><span class="nx">managed_private_endpoint_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:dashboard:getManagedPrivateEndpoint
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#managedprivateendpointname_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Private<wbr>Endpoint<wbr>Name</a>
    ...
    <dd>The managed private endpoint name of Azure Managed Grafana.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupids_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Ids</a>
    ...
    <dd>The group Ids of the managed private endpoint.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkresourceid_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Resource<wbr>Id</a>
    ...
    <dd>The ARM resource ID of the resource for which the managed private endpoint is pointing to.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkresourceregion_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Resource<wbr>Region</a>
    ...
    <dd>The region of the resource to which the managed private endpoint is pointing to.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceurl_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Url</a>
    ...
    <dd>The URL of the data store behind the private link service. It would be the URL in the Grafana data source configuration page without the protocol and port.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#requestmessage_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Message</a>
    ...
    <dd>User input request message of the managed private endpoint.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<h4 id="managedprivateendpointconnectionstateresponse">Managed<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>State<wbr>Response</h4>
