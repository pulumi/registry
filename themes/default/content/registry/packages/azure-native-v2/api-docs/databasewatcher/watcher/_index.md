...
---
title: "Watcher"
title_tag: "azure-native.databasewatcher.Watcher"
meta_desc: "Documentation for the azure-native.databasewatcher.Watcher resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Watcher</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">datastore</span><span class="p">:</span> <span class="nx">Optional[DatastoreArgs]</span> = None<span class="p">,</span>
            <span class="nx">default_alert_rule_identity_resource_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:databasewatcher:Watcher</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_csharp" style="color: inherit; text-decoration: inherit;">Datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datastore">Pulumi.<wbr>Azure<wbr>Native.<wbr>Database<wbr>Watcher.<wbr>Inputs.<wbr>Datastore</a></span>
    </dt>
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultalertruleidentityresourceid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultalertruleidentityresourceid_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Alert<wbr>Rule<wbr>Identity<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.</dd><dt class="property-optional"
            title="Optional">
        <span id="identity_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managedserviceidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Database<wbr>Watcher.<wbr>Inputs.<wbr>Managed<wbr>Service<wbr>Identity</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_go" style="color: inherit; text-decoration: inherit;">Datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datastore">Datastore<wbr>Args</a></span>
    </dt>
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultalertruleidentityresourceid_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultalertruleidentityresourceid_go" style="color: inherit; text-decoration: inherit;">Default<wbr>Alert<wbr>Rule<wbr>Identity<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_java" style="color: inherit; text-decoration: inherit;">datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datastore">Datastore</a></span>
    </dt>
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultalertruleidentityresourceid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultalertruleidentityresourceid_java" style="color: inherit; text-decoration: inherit;">default<wbr>Alert<wbr>Rule<wbr>Identity<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_nodejs" style="color: inherit; text-decoration: inherit;">datastore</a>
    ...
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultalertruleidentityresourceid_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultalertruleidentityresourceid_nodejs" style="color: inherit; text-decoration: inherit;">default<wbr>Alert<wbr>Rule<wbr>Identity<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_python" style="color: inherit; text-decoration: inherit;">datastore</a>
    ...
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="default_alert_rule_identity_resource_id_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#default_alert_rule_identity_resource_id_python" style="color: inherit; text-decoration: inherit;">default_<wbr>alert_<wbr>rule_<wbr>identity_<wbr>resource_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datastore_yaml" style="color: inherit; text-decoration: inherit;">datastore</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datastore">Property Map</a></span>
    </dt>
    <dd>The data store for collected monitoring data.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultalertruleidentityresourceid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultalertruleidentityresourceid_yaml" style="color: inherit; text-decoration: inherit;">default<wbr>Alert<wbr>Rule<wbr>Identity<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>The provisioning state of the resource watcher.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>The monitoring collection status of the watcher.</dd><dt class="property-"
            title="">
...
<h4 id="datastore">
Datastore<pulumi-choosable type="language" values="python,go" class="inline">, Datastore<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kustoclusteruri_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusteruri_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Cluster<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodataingestionuri_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodataingestionuri_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Data<wbr>Ingestion<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto data ingestion URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodatabasename_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodatabasename_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Database<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kustomanagementurl_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustomanagementurl_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Management<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kustoofferingtype_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoofferingtype_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Offering<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#kustoofferingtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Database<wbr>Watcher.<wbr>Kusto<wbr>Offering<wbr>Type</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adxclusterresourceid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adxclusterresourceid_csharp" style="color: inherit; text-decoration: inherit;">Adx<wbr>Cluster<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kustoclusterdisplayname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusterdisplayname_csharp" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Cluster<wbr>Display<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto cluster display name.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kustoclusteruri_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusteruri_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Cluster<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodataingestionuri_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodataingestionuri_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Data<wbr>Ingestion<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodatabasename_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Database<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kustomanagementurl_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustomanagementurl_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Management<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kustoofferingtype_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoofferingtype_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Offering<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#kustoofferingtype">Kusto<wbr>Offering<wbr>Type</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adxclusterresourceid_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adxclusterresourceid_go" style="color: inherit; text-decoration: inherit;">Adx<wbr>Cluster<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kustoclusterdisplayname_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusterdisplayname_go" style="color: inherit; text-decoration: inherit;">Kusto<wbr>Cluster<wbr>Display<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kustoclusteruri_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusteruri_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodataingestionuri_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodataingestionuri_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Data<wbr>Ingestion<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto data ingestion URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodatabasename_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodatabasename_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Database<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kustomanagementurl_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustomanagementurl_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Management<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kustoofferingtype_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoofferingtype_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Offering<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#kustoofferingtype">Kusto<wbr>Offering<wbr>Type</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adxclusterresourceid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adxclusterresourceid_java" style="color: inherit; text-decoration: inherit;">adx<wbr>Cluster<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kustoclusterdisplayname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusterdisplayname_java" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Display<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kustoclusteruri_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusteruri_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodataingestionuri_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodataingestionuri_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Data<wbr>Ingestion<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodatabasename_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Database<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kustomanagementurl_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustomanagementurl_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Management<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kustoofferingtype_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoofferingtype_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Offering<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#kustoofferingtype">Kusto<wbr>Offering<wbr>Type</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adxclusterresourceid_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adxclusterresourceid_nodejs" style="color: inherit; text-decoration: inherit;">adx<wbr>Cluster<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kustoclusterdisplayname_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusterdisplayname_nodejs" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Display<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kusto_cluster_uri_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_cluster_uri_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>cluster_<wbr>uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kusto_data_ingestion_uri_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_data_ingestion_uri_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>data_<wbr>ingestion_<wbr>uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_database_name_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>database_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kusto_management_url_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_management_url_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>management_<wbr>url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kusto_offering_type_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_offering_type_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>offering_<wbr>type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#kustoofferingtype">Kusto<wbr>Offering<wbr>Type</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adx_cluster_resource_id_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adx_cluster_resource_id_python" style="color: inherit; text-decoration: inherit;">adx_<wbr>cluster_<wbr>resource_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kusto_cluster_display_name_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kusto_cluster_display_name_python" style="color: inherit; text-decoration: inherit;">kusto_<wbr>cluster_<wbr>display_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="kustoclusteruri_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusteruri_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto cluster URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodataingestionuri_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodataingestionuri_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Data<wbr>Ingestion<wbr>Uri</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto data ingestion URI.</dd><dt class="property-required"
            title="Required">
        <span id="kustodatabasename_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustodatabasename_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Database<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The name of a Kusto database.</dd><dt class="property-required"
            title="Required">
        <span id="kustomanagementurl_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustomanagementurl_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Management<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Kusto management URL.</dd><dt class="property-required"
            title="Required">
        <span id="kustoofferingtype_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoofferingtype_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Offering<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#kustoofferingtype">&#34;adx&#34; | &#34;free&#34; | &#34;fabric&#34;</a></span>
    </dt>
    <dd>The type of a Kusto offering.</dd><dt class="property-optional"
            title="Optional">
        <span id="adxclusterresourceid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adxclusterresourceid_yaml" style="color: inherit; text-decoration: inherit;">adx<wbr>Cluster<wbr>Resource<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd>The Azure resource ID of an Azure Data Explorer cluster.</dd><dt class="property-optional"
            title="Optional">
        <span id="kustoclusterdisplayname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kustoclusterdisplayname_yaml" style="color: inherit; text-decoration: inherit;">kusto<wbr>Cluster<wbr>Display<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="kustoofferingtype">
Kusto<wbr>Offering<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Kusto<wbr>Offering<wbr>Type<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Adx</dt>
    <dd>adxThe Azure Data Explorer cluster Kusto offering.</dd><dt>Free</dt>
    <dd>freeThe free Azure Data Explorer cluster Kusto offering.</dd><dt>Fabric</dt>
    <dd>fabricThe Fabric Real-Time Analytics Kusto offering.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Kusto<wbr>Offering<wbr>Type<wbr>Adx</dt>
    <dd>adxThe Azure Data Explorer cluster Kusto offering.</dd><dt>Kusto<wbr>Offering<wbr>Type<wbr>Free</dt>
    <dd>freeThe free Azure Data Explorer cluster Kusto offering.</dd><dt>Kusto<wbr>Offering<wbr>Type<wbr>Fabric</dt>
    <dd>fabricThe Fabric Real-Time Analytics Kusto offering.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#managedserviceidentitytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Database<wbr>Watcher.<wbr>Managed<wbr>Service<wbr>Identity<wbr>Type</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userassignedidentities_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Assigned<wbr>Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>Native.<wbr>Database<wbr>Watcher.<wbr>Inputs.<wbr>User<wbr>Assigned<wbr>Identity<wbr>Response&gt;</span>
    </dt>
    <dd>The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.</dd></dl>
</pulumi-choosable>
</div>
