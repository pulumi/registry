...
<span class="k">def </span><span class="nx">StorageAccountCredential</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">ssl_status</span><span class="p">:</span> <span class="nx">Optional[Union[str, SSLStatus]]</span> = None<span class="p">,</span>
                             <span class="nx">account_key</span><span class="p">:</span> <span class="nx">Optional[AsymmetricEncryptedSecretArgs]</span> = None<span class="p">,</span>
                             <span class="nx">blob_domain_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:databoxedge:StorageAccountCredential</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accounttype_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#accounttype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Box<wbr>Edge.<wbr>Account<wbr>Type</a></span>
    </dt>
    <dd>Type of storage accessed on the storage account.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#alias_csharp" style="color: inherit; text-decoration: inherit;">Alias</a>
    ...
    <dd>Alias for the storage account.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslstatus_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#sslstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Box<wbr>Edge.<wbr>SSLStatus</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountkey_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Key</a>
    ...
    <dd>Encrypted storage key.</dd><dt class="property-optional"
            title="Optional">
        <span id="blobdomainname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blobdomainname_csharp" style="color: inherit; text-decoration: inherit;">Blob<wbr>Domain<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Blob end point for private clouds.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#connectionstring_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>String</a>
    ...
    <dd>Connection string for the storage account. Use this string if username and account key are not specified.</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>The storage account credential name.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storageaccountid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Id</a>
    ...
    <dd>Id of the storage account.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>Username for the storage account.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslstatus_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#sslstatus">SSLStatus</a></span>
    </dt>
    <dd>Signifies whether SSL needs to be enabled or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blobdomainname_go" style="color: inherit; text-decoration: inherit;">Blob<wbr>Domain<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountkey_java" style="color: inherit; text-decoration: inherit;">account<wbr>Key</a>
    ...
    <dd>Encrypted storage key.</dd><dt class="property-optional"
            title="Optional">
        <span id="blobdomainname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blobdomainname_java" style="color: inherit; text-decoration: inherit;">blob<wbr>Domain<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blobdomainname_nodejs" style="color: inherit; text-decoration: inherit;">blob<wbr>Domain<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ssl_status_python" style="color: inherit; text-decoration: inherit;">ssl_<wbr>status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#sslstatus">SSLStatus</a></span>
    </dt>
    <dd>Signifies whether SSL needs to be enabled or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blob_domain_name_python" style="color: inherit; text-decoration: inherit;">blob_<wbr>domain_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accounttype_yaml" style="color: inherit; text-decoration: inherit;">account<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#accounttype">&#34;General<wbr>Purpose<wbr>Storage&#34; | &#34;Blob<wbr>Storage&#34;</a></span>
    </dt>
    <dd>Type of storage accessed on the storage account.</dd><dt class="property-required"
            title="Required">
        <span id="alias_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sslstatus_yaml" style="color: inherit; text-decoration: inherit;">ssl<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#sslstatus">&#34;Enabled&#34; | &#34;Disabled&#34;</a></span>
    </dt>
    <dd>Signifies whether SSL needs to be enabled or not.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountkey_yaml" style="color: inherit; text-decoration: inherit;">account<wbr>Key</a>
    ...
    <dd>Encrypted storage key.</dd><dt class="property-optional"
            title="Optional">
        <span id="blobdomainname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#blobdomainname_yaml" style="color: inherit; text-decoration: inherit;">blob<wbr>Domain<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
    ...
    <dd>Metadata pertaining to creation and last modification of StorageAccountCredential</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>General<wbr>Purpose<wbr>Storage</dt>
    <dd>GeneralPurposeStorage</dd><dt>Blob<wbr>Storage</dt>
    <dd>BlobStorage</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Account<wbr>Type<wbr>General<wbr>Purpose<wbr>Storage</dt>
    <dd>GeneralPurposeStorage</dd><dt>Account<wbr>Type<wbr>Blob<wbr>Storage</dt>
    <dd>BlobStorage</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="python">
<dl class="tabular"><dt>GENERAL_PURPOSE_STORAGE</dt>
    <dd>GeneralPurposeStorage</dd><dt>BLOB_STORAGE</dt>
    <dd>BlobStorage</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="sslstatus">
SSLStatus<pulumi-choosable type="language" values="python,go" class="inline">, SSLStatus<wbr>Args</pulumi-choosable>
</h4>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>SSLStatus<wbr>Enabled</dt>
    <dd>Enabled</dd><dt>SSLStatus<wbr>Disabled</dt>
    <dd>Disabled</dd></dl>
</pulumi-choosable>
</div>
