...
title_tag: "azure-native.datafactory.getPrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.datafactory.getPrivateEndpointConnection function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_private_endpoint_connection<span class="p">(</span><span class="nx">factory_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_private_endpoint_connection_output<span class="p">(</span><span class="nx">factory_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:datafactory:getPrivateEndpointConnection
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#remoteprivateendpointconnectionresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Factory.<wbr>Outputs.<wbr>Remote<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Response</a></span>
    </dt>
    <dd>Core resource properties</dd><dt class="property-"
            title="">
        <span id="type_csharp">
