...
## Create ADLSGen1FolderDataSet Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewADLSGen1FolderDataSet</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ADLSGen1FolderDataSetArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ADLSGen1FolderDataSet</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ADLSGen1FolderDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen1FolderDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ADLSGen1FolderDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen1FolderDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:ADLSGen1FolderDataSet</span><span class="p"></span>
...
```csharp
var adlsgen1FolderDataSetResource = new AzureNative.DataShare.ADLSGen1FolderDataSet("adlsgen1FolderDataSetResource", new()
{
    AccountName = "string",
    FolderPath = "string",
    Kind = "string",
...
```go
example, err := datashare.NewADLSGen1FolderDataSet(ctx, "adlsgen1FolderDataSetResource", &datashare.ADLSGen1FolderDataSetArgs{
...
```java
var adlsgen1FolderDataSetResource = new ADLSGen1FolderDataSet("adlsgen1FolderDataSetResource", ADLSGen1FolderDataSetArgs.builder()
    .accountName("string")
    .folderPath("string")
    .kind("string")
    .resourceGroup("string")
...
```python
adlsgen1_folder_data_set_resource = azure_native.datashare.ADLSGen1FolderDataSet("adlsgen1FolderDataSetResource",
    account_name="string",
    folder_path="string",
    kind="string",
...
```typescript
const adlsgen1FolderDataSetResource = new azure_native.datashare.ADLSGen1FolderDataSet("adlsgen1FolderDataSetResource", {
    accountName: "string",
    folderPath: "string",
    kind: "string",
    resourceGroup: "string",
...
The ADLSGen1FolderDataSet resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountname_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Name</a>
    ...
    <dd>The ADLS account name.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#folderpath_csharp" style="color: inherit; text-decoration: inherit;">Folder<wbr>Path</a>
    ...
    <dd>The folder path within the ADLS account.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcegroup_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group</a>
    ...
    <dd>Resource group of ADLS account.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subscriptionid_csharp" style="color: inherit; text-decoration: inherit;">Subscription<wbr>Id</a>
    ...
    <dd>Subscription id of ADLS account.</dd><dt class="property-optional property-replacement"
            title="Optional">
