...
## Create ADLSGen2FileSystemDataSet Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewADLSGen2FileSystemDataSet</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ADLSGen2FileSystemDataSetArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ADLSGen2FileSystemDataSet</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ADLSGen2FileSystemDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen2FileSystemDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ADLSGen2FileSystemDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen2FileSystemDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:ADLSGen2FileSystemDataSet</span><span class="p"></span>
...
```csharp
var adlsgen2FileSystemDataSetResource = new AzureNative.DataShare.ADLSGen2FileSystemDataSet("adlsgen2FileSystemDataSetResource", new()
{
    AccountName = "string",
    FileSystem = "string",
    Kind = "string",
...
```go
example, err := datashare.NewADLSGen2FileSystemDataSet(ctx, "adlsgen2FileSystemDataSetResource", &datashare.ADLSGen2FileSystemDataSetArgs{
...
```java
var adlsgen2FileSystemDataSetResource = new ADLSGen2FileSystemDataSet("adlsgen2FileSystemDataSetResource", ADLSGen2FileSystemDataSetArgs.builder()
    .accountName("string")
    .fileSystem("string")
    .kind("string")
    .resourceGroup("string")
...
```python
adlsgen2_file_system_data_set_resource = azure_native.datashare.ADLSGen2FileSystemDataSet("adlsgen2FileSystemDataSetResource",
    account_name="string",
    file_system="string",
    kind="string",
...
```typescript
const adlsgen2FileSystemDataSetResource = new azure_native.datashare.ADLSGen2FileSystemDataSet("adlsgen2FileSystemDataSetResource", {
    accountName: "string",
    fileSystem: "string",
    kind: "string",
    resourceGroup: "string",
...
The ADLSGen2FileSystemDataSet resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
