...
## Create ADLSGen2FolderDataSetMapping Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewADLSGen2FolderDataSetMapping</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ADLSGen2FolderDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ADLSGen2FolderDataSetMapping</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ADLSGen2FolderDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen2FolderDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ADLSGen2FolderDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ADLSGen2FolderDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:ADLSGen2FolderDataSetMapping</span><span class="p"></span>
...
```csharp
var adlsgen2FolderDataSetMappingResource = new AzureNative.DataShare.ADLSGen2FolderDataSetMapping("adlsgen2FolderDataSetMappingResource", new()
{
    AccountName = "string",
    DataSetId = "string",
    FileSystem = "string",
...
```go
example, err := datashare.NewADLSGen2FolderDataSetMapping(ctx, "adlsgen2FolderDataSetMappingResource", &datashare.ADLSGen2FolderDataSetMappingArgs{
...
```java
var adlsgen2FolderDataSetMappingResource = new ADLSGen2FolderDataSetMapping("adlsgen2FolderDataSetMappingResource", ADLSGen2FolderDataSetMappingArgs.builder()
    .accountName("string")
    .dataSetId("string")
    .fileSystem("string")
    .folderPath("string")
...
```python
adlsgen2_folder_data_set_mapping_resource = azure_native.datashare.ADLSGen2FolderDataSetMapping("adlsgen2FolderDataSetMappingResource",
    account_name="string",
    data_set_id="string",
    file_system="string",
    folder_path="string",
...
```typescript
const adlsgen2FolderDataSetMappingResource = new azure_native.datashare.ADLSGen2FolderDataSetMapping("adlsgen2FolderDataSetMappingResource", {
    accountName: "string",
    dataSetId: "string",
    fileSystem: "string",
    folderPath: "string",
...
The ADLSGen2FolderDataSetMapping resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filesystem_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>System</a>
    ...
    <dd>File system to which the folder belongs.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#folderpath_csharp" style="color: inherit; text-decoration: inherit;">Folder<wbr>Path</a>
    ...
    <dd>Folder path within the file system.</dd><dt class="property-required"
            title="Required">
