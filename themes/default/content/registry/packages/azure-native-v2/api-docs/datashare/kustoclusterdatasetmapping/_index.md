...
## Create KustoClusterDataSetMapping Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewKustoClusterDataSetMapping</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">KustoClusterDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">KustoClusterDataSetMapping</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">KustoClusterDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoClusterDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">KustoClusterDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoClusterDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:KustoClusterDataSetMapping</span><span class="p"></span>
...
```csharp
var kustoClusterDataSetMappingResource = new AzureNative.DataShare.KustoClusterDataSetMapping("kustoClusterDataSetMappingResource", new()
{
    AccountName = "string",
    DataSetId = "string",
    Kind = "string",
...
```go
example, err := datashare.NewKustoClusterDataSetMapping(ctx, "kustoClusterDataSetMappingResource", &datashare.KustoClusterDataSetMappingArgs{
...
```java
var kustoClusterDataSetMappingResource = new KustoClusterDataSetMapping("kustoClusterDataSetMappingResource", KustoClusterDataSetMappingArgs.builder()
    .accountName("string")
    .dataSetId("string")
    .kind("string")
    .kustoClusterResourceId("string")
...
```python
kusto_cluster_data_set_mapping_resource = azure_native.datashare.KustoClusterDataSetMapping("kustoClusterDataSetMappingResource",
    account_name="string",
    data_set_id="string",
    kind="string",
...
```typescript
const kustoClusterDataSetMappingResource = new azure_native.datashare.KustoClusterDataSetMapping("kustoClusterDataSetMappingResource", {
    accountName: "string",
    dataSetId: "string",
    kind: "string",
    kustoClusterResourceId: "string",
...
The KustoClusterDataSetMapping resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
