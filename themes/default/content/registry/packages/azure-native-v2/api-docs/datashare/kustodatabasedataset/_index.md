...
## Create KustoDatabaseDataSet Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewKustoDatabaseDataSet</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">KustoDatabaseDataSetArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">KustoDatabaseDataSet</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">KustoDatabaseDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoDatabaseDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">KustoDatabaseDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoDatabaseDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:KustoDatabaseDataSet</span><span class="p"></span>
...
```csharp
var kustoDatabaseDataSetResource = new AzureNative.DataShare.KustoDatabaseDataSet("kustoDatabaseDataSetResource", new()
{
    AccountName = "string",
    Kind = "string",
...
```go
example, err := datashare.NewKustoDatabaseDataSet(ctx, "kustoDatabaseDataSetResource", &datashare.KustoDatabaseDataSetArgs{
...
```java
var kustoDatabaseDataSetResource = new KustoDatabaseDataSet("kustoDatabaseDataSetResource", KustoDatabaseDataSetArgs.builder()
    .accountName("string")
    .kind("string")
    .kustoDatabaseResourceId("string")
    .resourceGroupName("string")
...
```python
kusto_database_data_set_resource = azure_native.datashare.KustoDatabaseDataSet("kustoDatabaseDataSetResource",
    account_name="string",
    kind="string",
...
```typescript
const kustoDatabaseDataSetResource = new azure_native.datashare.KustoDatabaseDataSet("kustoDatabaseDataSetResource", {
    accountName: "string",
    kind: "string",
    kustoDatabaseResourceId: "string",
    resourceGroupName: "string",
...
The KustoDatabaseDataSet resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
