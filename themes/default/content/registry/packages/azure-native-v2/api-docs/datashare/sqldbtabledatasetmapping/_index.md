...
## Create SqlDBTableDataSetMapping Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSqlDBTableDataSetMapping</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SqlDBTableDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SqlDBTableDataSetMapping</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">SqlDBTableDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SqlDBTableDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">SqlDBTableDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SqlDBTableDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:SqlDBTableDataSetMapping</span><span class="p"></span>
...
```csharp
var sqlDBTableDataSetMappingResource = new AzureNative.DataShare.SqlDBTableDataSetMapping("sqlDBTableDataSetMappingResource", new()
{
    AccountName = "string",
    DataSetId = "string",
    DatabaseName = "string",
...
```go
example, err := datashare.NewSqlDBTableDataSetMapping(ctx, "sqlDBTableDataSetMappingResource", &datashare.SqlDBTableDataSetMappingArgs{
...
```java
var sqlDBTableDataSetMappingResource = new SqlDBTableDataSetMapping("sqlDBTableDataSetMappingResource", SqlDBTableDataSetMappingArgs.builder()
    .accountName("string")
    .dataSetId("string")
    .databaseName("string")
    .kind("string")
...
```python
sql_db_table_data_set_mapping_resource = azure_native.datashare.SqlDBTableDataSetMapping("sqlDBTableDataSetMappingResource",
    account_name="string",
    data_set_id="string",
...
```typescript
const sqlDBTableDataSetMappingResource = new azure_native.datashare.SqlDBTableDataSetMapping("sqlDBTableDataSetMappingResource", {
    accountName: "string",
    dataSetId: "string",
    databaseName: "string",
    kind: "string",
...
The SqlDBTableDataSetMapping resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#databasename_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Name</a>
    ...
    <dd>DatabaseName name of the sink data set</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tablename_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Name</a>
    ...
    <dd>SQL DB table name.</dd><dt class="property-optional property-replacement"
            title="Optional">
