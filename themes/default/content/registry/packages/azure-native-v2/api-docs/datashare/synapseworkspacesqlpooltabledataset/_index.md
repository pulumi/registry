...
---
title: "SynapseWorkspaceSqlPoolTableDataSet"
title_tag: "azure-native.datashare.SynapseWorkspaceSqlPoolTableDataSet"
meta_desc: "Documentation for the azure-native.datashare.SynapseWorkspaceSqlPoolTableDataSet resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create SynapseWorkspaceSqlPoolTableDataSet Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                        <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                        ...
                                        <span class="nx">synapse_workspace_sql_pool_table_resource_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSet</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSet</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetArgs</a></span>
    </dt>
...
```csharp
var synapseWorkspaceSqlPoolTableDataSetResource = new AzureNative.DataShare.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSetResource", new()
{
    AccountName = "string",
    Kind = "string",
...
```go
example, err := datashare.NewSynapseWorkspaceSqlPoolTableDataSet(ctx, "synapseWorkspaceSqlPoolTableDataSetResource", &datashare.SynapseWorkspaceSqlPoolTableDataSetArgs{
	AccountName:                            pulumi.String("string"),
	Kind:                                   pulumi.String("string"),
	ResourceGroupName:                      pulumi.String("string"),
	ShareName:                              pulumi.String("string"),
	SynapseWorkspaceSqlPoolTableResourceId: pulumi.String("string"),
...
```java
var synapseWorkspaceSqlPoolTableDataSetResource = new SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSetResource", SynapseWorkspaceSqlPoolTableDataSetArgs.builder()
    .accountName("string")
    .kind("string")
    .resourceGroupName("string")
    .shareName("string")
...
```python
synapse_workspace_sql_pool_table_data_set_resource = azure_native.datashare.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSetResource",
    account_name="string",
    kind="string",
    resource_group_name="string",
    share_name="string",
    synapse_workspace_sql_pool_table_resource_id="string",
...
```typescript
const synapseWorkspaceSqlPoolTableDataSetResource = new azure_native.datashare.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSetResource", {
    accountName: "string",
    kind: "string",
    resourceGroupName: "string",
    shareName: "string",
...
## SynapseWorkspaceSqlPoolTableDataSet Resource Properties {#properties}
...
The SynapseWorkspaceSqlPoolTableDataSet resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#synapseworkspacesqlpooltableresourceid_csharp" style="color: inherit; text-decoration: inherit;">Synapse<wbr>Workspace<wbr>Sql<wbr>Pool<wbr>Table<wbr>Resource<wbr>Id</a>
    ...
    <dd>Resource id of the Synapse Workspace SQL Pool Table</dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SynapseWorkspaceSqlPoolTableDataSet resource produces the following output properties:
