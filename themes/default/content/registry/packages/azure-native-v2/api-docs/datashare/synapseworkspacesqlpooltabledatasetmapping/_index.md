...
---
title: "SynapseWorkspaceSqlPoolTableDataSetMapping"
...
## Create SynapseWorkspaceSqlPoolTableDataSetMapping Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                               <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span>
    </dt>
...
```csharp
var synapseWorkspaceSqlPoolTableDataSetMappingResource = new AzureNative.DataShare.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMappingResource", new()
{
    AccountName = "string",
    DataSetId = "string",
    Kind = "string",
...
```go
example, err := datashare.NewSynapseWorkspaceSqlPoolTableDataSetMapping(ctx, "synapseWorkspaceSqlPoolTableDataSetMappingResource", &datashare.SynapseWorkspaceSqlPoolTableDataSetMappingArgs{
...
```java
var synapseWorkspaceSqlPoolTableDataSetMappingResource = new SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMappingResource", SynapseWorkspaceSqlPoolTableDataSetMappingArgs.builder()
    .accountName("string")
    .dataSetId("string")
    .kind("string")
    .resourceGroupName("string")
...
```python
synapse_workspace_sql_pool_table_data_set_mapping_resource = azure_native.datashare.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMappingResource",
    account_name="string",
    data_set_id="string",
    kind="string",
...
```typescript
const synapseWorkspaceSqlPoolTableDataSetMappingResource = new azure_native.datashare.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMappingResource", {
    accountName: "string",
    dataSetId: "string",
    kind: "string",
    resourceGroupName: "string",
...
## SynapseWorkspaceSqlPoolTableDataSetMapping Resource Properties {#properties}
...
The SynapseWorkspaceSqlPoolTableDataSetMapping resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datasetid_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Set<wbr>Id</a>
    ...
    <dd>The id of the source data set.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SynapseWorkspaceSqlPoolTableDataSetMapping resource produces the following output properties:
