...
title_tag: "azure-native.dbformariadb.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.dbformariadb.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:dbformariadb:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromDbformariadb = new AzureNative.DBforMariaDB.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDbformariadb", new()
{
    ResourceGroupName = "string",
    ServerName = "string",
    PrivateEndpoint = new AzureNative.DBforMariaDB.Inputs.PrivateEndpointPropertyArgs
    {
        Id = "string",
    },
...
```go
example, err := dbformariadb.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromDbformariadb", &dbformariadb.PrivateEndpointConnectionArgs{
	ResourceGroupName: pulumi.String("string"),
	ServerName:        pulumi.String("string"),
	PrivateEndpoint: &dbformariadb.PrivateEndpointPropertyArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromDbformariadb = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDbformariadb", PrivateEndpointConnectionArgs.builder()
    .resourceGroupName("string")
    .serverName("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_dbformariadb = azure_native.dbformariadb.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDbformariadb",
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromDbformariadb = new azure_native.dbformariadb.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDbformariadb", {
    resourceGroupName: "string",
    serverName: "string",
    privateEndpoint: {
        id: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>DBfor<wbr>Maria<wbr>DB.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Property</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstateproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>DBfor<wbr>Maria<wbr>DB.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Property</a></span>
    </dt>
