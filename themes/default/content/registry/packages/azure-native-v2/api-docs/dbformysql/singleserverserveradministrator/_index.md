...
title_tag: "azure-native.dbformysql.SingleServerServerAdministrator"
meta_desc: "Documentation for the azure-native.dbformysql.SingleServerServerAdministrator resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:dbformysql:SingleServerServerAdministrator</span><span class="p"></span>
...
```java
var singleServerServerAdministratorResource = new SingleServerServerAdministrator("singleServerServerAdministratorResource", SingleServerServerAdministratorArgs.builder()
    .administratorType("string")
    .login("string")
    .resourceGroupName("string")
    .serverName("string")
