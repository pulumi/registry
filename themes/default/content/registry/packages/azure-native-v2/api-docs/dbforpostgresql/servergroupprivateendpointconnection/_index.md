...
---
title: "ServerGroupPrivateEndpointConnection"
title_tag: "azure-native.dbforpostgresql.ServerGroupPrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.dbforpostgresql.ServerGroupPrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ServerGroupPrivateEndpointConnection Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                         <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServerGroupPrivateEndpointConnection</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ServerGroupPrivateEndpointConnection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ServerGroupPrivateEndpointConnectionArgs</a></span>
    </dt>
...
```csharp
var serverGroupPrivateEndpointConnectionResource = new AzureNative.DBforPostgreSQL.ServerGroupPrivateEndpointConnection("serverGroupPrivateEndpointConnectionResource", new()
{
    ClusterName = "string",
    PrivateLinkServiceConnectionState = new AzureNative.DBforPostgreSQL.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := dbforpostgresql.NewServerGroupPrivateEndpointConnection(ctx, "serverGroupPrivateEndpointConnectionResource", &dbforpostgresql.ServerGroupPrivateEndpointConnectionArgs{
...
```java
var serverGroupPrivateEndpointConnectionResource = new ServerGroupPrivateEndpointConnection("serverGroupPrivateEndpointConnectionResource", ServerGroupPrivateEndpointConnectionArgs.builder()
    .clusterName("string")
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
...
```python
server_group_private_endpoint_connection_resource = azure_native.dbforpostgresql.ServerGroupPrivateEndpointConnection("serverGroupPrivateEndpointConnectionResource",
    cluster_name="string",
    private_link_service_connection_state={
...
```typescript
const serverGroupPrivateEndpointConnectionResource = new azure_native.dbforpostgresql.ServerGroupPrivateEndpointConnection("serverGroupPrivateEndpointConnectionResource", {
    clusterName: "string",
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
...
## ServerGroupPrivateEndpointConnection Resource Properties {#properties}
...
The ServerGroupPrivateEndpointConnection resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpointconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>The name of the private endpoint connection associated with the cluster.</dd></dl>
</pulumi-choosable>
</div>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ServerGroupPrivateEndpointConnection resource produces the following output properties:
