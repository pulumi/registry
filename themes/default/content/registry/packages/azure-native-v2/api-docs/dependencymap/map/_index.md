...
---
title: "Map"
title_tag: "azure-native.dependencymap.Map"
meta_desc: "Documentation for the azure-native.dependencymap.Map resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:dependencymap:Map</span><span class="p"></span>
...
```csharp
var mapResource = new AzureNative.DependencyMap.Map("mapResource", new()
{
...
```go
example, err := dependencymap.NewMap(ctx, "mapResource", &dependencymap.MapArgs{
...
```python
map_resource = azure_native.dependencymap.Map("mapResource",
...
```typescript
const mapResource = new azure_native.dependencymap.Map("mapResource", {
    resourceGroupName: "string",
    location: "string",
    mapName: "string",
    tags: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mapname_csharp" style="color: inherit; text-decoration: inherit;">Map<wbr>Name</a>
    ...
    <dd>Maps resource name</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
