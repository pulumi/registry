...
---
title: "getPlan"
title_tag: "azure-native.devcenter.getPlan"
meta_desc: "Documentation for the azure-native.devcenter.getPlan function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_plan<span class="p">(</span><span class="nx">plan_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_plan_output<span class="p">(</span><span class="nx">plan_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:devcenter:getPlan
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>The SKU for DevCenters created using this definition.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
