...
title_tag: "azure-native.devcenter.ProjectCatalog"
meta_desc: "Documentation for the azure-native.devcenter.ProjectCatalog resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ProjectCatalog Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">ado_git</span><span class="p">:</span> <span class="nx">Optional[GitCatalogArgs]</span> = None<span class="p">,</span>
                   <span class="nx">catalog_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                   <span class="nx">git_hub</span><span class="p">:</span> <span class="nx">Optional[GitCatalogArgs]</span> = None<span class="p">,</span>
                   <span class="nx">sync_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, CatalogSyncType]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewProjectCatalog</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ProjectCatalog</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ProjectCatalog</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ProjectCatalogArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:devcenter:ProjectCatalog</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ProjectCatalogArgs</a></span>
    </dt>
...
## ProjectCatalog Resource Properties {#properties}
...
The ProjectCatalog resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adogit_csharp" style="color: inherit; text-decoration: inherit;">Ado<wbr>Git</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitcatalog">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Center.<wbr>Inputs.<wbr>Git<wbr>Catalog</a></span>
    </dt>
    <dd>Properties for an Azure DevOps catalog type.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#catalogname_csharp" style="color: inherit; text-decoration: inherit;">Catalog<wbr>Name</a>
    ...
    <dd>The name of the Catalog.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#github_csharp" style="color: inherit; text-decoration: inherit;">Git<wbr>Hub</a>
    ...
    <dd>Properties for a GitHub catalog type.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#synctype_csharp" style="color: inherit; text-decoration: inherit;">Sync<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#catalogsynctype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Center.<wbr>Catalog<wbr>Sync<wbr>Type</a></span>
    </dt>
    <dd>Indicates the type of sync that is configured for the catalog.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adogit_go" style="color: inherit; text-decoration: inherit;">Ado<wbr>Git</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitcatalog">Git<wbr>Catalog<wbr>Args</a></span>
    </dt>
    <dd>Properties for an Azure DevOps catalog type.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#synctype_go" style="color: inherit; text-decoration: inherit;">Sync<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#catalogsynctype">Catalog<wbr>Sync<wbr>Type</a></span>
    </dt>
    <dd>Indicates the type of sync that is configured for the catalog.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adogit_java" style="color: inherit; text-decoration: inherit;">ado<wbr>Git</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitcatalog">Git<wbr>Catalog</a></span>
    </dt>
    <dd>Properties for an Azure DevOps catalog type.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sync_type_python" style="color: inherit; text-decoration: inherit;">sync_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#catalogsynctype">Catalog<wbr>Sync<wbr>Type</a></span>
    </dt>
    <dd>Indicates the type of sync that is configured for the catalog.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_python">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adogit_yaml" style="color: inherit; text-decoration: inherit;">ado<wbr>Git</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitcatalog">Property Map</a></span>
    </dt>
    <dd>Properties for an Azure DevOps catalog type.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#synctype_yaml" style="color: inherit; text-decoration: inherit;">sync<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#catalogsynctype">&#34;Manual&#34; | &#34;Scheduled&#34;</a></span>
    </dt>
    <dd>Indicates the type of sync that is configured for the catalog.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ProjectCatalog resource produces the following output properties:
...
<h4 id="catalogsynctype">
Catalog<wbr>Sync<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Catalog<wbr>Sync<wbr>Type<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Manual</dt>
    <dd>Manual</dd><dt>Scheduled</dt>
    <dd>Scheduled</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Catalog<wbr>Sync<wbr>Type<wbr>Manual</dt>
    <dd>Manual</dd><dt>Catalog<wbr>Sync<wbr>Type<wbr>Scheduled</dt>
    <dd>Scheduled</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="gitcatalog">
Git<wbr>Catalog<pulumi-choosable type="language" values="python,go" class="inline">, Git<wbr>Catalog<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="gitcatalogresponse">
Git<wbr>Catalog<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Git<wbr>Catalog<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="syncstatsresponse">
Sync<wbr>Stats<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Sync<wbr>Stats<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
