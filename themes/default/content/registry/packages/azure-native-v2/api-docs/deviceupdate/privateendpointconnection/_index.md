...
title_tag: "azure-native.deviceupdate.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.deviceupdate.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:deviceupdate:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromDeviceupdate = new AzureNative.DeviceUpdate.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDeviceupdate", new()
{
    AccountName = "string",
    PrivateLinkServiceConnectionState = new AzureNative.DeviceUpdate.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := deviceupdate.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromDeviceupdate", &deviceupdate.PrivateEndpointConnectionArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromDeviceupdate = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDeviceupdate", PrivateEndpointConnectionArgs.builder()
    .accountName("string")
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_deviceupdate = azure_native.deviceupdate.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDeviceupdate",
    account_name="string",
    private_link_service_connection_state={
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromDeviceupdate = new azure_native.deviceupdate.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromDeviceupdate", {
    accountName: "string",
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupids_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Ids</a>
    ...
    <dd>Array of group IDs.</dd><dt class="property-optional property-replacement"
            title="Optional">
