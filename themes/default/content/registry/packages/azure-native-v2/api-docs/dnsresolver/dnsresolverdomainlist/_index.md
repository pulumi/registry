...
---
title: "DnsResolverDomainList"
title_tag: "azure-native.dnsresolver.DnsResolverDomainList"
meta_desc: "Documentation for the azure-native.dnsresolver.DnsResolverDomainList resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create DnsResolverDomainList Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">dns_resolver_domain_list_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewDnsResolverDomainList</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">DnsResolverDomainList</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">DnsResolverDomainList</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DnsResolverDomainListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:dnsresolver:DnsResolverDomainList</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">DnsResolverDomainListArgs</a></span>
    </dt>
...
```csharp
var dnsResolverDomainListResource = new AzureNative.DnsResolver.DnsResolverDomainList("dnsResolverDomainListResource", new()
{
    Domains = new[]
    {
        "string",
...
```go
example, err := dnsresolver.NewDnsResolverDomainList(ctx, "dnsResolverDomainListResource", &dnsresolver.DnsResolverDomainListArgs{
	Domains: pulumi.StringArray{
		pulumi.String("string"),
	},
	ResourceGroupName:         pulumi.String("string"),
	DnsResolverDomainListName: pulumi.String("string"),
...
```java
var dnsResolverDomainListResource = new DnsResolverDomainList("dnsResolverDomainListResource", DnsResolverDomainListArgs.builder()
    .domains("string")
    .resourceGroupName("string")
    .dnsResolverDomainListName("string")
    .location("string")
...
```python
dns_resolver_domain_list_resource = azure_native.dnsresolver.DnsResolverDomainList("dnsResolverDomainListResource",
    domains=["string"],
    resource_group_name="string",
    dns_resolver_domain_list_name="string",
    location="string",
    tags={
        "string": "string",
    })
...
```typescript
const dnsResolverDomainListResource = new azure_native.dnsresolver.DnsResolverDomainList("dnsResolverDomainListResource", {
    domains: ["string"],
    resourceGroupName: "string",
    dnsResolverDomainListName: "string",
    location: "string",
...
## DnsResolverDomainList Resource Properties {#properties}
...
The DnsResolverDomainList resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#domains_csharp" style="color: inherit; text-decoration: inherit;">Domains</a>
    ...
    <dd>The domains in the domain list.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dnsresolverdomainlistname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Resolver<wbr>Domain<wbr>List<wbr>Name</a>
    ...
    <dd>The name of the DNS resolver domain list.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the DnsResolverDomainList resource produces the following output properties:
