...
title_tag: "azure-native.eventhub.getApplicationGroup"
meta_desc: "Documentation for the azure-native.eventhub.getApplicationGroup function with examples, input properties, output properties, and supporting types."
layout: api
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:eventhub:getApplicationGroup
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applicationgroupname_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Group<wbr>Name</a>
    ...
    <dd>The Application Group name</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clientappgroupidentifier_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>App<wbr>Group<wbr>Identifier</a>
    ...
    <dd>The Unique identifier for application group.Supports SAS(SASKeyName=KeyName) or AAD(AADAppID=Guid)</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#isenabled_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Enabled</a>
    ...
    <dd>Determines if Application Group is allowed to create connection with namespace or not. Once the isEnabled is set to false, all the existing connections of application group gets dropped and no new connections will be allowed</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policies_csharp" style="color: inherit; text-decoration: inherit;">Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#throttlingpolicyresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Event<wbr>Hub.<wbr>Outputs.<wbr>Throttling<wbr>Policy<wbr>Response&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policies_go" style="color: inherit; text-decoration: inherit;">Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#throttlingpolicyresponse">[]Throttling<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policies_java" style="color: inherit; text-decoration: inherit;">policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#throttlingpolicyresponse">List&lt;Throttling<wbr>Policy<wbr>Response&gt;</a></span>
    </dt>
    <dd>List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policies_python" style="color: inherit; text-decoration: inherit;">policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#throttlingpolicyresponse">Sequence[Throttling<wbr>Policy<wbr>Response]</a></span>
    </dt>
    <dd>List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#policies_yaml" style="color: inherit; text-decoration: inherit;">policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#throttlingpolicyresponse">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="throttlingpolicyresponse">Throttling<wbr>Policy<wbr>Response</h4>
