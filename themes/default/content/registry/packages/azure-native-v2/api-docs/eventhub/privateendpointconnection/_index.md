...
title_tag: "azure-native.eventhub.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.eventhub.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:eventhub:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromEventhub = new AzureNative.EventHub.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromEventhub", new()
{
...
```go
example, err := eventhub.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromEventhub", &eventhub.PrivateEndpointConnectionArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromEventhub = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromEventhub", PrivateEndpointConnectionArgs.builder()
    .namespaceName("string")
    .resourceGroupName("string")
    .privateEndpoint(PrivateEndpointArgs.builder()
        .id("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_eventhub = azure_native.eventhub.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromEventhub",
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromEventhub = new azure_native.eventhub.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromEventhub", {
    namespaceName: "string",
    resourceGroupName: "string",
    privateEndpoint: {
        id: "string",
