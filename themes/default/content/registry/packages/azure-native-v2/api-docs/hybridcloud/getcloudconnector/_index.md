...
title_tag: "azure-native.hybridcloud.getCloudConnector"
meta_desc: "Documentation for the azure-native.hybridcloud.getCloudConnector function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_cloud_connector<span class="p">(</span><span class="nx">cloud_connector_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_cloud_connector_output<span class="p">(</span><span class="nx">cloud_connector_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:hybridcloud:getCloudConnector
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudconnectorname_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Connector<wbr>Name</a>
    ...
    <dd>The name of the cloud connector resource</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>Account identifier of the remote cloud.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cloudtype_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Type</a>
    ...
    <dd>The cloud connector type.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
