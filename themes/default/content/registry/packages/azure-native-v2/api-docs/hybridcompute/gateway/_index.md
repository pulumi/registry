...
---
title: "Gateway"
title_tag: "azure-native.hybridcompute.Gateway"
meta_desc: "Documentation for the azure-native.hybridcompute.Gateway resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Gateway</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">allowed_features</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
            <span class="nx">gateway_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">gateway_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, GatewayType]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:hybridcompute:Gateway</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedfeatures_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Features</a>
    ...
    <dd>Specifies the list of features that are enabled for this Gateway.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewaytype_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#gatewaytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Compute.<wbr>Gateway<wbr>Type</a></span>
    </dt>
    <dd>The type of the Gateway resource.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewaytype_yaml" style="color: inherit; text-decoration: inherit;">gateway<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#gatewaytype">&#34;Public&#34;</a></span>
    </dt>
    <dd>The type of the Gateway resource.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Gateway<wbr>Type<wbr>Public</dt>
    <dd>Public</dd></dl>
</pulumi-choosable>
</div>
