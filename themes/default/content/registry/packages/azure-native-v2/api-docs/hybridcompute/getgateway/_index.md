...
---
title: "getGateway"
title_tag: "azure-native.hybridcompute.getGateway"
meta_desc: "Documentation for the azure-native.hybridcompute.getGateway function with examples, input properties, output properties, and supporting types."
layout: api
...
Other available API versions: 2024-03-31-preview, 2025-01-13.
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:hybridcompute:getGateway
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewayendpoint_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Endpoint</a>
    ...
    <dd>The endpoint fqdn for the Gateway.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewayid_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Id</a>
    ...
    <dd>A unique, immutable, identifier for the Gateway.</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowedfeatures_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Features</a>
    ...
    <dd>Specifies the list of features that are enabled for this Gateway.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewaytype_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Type</a>
    ...
    <dd>The type of the Gateway resource.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
