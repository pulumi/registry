...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:hybridcompute:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromHybridcompute = new AzureNative.HybridCompute.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromHybridcompute", new()
{
    ...
    Properties = new AzureNative.HybridCompute.Inputs.PrivateEndpointConnectionPropertiesArgs
    {
        PrivateEndpoint = new AzureNative.HybridCompute.Inputs.PrivateEndpointPropertyArgs
        {
            Id = "string",
        },
        PrivateLinkServiceConnectionState = new AzureNative.HybridCompute.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
...
```go
example, err := hybridcompute.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromHybridcompute", &hybridcompute.PrivateEndpointConnectionArgs{
	ResourceGroupName:             pulumi.String("string"),
	ScopeName:                     pulumi.String("string"),
	PrivateEndpointConnectionName: pulumi.String("string"),
	Properties: &hybridcompute.PrivateEndpointConnectionPropertiesArgs{
		PrivateEndpoint: &hybridcompute.PrivateEndpointPropertyArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromHybridcompute = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromHybridcompute", PrivateEndpointConnectionArgs.builder()
    .resourceGroupName("string")
    .scopeName("string")
    .privateEndpointConnectionName("string")
    .properties(PrivateEndpointConnectionPropertiesArgs.builder()
...
```python
exampleprivate_endpoint_connection_resource_resource_from_hybridcompute = azure_native.hybridcompute.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromHybridcompute",
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromHybridcompute = new azure_native.hybridcompute.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromHybridcompute", {
    resourceGroupName: "string",
    scopeName: "string",
    privateEndpointConnectionName: "string",
    properties: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scopename_csharp" style="color: inherit; text-decoration: inherit;">Scope<wbr>Name</a>
    ...
    <dd>The name of the Azure Arc PrivateLinkScope resource.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointconnectionproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Compute.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Compute.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Property</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstateproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Compute.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Property</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpoint_yaml" style="color: inherit; text-decoration: inherit;">private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointproperty">Property Map</a></span>
    </dt>
    <dd>Private endpoint which the connection belongs to.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_yaml" style="color: inherit; text-decoration: inherit;">private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstateproperty">Property Map</a></span>
    </dt>
    <dd>Connection state of the private endpoint connection.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="privateendpointproperty">
Private<wbr>Endpoint<wbr>Property<pulumi-choosable type="language" values="python,go" class="inline">, Private<wbr>Endpoint<wbr>Property<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="privatelinkserviceconnectionstateproperty">
Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Property<pulumi-choosable type="language" values="python,go" class="inline">, Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Property<wbr>Args</pulumi-choosable>
</h4>
