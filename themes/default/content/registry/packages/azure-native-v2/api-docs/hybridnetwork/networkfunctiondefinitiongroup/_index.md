...
---
title: "NetworkFunctionDefinitionGroup"
title_tag: "azure-native.hybridnetwork.NetworkFunctionDefinitionGroup"
meta_desc: "Documentation for the azure-native.hybridnetwork.NetworkFunctionDefinitionGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create NetworkFunctionDefinitionGroup Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   ...
                                   <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[NetworkFunctionDefinitionGroupPropertiesFormatArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewNetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">NetworkFunctionDefinitionGroup</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">NetworkFunctionDefinitionGroup</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:hybridnetwork:NetworkFunctionDefinitionGroup</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">NetworkFunctionDefinitionGroupArgs</a></span>
    </dt>
...
```csharp
var networkFunctionDefinitionGroupResource = new AzureNative.HybridNetwork.NetworkFunctionDefinitionGroup("networkFunctionDefinitionGroupResource", new()
{
    PublisherName = "string",
    ResourceGroupName = "string",
    Location = "string",
    NetworkFunctionDefinitionGroupName = "string",
    Properties = new AzureNative.HybridNetwork.Inputs.NetworkFunctionDefinitionGroupPropertiesFormatArgs
    {
        Description = "string",
    },
    Tags = 
...
```go
example, err := hybridnetwork.NewNetworkFunctionDefinitionGroup(ctx, "networkFunctionDefinitionGroupResource", &hybridnetwork.NetworkFunctionDefinitionGroupArgs{
	PublisherName:                      pulumi.String("string"),
	ResourceGroupName:                  pulumi.String("string"),
	Location:                           pulumi.String("string"),
	NetworkFunctionDefinitionGroupName: pulumi.String("string"),
	Properties: &hybridnetwork.NetworkFunctionDefinitionGroupPropertiesFormatArgs{
...
```java
var networkFunctionDefinitionGroupResource = new NetworkFunctionDefinitionGroup("networkFunctionDefinitionGroupResource", NetworkFunctionDefinitionGroupArgs.builder()
    .publisherName("string")
    .resourceGroupName("string")
    .location("string")
    .networkFunctionDefinitionGroupName("string")
    .properties(NetworkFunctionDefinitionGroupPropertiesFormatArgs.builder()
        .description("string")
        .build())
...
```python
network_function_definition_group_resource = azure_native.hybridnetwork.NetworkFunctionDefinitionGroup("networkFunctionDefinitionGroupResource",
...
```typescript
const networkFunctionDefinitionGroupResource = new azure_native.hybridnetwork.NetworkFunctionDefinitionGroup("networkFunctionDefinitionGroupResource", {
    publisherName: "string",
    resourceGroupName: "string",
    location: "string",
    networkFunctionDefinitionGroupName: "string",
...
## NetworkFunctionDefinitionGroup Resource Properties {#properties}
...
The NetworkFunctionDefinitionGroup resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networkfunctiondefinitiongroupname_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Name</a>
    ...
    <dd>The name of the network function definition group.</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkfunctiondefinitiongrouppropertiesformat">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Network.<wbr>Inputs.<wbr>Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format</a></span>
    </dt>
    <dd>Network function definition group properties.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkfunctiondefinitiongrouppropertiesformat">Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format<wbr>Args</a></span>
    </dt>
    <dd>Network function definition group properties.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkfunctiondefinitiongrouppropertiesformat">Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format</a></span>
    </dt>
    <dd>Network function definition group properties.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_java">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkfunctiondefinitiongrouppropertiesformat">Property Map</a></span>
    </dt>
    <dd>Network function definition group properties.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NetworkFunctionDefinitionGroup resource produces the following output properties:
...
<h4 id="networkfunctiondefinitiongrouppropertiesformat">
Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>The network function definition group description.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="networkfunctiondefinitiongrouppropertiesformatresponse">
Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Function<wbr>Definition<wbr>Group<wbr>Properties<wbr>Format<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>The provisioning state of the network function definition groups resource.</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
