...
---
title: "Space"
title_tag: "azure-native.integrationspaces.Space"
meta_desc: "Documentation for the azure-native.integrationspaces.Space resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:integrationspaces:Space</span><span class="p"></span>
...
```csharp
var spaceResource = new AzureNative.IntegrationSpaces.Space("spaceResource", new()
{
...
```go
example, err := integrationspaces.NewSpace(ctx, "spaceResource", &integrationspaces.SpaceArgs{
...
```python
space_resource = azure_native.integrationspaces.Space("spaceResource",
...
```typescript
const spaceResource = new azure_native.integrationspaces.Space("spaceResource", {
    resourceGroupName: "string",
    description: "string",
    location: "string",
    spaceName: "string",
