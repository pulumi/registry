...
title_tag: "azure-native.iotcentral.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.iotcentral.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:iotcentral:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromIotcentral = new AzureNative.IoTCentral.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromIotcentral", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.IoTCentral.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := iotcentral.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromIotcentral", &iotcentral.PrivateEndpointConnectionArgs{
	PrivateLinkServiceConnectionState: &iotcentral.PrivateLinkServiceConnectionStateArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromIotcentral = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromIotcentral", PrivateEndpointConnectionArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_iotcentral = azure_native.iotcentral.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromIotcentral",
    private_link_service_connection_state={
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromIotcentral = new azure_native.iotcentral.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromIotcentral", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TCentral.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>The ARM resource name of the IoT Central application.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpointconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>The private endpoint connection name.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#privateendpointserviceconnectionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TCentral.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</a></span>
    </dt>
