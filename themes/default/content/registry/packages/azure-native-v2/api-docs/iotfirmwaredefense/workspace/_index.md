...
---
title: "Workspace"
title_tag: "azure-native.iotfirmwaredefense.Workspace"
meta_desc: "Documentation for the azure-native.iotfirmwaredefense.Workspace resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:iotfirmwaredefense:Workspace</span><span class="p"></span>
...
```csharp
var exampleworkspaceResourceResourceFromIotfirmwaredefense = new AzureNative.IoTFirmwareDefense.Workspace("exampleworkspaceResourceResourceFromIotfirmwaredefense", new()
{
...
```go
example, err := iotfirmwaredefense.NewWorkspace(ctx, "exampleworkspaceResourceResourceFromIotfirmwaredefense", &iotfirmwaredefense.WorkspaceArgs{
...
```java
var exampleworkspaceResourceResourceFromIotfirmwaredefense = new Workspace("exampleworkspaceResourceResourceFromIotfirmwaredefense", WorkspaceArgs.builder()
    .resourceGroupName("string")
    .location("string")
...
```python
exampleworkspace_resource_resource_from_iotfirmwaredefense = azure_native.iotfirmwaredefense.Workspace("exampleworkspaceResourceResourceFromIotfirmwaredefense",
...
```typescript
const exampleworkspaceResourceResourceFromIotfirmwaredefense = new azure_native.iotfirmwaredefense.Workspace("exampleworkspaceResourceResourceFromIotfirmwaredefense", {
    resourceGroupName: "string",
    location: "string",
    tags: {
        string: "string",
