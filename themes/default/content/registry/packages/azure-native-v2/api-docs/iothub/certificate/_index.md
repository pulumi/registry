...
---
title: "Certificate"
title_tag: "azure-native.iothub.Certificate"
meta_desc: "Documentation for the azure-native.iothub.Certificate resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:iothub:Certificate</span><span class="p"></span>
...
```csharp
var examplecertificateResourceResourceFromIothub = new AzureNative.IoTHub.Certificate("examplecertificateResourceResourceFromIothub", new()
{
...
```go
example, err := iothub.NewCertificate(ctx, "examplecertificateResourceResourceFromIothub", &iothub.CertificateArgs{
...
```java
var examplecertificateResourceResourceFromIothub = new Certificate("examplecertificateResourceResourceFromIothub", CertificateArgs.builder()
    .resourceGroupName("string")
    .resourceName("string")
    .certificateName("string")
    .properties(CertificatePropertiesArgs.builder()
...
```python
examplecertificate_resource_resource_from_iothub = azure_native.iothub.Certificate("examplecertificateResourceResourceFromIothub",
...
```typescript
const examplecertificateResourceResourceFromIothub = new azure_native.iothub.Certificate("examplecertificateResourceResourceFromIothub", {
    resourceGroupName: "string",
    resourceName: "string",
    certificateName: "string",
    properties: {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatename_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Name</a>
    ...
    <dd>The name of the certificate</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificateproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>THub.<wbr>Inputs.<wbr>Certificate<wbr>Properties</a></span>
    </dt>
    <dd>The description of an X509 CA Certificate.</dd></dl>
</pulumi-choosable>
</div>
