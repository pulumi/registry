...
---
title: "getPipeline"
title_tag: "azure-native.iotoperationsdataprocessor.getPipeline"
meta_desc: "Documentation for the azure-native.iotoperationsdataprocessor.getPipeline function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_pipeline<span class="p">(</span><span class="nx">instance_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_pipeline_output<span class="p">(</span><span class="nx">instance_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
><span class="k">
func </span>LookupPipelineOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupPipelineOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupPipelineResultOutput</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetPipelineResult</a></span>> </span>getPipeline<span class="p">(</span><span class="nx">GetPipelineArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetPipelineResult</a></span>> </span>getPipeline<span class="p">(</span><span class="nx">GetPipelineArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:iotoperationsdataprocessor:getPipeline
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pipelinename_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Name</a>
    ...
    <dd>Name of pipeline</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Flag indicating whether the pipeline should be running or not.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_csharp" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinputresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TOperations<wbr>Data<wbr>Processor.<wbr>Outputs.<wbr>Pipeline<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_csharp" style="color: inherit; text-decoration: inherit;">Stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TOperations<wbr>Data<wbr>Processor.<wbr>Outputs.<wbr>Pipeline<wbr>Stage<wbr>Response&gt;</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Detailed description of the Pipeline.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_go" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinputresponse">Pipeline<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-"
            title="">
        <span id="location_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_go" style="color: inherit; text-decoration: inherit;">Stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">map[string]Pipeline<wbr>Stage<wbr>Response</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_nodejs" style="color: inherit; text-decoration: inherit;">stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">{[key: string]: Pipeline<wbr>Stage<wbr>Response}</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_python" style="color: inherit; text-decoration: inherit;">stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, Pipeline<wbr>Stage<wbr>Response]</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_yaml" style="color: inherit; text-decoration: inherit;">input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinputresponse">Property Map</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-"
            title="">
...
<h4 id="pipelineinputresponse">Pipeline<wbr>Input<wbr>Response</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#next_csharp" style="color: inherit; text-decoration: inherit;">Next</a>
    ...
    <dd>Next stage in the pipeline.</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
    ...
    <dd>ARM resource type.</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
    ...
    <dd>Description for stage.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="pipelinestageresponse">Pipeline<wbr>Stage<wbr>Response</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Description for stage.</dd><dt class="property-optional"
            title="Optional">
        <span id="next_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#next_csharp" style="color: inherit; text-decoration: inherit;">Next</a>
</span>
    ...
    <dd>Next stage in the pipeline. Not required if output stage.</dd></dl>
</pulumi-choosable>
</div>
