...
---
title: "Pipeline"
title_tag: "azure-native.iotoperationsdataprocessor.Pipeline"
meta_desc: "Documentation for the azure-native.iotoperationsdataprocessor.Pipeline resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Pipeline</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">input</span><span class="p">:</span> <span class="nx">Optional[PipelineInputArgs]</span> = None<span class="p">,</span>
             ...
             <span class="nx">stages</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, PipelineStageArgs]]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:iotoperationsdataprocessor:Pipeline</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>Flag indicating whether the pipeline should be running or not.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
    ...
    <dd>Edge location of the resource.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_csharp" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinput">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TOperations<wbr>Data<wbr>Processor.<wbr>Inputs.<wbr>Pipeline<wbr>Input</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_csharp" style="color: inherit; text-decoration: inherit;">Stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TOperations<wbr>Data<wbr>Processor.<wbr>Inputs.<wbr>Pipeline<wbr>Stage<wbr>Args&gt;</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>Detailed description of the Pipeline.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pipelinename_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Name</a>
    ...
    <dd>Name of pipeline</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_go" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinput">Pipeline<wbr>Input<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_go" style="color: inherit; text-decoration: inherit;">Stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">map[string]Pipeline<wbr>Stage<wbr>Args</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_java" style="color: inherit; text-decoration: inherit;">input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinput">Pipeline<wbr>Input</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_nodejs" style="color: inherit; text-decoration: inherit;">stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">{[key: string]: Pipeline<wbr>Stage<wbr>Args}</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_python" style="color: inherit; text-decoration: inherit;">input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinput">Pipeline<wbr>Input<wbr>Args</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stages_python" style="color: inherit; text-decoration: inherit;">stages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, Pipeline<wbr>Stage<wbr>Args]</span>
    </dt>
    <dd>Map of stage ids to stage configurations for all pipeline processing and output stages.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#input_yaml" style="color: inherit; text-decoration: inherit;">input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineinput">Property Map</a></span>
    </dt>
    <dd>Information about where to pull input data from.</dd><dt class="property-required property-replacement"
            title="Required">
...
<h4 id="pipelineinput">
Pipeline<wbr>Input<pulumi-choosable type="language" values="python,go" class="inline">, Pipeline<wbr>Input<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="pipelineinputresponse">
Pipeline<wbr>Input<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Pipeline<wbr>Input<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="pipelinestageresponse">
Pipeline<wbr>Stage<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Pipeline<wbr>Stage<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
