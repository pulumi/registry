...
title_tag: "azure-native.iotoperationsmq.getBrokerAuthorization"
meta_desc: "Documentation for the azure-native.iotoperationsmq.getBrokerAuthorization function with examples, input properties, output properties, and supporting types."
layout: api
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:iotoperationsmq:getBrokerAuthorization
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authorizationname_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Name</a>
    ...
    <dd>Name of MQ broker/authorization resource</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authorizationpolicies_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authorizationconfigresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TOperations<wbr>MQ.<wbr>Outputs.<wbr>Authorization<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>The list of authorization policies supported by the Authorization Resource.</dd><dt class="property-"
            title="">
...
<h4 id="authorizationbasicruleresponse">Authorization<wbr>Basic<wbr>Rule<wbr>Response</h4>
...
<h4 id="resourceinfodefinitionresponse">Resource<wbr>Info<wbr>Definition<wbr>Response</h4>
