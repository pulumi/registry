...
title_tag: "azure-native.kusto.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.kusto.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:kusto:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromKusto = new AzureNative.Kusto.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromKusto", new()
{
    ClusterName = "string",
    PrivateLinkServiceConnectionState = new AzureNative.Kusto.Inputs.PrivateLinkServiceConnectionStatePropertyArgs
    {
...
```go
example, err := kusto.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromKusto", &kusto.PrivateEndpointConnectionArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromKusto = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromKusto", PrivateEndpointConnectionArgs.builder()
    .clusterName("string")
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStatePropertyArgs.builder()
        .description("string")
        .status("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_kusto = azure_native.kusto.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromKusto",
    cluster_name="string",
    private_link_service_connection_state={
        "description": "string",
        "status": "string",
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromKusto = new azure_native.kusto.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromKusto", {
    clusterName: "string",
    privateLinkServiceConnectionState: {
        description: "string",
        status: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstateproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>Kusto.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Property</a></span>
    </dt>
    <dd>Connection State of the Private Endpoint Connection.</dd><dt class="property-required property-replacement"
            title="Required">
