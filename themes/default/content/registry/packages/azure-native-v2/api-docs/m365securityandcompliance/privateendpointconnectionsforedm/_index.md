...
title_tag: "azure-native.m365securityandcompliance.PrivateEndpointConnectionsForEDM"
meta_desc: "Documentation for the azure-native.m365securityandcompliance.PrivateEndpointConnectionsForEDM resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:m365securityandcompliance:PrivateEndpointConnectionsForEDM</span><span class="p"></span>
...
```csharp
var privateEndpointConnectionsForEDMResource = new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsForEDM("privateEndpointConnectionsForEDMResource", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.M365SecurityAndCompliance.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := m365securityandcompliance.NewPrivateEndpointConnectionsForEDM(ctx, "privateEndpointConnectionsForEDMResource", &m365securityandcompliance.PrivateEndpointConnectionsForEDMArgs{
	PrivateLinkServiceConnectionState: &m365securityandcompliance.PrivateLinkServiceConnectionStateArgs{
...
```java
var privateEndpointConnectionsForEDMResource = new PrivateEndpointConnectionsForEDM("privateEndpointConnectionsForEDMResource", PrivateEndpointConnectionsForEDMArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
private_endpoint_connections_for_edm_resource = azure_native.m365securityandcompliance.PrivateEndpointConnectionsForEDM("privateEndpointConnectionsForEDMResource",
    private_link_service_connection_state={
...
```typescript
const privateEndpointConnectionsForEDMResource = new azure_native.m365securityandcompliance.PrivateEndpointConnectionsForEDM("privateEndpointConnectionsForEDMResource", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
