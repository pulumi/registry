...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell</span><span class="p"></span>
...
```csharp
var privateEndpointConnectionsForSCCPowershellResource = new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsForSCCPowershell("privateEndpointConnectionsForSCCPowershellResource", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.M365SecurityAndCompliance.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := m365securityandcompliance.NewPrivateEndpointConnectionsForSCCPowershell(ctx, "privateEndpointConnectionsForSCCPowershellResource", &m365securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs{
	PrivateLinkServiceConnectionState: &m365securityandcompliance.PrivateLinkServiceConnectionStateArgs{
...
```java
var privateEndpointConnectionsForSCCPowershellResource = new PrivateEndpointConnectionsForSCCPowershell("privateEndpointConnectionsForSCCPowershellResource", PrivateEndpointConnectionsForSCCPowershellArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
private_endpoint_connections_for_scc_powershell_resource = azure_native.m365securityandcompliance.PrivateEndpointConnectionsForSCCPowershell("privateEndpointConnectionsForSCCPowershellResource",
    private_link_service_connection_state={
...
```typescript
const privateEndpointConnectionsForSCCPowershellResource = new azure_native.m365securityandcompliance.PrivateEndpointConnectionsForSCCPowershell("privateEndpointConnectionsForSCCPowershellResource", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
