...
title_tag: "azure-native.m365securityandcompliance.PrivateEndpointConnectionsSec"
meta_desc: "Documentation for the azure-native.m365securityandcompliance.PrivateEndpointConnectionsSec resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:m365securityandcompliance:PrivateEndpointConnectionsSec</span><span class="p"></span>
...
```csharp
var privateEndpointConnectionsSecResource = new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsSec("privateEndpointConnectionsSecResource", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.M365SecurityAndCompliance.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := m365securityandcompliance.NewPrivateEndpointConnectionsSec(ctx, "privateEndpointConnectionsSecResource", &m365securityandcompliance.PrivateEndpointConnectionsSecArgs{
	PrivateLinkServiceConnectionState: &m365securityandcompliance.PrivateLinkServiceConnectionStateArgs{
...
```java
var privateEndpointConnectionsSecResource = new PrivateEndpointConnectionsSec("privateEndpointConnectionsSecResource", PrivateEndpointConnectionsSecArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
private_endpoint_connections_sec_resource = azure_native.m365securityandcompliance.PrivateEndpointConnectionsSec("privateEndpointConnectionsSecResource",
    private_link_service_connection_state={
...
```typescript
const privateEndpointConnectionsSecResource = new azure_native.m365securityandcompliance.PrivateEndpointConnectionsSec("privateEndpointConnectionsSecResource", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
