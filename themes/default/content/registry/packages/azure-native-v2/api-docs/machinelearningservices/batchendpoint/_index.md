...
## Create BatchEndpoint Resource {#create}
...
<span class="k">def </span><span class="nx">BatchEndpoint</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                  <span class="nx">batch_endpoint_properties</span><span class="p">:</span> <span class="nx">Optional[BatchEndpointArgs]</span> = None<span class="p">,</span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewBatchEndpoint</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">BatchEndpointArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">BatchEndpoint</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">BatchEndpoint</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">BatchEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">BatchEndpoint</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">BatchEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:machinelearningservices:BatchEndpoint</span><span class="p"></span>
...
{
    BatchEndpointProperties = new AzureNative.MachineLearningServices.Inputs.BatchEndpointArgs
    {
        AuthMode = "string",
        Defaults = new AzureNative.MachineLearningServices.Inputs.BatchEndpointDefaultsArgs
        {
...
example, err := machinelearningservices.NewBatchEndpoint(ctx, "batchEndpointResource", &machinelearningservices.BatchEndpointArgs{
	BatchEndpointProperties: &machinelearningservices.BatchEndpointTypeArgs{
		AuthMode: pulumi.String("string"),
		Defaults: &machinelearningservices.BatchEndpointDefaultsArgs{
...
var batchEndpointResource = new BatchEndpoint("batchEndpointResource", BatchEndpointArgs.builder()
    .batchEndpointProperties(BatchEndpointArgs.builder()
        .authMode("string")
        .defaults(BatchEndpointDefaultsArgs.builder()
            .deploymentName("string")
            .build())
        .description("string")
...
The BatchEndpoint resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batchendpointproperties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batchendpointproperties_csharp" style="color: inherit; text-decoration: inherit;">Batch<wbr>Endpoint<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpoint">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Batch<wbr>Endpoint</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#endpointname_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Name</a>
    ...
    <dd>Name for the Batch inference endpoint.</dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batchendpointproperties_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batchendpointproperties_go" style="color: inherit; text-decoration: inherit;">Batch<wbr>Endpoint<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batchendpointproperties_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batchendpointproperties_java" style="color: inherit; text-decoration: inherit;">batch<wbr>Endpoint<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpoint">Batch<wbr>Endpoint</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batchendpointproperties_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batchendpointproperties_nodejs" style="color: inherit; text-decoration: inherit;">batch<wbr>Endpoint<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpoint">Batch<wbr>Endpoint</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batch_endpoint_properties_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batch_endpoint_properties_python" style="color: inherit; text-decoration: inherit;">batch_<wbr>endpoint_<wbr>properties</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="batchendpointproperties_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#batchendpointproperties_yaml" style="color: inherit; text-decoration: inherit;">batch<wbr>Endpoint<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpoint">Property Map</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<h4 id="batchendpoint">
Batch<wbr>Endpoint<pulumi-choosable type="language" values="python,go" class="inline">, Batch<wbr>Endpoint<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_csharp" style="color: inherit; text-decoration: inherit;">Defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Batch<wbr>Endpoint<wbr>Defaults</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>Property dictionary. Properties can be added, but not removed or altered.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_go" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_go" style="color: inherit; text-decoration: inherit;">Defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Batch<wbr>Endpoint<wbr>Defaults</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_java" style="color: inherit; text-decoration: inherit;">auth<wbr>Mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_java" style="color: inherit; text-decoration: inherit;">defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Batch<wbr>Endpoint<wbr>Defaults</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_nodejs" style="color: inherit; text-decoration: inherit;">auth<wbr>Mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_nodejs" style="color: inherit; text-decoration: inherit;">defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Batch<wbr>Endpoint<wbr>Defaults</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#auth_mode_python" style="color: inherit; text-decoration: inherit;">auth_<wbr>mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_python" style="color: inherit; text-decoration: inherit;">defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Batch<wbr>Endpoint<wbr>Defaults</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_yaml" style="color: inherit; text-decoration: inherit;">auth<wbr>Mode</a>
    ...
    <dd>[Required] The authentication method for invoking the endpoint (data plane operation). Use 'Key' for key-based authentication. Use 'AMLToken' for Azure Machine Learning token-based authentication. Use 'AADToken' for Microsoft Entra token-based authentication.</dd><dt class="property-optional"
            title="Optional">
        <span id="defaults_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_yaml" style="color: inherit; text-decoration: inherit;">defaults</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaults">Property Map</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="batchendpointdefaults">
Batch<wbr>Endpoint<wbr>Defaults<pulumi-choosable type="language" values="python,go" class="inline">, Batch<wbr>Endpoint<wbr>Defaults<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deploymentname_csharp" style="color: inherit; text-decoration: inherit;">Deployment<wbr>Name</a>
    ...
    <dd>Name of the deployment that will be default for the endpoint.
This deployment will end up getting 100% traffic when the endpoint scoring URL is invoked.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="batchendpointdefaultsresponse">
Batch<wbr>Endpoint<wbr>Defaults<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Batch<wbr>Endpoint<wbr>Defaults<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="batchendpointresponse">
Batch<wbr>Endpoint<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Batch<wbr>Endpoint<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_csharp" style="color: inherit; text-decoration: inherit;">Defaults</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaultsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Batch<wbr>Endpoint<wbr>Defaults<wbr>Response</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_go" style="color: inherit; text-decoration: inherit;">Defaults</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaultsresponse">Batch<wbr>Endpoint<wbr>Defaults<wbr>Response</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
        <span id="description_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaults_yaml" style="color: inherit; text-decoration: inherit;">defaults</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchendpointdefaultsresponse">Property Map</a></span>
    </dt>
    <dd>Default values for Batch Endpoint</dd><dt class="property-optional"
            title="Optional">
        <span id="description_yaml">
