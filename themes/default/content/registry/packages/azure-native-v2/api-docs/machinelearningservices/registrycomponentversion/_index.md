...
---
title: "RegistryComponentVersion"
title_tag: "azure-native.machinelearningservices.RegistryComponentVersion"
meta_desc: "Documentation for the azure-native.machinelearningservices.RegistryComponentVersion resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create RegistryComponentVersion Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">component_version_properties</span><span class="p">:</span> <span class="nx">Optional[ComponentVersionArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRegistryComponentVersion</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RegistryComponentVersion</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">RegistryComponentVersion</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RegistryComponentVersionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:machinelearningservices:RegistryComponentVersion</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">RegistryComponentVersionArgs</a></span>
    </dt>
...
```csharp
var registryComponentVersionResource = new AzureNative.MachineLearningServices.RegistryComponentVersion("registryComponentVersionResource", new()
{
    ComponentName = "string",
    ComponentVersionProperties = new AzureNative.MachineLearningServices.Inputs.ComponentVersionArgs
    {
...
```go
example, err := machinelearningservices.NewRegistryComponentVersion(ctx, "registryComponentVersionResource", &machinelearningservices.RegistryComponentVersionArgs{
	ComponentName: pulumi.String("string"),
	ComponentVersionProperties: &machinelearningservices.ComponentVersionTypeArgs{
		ComponentSpec: pulumi.Any("any"),
		Description:   pulumi.String("string"),
		IsAnonymous:   pulumi.Bool(false),
...
```java
var registryComponentVersionResource = new RegistryComponentVersion("registryComponentVersionResource", RegistryComponentVersionArgs.builder()
    .componentName("string")
    .componentVersionProperties(ComponentVersionArgs.builder()
        .componentSpec("any")
        .description("string")
...
```python
registry_component_version_resource = azure_native.machinelearningservices.RegistryComponentVersion("registryComponentVersionResource",
    component_name="string",
    component_version_properties={
        "component_spec": "any",
        "description": "string",
...
```typescript
const registryComponentVersionResource = new azure_native.machinelearningservices.RegistryComponentVersion("registryComponentVersionResource", {
    componentName: "string",
    componentVersionProperties: {
        componentSpec: "any",
        description: "string",
...
## RegistryComponentVersion Resource Properties {#properties}
...
The RegistryComponentVersion resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentname_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="componentversionproperties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentversionproperties_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Version<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Component<wbr>Version</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentname_go" style="color: inherit; text-decoration: inherit;">Component<wbr>Name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="componentversionproperties_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentversionproperties_go" style="color: inherit; text-decoration: inherit;">Component<wbr>Version<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Component<wbr>Version<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentname_java" style="color: inherit; text-decoration: inherit;">component<wbr>Name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="componentversionproperties_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentversionproperties_java" style="color: inherit; text-decoration: inherit;">component<wbr>Version<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Component<wbr>Version</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentname_nodejs" style="color: inherit; text-decoration: inherit;">component<wbr>Name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="componentversionproperties_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentversionproperties_nodejs" style="color: inherit; text-decoration: inherit;">component<wbr>Version<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Component<wbr>Version</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#component_name_python" style="color: inherit; text-decoration: inherit;">component_<wbr>name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="component_version_properties_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#component_version_properties_python" style="color: inherit; text-decoration: inherit;">component_<wbr>version_<wbr>properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Component<wbr>Version<wbr>Args</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentname_yaml" style="color: inherit; text-decoration: inherit;">component<wbr>Name</a>
    ...
    <dd>Container name.</dd><dt class="property-required"
            title="Required">
        <span id="componentversionproperties_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentversionproperties_yaml" style="color: inherit; text-decoration: inherit;">component<wbr>Version<wbr>Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#componentversion">Property Map</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RegistryComponentVersion resource produces the following output properties:
...
<h4 id="componentversion">
Component<wbr>Version<pulumi-choosable type="language" values="python,go" class="inline">, Component<wbr>Version<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="componentspec_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Spec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">object</span>
    </dt>
    <dd>Defines Component definition details.
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="componentspec_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_go" style="color: inherit; text-decoration: inherit;">Component<wbr>Spec</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="componentspec_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_java" style="color: inherit; text-decoration: inherit;">component<wbr>Spec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Object</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="componentspec_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_nodejs" style="color: inherit; text-decoration: inherit;">component<wbr>Spec</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="component_spec_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#component_spec_python" style="color: inherit; text-decoration: inherit;">component_<wbr>spec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Any</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="componentspec_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_yaml" style="color: inherit; text-decoration: inherit;">component<wbr>Spec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Any</span>
    </dt>
...
<h4 id="componentversionresponse">
Component<wbr>Version<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Component<wbr>Version<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>Provisioning state for the component version.</dd><dt class="property-optional"
            title="Optional">
        <span id="componentspec_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#componentspec_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Spec</a>
</span>
