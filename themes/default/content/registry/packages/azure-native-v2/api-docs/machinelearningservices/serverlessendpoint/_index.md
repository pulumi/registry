...
---
title: "ServerlessEndpoint"
title_tag: "azure-native.machinelearningservices.ServerlessEndpoint"
meta_desc: "Documentation for the azure-native.machinelearningservices.ServerlessEndpoint resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ServerlessEndpoint Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ServerlessEndpointArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ServerlessEndpointInitArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">serverless_endpoint_properties</span><span class="p">:</span> <span class="nx">Optional[ServerlessEndpointArgs]</span> = None<span class="p">,</span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewServerlessEndpoint</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ServerlessEndpointArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServerlessEndpoint</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerlessEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerlessEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ServerlessEndpoint</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ServerlessEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:machinelearningservices:ServerlessEndpoint</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ServerlessEndpointArgs</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ServerlessEndpointInitArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
## ServerlessEndpoint Resource Properties {#properties}
...
The ServerlessEndpoint resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serverlessendpointproperties_csharp" style="color: inherit; text-decoration: inherit;">Serverless<wbr>Endpoint<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverlessendpoint">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Serverless<wbr>Endpoint</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Serverless Endpoint name.</dd><dt class="property-optional"
            title="Optional">
        <span id="sku_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serverlessendpointproperties_go" style="color: inherit; text-decoration: inherit;">Serverless<wbr>Endpoint<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverlessendpoint">Serverless<wbr>Endpoint<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serverlessendpointproperties_java" style="color: inherit; text-decoration: inherit;">serverless<wbr>Endpoint<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverlessendpoint">Serverless<wbr>Endpoint</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serverless_endpoint_properties_python" style="color: inherit; text-decoration: inherit;">serverless_<wbr>endpoint_<wbr>properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverlessendpoint">Serverless<wbr>Endpoint<wbr>Args</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serverlessendpointproperties_yaml" style="color: inherit; text-decoration: inherit;">serverless<wbr>Endpoint<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverlessendpoint">Property Map</a></span>
    </dt>
    <dd>[Required] Additional attributes of the entity.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ServerlessEndpoint resource produces the following output properties:
...
<h4 id="contentsafety">
Content<wbr>Safety<pulumi-choosable type="language" values="python,go" class="inline">, Content<wbr>Safety<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafetystatus_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Safety<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#contentsafetystatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Content<wbr>Safety<wbr>Status</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafetystatus_go" style="color: inherit; text-decoration: inherit;">Content<wbr>Safety<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#contentsafetystatus">Content<wbr>Safety<wbr>Status</a></span>
    </dt>
    <dd>[Required] Specifies the status of content safety.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#content_safety_status_python" style="color: inherit; text-decoration: inherit;">content_<wbr>safety_<wbr>status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#contentsafetystatus">Content<wbr>Safety<wbr>Status</a></span>
    </dt>
    <dd>[Required] Specifies the status of content safety.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafetystatus_yaml" style="color: inherit; text-decoration: inherit;">content<wbr>Safety<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#contentsafetystatus">&#34;Enabled&#34; | &#34;Disabled&#34;</a></span>
    </dt>
    <dd>[Required] Specifies the status of content safety.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="contentsafetyresponse">
Content<wbr>Safety<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Content<wbr>Safety<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="contentsafetystatus">
Content<wbr>Safety<wbr>Status<pulumi-choosable type="language" values="python,go" class="inline">, Content<wbr>Safety<wbr>Status<wbr>Args</pulumi-choosable>
</h4>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Content<wbr>Safety<wbr>Status<wbr>Enabled</dt>
    <dd>Enabled</dd><dt>Content<wbr>Safety<wbr>Status<wbr>Disabled</dt>
    <dd>Disabled</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="modelsettings">
Model<wbr>Settings<pulumi-choosable type="language" values="python,go" class="inline">, Model<wbr>Settings<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="modelsettingsresponse">
Model<wbr>Settings<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Model<wbr>Settings<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="serverlessendpoint">
Serverless<wbr>Endpoint<pulumi-choosable type="language" values="python,go" class="inline">, Serverless<wbr>Endpoint<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#serverlessinferenceendpointauthmode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode</a></span>
    </dt>
    <dd>[Required] Specifies the authentication mode for the Serverless endpoint.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafety_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Safety</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contentsafety">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Content<wbr>Safety</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#modelsettings_csharp" style="color: inherit; text-decoration: inherit;">Model<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelsettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Model<wbr>Settings</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_go" style="color: inherit; text-decoration: inherit;">Auth<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#serverlessinferenceendpointauthmode">Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode</a></span>
    </dt>
    <dd>[Required] Specifies the authentication mode for the Serverless endpoint.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafety_go" style="color: inherit; text-decoration: inherit;">Content<wbr>Safety</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contentsafety">Content<wbr>Safety</a></span>
    </dt>
    <dd>Specifies the content safety options. If omitted, the default content safety settings will be configured</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#modelsettings_go" style="color: inherit; text-decoration: inherit;">Model<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelsettings">Model<wbr>Settings</a></span>
    </dt>
    <dd>The model settings (model id) for the model being serviced on the ServerlessEndpoint.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#auth_mode_python" style="color: inherit; text-decoration: inherit;">auth_<wbr>mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#serverlessinferenceendpointauthmode">Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode</a></span>
    </dt>
    <dd>[Required] Specifies the authentication mode for the Serverless endpoint.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authmode_yaml" style="color: inherit; text-decoration: inherit;">auth<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#serverlessinferenceendpointauthmode">&#34;Key&#34;</a></span>
    </dt>
    <dd>[Required] Specifies the authentication mode for the Serverless endpoint.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contentsafety_yaml" style="color: inherit; text-decoration: inherit;">content<wbr>Safety</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contentsafety">Property Map</a></span>
    </dt>
    <dd>Specifies the content safety options. If omitted, the default content safety settings will be configured</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#modelsettings_yaml" style="color: inherit; text-decoration: inherit;">model<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelsettings">Property Map</a></span>
    </dt>
    <dd>The model settings (model id) for the model being serviced on the ServerlessEndpoint.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="serverlessendpointresponse">
Serverless<wbr>Endpoint<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Serverless<wbr>Endpoint<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="serverlessinferenceendpointauthmode">
Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode<pulumi-choosable type="language" values="python,go" class="inline">, Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Key</dt>
    <dd>Key</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Serverless<wbr>Inference<wbr>Endpoint<wbr>Auth<wbr>Mode<wbr>Key</dt>
    <dd>Key</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="serverlessinferenceendpointresponse">
Serverless<wbr>Inference<wbr>Endpoint<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Serverless<wbr>Inference<wbr>Endpoint<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
