...
---
title: "getFederatedIdentityCredential"
title_tag: "azure-native.managedidentity.getFederatedIdentityCredential"
meta_desc: "Documentation for the azure-native.managedidentity.getFederatedIdentityCredential function with examples, input properties, output properties, and supporting types."
layout: api
...
Other available API versions: 2024-11-30, 2025-01-31-preview.
...
## Using getFederatedIdentityCredential {#using}
...
><span class="k">function </span>getFederatedIdentityCredential<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetFederatedIdentityCredentialArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>></span
><span class="k">
function </span>getFederatedIdentityCredentialOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetFederatedIdentityCredentialOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_federated_identity_credential<span class="p">(</span><span class="nx">federated_identity_credential_resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      ...
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetFederatedIdentityCredentialResult</span
><span class="k">
def </span>get_federated_identity_credential_output<span class="p">(</span><span class="nx">federated_identity_credential_resource_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                      ...
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetFederatedIdentityCredentialResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>LookupFederatedIdentityCredential<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupFederatedIdentityCredentialArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupFederatedIdentityCredentialResult</a></span>, error)</span
><span class="k">
func </span>LookupFederatedIdentityCredentialOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupFederatedIdentityCredentialOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupFederatedIdentityCredentialResultOutput</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetFederatedIdentityCredential </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetFederatedIdentityCredentialArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetFederatedIdentityCredentialInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>> </span>getFederatedIdentityCredential<span class="p">(</span><span class="nx">GetFederatedIdentityCredentialArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetFederatedIdentityCredentialResult</a></span>> </span>getFederatedIdentityCredential<span class="p">(</span><span class="nx">GetFederatedIdentityCredentialArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:managedidentity:getFederatedIdentityCredential
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federatedidentitycredentialresourcename_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federatedidentitycredentialresourcename_csharp" style="color: inherit; text-decoration: inherit;">Federated<wbr>Identity<wbr>Credential<wbr>Resource<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The name of the federated identity credential resource.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>The name of the identity resource.</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federatedidentitycredentialresourcename_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federatedidentitycredentialresourcename_go" style="color: inherit; text-decoration: inherit;">Federated<wbr>Identity<wbr>Credential<wbr>Resource<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federatedidentitycredentialresourcename_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federatedidentitycredentialresourcename_java" style="color: inherit; text-decoration: inherit;">federated<wbr>Identity<wbr>Credential<wbr>Resource<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federatedidentitycredentialresourcename_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federatedidentitycredentialresourcename_nodejs" style="color: inherit; text-decoration: inherit;">federated<wbr>Identity<wbr>Credential<wbr>Resource<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federated_identity_credential_resource_name_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federated_identity_credential_resource_name_python" style="color: inherit; text-decoration: inherit;">federated_<wbr>identity_<wbr>credential_<wbr>resource_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-required property-replacement"
            title="Required">
        <span id="federatedidentitycredentialresourcename_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#federatedidentitycredentialresourcename_yaml" style="color: inherit; text-decoration: inherit;">federated<wbr>Identity<wbr>Credential<wbr>Resource<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
## getFederatedIdentityCredential Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#audiences_csharp" style="color: inherit; text-decoration: inherit;">Audiences</a>
    ...
    <dd>The list of audiences that can appear in the issued token.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#issuer_csharp" style="color: inherit; text-decoration: inherit;">Issuer</a>
    ...
    <dd>The URL of the issuer to be trusted.</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subject_csharp" style="color: inherit; text-decoration: inherit;">Subject</a>
    ...
    <dd>The identifier of the external identity.</dd><dt class="property-"
            title="">
