...
---
title: "NetworkToNetworkInterconnect"
title_tag: "azure-native.managednetworkfabric.NetworkToNetworkInterconnect"
meta_desc: "Documentation for the azure-native.managednetworkfabric.NetworkToNetworkInterconnect resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create NetworkToNetworkInterconnect Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 ...
                                 <span class="nx">use_option_b</span><span class="p">:</span> <span class="nx">Optional[Union[str, BooleanEnumProperty]]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">is_management_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, IsManagementType]]</span> = None<span class="p">,</span>
                                 <span class="nx">layer2_configuration</span><span class="p">:</span> <span class="nx">Optional[Layer2ConfigurationArgs]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">nni_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, NniType]]</span> = None<span class="p">,</span>
                                 <span class="nx">npb_static_route_configuration</span><span class="p">:</span> <span class="nx">Optional[NpbStaticRouteConfigurationArgs]</span> = None<span class="p">,</span>
                                 <span class="nx">option_b_layer3_configuration</span><span class="p">:</span> <span class="nx">Optional[NetworkToNetworkInterconnectPropertiesOptionBLayer3ConfigurationArgs]</span> = None<span class="p">,</span>
                                 <span class="nx">import_route_policy</span><span class="p">:</span> <span class="nx">Optional[ImportRoutePolicyInformationArgs]</span> = None<span class="p">,</span>
                                 <span class="nx">export_route_policy</span><span class="p">:</span> <span class="nx">Optional[ExportRoutePolicyInformationArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewNetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">NetworkToNetworkInterconnect</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">NetworkToNetworkInterconnect</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:managednetworkfabric:NetworkToNetworkInterconnect</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">NetworkToNetworkInterconnectArgs</a></span>
    </dt>
...
## NetworkToNetworkInterconnect Resource Properties {#properties}
...
The NetworkToNetworkInterconnect resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#useoptionb_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Option<wbr>B</a>
    ...
    <dd>Based on this option layer3 parameters are mandatory. Example: True/False</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#exportroutepolicy_csharp" style="color: inherit; text-decoration: inherit;">Export<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#exportroutepolicyinformation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Inputs.<wbr>Export<wbr>Route<wbr>Policy<wbr>Information</a></span>
    </dt>
    <dd>Export Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#importroutepolicy_csharp" style="color: inherit; text-decoration: inherit;">Import<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importroutepolicyinformation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Inputs.<wbr>Import<wbr>Route<wbr>Policy<wbr>Information</a></span>
    </dt>
    <dd>Import Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ismanagementtype_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Management<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#ismanagementtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Is<wbr>Management<wbr>Type</a></span>
    </dt>
    <dd>Configuration to use NNI for Infrastructure Management. Example: True/False.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layer2configuration_csharp" style="color: inherit; text-decoration: inherit;">Layer2Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#layer2configuration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Inputs.<wbr>Layer2Configuration</a></span>
    </dt>
    <dd>Common properties for Layer2 Configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#networktonetworkinterconnectname_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Name</a>
    ...
    <dd>Name of the Network to Network Interconnect.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nnitype_csharp" style="color: inherit; text-decoration: inherit;">Nni<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#nnitype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Nni<wbr>Type</a></span>
    </dt>
    <dd>Type of NNI used. Example: CE | NPB</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#npbstaticrouteconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Npb<wbr>Static<wbr>Route<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#npbstaticrouteconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Inputs.<wbr>Npb<wbr>Static<wbr>Route<wbr>Configuration</a></span>
    </dt>
    <dd>NPB Static Route Configuration properties.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#optionblayer3configuration_csharp" style="color: inherit; text-decoration: inherit;">Option<wbr>BLayer3Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networktonetworkinterconnectpropertiesoptionblayer3configuration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Managed<wbr>Network<wbr>Fabric.<wbr>Inputs.<wbr>Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Option<wbr>BLayer3Configuration</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#exportroutepolicy_go" style="color: inherit; text-decoration: inherit;">Export<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#exportroutepolicyinformation">Export<wbr>Route<wbr>Policy<wbr>Information<wbr>Args</a></span>
    </dt>
    <dd>Export Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#importroutepolicy_go" style="color: inherit; text-decoration: inherit;">Import<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importroutepolicyinformation">Import<wbr>Route<wbr>Policy<wbr>Information<wbr>Args</a></span>
    </dt>
    <dd>Import Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ismanagementtype_go" style="color: inherit; text-decoration: inherit;">Is<wbr>Management<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#ismanagementtype">Is<wbr>Management<wbr>Type</a></span>
    </dt>
    <dd>Configuration to use NNI for Infrastructure Management. Example: True/False.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layer2configuration_go" style="color: inherit; text-decoration: inherit;">Layer2Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#layer2configuration">Layer2Configuration<wbr>Args</a></span>
    </dt>
    <dd>Common properties for Layer2 Configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nnitype_go" style="color: inherit; text-decoration: inherit;">Nni<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#nnitype">Nni<wbr>Type</a></span>
    </dt>
    <dd>Type of NNI used. Example: CE | NPB</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#npbstaticrouteconfiguration_go" style="color: inherit; text-decoration: inherit;">Npb<wbr>Static<wbr>Route<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#npbstaticrouteconfiguration">Npb<wbr>Static<wbr>Route<wbr>Configuration<wbr>Args</a></span>
    </dt>
    <dd>NPB Static Route Configuration properties.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#optionblayer3configuration_go" style="color: inherit; text-decoration: inherit;">Option<wbr>BLayer3Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networktonetworkinterconnectpropertiesoptionblayer3configuration">Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Option<wbr>BLayer3Configuration<wbr>Args</a></span>
    </dt>
    <dd>Common properties for Layer3Configuration.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#exportroutepolicy_java" style="color: inherit; text-decoration: inherit;">export<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#exportroutepolicyinformation">Export<wbr>Route<wbr>Policy<wbr>Information</a></span>
    </dt>
    <dd>Export Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#importroutepolicy_java" style="color: inherit; text-decoration: inherit;">import<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importroutepolicyinformation">Import<wbr>Route<wbr>Policy<wbr>Information</a></span>
    </dt>
    <dd>Import Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layer2configuration_java" style="color: inherit; text-decoration: inherit;">layer2Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#layer2configuration">Layer2Configuration</a></span>
    </dt>
    <dd>Common properties for Layer2 Configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#npbstaticrouteconfiguration_java" style="color: inherit; text-decoration: inherit;">npb<wbr>Static<wbr>Route<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#npbstaticrouteconfiguration">Npb<wbr>Static<wbr>Route<wbr>Configuration</a></span>
    </dt>
    <dd>NPB Static Route Configuration properties.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#optionblayer3configuration_java" style="color: inherit; text-decoration: inherit;">option<wbr>BLayer3Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networktonetworkinterconnectpropertiesoptionblayer3configuration">Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Option<wbr>BLayer3Configuration</a></span>
    </dt>
    <dd>Common properties for Layer3Configuration.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#is_management_type_python" style="color: inherit; text-decoration: inherit;">is_<wbr>management_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#ismanagementtype">Is<wbr>Management<wbr>Type</a></span>
    </dt>
    <dd>Configuration to use NNI for Infrastructure Management. Example: True/False.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nni_type_python" style="color: inherit; text-decoration: inherit;">nni_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#nnitype">Nni<wbr>Type</a></span>
    </dt>
    <dd>Type of NNI used. Example: CE | NPB</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#exportroutepolicy_yaml" style="color: inherit; text-decoration: inherit;">export<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#exportroutepolicyinformation">Property Map</a></span>
    </dt>
    <dd>Export Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#importroutepolicy_yaml" style="color: inherit; text-decoration: inherit;">import<wbr>Route<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importroutepolicyinformation">Property Map</a></span>
    </dt>
    <dd>Import Route Policy configuration.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ismanagementtype_yaml" style="color: inherit; text-decoration: inherit;">is<wbr>Management<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#ismanagementtype">&#34;True&#34; | &#34;False&#34;</a></span>
    </dt>
    <dd>Configuration to use NNI for Infrastructure Management. Example: True/False.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#layer2configuration_yaml" style="color: inherit; text-decoration: inherit;">layer2Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#layer2configuration">Property Map</a></span>
    </dt>
    <dd>Common properties for Layer2 Configuration.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nnitype_yaml" style="color: inherit; text-decoration: inherit;">nni<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#nnitype">&#34;CE&#34; | &#34;NPB&#34;</a></span>
    </dt>
    <dd>Type of NNI used. Example: CE | NPB</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#npbstaticrouteconfiguration_yaml" style="color: inherit; text-decoration: inherit;">npb<wbr>Static<wbr>Route<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#npbstaticrouteconfiguration">Property Map</a></span>
    </dt>
    <dd>NPB Static Route Configuration properties.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#optionblayer3configuration_yaml" style="color: inherit; text-decoration: inherit;">option<wbr>BLayer3Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networktonetworkinterconnectpropertiesoptionblayer3configuration">Property Map</a></span>
    </dt>
    <dd>Common properties for Layer3Configuration.</dd></dl>
</pulumi-choosable>
</div>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NetworkToNetworkInterconnect resource produces the following output properties:
...
<h4 id="exportroutepolicyinformation">
Export<wbr>Route<wbr>Policy<wbr>Information<pulumi-choosable type="language" values="python,go" class="inline">, Export<wbr>Route<wbr>Policy<wbr>Information<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="exportroutepolicyinformationresponse">
Export<wbr>Route<wbr>Policy<wbr>Information<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Export<wbr>Route<wbr>Policy<wbr>Information<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="importroutepolicyinformation">
Import<wbr>Route<wbr>Policy<wbr>Information<pulumi-choosable type="language" values="python,go" class="inline">, Import<wbr>Route<wbr>Policy<wbr>Information<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="importroutepolicyinformationresponse">
Import<wbr>Route<wbr>Policy<wbr>Information<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Import<wbr>Route<wbr>Policy<wbr>Information<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="ismanagementtype">
Is<wbr>Management<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Is<wbr>Management<wbr>Type<wbr>Args</pulumi-choosable>
</h4>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Is<wbr>Management<wbr>Type<wbr>True</dt>
    <dd>True</dd><dt>Is<wbr>Management<wbr>Type<wbr>False</dt>
    <dd>False</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="layer2configuration">
Layer2Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Layer2Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="layer2configurationresponse">
Layer2Configuration<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Layer2Configuration<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="networktonetworkinterconnectpropertiesoptionblayer3configuration">
Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Option<wbr>BLayer3Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Option<wbr>BLayer3Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="networktonetworkinterconnectpropertiesresponseoptionblayer3configuration">
Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Response<wbr>Option<wbr>BLayer3Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>To<wbr>Network<wbr>Interconnect<wbr>Properties<wbr>Response<wbr>Option<wbr>BLayer3Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="nnitype">
Nni<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Nni<wbr>Type<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>CE</dt>
    <dd>CE</dd><dt>NPB</dt>
    <dd>NPB</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Nni<wbr>Type<wbr>CE</dt>
    <dd>CE</dd><dt>Nni<wbr>Type<wbr>NPB</dt>
    <dd>NPB</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="npbstaticrouteconfiguration">
Npb<wbr>Static<wbr>Route<wbr>Configuration<pulumi-choosable type="language" values="python,go" class="inline">, Npb<wbr>Static<wbr>Route<wbr>Configuration<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="npbstaticrouteconfigurationresponse">
Npb<wbr>Static<wbr>Route<wbr>Configuration<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Npb<wbr>Static<wbr>Route<wbr>Configuration<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
