...
---
title: "getAssessmentProjectsOperation"
title_tag: "azure-native.migrate.getAssessmentProjectsOperation"
meta_desc: "Documentation for the azure-native.migrate.getAssessmentProjectsOperation function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getAssessmentProjectsOperation {#using}
...
><span class="k">function </span>getAssessmentProjectsOperation<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetAssessmentProjectsOperationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>></span
><span class="k">
function </span>getAssessmentProjectsOperationOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetAssessmentProjectsOperationOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_assessment_projects_operation<span class="p">(</span><span class="nx">project_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetAssessmentProjectsOperationResult</span
><span class="k">
def </span>get_assessment_projects_operation_output<span class="p">(</span><span class="nx">project_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                      <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetAssessmentProjectsOperationResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>LookupAssessmentProjectsOperation<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAssessmentProjectsOperationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupAssessmentProjectsOperationResult</a></span>, error)</span
><span class="k">
func </span>LookupAssessmentProjectsOperationOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAssessmentProjectsOperationOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) LookupAssessmentProjectsOperationResultOutput</span
></code></pre></div>

&gt; Note: This function is named `LookupAssessmentProjectsOperation` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAssessmentProjectsOperation </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetAssessmentProjectsOperationArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetAssessmentProjectsOperationInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>> </span>getAssessmentProjectsOperation<span class="p">(</span><span class="nx">GetAssessmentProjectsOperationArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
<span class="k">public static Output&lt;<span class="nx"><a href="#result">GetAssessmentProjectsOperationResult</a></span>> </span>getAssessmentProjectsOperation<span class="p">(</span><span class="nx">GetAssessmentProjectsOperationArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:migrate:getAssessmentProjectsOperation
...
## getAssessmentProjectsOperation Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assessmentsolutionid_csharp" style="color: inherit; text-decoration: inherit;">Assessment<wbr>Solution<wbr>Id</a>
    ...
    <dd>Assessment solution ARM id tracked by Microsoft.Migrate/migrateProjects.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customerworkspaceid_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Workspace<wbr>Id</a>
    ...
    <dd>The ARM id of service map workspace created by customer.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#customerworkspacelocation_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Workspace<wbr>Location</a>
    ...
    <dd>Location of service map workspace created by customer.</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#projectstatus_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Status</a>
    ...
    <dd>Assessment project status.</dd><dt class="property-"
            title="">
...
exclusive access method.</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
