...
---
title: "getSite"
title_tag: "azure-native.mobilenetwork.getSite"
meta_desc: "Documentation for the azure-native.mobilenetwork.getSite function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_site<span class="p">(</span><span class="nx">mobile_network_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_site_output<span class="p">(</span><span class="nx">mobile_network_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:mobilenetwork:getSite
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sitename_csharp" style="color: inherit; text-decoration: inherit;">Site<wbr>Name</a>
    ...
    <dd>The name of the mobile network site.</dd></dl>
</pulumi-choosable>
</div>
