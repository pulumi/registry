...
---
title: "Backup"
title_tag: "azure-native.netapp.Backup"
meta_desc: "Documentation for the azure-native.netapp.Backup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Backup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">volume_resource_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:netapp:Backup</span><span class="p"></span>
...
```java
var azure_nativeBackupResource = new Backup("azure-nativeBackupResource", BackupArgs.builder()
    .accountName("string")
    .backupVaultName("string")
    .resourceGroupName("string")
    .volumeResourceId("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#volumeresourceid_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Resource<wbr>Id</a>
    ...
    <dd>ResourceId used to identify the Volume</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotname_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Name</a>
    ...
    <dd>The name of the snapshot</dd><dt class="property-optional property-replacement"
            title="Optional">
