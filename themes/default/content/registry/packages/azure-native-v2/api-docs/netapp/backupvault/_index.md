...
---
title: "BackupVault"
title_tag: "azure-native.netapp.BackupVault"
meta_desc: "Documentation for the azure-native.netapp.BackupVault resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:netapp:BackupVault</span><span class="p"></span>
...
```csharp
var azure_nativeBackupVaultResource = new AzureNative.NetApp.BackupVault("azure-nativeBackupVaultResource", new()
{
    AccountName = "string",
...
```go
example, err := netapp.NewBackupVault(ctx, "azure-nativeBackupVaultResource", &netapp.BackupVaultArgs{
...
```java
var azure_nativeBackupVaultResource = new BackupVault("azure-nativeBackupVaultResource", BackupVaultArgs.builder()
    .accountName("string")
    .resourceGroupName("string")
    .backupVaultName("string")
    .location("string")
...
```python
azure_native_backup_vault_resource = azure_native.netapp.BackupVault("azure-nativeBackupVaultResource",
    account_name="string",
...
```typescript
const azure_nativeBackupVaultResource = new azure_native.netapp.BackupVault("azure-nativeBackupVaultResource", {
    accountName: "string",
    resourceGroupName: "string",
    backupVaultName: "string",
    location: "string",
