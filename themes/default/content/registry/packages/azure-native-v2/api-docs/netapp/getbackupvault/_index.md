...
title_tag: "azure-native.netapp.getBackupVault"
meta_desc: "Documentation for the azure-native.netapp.getBackupVault function with examples, input properties, output properties, and supporting types."
layout: api
...
Other available API versions: 2022-11-01-preview, 2024-09-01-preview.
...
><span class="k">def </span>get_backup_vault<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_backup_vault_output<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> azure-native:netapp:getBackupVault
