...
><span class="k">
def </span>get_network_security_perimeter_link_output<span class="p">(</span><span class="nx">link_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
