...
---
title: "RoutingRuleCollection"
title_tag: "azure-native.network.RoutingRuleCollection"
meta_desc: "Documentation for the azure-native.network.RoutingRuleCollection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create RoutingRuleCollection Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span>
<span></span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                          <span class="nx">applies_to</span><span class="p">:</span> <span class="nx">Optional[Sequence[NetworkManagerRoutingGroupItemArgs]]</span> = None<span class="p">,</span>
                          ...
                          <span class="nx">disable_bgp_route_propagation</span><span class="p">:</span> <span class="nx">Optional[Union[str, DisableBgpRoutePropagation]]</span> = None<span class="p">,</span>
                          <span class="nx">rule_collection_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRoutingRuleCollection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RoutingRuleCollection</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">RoutingRuleCollection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RoutingRuleCollectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:network:RoutingRuleCollection</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">RoutingRuleCollectionArgs</a></span>
    </dt>
...
```csharp
var routingRuleCollectionResource = new AzureNative.Network.RoutingRuleCollection("routingRuleCollectionResource", new()
{
    AppliesTo = new[]
    {
        new AzureNative.Network.Inputs.NetworkManagerRoutingGroupItemArgs
...
```go
example, err := network.NewRoutingRuleCollection(ctx, "routingRuleCollectionResource", &network.RoutingRuleCollectionArgs{
	AppliesTo: network.NetworkManagerRoutingGroupItemArray{
		&network.NetworkManagerRoutingGroupItemArgs{
	...
	DisableBgpRoutePropagation: pulumi.String("string"),
...
```java
var routingRuleCollectionResource = new RoutingRuleCollection("routingRuleCollectionResource", RoutingRuleCollectionArgs.builder()
    .appliesTo(NetworkManagerRoutingGroupItemArgs.builder()
        .networkGroupId("string")
        .build())
    .configurationName("string")
...
```python
routing_rule_collection_resource = azure_native.network.RoutingRuleCollection("routingRuleCollectionResource",
    applies_to=[{
...
```typescript
const routingRuleCollectionResource = new azure_native.network.RoutingRuleCollection("routingRuleCollectionResource", {
    appliesTo: [{
        networkGroupId: "string",
    }],
    configurationName: "string",
...
## RoutingRuleCollection Resource Properties {#properties}
...
The RoutingRuleCollection resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliesto_csharp" style="color: inherit; text-decoration: inherit;">Applies<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item&gt;</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A description of the routing rule collection.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disablebgproutepropagation_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#disablebgproutepropagation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a></span>
    </dt>
    <dd>Determines whether BGP route propagation is enabled. Defaults to true.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliesto_go" style="color: inherit; text-decoration: inherit;">Applies<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">[]Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<wbr>Args</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disablebgproutepropagation_go" style="color: inherit; text-decoration: inherit;">Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#disablebgproutepropagation">Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a></span>
    </dt>
    <dd>Determines whether BGP route propagation is enabled. Defaults to true.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliesto_java" style="color: inherit; text-decoration: inherit;">applies<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">List&lt;Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item&gt;</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliesto_nodejs" style="color: inherit; text-decoration: inherit;">applies<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item[]</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#applies_to_python" style="color: inherit; text-decoration: inherit;">applies_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">Sequence[Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<wbr>Args]</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disable_bgp_route_propagation_python" style="color: inherit; text-decoration: inherit;">disable_<wbr>bgp_<wbr>route_<wbr>propagation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#disablebgproutepropagation">Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a></span>
    </dt>
    <dd>Determines whether BGP route propagation is enabled. Defaults to true.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliesto_yaml" style="color: inherit; text-decoration: inherit;">applies<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagerroutinggroupitem">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#disablebgproutepropagation_yaml" style="color: inherit; text-decoration: inherit;">disable<wbr>Bgp<wbr>Route<wbr>Propagation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#disablebgproutepropagation">&#34;False&#34; | &#34;True&#34;</a></span>
    </dt>
    <dd>Determines whether BGP route propagation is enabled. Defaults to true.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RoutingRuleCollection resource produces the following output properties:
...
<h4 id="disablebgproutepropagation">
Disable<wbr>Bgp<wbr>Route<wbr>Propagation<pulumi-choosable type="language" values="python,go" class="inline">, Disable<wbr>Bgp<wbr>Route<wbr>Propagation<wbr>Args</pulumi-choosable>
</h4>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Disable<wbr>Bgp<wbr>Route<wbr>Propagation<wbr>False</dt>
    <dd>False</dd><dt>Disable<wbr>Bgp<wbr>Route<wbr>Propagation<wbr>True</dt>
    <dd>True</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="networkmanagerroutinggroupitem">
Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="networkmanagerroutinggroupitemresponse">
Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Manager<wbr>Routing<wbr>Group<wbr>Item<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
