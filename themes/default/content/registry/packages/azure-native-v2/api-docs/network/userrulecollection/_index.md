...
## Create UserRuleCollection Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewUserRuleCollection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">UserRuleCollectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">UserRuleCollection</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">UserRuleCollection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">UserRuleCollectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">UserRuleCollection</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">UserRuleCollectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:network:UserRuleCollection</span><span class="p"></span>
...
```csharp
var userRuleCollectionResource = new AzureNative.Network.UserRuleCollection("userRuleCollectionResource", new()
{
    AppliesToGroups = new[]
    {
        new AzureNative.Network.Inputs.NetworkManagerSecurityGroupItemArgs
...
```go
example, err := network.NewUserRuleCollection(ctx, "userRuleCollectionResource", &network.UserRuleCollectionArgs{
	AppliesToGroups: network.NetworkManagerSecurityGroupItemArray{
		&network.NetworkManagerSecurityGroupItemArgs{
...
```java
var userRuleCollectionResource = new UserRuleCollection("userRuleCollectionResource", UserRuleCollectionArgs.builder()
    .appliesToGroups(NetworkManagerSecurityGroupItemArgs.builder()
        .networkGroupId("string")
        .build())
    .configurationName("string")
...
```python
user_rule_collection_resource = azure_native.network.UserRuleCollection("userRuleCollectionResource",
    applies_to_groups=[{
...
```typescript
const userRuleCollectionResource = new azure_native.network.UserRuleCollection("userRuleCollectionResource", {
    appliesToGroups: [{
        networkGroupId: "string",
    }],
    configurationName: "string",
...
The UserRuleCollection resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliestogroups_csharp" style="color: inherit; text-decoration: inherit;">Applies<wbr>To<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagersecuritygroupitem">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>A description of the user rule collection.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliestogroups_java" style="color: inherit; text-decoration: inherit;">applies<wbr>To<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagersecuritygroupitem">List&lt;Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item&gt;</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliestogroups_yaml" style="color: inherit; text-decoration: inherit;">applies<wbr>To<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkmanagersecuritygroupitem">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd>Groups for configuration</dd><dt class="property-required property-replacement"
            title="Required">
...
<h4 id="networkmanagersecuritygroupitem">
Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="networkmanagersecuritygroupitemresponse">
Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Network<wbr>Manager<wbr>Security<wbr>Group<wbr>Item<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
