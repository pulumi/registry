...
---
title: "HypervSitesController"
title_tag: "azure-native.offazure.HypervSitesController"
meta_desc: "Documentation for the azure-native.offazure.HypervSitesController resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create HypervSitesController Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">agent_details</span><span class="p">:</span> <span class="nx">Optional[SiteAgentPropertiesArgs]</span> = None<span class="p">,</span>
                          <span class="nx">appliance_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          <span class="nx">discovery_solution_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          ...
                          <span class="nx">service_principal_identity_details</span><span class="p">:</span> <span class="nx">Optional[SiteSpnPropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewHypervSitesController</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">HypervSitesController</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">HypervSitesController</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">HypervSitesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:offazure:HypervSitesController</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">HypervSitesControllerArgs</a></span>
    </dt>
...
```csharp
var hypervSitesControllerResource = new AzureNative.OffAzure.HypervSitesController("hypervSitesControllerResource", new()
{
...
```go
example, err := offazure.NewHypervSitesController(ctx, "hypervSitesControllerResource", &offazure.HypervSitesControllerArgs{
...
```java
var hypervSitesControllerResource = new HypervSitesController("hypervSitesControllerResource", HypervSitesControllerArgs.builder()
    .resourceGroupName("string")
    .agentDetails(SiteAgentPropertiesArgs.builder()
        .keyVaultId("string")
        .keyVaultUri("string")
...
```python
hyperv_sites_controller_resource = azure_native.offazure.HypervSitesController("hypervSitesControllerResource",
...
```typescript
const hypervSitesControllerResource = new azure_native.offazure.HypervSitesController("hypervSitesControllerResource", {
    resourceGroupName: "string",
    agentDetails: {
        keyVaultId: "string",
        keyVaultUri: "string",
...
## HypervSitesController Resource Properties {#properties}
...
The HypervSitesController resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysolutionid_csharp" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Solution<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Gets or sets the ARM ID of migration hub solution for SDS.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceprincipalidentitydetails_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Principal<wbr>Identity<wbr>Details</a>
    ...
    <dd>Gets or sets the service principal identity details used by agent for
communication
to the service.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysolutionid_go" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Solution<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliancename_java" style="color: inherit; text-decoration: inherit;">appliance<wbr>Name</a>
    ...
    <dd>Gets or sets the Appliance Name.</dd><dt class="property-optional"
            title="Optional">
        <span id="discoverysolutionid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysolutionid_java" style="color: inherit; text-decoration: inherit;">discovery<wbr>Solution<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysolutionid_nodejs" style="color: inherit; text-decoration: inherit;">discovery<wbr>Solution<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discovery_solution_id_python" style="color: inherit; text-decoration: inherit;">discovery_<wbr>solution_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#appliancename_yaml" style="color: inherit; text-decoration: inherit;">appliance<wbr>Name</a>
    ...
    <dd>Gets or sets the Appliance Name.</dd><dt class="property-optional"
            title="Optional">
        <span id="discoverysolutionid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysolutionid_yaml" style="color: inherit; text-decoration: inherit;">discovery<wbr>Solution<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the HypervSitesController resource produces the following output properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mastersiteid_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Site<wbr>Id</a>
    ...
    <dd>Gets the Master Site this site is linked to.</dd><dt class="property-"
            title="">
        <span id="name_csharp">
