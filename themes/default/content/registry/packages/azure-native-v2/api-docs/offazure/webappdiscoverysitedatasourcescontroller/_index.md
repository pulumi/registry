...
---
title: "WebAppDiscoverySiteDataSourcesController"
title_tag: "azure-native.offazure.WebAppDiscoverySiteDataSourcesController"
meta_desc: "Documentation for the azure-native.offazure.WebAppDiscoverySiteDataSourcesController resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create WebAppDiscoverySiteDataSourcesController Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                             <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                             ...
                                             <span class="nx">discovery_site_data_source_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WebAppDiscoverySiteDataSourcesController</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">WebAppDiscoverySiteDataSourcesController</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:offazure:WebAppDiscoverySiteDataSourcesController</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">WebAppDiscoverySiteDataSourcesControllerArgs</a></span>
    </dt>
...
```csharp
var webAppDiscoverySiteDataSourcesControllerResource = new AzureNative.OffAzure.WebAppDiscoverySiteDataSourcesController("webAppDiscoverySiteDataSourcesControllerResource", new()
{
...
```go
example, err := offazure.NewWebAppDiscoverySiteDataSourcesController(ctx, "webAppDiscoverySiteDataSourcesControllerResource", &offazure.WebAppDiscoverySiteDataSourcesControllerArgs{
...
```java
var webAppDiscoverySiteDataSourcesControllerResource = new WebAppDiscoverySiteDataSourcesController("webAppDiscoverySiteDataSourcesControllerResource", WebAppDiscoverySiteDataSourcesControllerArgs.builder()
    .resourceGroupName("string")
    .siteName("string")
    .webAppSiteName("string")
    .discoverySiteDataSourceName("string")
...
```python
web_app_discovery_site_data_sources_controller_resource = azure_native.offazure.WebAppDiscoverySiteDataSourcesController("webAppDiscoverySiteDataSourcesControllerResource",
...
```typescript
const webAppDiscoverySiteDataSourcesControllerResource = new azure_native.offazure.WebAppDiscoverySiteDataSourcesController("webAppDiscoverySiteDataSourcesControllerResource", {
    resourceGroupName: "string",
    siteName: "string",
    webAppSiteName: "string",
    discoverySiteDataSourceName: "string",
...
## WebAppDiscoverySiteDataSourcesController Resource Properties {#properties}
...
The WebAppDiscoverySiteDataSourcesController resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#webappsitename_csharp" style="color: inherit; text-decoration: inherit;">Web<wbr>App<wbr>Site<wbr>Name</a>
    ...
    <dd>Web app site name.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#discoverysitedatasourcename_csharp" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Site<wbr>Data<wbr>Source<wbr>Name</a>
    ...
    <dd>Data Source ARM name.</dd><dt class="property-optional"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the WebAppDiscoverySiteDataSourcesController resource produces the following output properties:
