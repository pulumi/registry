...
---
title: "EnergyService"
title_tag: "azure-native.openenergyplatform.EnergyService"
meta_desc: "Documentation for the azure-native.openenergyplatform.EnergyService resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create EnergyService Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[EnergyServicePropertiesArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEnergyService</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">EnergyService</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">EnergyService</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EnergyServiceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:openenergyplatform:EnergyService</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">EnergyServiceArgs</a></span>
    </dt>
...
var energyServiceResource = new AzureNative.OpenEnergyPlatform.EnergyService("energyServiceResource", new()
{
    ...
    Location = "string",
    Properties = new AzureNative.OpenEnergyPlatform.Inputs.EnergyServicePropertiesArgs
    {
        AuthAppId = "string",
        DataPartitionNames = new[]
        {
            new AzureNative.OpenEnergyPlatform.Inputs.DataPartitionNamesArgs
            {
                Name = "string",
            },
        },
...
example, err := openenergyplatform.NewEnergyService(ctx, "energyServiceResource", &openenergyplatform.EnergyServiceArgs{
	...
	Properties: &openenergyplatform.EnergyServicePropertiesArgs{
		AuthAppId: pulumi.String("string"),
		DataPartitionNames: openenergyplatform.DataPartitionNamesArray{
			&openenergyplatform.DataPartitionNamesArgs{
...
var energyServiceResource = new EnergyService("energyServiceResource", EnergyServiceArgs.builder()
    .resourceGroupName("string")
    .location("string")
    .properties(EnergyServicePropertiesArgs.builder()
        .authAppId("string")
        .dataPartitionNames(DataPartitionNamesArgs.builder()
            .name("string")
            .build())
        .build())
    .resourceName("string")
...
## EnergyService Resource Properties {#properties}
...
The EnergyService resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>Geo-location where the resource lives.</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#energyserviceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Open<wbr>Energy<wbr>Platform.<wbr>Inputs.<wbr>Energy<wbr>Service<wbr>Properties</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#energyserviceproperties">Energy<wbr>Service<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd></dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_java" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#energyserviceproperties">Energy<wbr>Service<wbr>Properties</a></span>
    </dt>
    <dd></dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_yaml" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#energyserviceproperties">Property Map</a></span>
    </dt>
    <dd></dd><dt class="property-optional property-replacement"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the EnergyService resource produces the following output properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#systemdataresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Open<wbr>Energy<wbr>Platform.<wbr>Outputs.<wbr>System<wbr>Data<wbr>Response</a></span>
    </dt>
...
<h4 id="datapartitionnames">
Data<wbr>Partition<wbr>Names<pulumi-choosable type="language" values="python,go" class="inline">, Data<wbr>Partition<wbr>Names<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="datapartitionnamesresponse">
Data<wbr>Partition<wbr>Names<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Data<wbr>Partition<wbr>Names<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="energyserviceproperties">
Energy<wbr>Service<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Energy<wbr>Service<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="authappid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authappid_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>App<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="datapartitionnames_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Partition<wbr>Names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Open<wbr>Energy<wbr>Platform.<wbr>Inputs.<wbr>Data<wbr>Partition<wbr>Names&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="authappid_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authappid_go" style="color: inherit; text-decoration: inherit;">Auth<wbr>App<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="datapartitionnames_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_go" style="color: inherit; text-decoration: inherit;">Data<wbr>Partition<wbr>Names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">[]Data<wbr>Partition<wbr>Names</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="authappid_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authappid_java" style="color: inherit; text-decoration: inherit;">auth<wbr>App<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="datapartitionnames_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_java" style="color: inherit; text-decoration: inherit;">data<wbr>Partition<wbr>Names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">List&lt;Data<wbr>Partition<wbr>Names&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="authappid_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authappid_nodejs" style="color: inherit; text-decoration: inherit;">auth<wbr>App<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="datapartitionnames_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_nodejs" style="color: inherit; text-decoration: inherit;">data<wbr>Partition<wbr>Names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">Data<wbr>Partition<wbr>Names[]</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="auth_app_id_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#auth_app_id_python" style="color: inherit; text-decoration: inherit;">auth_<wbr>app_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="data_partition_names_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#data_partition_names_python" style="color: inherit; text-decoration: inherit;">data_<wbr>partition_<wbr>names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">Sequence[Data<wbr>Partition<wbr>Names]</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="authappid_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#authappid_yaml" style="color: inherit; text-decoration: inherit;">auth<wbr>App<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="datapartitionnames_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Partition<wbr>Names</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnames">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>

<h4 id="energyservicepropertiesresponse">
Energy<wbr>Service<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Energy<wbr>Service<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Partition<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnamesresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Open<wbr>Energy<wbr>Platform.<wbr>Inputs.<wbr>Data<wbr>Partition<wbr>Names<wbr>Response&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_go" style="color: inherit; text-decoration: inherit;">Data<wbr>Partition<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnamesresponse">[]Data<wbr>Partition<wbr>Names<wbr>Response</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_java" style="color: inherit; text-decoration: inherit;">data<wbr>Partition<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnamesresponse">List&lt;Data<wbr>Partition<wbr>Names<wbr>Response&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#data_partition_names_python" style="color: inherit; text-decoration: inherit;">data_<wbr>partition_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnamesresponse">Sequence[Data<wbr>Partition<wbr>Names<wbr>Response]</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datapartitionnames_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Partition<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datapartitionnamesresponse">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
