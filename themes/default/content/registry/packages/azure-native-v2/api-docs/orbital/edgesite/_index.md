...
---
title: "EdgeSite"
title_tag: "azure-native.orbital.EdgeSite"
meta_desc: "Documentation for the azure-native.orbital.EdgeSite resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create EdgeSite Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p">,</span>
             <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span>
<span></span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
             <span class="nx">global_communications_site</span><span class="p">:</span> <span class="nx">Optional[EdgeSitesPropertiesGlobalCommunicationsSiteArgs]</span> = None<span class="p">,</span>
             <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">edge_site_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEdgeSite</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">EdgeSite</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">EdgeSite</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EdgeSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:orbital:EdgeSite</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">EdgeSiteArgs</a></span>
    </dt>
...
```csharp
var edgeSiteResource = new AzureNative.Orbital.EdgeSite("edgeSiteResource", new()
{
    GlobalCommunicationsSite = new AzureNative.Orbital.Inputs.EdgeSitesPropertiesGlobalCommunicationsSiteArgs
    {
        Id = "string",
...
```go
example, err := orbital.NewEdgeSite(ctx, "edgeSiteResource", &orbital.EdgeSiteArgs{
	GlobalCommunicationsSite: &orbital.EdgeSitesPropertiesGlobalCommunicationsSiteArgs{
		Id: pulumi.String("string"),
	},
	ResourceGroupName: pulumi.String("string"),
	EdgeSiteName:      pulumi.String("string"),
...
```java
var edgeSiteResource = new EdgeSite("edgeSiteResource", EdgeSiteArgs.builder()
    .globalCommunicationsSite(EdgeSitesPropertiesGlobalCommunicationsSiteArgs.builder()
        .id("string")
        .build())
    .resourceGroupName("string")
...
```python
edge_site_resource = azure_native.orbital.EdgeSite("edgeSiteResource",
    global_communications_site={
        "id": "string",
    },
    resource_group_name="string",
    edge_site_name="string",
    location="string",
    tags={
        "string": "string",
    })
...
```typescript
const edgeSiteResource = new azure_native.orbital.EdgeSite("edgeSiteResource", {
    globalCommunicationsSite: {
        id: "string",
    },
    resourceGroupName: "string",
...
## EdgeSite Resource Properties {#properties}
...
The EdgeSite resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#globalcommunicationssite_csharp" style="color: inherit; text-decoration: inherit;">Global<wbr>Communications<wbr>Site</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#edgesitespropertiesglobalcommunicationssite">Pulumi.<wbr>Azure<wbr>Native.<wbr>Orbital.<wbr>Inputs.<wbr>Edge<wbr>Sites<wbr>Properties<wbr>Global<wbr>Communications<wbr>Site</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#edgesitename_csharp" style="color: inherit; text-decoration: inherit;">Edge<wbr>Site<wbr>Name</a>
    ...
    <dd>Edge site name.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#globalcommunicationssite_go" style="color: inherit; text-decoration: inherit;">Global<wbr>Communications<wbr>Site</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#edgesitespropertiesglobalcommunicationssite">Edge<wbr>Sites<wbr>Properties<wbr>Global<wbr>Communications<wbr>Site<wbr>Args</a></span>
    </dt>
    <dd>A reference to global communications site.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#globalcommunicationssite_java" style="color: inherit; text-decoration: inherit;">global<wbr>Communications<wbr>Site</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#edgesitespropertiesglobalcommunicationssite">Edge<wbr>Sites<wbr>Properties<wbr>Global<wbr>Communications<wbr>Site</a></span>
    </dt>
    <dd>A reference to global communications site.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#globalcommunicationssite_yaml" style="color: inherit; text-decoration: inherit;">global<wbr>Communications<wbr>Site</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#edgesitespropertiesglobalcommunicationssite">Property Map</a></span>
    </dt>
    <dd>A reference to global communications site.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the EdgeSite resource produces the following output properties:
...
<h4 id="edgesitespropertiesglobalcommunicationssite">
Edge<wbr>Sites<wbr>Properties<wbr>Global<wbr>Communications<wbr>Site<pulumi-choosable type="language" values="python,go" class="inline">, Edge<wbr>Sites<wbr>Properties<wbr>Global<wbr>Communications<wbr>Site<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="edgesitespropertiesresponseglobalcommunicationssite">
Edge<wbr>Sites<wbr>Properties<wbr>Response<wbr>Global<wbr>Communications<wbr>Site<pulumi-choosable type="language" values="python,go" class="inline">, Edge<wbr>Sites<wbr>Properties<wbr>Response<wbr>Global<wbr>Communications<wbr>Site<wbr>Args</pulumi-choosable>
</h4>
