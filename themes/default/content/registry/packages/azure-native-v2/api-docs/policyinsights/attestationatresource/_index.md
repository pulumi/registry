...
## Create AttestationAtResource Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAttestationAtResource</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">AttestationAtResourceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AttestationAtResource</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">AttestationAtResource</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AttestationAtResourceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">AttestationAtResource</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AttestationAtResourceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:policyinsights:AttestationAtResource</span><span class="p"></span>
...
```csharp
var attestationAtResourceResource = new AzureNative.PolicyInsights.AttestationAtResource("attestationAtResourceResource", new()
{
...
```go
example, err := policyinsights.NewAttestationAtResource(ctx, "attestationAtResourceResource", &policyinsights.AttestationAtResourceArgs{
...
```java
var attestationAtResourceResource = new AttestationAtResource("attestationAtResourceResource", AttestationAtResourceArgs.builder()
    .policyAssignmentId("string")
    .resourceId("string")
    .assessmentDate("string")
    .attestationName("string")
...
```python
attestation_at_resource_resource = azure_native.policyinsights.AttestationAtResource("attestationAtResourceResource",
...
```typescript
const attestationAtResourceResource = new azure_native.policyinsights.AttestationAtResource("attestationAtResourceResource", {
    policyAssignmentId: "string",
    resourceId: "string",
    assessmentDate: "string",
    attestationName: "string",
...
The AttestationAtResource resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
