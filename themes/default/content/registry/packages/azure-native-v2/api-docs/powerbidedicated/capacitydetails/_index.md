...
## Create CapacityDetails Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewCapacityDetails</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">CapacityDetailsArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">CapacityDetails</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">CapacityDetails</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CapacityDetailsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">CapacityDetails</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CapacityDetailsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:powerbidedicated:CapacityDetails</span><span class="p"></span>
...
The CapacityDetails resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#capacitysku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>BIDedicated.<wbr>Inputs.<wbr>Capacity<wbr>Sku</a></span>
    </dt>
    <dd>The SKU of the PowerBI Dedicated capacity resource.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#administration_csharp" style="color: inherit; text-decoration: inherit;">Administration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedcapacityadministrators">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>BIDedicated.<wbr>Inputs.<wbr>Dedicated<wbr>Capacity<wbr>Administrators</a></span>
    </dt>
    <dd>A collection of Dedicated capacity administrators</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dedicatedcapacityname_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Capacity<wbr>Name</a>
    ...
    <dd>The name of the Dedicated capacity. It must be a minimum of 3 characters, and a maximum of 63.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>Specifies the generation of the Power BI Embedded capacity. If no value is specified, the default value 'Gen2' is used. <a href="https://docs.microsoft.com/power-bi/developer/embedded/power-bi-embedded-generation-2">Learn More</a></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sku_yaml" style="color: inherit; text-decoration: inherit;">sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#capacitysku">Property Map</a></span>
    </dt>
    <dd>The SKU of the PowerBI Dedicated capacity resource.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#administration_yaml" style="color: inherit; text-decoration: inherit;">administration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedcapacityadministrators">Property Map</a></span>
    </dt>
    <dd>A collection of Dedicated capacity administrators</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mode_yaml" style="color: inherit; text-decoration: inherit;">mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#mode">&#34;Gen1&#34; | &#34;Gen2&#34;</a></span>
    </dt>
    <dd>Specifies the generation of the Power BI Embedded capacity. If no value is specified, the default value 'Gen2' is used. <a href="https://docs.microsoft.com/power-bi/developer/embedded/power-bi-embedded-generation-2">Learn More</a></dd><dt class="property-optional"
            title="Optional">
...
<h4 id="capacitysku">
Capacity<wbr>Sku<pulumi-choosable type="language" values="python,go" class="inline">, Capacity<wbr>Sku<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tier_yaml" style="color: inherit; text-decoration: inherit;">tier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#capacityskutier">&#34;PBIE_Azure&#34; | &#34;Premium&#34; | &#34;Auto<wbr>Premium<wbr>Host&#34;</a></span>
    </dt>
    <dd>The name of the Azure pricing tier to which the SKU applies.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="capacityskuresponse">
Capacity<wbr>Sku<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Capacity<wbr>Sku<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="capacityskutier">
Capacity<wbr>Sku<wbr>Tier<pulumi-choosable type="language" values="python,go" class="inline">, Capacity<wbr>Sku<wbr>Tier<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="dedicatedcapacityadministrators">
Dedicated<wbr>Capacity<wbr>Administrators<pulumi-choosable type="language" values="python,go" class="inline">, Dedicated<wbr>Capacity<wbr>Administrators<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="dedicatedcapacityadministratorsresponse">
Dedicated<wbr>Capacity<wbr>Administrators<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Dedicated<wbr>Capacity<wbr>Administrators<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
