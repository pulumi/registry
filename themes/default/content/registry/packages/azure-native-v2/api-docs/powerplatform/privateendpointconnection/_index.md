...
title_tag: "azure-native.powerplatform.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.powerplatform.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:powerplatform:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromPowerplatform = new AzureNative.PowerPlatform.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromPowerplatform", new()
{
...
```go
example, err := powerplatform.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromPowerplatform", &powerplatform.PrivateEndpointConnectionArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromPowerplatform = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromPowerplatform", PrivateEndpointConnectionArgs.builder()
    .enterprisePolicyName("string")
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_powerplatform = azure_native.powerplatform.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromPowerplatform",
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromPowerplatform = new azure_native.powerplatform.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromPowerplatform", {
    enterprisePolicyName: "string",
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterprisepolicyname_csharp" style="color: inherit; text-decoration: inherit;">Enterprise<wbr>Policy<wbr>Name</a>
    ...
    <dd>EnterprisePolicy for the Microsoft Azure subscription.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>Platform.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#privateendpointserviceconnectionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>Platform.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</a></span>
    </dt>
