...
title_tag: "azure-native.redisenterprise.AccessPolicyAssignment"
meta_desc: "Documentation for the azure-native.redisenterprise.AccessPolicyAssignment resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">AccessPolicyAssignment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">user</span><span class="p">:</span> <span class="nx">Optional[AccessPolicyAssignmentPropertiesUserArgs]</span> = None<span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:redisenterprise:AccessPolicyAssignment</span><span class="p"></span>
...
```java
var azure_nativeAccessPolicyAssignmentResource = new AccessPolicyAssignment("azure-nativeAccessPolicyAssignmentResource", AccessPolicyAssignmentArgs.builder()
    .accessPolicyName("string")
    .clusterName("string")
    .databaseName("string")
    .resourceGroupName("string")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accesspolicyname_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Policy<wbr>Name</a>
    ...
    <dd>Name of access policy under specific access policy assignment. Only &quot;default&quot; policy is supported for now.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_csharp" style="color: inherit; text-decoration: inherit;">User</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accesspolicyassignmentpropertiesuser">Pulumi.<wbr>Azure<wbr>Native.<wbr>Redis<wbr>Enterprise.<wbr>Inputs.<wbr>Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>User</a></span>
    </dt>
    <dd>The user associated with the access policy.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accesspolicyassignmentname_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Policy<wbr>Assignment<wbr>Name</a>
    ...
    <dd>The name of the Redis Enterprise database access policy assignment.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_go" style="color: inherit; text-decoration: inherit;">User</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accesspolicyassignmentpropertiesuser">Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>User<wbr>Args</a></span>
    </dt>
    <dd>The user associated with the access policy.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_java" style="color: inherit; text-decoration: inherit;">user</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accesspolicyassignmentpropertiesuser">Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>User</a></span>
    </dt>
    <dd>The user associated with the access policy.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_yaml" style="color: inherit; text-decoration: inherit;">user</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accesspolicyassignmentpropertiesuser">Property Map</a></span>
    </dt>
    <dd>The user associated with the access policy.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<h4 id="accesspolicyassignmentpropertiesresponseuser">
Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>User<pulumi-choosable type="language" values="python,go" class="inline">, Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>Response<wbr>User<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="accesspolicyassignmentpropertiesuser">
Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>User<pulumi-choosable type="language" values="python,go" class="inline">, Access<wbr>Policy<wbr>Assignment<wbr>Properties<wbr>User<wbr>Args</pulumi-choosable>
</h4>
