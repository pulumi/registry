...
title_tag: "azure-native.resources.DeploymentAtScope"
meta_desc: "Documentation for the azure-native.resources.DeploymentAtScope resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create DeploymentAtScope Resource {#create}
...
<span class="k">def </span><span class="nx">DeploymentAtScope</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">DeploymentAtScopeArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewDeploymentAtScope</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">DeploymentAtScopeArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">DeploymentAtScope</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">DeploymentAtScope</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DeploymentAtScopeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">DeploymentAtScope</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">DeploymentAtScopeArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:resources:DeploymentAtScope</span><span class="p"></span>
...
```csharp
var deploymentAtScopeResource = new AzureNative.Resources.DeploymentAtScope("deploymentAtScopeResource", new()
{
    Properties = new AzureNative.Resources.Inputs.DeploymentPropertiesArgs
    {
        Mode = AzureNative.Resources.DeploymentMode.Incremental,
...
```go
example, err := resources.NewDeploymentAtScope(ctx, "deploymentAtScopeResource", &resources.DeploymentAtScopeArgs{
	Properties: &resources.DeploymentPropertiesArgs{
		Mode: resources.DeploymentModeIncremental,
...
```java
var deploymentAtScopeResource = new DeploymentAtScope("deploymentAtScopeResource", DeploymentAtScopeArgs.builder()
    .properties(DeploymentPropertiesArgs.builder()
        .mode("Incremental")
...
```python
deployment_at_scope_resource = azure_native.resources.DeploymentAtScope("deploymentAtScopeResource",
    properties={
        "mode": azure_native.resources.DeploymentMode.INCREMENTAL,
        "debug_setting": {
            "detail_level": "string",
...
```typescript
const deploymentAtScopeResource = new azure_native.resources.DeploymentAtScope("deploymentAtScopeResource", {
    properties: {
        mode: azure_native.resources.DeploymentMode.Incremental,
        debugSetting: {
            detailLevel: "string",
...
The DeploymentAtScope resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>The deployment properties.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scope_csharp" style="color: inherit; text-decoration: inherit;">Scope</a>
    ...
    <dd>The resource scope.</dd><dt class="property-optional property-replacement"
            title="Optional">
