...
title_tag: "azure-native.securityandcompliance.PrivateEndpointConnectionsForSCCPowershell"
meta_desc: "Documentation for the azure-native.securityandcompliance.PrivateEndpointConnectionsForSCCPowershell resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create PrivateEndpointConnectionsForSCCPowershell Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPrivateEndpointConnectionsForSCCPowershell</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">PrivateEndpointConnectionsForSCCPowershellArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PrivateEndpointConnectionsForSCCPowershell</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">PrivateEndpointConnectionsForSCCPowershell</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateEndpointConnectionsForSCCPowershellArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">PrivateEndpointConnectionsForSCCPowershell</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateEndpointConnectionsForSCCPowershellArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityandcompliance:PrivateEndpointConnectionsForSCCPowershell</span><span class="p"></span>
...
```csharp
var azure_nativePrivateEndpointConnectionsForSCCPowershellResource = new AzureNative.SecurityAndCompliance.PrivateEndpointConnectionsForSCCPowershell("azure-nativePrivateEndpointConnectionsForSCCPowershellResource", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.SecurityAndCompliance.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := securityandcompliance.NewPrivateEndpointConnectionsForSCCPowershell(ctx, "azure-nativePrivateEndpointConnectionsForSCCPowershellResource", &securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs{
	PrivateLinkServiceConnectionState: &securityandcompliance.PrivateLinkServiceConnectionStateArgs{
...
```java
var azure_nativePrivateEndpointConnectionsForSCCPowershellResource = new PrivateEndpointConnectionsForSCCPowershell("azure-nativePrivateEndpointConnectionsForSCCPowershellResource", PrivateEndpointConnectionsForSCCPowershellArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
azure_native_private_endpoint_connections_for_scc_powershell_resource = azure_native.securityandcompliance.PrivateEndpointConnectionsForSCCPowershell("azure-nativePrivateEndpointConnectionsForSCCPowershellResource",
    private_link_service_connection_state={
...
```typescript
const azure_nativePrivateEndpointConnectionsForSCCPowershellResource = new azure_native.securityandcompliance.PrivateEndpointConnectionsForSCCPowershell("azure-nativePrivateEndpointConnectionsForSCCPowershellResource", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
...
The PrivateEndpointConnectionsForSCCPowershell resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
