...
---
title: "PrivateLinkServicesForM365ComplianceCenter"
...
## Create PrivateLinkServicesForM365ComplianceCenter Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">PrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">PrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                               <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PrivateLinkServicesForM365ComplianceCenter</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">PrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">PrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">PrivateLinkServicesForM365ComplianceCenter</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityandcompliance:PrivateLinkServicesForM365ComplianceCenter</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">PrivateLinkServicesForM365ComplianceCenterArgs</a></span>
    </dt>
...
```csharp
var azure_nativePrivateLinkServicesForM365ComplianceCenterResource = new AzureNative.SecurityAndCompliance.PrivateLinkServicesForM365ComplianceCenter("azure-nativePrivateLinkServicesForM365ComplianceCenterResource", new()
{
...
```go
example, err := securityandcompliance.NewPrivateLinkServicesForM365ComplianceCenter(ctx, "azure-nativePrivateLinkServicesForM365ComplianceCenterResource", &securityandcompliance.PrivateLinkServicesForM365ComplianceCenterArgs{
...
```java
var azure_nativePrivateLinkServicesForM365ComplianceCenterResource = new PrivateLinkServicesForM365ComplianceCenter("azure-nativePrivateLinkServicesForM365ComplianceCenterResource", PrivateLinkServicesForM365ComplianceCenterArgs.builder()
    .kind("fhir")
    .resourceGroupName("string")
    .identity(ServicesResourceIdentityArgs.builder()
        .type("string")
...
```python
azure_native_private_link_services_for_m365_compliance_center_resource = azure_native.securityandcompliance.PrivateLinkServicesForM365ComplianceCenter("azure-nativePrivateLinkServicesForM365ComplianceCenterResource",
...
```typescript
const azure_nativePrivateLinkServicesForM365ComplianceCenterResource = new azure_native.securityandcompliance.PrivateLinkServicesForM365ComplianceCenter("azure-nativePrivateLinkServicesForM365ComplianceCenterResource", {
    kind: azure_native.securityandcompliance.Kind.Fhir,
    resourceGroupName: "string",
    identity: {
        type: "string",
...
## PrivateLinkServicesForM365ComplianceCenter Resource Properties {#properties}
...
The PrivateLinkServicesForM365ComplianceCenter resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicesresourceidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Security<wbr>And<wbr>Compliance.<wbr>Inputs.<wbr>Services<wbr>Resource<wbr>Identity</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicesproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Security<wbr>And<wbr>Compliance.<wbr>Inputs.<wbr>Services<wbr>Properties</a></span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the PrivateLinkServicesForM365ComplianceCenter resource produces the following output properties:
