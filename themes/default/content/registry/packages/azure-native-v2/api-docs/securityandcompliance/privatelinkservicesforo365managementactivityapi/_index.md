...
## Create PrivateLinkServicesForO365ManagementActivityAPI Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPrivateLinkServicesForO365ManagementActivityAPI</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">PrivateLinkServicesForO365ManagementActivityAPIArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PrivateLinkServicesForO365ManagementActivityAPI</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">PrivateLinkServicesForO365ManagementActivityAPI</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForO365ManagementActivityAPIArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">PrivateLinkServicesForO365ManagementActivityAPI</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">PrivateLinkServicesForO365ManagementActivityAPIArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityandcompliance:PrivateLinkServicesForO365ManagementActivityAPI</span><span class="p"></span>
...
```csharp
var azure_nativePrivateLinkServicesForO365ManagementActivityAPIResource = new AzureNative.SecurityAndCompliance.PrivateLinkServicesForO365ManagementActivityAPI("azure-nativePrivateLinkServicesForO365ManagementActivityAPIResource", new()
{
...
```go
example, err := securityandcompliance.NewPrivateLinkServicesForO365ManagementActivityAPI(ctx, "azure-nativePrivateLinkServicesForO365ManagementActivityAPIResource", &securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIArgs{
...
```java
var azure_nativePrivateLinkServicesForO365ManagementActivityAPIResource = new PrivateLinkServicesForO365ManagementActivityAPI("azure-nativePrivateLinkServicesForO365ManagementActivityAPIResource", PrivateLinkServicesForO365ManagementActivityAPIArgs.builder()
    .kind("fhir")
    .resourceGroupName("string")
    .identity(ServicesResourceIdentityArgs.builder()
        .type("string")
...
```python
azure_native_private_link_services_for_o365_management_activity_api_resource = azure_native.securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPI("azure-nativePrivateLinkServicesForO365ManagementActivityAPIResource",
...
```typescript
const azure_nativePrivateLinkServicesForO365ManagementActivityAPIResource = new azure_native.securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPI("azure-nativePrivateLinkServicesForO365ManagementActivityAPIResource", {
    kind: azure_native.securityandcompliance.Kind.Fhir,
    resourceGroupName: "string",
    identity: {
        type: "string",
...
The PrivateLinkServicesForO365ManagementActivityAPI resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
