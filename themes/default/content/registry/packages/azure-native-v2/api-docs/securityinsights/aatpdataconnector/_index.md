...
## Create AATPDataConnector Resource {#create}
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAATPDataConnector</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">AATPDataConnectorArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AATPDataConnector</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">AATPDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AATPDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">AATPDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AATPDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityinsights:AATPDataConnector</span><span class="p"></span>
...
```csharp
var aatpdataConnectorResource = new AzureNative.SecurityInsights.AATPDataConnector("aatpdataConnectorResource", new()
{
    Kind = "string",
...
```go
example, err := securityinsights.NewAATPDataConnector(ctx, "aatpdataConnectorResource", &securityinsights.AATPDataConnectorArgs{
...
```java
var aatpdataConnectorResource = new AATPDataConnector("aatpdataConnectorResource", AATPDataConnectorArgs.builder()
    .kind("string")
    .resourceGroupName("string")
    .workspaceName("string")
    .dataConnectorId("string")
...
```python
aatpdata_connector_resource = azure_native.securityinsights.AATPDataConnector("aatpdataConnectorResource",
    kind="string",
...
```typescript
const aatpdataConnectorResource = new azure_native.securityinsights.AATPDataConnector("aatpdataConnectorResource", {
    kind: "string",
    resourceGroupName: "string",
    workspaceName: "string",
    dataConnectorId: "string",
...
The AATPDataConnector resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
