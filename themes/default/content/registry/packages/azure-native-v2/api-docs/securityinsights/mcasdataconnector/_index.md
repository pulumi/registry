...
## Create MCASDataConnector Resource {#create}
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">MCASDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">MCASDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">MCASDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">MCASDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityinsights:MCASDataConnector</span><span class="p"></span>
...
var mcasdataConnectorResource = new AzureNative.SecurityInsights.MCASDataConnector("mcasdataConnectorResource", new()
{
    ...
    DataTypes = new AzureNative.SecurityInsights.Inputs.MCASDataConnectorDataTypesArgs
    {
        Alerts = new AzureNative.SecurityInsights.Inputs.DataConnectorDataTypeCommonArgs
        {
            State = "string",
        },
        DiscoveryLogs = new AzureNative.SecurityInsights.Inputs.DataConnectorDataTypeCommonArgs
        {
            State = "string",
        },
    },
...
example, err := securityinsights.NewMCASDataConnector(ctx, "mcasdataConnectorResource", &securityinsights.MCASDataConnectorArgs{
	...
	DataTypes: &securityinsights.MCASDataConnectorDataTypesArgs{
		Alerts: &securityinsights.DataConnectorDataTypeCommonArgs{
			State: pulumi.String("string"),
		},
		DiscoveryLogs: &securityinsights.DataConnectorDataTypeCommonArgs{
			State: pulumi.String("string"),
		},
	},
...
var mcasdataConnectorResource = new MCASDataConnector("mcasdataConnectorResource", MCASDataConnectorArgs.builder()
    ...
    .workspaceName("string")
    .dataConnectorId("string")
    .dataTypes(MCASDataConnectorDataTypesArgs.builder()
        .alerts(DataConnectorDataTypeCommonArgs.builder()
            .state("string")
            .build())
        .discoveryLogs(DataConnectorDataTypeCommonArgs.builder()
            .state("string")
            .build())
        .build())
    .tenantId("string")
...
The MCASDataConnector resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatypes_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mcasdataconnectordatatypes">Pulumi.<wbr>Azure<wbr>Native.<wbr>Security<wbr>Insights.<wbr>Inputs.<wbr>MCASData<wbr>Connector<wbr>Data<wbr>Types</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatypes_java" style="color: inherit; text-decoration: inherit;">data<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mcasdataconnectordatatypes">MCASData<wbr>Connector<wbr>Data<wbr>Types</a></span>
    </dt>
    <dd>The available data types for the connector.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatypes_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mcasdataconnectordatatypes">Property Map</a></span>
    </dt>
    <dd>The available data types for the connector.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="mcasdataconnectordatatypes">
MCASData<wbr>Connector<wbr>Data<wbr>Types<pulumi-choosable type="language" values="python,go" class="inline">, MCASData<wbr>Connector<wbr>Data<wbr>Types<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="mcasdataconnectordatatypesresponse">
MCASData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, MCASData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
