...
## Create TIDataConnector Resource {#create}
...
<span class="k">def </span><span class="nx">TIDataConnector</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">tip_lookback_period</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewTIDataConnector</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">TIDataConnectorArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">TIDataConnector</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">TIDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">TIDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">TIDataConnector</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">TIDataConnectorArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityinsights:TIDataConnector</span><span class="p"></span>
...
The TIDataConnector resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatypes_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypes">Pulumi.<wbr>Azure<wbr>Native.<wbr>Security<wbr>Insights.<wbr>Inputs.<wbr>TIData<wbr>Connector<wbr>Data<wbr>Types</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenantid_csharp" style="color: inherit; text-decoration: inherit;">Tenant<wbr>Id</a>
    ...
    <dd>The tenant id to connect to, and get the data from.</dd><dt class="property-optional"
            title="Optional">
        <span id="tiplookbackperiod_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tiplookbackperiod_csharp" style="color: inherit; text-decoration: inherit;">Tip<wbr>Lookback<wbr>Period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The lookback period for the feed to be imported.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tiplookbackperiod_go" style="color: inherit; text-decoration: inherit;">Tip<wbr>Lookback<wbr>Period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenantid_java" style="color: inherit; text-decoration: inherit;">tenant<wbr>Id</a>
    ...
    <dd>The tenant id to connect to, and get the data from.</dd><dt class="property-optional"
            title="Optional">
        <span id="tiplookbackperiod_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tiplookbackperiod_java" style="color: inherit; text-decoration: inherit;">tip<wbr>Lookback<wbr>Period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tiplookbackperiod_nodejs" style="color: inherit; text-decoration: inherit;">tip<wbr>Lookback<wbr>Period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tip_lookback_period_python" style="color: inherit; text-decoration: inherit;">tip_<wbr>lookback_<wbr>period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datatypes_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypes">Property Map</a></span>
    </dt>
    <dd>The available data types for the connector.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenantid_yaml" style="color: inherit; text-decoration: inherit;">tenant<wbr>Id</a>
    ...
    <dd>The tenant id to connect to, and get the data from.</dd><dt class="property-optional"
            title="Optional">
        <span id="tiplookbackperiod_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tiplookbackperiod_yaml" style="color: inherit; text-decoration: inherit;">tip<wbr>Lookback<wbr>Period</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<h4 id="tidataconnectordatatypes">
TIData<wbr>Connector<wbr>Data<wbr>Types<pulumi-choosable type="language" values="python,go" class="inline">, TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_csharp" style="color: inherit; text-decoration: inherit;">Indicators</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>Data type for indicators connection.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_go" style="color: inherit; text-decoration: inherit;">Indicators</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="indicators_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_java" style="color: inherit; text-decoration: inherit;">indicators</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypesindicators">TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Indicators</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_nodejs" style="color: inherit; text-decoration: inherit;">indicators</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypesindicators">TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Indicators</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_python" style="color: inherit; text-decoration: inherit;">indicators</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypesindicators">TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Indicators</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="indicators_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_yaml" style="color: inherit; text-decoration: inherit;">indicators</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypesindicators">Property Map</a></span>
    </dt>
    <dd>Data type for indicators connection.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="tidataconnectordatatypesindicators">
TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Indicators<pulumi-choosable type="language" values="python,go" class="inline">, TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Indicators<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="tidataconnectordatatypesresponse">
TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#indicators_yaml" style="color: inherit; text-decoration: inherit;">indicators</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tidataconnectordatatypesresponseindicators">Property Map</a></span>
    </dt>
    <dd>Data type for indicators connection.</dd></dl>
</pulumi-choosable>
</div>

<h4 id="tidataconnectordatatypesresponseindicators">
TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<wbr>Indicators<pulumi-choosable type="language" values="python,go" class="inline">, TIData<wbr>Connector<wbr>Data<wbr>Types<wbr>Response<wbr>Indicators<wbr>Args</pulumi-choosable>
</h4>
