...
---
title: "Ueba"
title_tag: "azure-native.securityinsights.Ueba"
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">data_sources</span><span class="p">:</span> <span class="nx">Optional[Sequence[Union[str, UebaDataSources]]]</span> = None<span class="p">,</span>
         <span class="nx">settings_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewUeba</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Ueba</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">Ueba</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">UebaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:securityinsights:Ueba</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">UebaArgs</a></span>
    </dt>
...
```csharp
var uebaResource = new AzureNative.SecurityInsights.Ueba("uebaResource", new()
{
    Kind = "string",
...
```go
example, err := securityinsights.NewUeba(ctx, "uebaResource", &securityinsights.UebaArgs{
...
```java
var uebaResource = new Ueba("uebaResource", UebaArgs.builder()
    .kind("string")
    .resourceGroupName("string")
    .workspaceName("string")
    .dataSources("string")
...
```python
ueba_resource = azure_native.securityinsights.Ueba("uebaResource",
    kind="string",
...
```typescript
const uebaResource = new azure_native.securityinsights.Ueba("uebaResource", {
    kind: "string",
    resourceGroupName: "string",
    workspaceName: "string",
    dataSources: ["string"],
...
## Ueba Resource Properties {#properties}
...
The Ueba resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datasources_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Union&lt;string, Pulumi.<wbr>Azure<wbr>Native.<wbr>Security<wbr>Insights.<wbr>Ueba<wbr>Data<wbr>Sources&gt;&gt;</span>
    </dt>
    <dd>The relevant data sources that enriched by ueba</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="settingsname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settingsname_csharp" style="color: inherit; text-decoration: inherit;">Settings<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>The setting name. Supports - Anomalies, EyesOn, EntityAnalytics, Ueba</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settingsname_go" style="color: inherit; text-decoration: inherit;">Settings<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datasources_java" style="color: inherit; text-decoration: inherit;">data<wbr>Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Either&lt;String,Ueba<wbr>Data<wbr>Sources&gt;&gt;</span>
    </dt>
    <dd>The relevant data sources that enriched by ueba</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="settingsname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settingsname_java" style="color: inherit; text-decoration: inherit;">settings<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settingsname_nodejs" style="color: inherit; text-decoration: inherit;">settings<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#data_sources_python" style="color: inherit; text-decoration: inherit;">data_<wbr>sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[Union[str, Ueba<wbr>Data<wbr>Sources]]</span>
    </dt>
    <dd>The relevant data sources that enriched by ueba</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="settings_name_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settings_name_python" style="color: inherit; text-decoration: inherit;">settings_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#datasources_yaml" style="color: inherit; text-decoration: inherit;">data<wbr>Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;String | &#34;Audit<wbr>Logs&#34; | &#34;Azure<wbr>Activity&#34; | &#34;Security<wbr>Event&#34; | &#34;Signin<wbr>Logs&#34;&gt;</span>
    </dt>
    <dd>The relevant data sources that enriched by ueba</dd><dt class="property-optional property-replacement"
            title="Optional">
        <span id="settingsname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#settingsname_yaml" style="color: inherit; text-decoration: inherit;">settings<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the Ueba resource produces the following output properties:
...
<h4 id="uebadatasources">
Ueba<wbr>Data<wbr>Sources<pulumi-choosable type="language" values="python,go" class="inline">, Ueba<wbr>Data<wbr>Sources<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Audit<wbr>Logs</dt>
    <dd>AuditLogs</dd><dt>Azure<wbr>Activity</dt>
    <dd>AzureActivity</dd><dt>Security<wbr>Event</dt>
    <dd>SecurityEvent</dd><dt>Signin<wbr>Logs</dt>
    <dd>SigninLogs</dd></dl>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Ueba<wbr>Data<wbr>Sources<wbr>Audit<wbr>Logs</dt>
    <dd>AuditLogs</dd><dt>Ueba<wbr>Data<wbr>Sources<wbr>Azure<wbr>Activity</dt>
    <dd>AzureActivity</dd><dt>Ueba<wbr>Data<wbr>Sources<wbr>Security<wbr>Event</dt>
    <dd>SecurityEvent</dd><dt>Ueba<wbr>Data<wbr>Sources<wbr>Signin<wbr>Logs</dt>
    <dd>SigninLogs</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="tabular"><dt>AUDIT_LOGS</dt>
    <dd>AuditLogs</dd><dt>AZURE_ACTIVITY</dt>
    <dd>AzureActivity</dd><dt>SECURITY_EVENT</dt>
    <dd>SecurityEvent</dd><dt>SIGNIN_LOGS</dt>
    <dd>SigninLogs</dd></dl>
</pulumi-choosable>
</div>
