...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:servicebus:NamespaceAuthorizationRule</span><span class="p"></span>
...
```csharp
var examplenamespaceAuthorizationRuleResourceResourceFromServicebus = new AzureNative.ServiceBus.NamespaceAuthorizationRule("examplenamespaceAuthorizationRuleResourceResourceFromServicebus", new()
{
    NamespaceName = "string",
    ResourceGroupName = "string",
    Rights = new[]
    {
        AzureNative.ServiceBus.AccessRights.Manage,
    },
...
```go
example, err := servicebus.NewNamespaceAuthorizationRule(ctx, "examplenamespaceAuthorizationRuleResourceResourceFromServicebus", &servicebus.NamespaceAuthorizationRuleArgs{
	NamespaceName:     pulumi.String("string"),
	ResourceGroupName: pulumi.String("string"),
	Rights: servicebus.AccessRightsArray{
		servicebus.AccessRightsManage,
	},
...
```java
var examplenamespaceAuthorizationRuleResourceResourceFromServicebus = new NamespaceAuthorizationRule("examplenamespaceAuthorizationRuleResourceResourceFromServicebus", NamespaceAuthorizationRuleArgs.builder()
    .namespaceName("string")
    .resourceGroupName("string")
    .rights("Manage")
    .authorizationRuleName("string")
...
```python
examplenamespace_authorization_rule_resource_resource_from_servicebus = azure_native.servicebus.NamespaceAuthorizationRule("examplenamespaceAuthorizationRuleResourceResourceFromServicebus",
    namespace_name="string",
    resource_group_name="string",
    rights=[azure_native.servicebus.AccessRights.MANAGE],
...
```typescript
const examplenamespaceAuthorizationRuleResourceResourceFromServicebus = new azure_native.servicebus.NamespaceAuthorizationRule("examplenamespaceAuthorizationRuleResourceResourceFromServicebus", {
    namespaceName: "string",
    resourceGroupName: "string",
    rights: [azure_native.servicebus.AccessRights.Manage],
    authorizationRuleName: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rights_java" style="color: inherit; text-decoration: inherit;">rights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessrights">List&lt;Access<wbr>Rights&gt;</a></span>
    </dt>
    <dd>The rights associated with the rule.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rights_yaml" style="color: inherit; text-decoration: inherit;">rights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessrights">List&lt;&#34;Manage&#34; | &#34;Send&#34; | &#34;Listen&#34;&gt;</a></span>
    </dt>
    <dd>The rights associated with the rule.</dd><dt class="property-optional property-replacement"
            title="Optional">
