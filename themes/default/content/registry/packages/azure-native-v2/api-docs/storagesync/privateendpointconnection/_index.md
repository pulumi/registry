...
title_tag: "azure-native.storagesync.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.storagesync.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:storagesync:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromStoragesync = new AzureNative.StorageSync.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromStoragesync", new()
{
    PrivateLinkServiceConnectionState = new AzureNative.StorageSync.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := storagesync.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromStoragesync", &storagesync.PrivateEndpointConnectionArgs{
	PrivateLinkServiceConnectionState: &storagesync.PrivateLinkServiceConnectionStateArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromStoragesync = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromStoragesync", PrivateEndpointConnectionArgs.builder()
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
        .status("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_storagesync = azure_native.storagesync.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromStoragesync",
    private_link_service_connection_state={
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromStoragesync = new azure_native.storagesync.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromStoragesync", {
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
        status: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Storage<wbr>Sync.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#storagesyncservicename_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Sync<wbr>Service<wbr>Name</a>
    ...
    <dd>The name of the storage sync service name within the specified resource group.</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#privateendpointserviceconnectionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Storage<wbr>Sync.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</a></span>
    </dt>
