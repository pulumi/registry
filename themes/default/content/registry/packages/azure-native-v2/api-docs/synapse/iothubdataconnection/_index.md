...
<span class="k">def </span><span class="nx">IotHubDataConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                         ...
                         <span class="nx">data_format</span><span class="p">:</span> <span class="nx">Optional[Union[str, IotHubDataFormat]]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:synapse:IotHubDataConnection</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sharedaccesspolicyname_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Access<wbr>Policy<wbr>Name</a>
    ...
    <dd>The name of the share access policy</dd><dt class="property-required property-replacement"
            title="Required">
