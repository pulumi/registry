...
---
title: "KustoPoolDatabasePrincipalAssignment"
title_tag: "azure-native.synapse.KustoPoolDatabasePrincipalAssignment"
meta_desc: "Documentation for the azure-native.synapse.KustoPoolDatabasePrincipalAssignment resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create KustoPoolDatabasePrincipalAssignment Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">KustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">KustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                         <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p">,</span>
...
<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewKustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">KustoPoolDatabasePrincipalAssignment</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">KustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">KustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">KustoPoolDatabasePrincipalAssignment</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:synapse:KustoPoolDatabasePrincipalAssignment</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">KustoPoolDatabasePrincipalAssignmentArgs</a></span>
    </dt>
...
```csharp
var kustoPoolDatabasePrincipalAssignmentResource = new AzureNative.Synapse.KustoPoolDatabasePrincipalAssignment("kustoPoolDatabasePrincipalAssignmentResource", new()
{
    DatabaseName = "string",
...
```go
example, err := synapse.NewKustoPoolDatabasePrincipalAssignment(ctx, "kustoPoolDatabasePrincipalAssignmentResource", &synapse.KustoPoolDatabasePrincipalAssignmentArgs{
...
```java
var kustoPoolDatabasePrincipalAssignmentResource = new KustoPoolDatabasePrincipalAssignment("kustoPoolDatabasePrincipalAssignmentResource", KustoPoolDatabasePrincipalAssignmentArgs.builder()
    .databaseName("string")
    .kustoPoolName("string")
    .principalId("string")
    .principalType("string")
...
```python
kusto_pool_database_principal_assignment_resource = azure_native.synapse.KustoPoolDatabasePrincipalAssignment("kustoPoolDatabasePrincipalAssignmentResource",
...
```typescript
const kustoPoolDatabasePrincipalAssignmentResource = new azure_native.synapse.KustoPoolDatabasePrincipalAssignment("kustoPoolDatabasePrincipalAssignmentResource", {
    databaseName: "string",
    kustoPoolName: "string",
    principalId: "string",
    principalType: "string",
...
## KustoPoolDatabasePrincipalAssignment Resource Properties {#properties}
...
The KustoPoolDatabasePrincipalAssignment resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#principalid_csharp" style="color: inherit; text-decoration: inherit;">Principal<wbr>Id</a>
    ...
    <dd>The principal ID assigned to the database principal. It can be a user email, application ID, or security group name.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#role_csharp" style="color: inherit; text-decoration: inherit;">Role</a>
    ...
    <dd>Database principal role.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#role_yaml" style="color: inherit; text-decoration: inherit;">role</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#databaseprincipalrole">&#34;Admin&#34; | &#34;Ingestor&#34; | &#34;Monitor&#34; | &#34;User&#34; | &#34;Unrestricted<wbr>Viewer&#34; | &#34;Viewer&#34;</a></span>
    </dt>
    <dd>Database principal role.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the KustoPoolDatabasePrincipalAssignment resource produces the following output properties:
...
<h4 id="databaseprincipalrole">
Database<wbr>Principal<wbr>Role<pulumi-choosable type="language" values="python,go" class="inline">, Database<wbr>Principal<wbr>Role<wbr>Args</pulumi-choosable>
</h4>
