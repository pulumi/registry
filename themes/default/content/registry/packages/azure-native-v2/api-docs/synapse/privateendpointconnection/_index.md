...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:synapse:PrivateEndpointConnection</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
    ...
    <dd>The private endpoint which the connection belongs to.</dd></dl>
</pulumi-choosable>
</div>
