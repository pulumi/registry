...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:synapse:ReadWriteDatabase</span><span class="p"></span>
...
```csharp
var azure_nativeReadWriteDatabaseResource = new AzureNative.Synapse.ReadWriteDatabase("azure-nativeReadWriteDatabaseResource", new()
{
    Kind = "string",
...
```go
example, err := synapse.NewReadWriteDatabase(ctx, "azure-nativeReadWriteDatabaseResource", &synapse.ReadWriteDatabaseArgs{
...
```java
var azure_nativeReadWriteDatabaseResource = new ReadWriteDatabase("azure-nativeReadWriteDatabaseResource", ReadWriteDatabaseArgs.builder()
    .kind("string")
    .kustoPoolName("string")
    .resourceGroupName("string")
    .workspaceName("string")
...
```python
azure_native_read_write_database_resource = azure_native.synapse.ReadWriteDatabase("azure-nativeReadWriteDatabaseResource",
    kind="string",
...
```typescript
const azure_nativeReadWriteDatabaseResource = new azure_native.synapse.ReadWriteDatabase("azure-nativeReadWriteDatabaseResource", {
    kind: "string",
    kustoPoolName: "string",
    resourceGroupName: "string",
    workspaceName: "string",
