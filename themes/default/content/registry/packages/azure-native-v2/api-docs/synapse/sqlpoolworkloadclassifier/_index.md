...
## Create SqlPoolWorkloadClassifier Resource {#create}
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:synapse:SqlPoolWorkloadClassifier</span><span class="p"></span>
...
The SqlPoolWorkloadClassifier resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#workloadclassifiername_csharp" style="color: inherit; text-decoration: inherit;">Workload<wbr>Classifier<wbr>Name</a>
    ...
    <dd>The name of the workload classifier.</dd></dl>
</pulumi-choosable>
</div>
