...
title_tag: "azure-native.testbase.ImageDefinition"
meta_desc: "Documentation for the azure-native.testbase.ImageDefinition resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create ImageDefinition Resource {#create}
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
...
<span class="k">def </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span>
<span></span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                    <span class="nx">architecture</span><span class="p">:</span> <span class="nx">Optional[Union[str, ImageArchitecture]]</span> = None<span class="p">,</span>
                    <span class="nx">os_state</span><span class="p">:</span> <span class="nx">Optional[Union[str, ImageOSState]]</span> = None<span class="p">,</span>
                    <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">security_type</span><span class="p">:</span> <span class="nx">Optional[Union[str, ImageSecurityType]]</span> = None<span class="p">,</span>
                    <span class="nx">test_base_account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">image_definition_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewImageDefinition</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ImageDefinition</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">ImageDefinition</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ImageDefinitionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:testbase:ImageDefinition</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ImageDefinitionArgs</a></span>
    </dt>
...
example, err := testbase.NewImageDefinition(ctx, "imageDefinitionResource", &testbase.ImageDefinitionArgs{
	...
	ImageDefinitionName: pulumi.String("string"),
})
```
...
## ImageDefinition Resource Properties {#properties}
...
The ImageDefinition resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_csharp" style="color: inherit; text-decoration: inherit;">Architecture</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imagearchitecture">Pulumi.<wbr>Azure<wbr>Native.<wbr>Test<wbr>Base.<wbr>Image<wbr>Architecture</a></span>
    </dt>
    <dd>Custom image architecture.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#osstate_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imageosstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Test<wbr>Base.<wbr>Image<wbr>OSState</a></span>
    </dt>
    <dd>Custom image OS state.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitytype_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imagesecuritytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Test<wbr>Base.<wbr>Image<wbr>Security<wbr>Type</a></span>
    </dt>
    <dd>Custom image security type.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#imagedefinitionname_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Definition<wbr>Name</a>
    ...
    <dd>The resource name of the test base image definition.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_go" style="color: inherit; text-decoration: inherit;">Architecture</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imagearchitecture">Image<wbr>Architecture</a></span>
    </dt>
    <dd>Custom image architecture.</dd><dt class="property-required"
            title="Required">
        <span id="osstate_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#osstate_go" style="color: inherit; text-decoration: inherit;">Os<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imageosstate">Image<wbr>OSState</a></span>
    </dt>
    <dd>Custom image OS state.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitytype_go" style="color: inherit; text-decoration: inherit;">Security<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#imagesecuritytype">Image<wbr>Security<wbr>Type</a></span>
    </dt>
    <dd>Custom image security type.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_python" style="color: inherit; text-decoration: inherit;">architecture</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#imagearchitecture">Image<wbr>Architecture</a></span>
    </dt>
    <dd>Custom image architecture.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#os_state_python" style="color: inherit; text-decoration: inherit;">os_<wbr>state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#imageosstate">Image<wbr>OSState</a></span>
    </dt>
    <dd>Custom image OS state.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#security_type_python" style="color: inherit; text-decoration: inherit;">security_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#imagesecuritytype">Image<wbr>Security<wbr>Type</a></span>
    </dt>
    <dd>Custom image security type.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#architecture_yaml" style="color: inherit; text-decoration: inherit;">architecture</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#imagearchitecture">&#34;x64&#34;</a></span>
    </dt>
    <dd>Custom image architecture.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#osstate_yaml" style="color: inherit; text-decoration: inherit;">os<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#imageosstate">&#34;Generalized&#34; | &#34;Specialized&#34;</a></span>
    </dt>
    <dd>Custom image OS state.</dd><dt class="property-required property-replacement"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#securitytype_yaml" style="color: inherit; text-decoration: inherit;">security<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#imagesecuritytype">&#34;Standard&#34; | &#34;Trusted<wbr>Launch&#34;</a></span>
    </dt>
    <dd>Custom image security type.</dd><dt class="property-required property-replacement"
            title="Required">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ImageDefinition resource produces the following output properties:
...
<h4 id="imagearchitecture">
Image<wbr>Architecture<pulumi-choosable type="language" values="python,go" class="inline">, Image<wbr>Architecture<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>X64</dt>
    <dd>x6464-bit architecture.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Image<wbr>Architecture<wbr>X64</dt>
    <dd>x6464-bit architecture.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="imageosstate">
Image<wbr>OSState<pulumi-choosable type="language" values="python,go" class="inline">, Image<wbr>OSState<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Generalized</dt>
    <dd>GeneralizedSysprep generalization processed.</dd><dt>Specialized</dt>
    <dd>SpecializedFully kept with user specified settings.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Image<wbr>OSState<wbr>Generalized</dt>
    <dd>GeneralizedSysprep generalization processed.</dd><dt>Image<wbr>OSState<wbr>Specialized</dt>
    <dd>SpecializedFully kept with user specified settings.</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="imagesecuritytype">
Image<wbr>Security<wbr>Type<pulumi-choosable type="language" values="python,go" class="inline">, Image<wbr>Security<wbr>Type<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Standard</dt>
    <dd>StandardStandard security type.</dd><dt>Trusted<wbr>Launch</dt>
    <dd>TrustedLaunchSpecify higher security level compared to Standard.</dd></dl>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Image<wbr>Security<wbr>Type<wbr>Standard</dt>
    <dd>StandardStandard security type.</dd><dt>Image<wbr>Security<wbr>Type<wbr>Trusted<wbr>Launch</dt>
    <dd>TrustedLaunchSpecify higher security level compared to Standard.</dd></dl>
</pulumi-choosable>
</div>
...
<pulumi-choosable type="language" values="python">
<dl class="tabular"><dt>STANDARD</dt>
    <dd>StandardStandard security type.</dd><dt>TRUSTED_LAUNCH</dt>
    <dd>TrustedLaunchSpecify higher security level compared to Standard.</dd></dl>
</pulumi-choosable>
</div>
