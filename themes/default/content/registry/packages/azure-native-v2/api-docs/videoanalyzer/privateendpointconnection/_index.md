...
title_tag: "azure-native.videoanalyzer.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.videoanalyzer.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:videoanalyzer:PrivateEndpointConnection</span><span class="p"></span>
...
```csharp
var exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer = new AzureNative.VideoAnalyzer.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer", new()
{
    AccountName = "string",
    PrivateLinkServiceConnectionState = new AzureNative.VideoAnalyzer.Inputs.PrivateLinkServiceConnectionStateArgs
    {
...
```go
example, err := videoanalyzer.NewPrivateEndpointConnection(ctx, "exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer", &videoanalyzer.PrivateEndpointConnectionArgs{
...
```java
var exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer = new PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer", PrivateEndpointConnectionArgs.builder()
    .accountName("string")
    .privateLinkServiceConnectionState(PrivateLinkServiceConnectionStateArgs.builder()
        .actionsRequired("string")
        .description("string")
...
```python
exampleprivate_endpoint_connection_resource_resource_from_videoanalyzer = azure_native.videoanalyzer.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer",
    account_name="string",
    private_link_service_connection_state={
...
```typescript
const exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer = new azure_native.videoanalyzer.PrivateEndpointConnection("exampleprivateEndpointConnectionResourceResourceFromVideoanalyzer", {
    accountName: "string",
    privateLinkServiceConnectionState: {
        actionsRequired: "string",
        description: "string",
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#accountname_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Name</a>
    ...
    <dd>The Video Analyzer account name.</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Video<wbr>Analyzer.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#privateendpointserviceconnectionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Video<wbr>Analyzer.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</a></span>
    </dt>
