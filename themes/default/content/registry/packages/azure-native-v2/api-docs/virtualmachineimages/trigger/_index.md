...
---
title: "Trigger"
title_tag: "azure-native.virtualmachineimages.Trigger"
meta_desc: "Documentation for the azure-native.virtualmachineimages.Trigger resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:virtualmachineimages:Trigger</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>The kind of trigger.</dd><dt class="property-required property-replacement"
            title="Required">
...
<h4 id="triggerstatusresponse">
Trigger<wbr>Status<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Trigger<wbr>Status<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
