...
## Create StaticSite Resource {#create}
...
<span class="k">def </span><span class="nx">StaticSite</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">enterprise_grade_cdn_status</span><span class="p">:</span> <span class="nx">Optional[Union[str, EnterpriseGradeCdnStatus]]</span> = None<span class="p">,</span>
               ...
               <span class="nx">template_properties</span><span class="p">:</span> <span class="nx">Optional[StaticSiteTemplateOptionsArgs]</span> = None<span class="p">)</span></code></pre></div>
</div></pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="go">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewStaticSite</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">StaticSiteArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">StaticSite</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">StaticSite</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">StaticSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">StaticSite</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">StaticSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:web:StaticSite</span><span class="p"></span>
...
The StaticSite resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowconfigfileupdates_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Config<wbr>File<wbr>Updates</a>
    ...
    <dd><!-- raw HTML omitted -->false<!-- raw HTML omitted --> if config file is locked for this static web app; otherwise, <!-- raw HTML omitted -->true<!-- raw HTML omitted -->.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#branch_csharp" style="color: inherit; text-decoration: inherit;">Branch</a>
    ...
    <dd>The target branch in the repository.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildproperties_csharp" style="color: inherit; text-decoration: inherit;">Build<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticsitebuildproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Static<wbr>Site<wbr>Build<wbr>Properties</a></span>
    </dt>
    <dd>Build properties to configure on the repository.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterprisegradecdnstatus_csharp" style="color: inherit; text-decoration: inherit;">Enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#enterprisegradecdnstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a></span>
    </dt>
    <dd>State indicating the status of the enterprise grade CDN serving traffic to the static web app.</dd><dt class="property-optional"
            title="Optional">
        <span id="identity_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managedserviceidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Managed<wbr>Service<wbr>Identity</a></span>
    </dt>
    <dd>Managed service identity.</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>Name of the static site to create or update.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provider_csharp" style="color: inherit; text-decoration: inherit;">Provider</a>
    ...
    <dd>The provider that submitted the last deployment to the primary environment of the static site.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#publicnetworkaccess_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access</a>
    ...
    <dd>State indicating whether public traffic are allowed or not for a static web app. Allowed Values: 'Enabled', 'Disabled' or an empty string.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositorytoken_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Token</a>
    ...
    <dd>A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repositoryurl_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Url</a>
    ...
    <dd>URL for the repository of the static site.</dd><dt class="property-optional"
            title="Optional">
        <span id="sku_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stagingenvironmentpolicy_csharp" style="color: inherit; text-decoration: inherit;">Staging<wbr>Environment<wbr>Policy</a>
    ...
    <dd>State indicating whether staging environments are allowed or not allowed for a static web app.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#templateproperties_csharp" style="color: inherit; text-decoration: inherit;">Template<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticsitetemplateoptions">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Static<wbr>Site<wbr>Template<wbr>Options</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterprisegradecdnstatus_go" style="color: inherit; text-decoration: inherit;">Enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#enterprisegradecdnstatus">Enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a></span>
    </dt>
    <dd>State indicating the status of the enterprise grade CDN serving traffic to the static web app.</dd><dt class="property-optional"
            title="Optional">
        <span id="identity_go">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterprise_grade_cdn_status_python" style="color: inherit; text-decoration: inherit;">enterprise_<wbr>grade_<wbr>cdn_<wbr>status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#enterprisegradecdnstatus">Enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a></span>
    </dt>
    <dd>State indicating the status of the enterprise grade CDN serving traffic to the static web app.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buildproperties_yaml" style="color: inherit; text-decoration: inherit;">build<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticsitebuildproperties">Property Map</a></span>
    </dt>
    <dd>Build properties to configure on the repository.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#enterprisegradecdnstatus_yaml" style="color: inherit; text-decoration: inherit;">enterprise<wbr>Grade<wbr>Cdn<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">String | <a href="#enterprisegradecdnstatus">&#34;Enabled&#34; | &#34;Enabling&#34; | &#34;Disabled&#34; | &#34;Disabling&#34;</a></span>
    </dt>
    <dd>State indicating the status of the enterprise grade CDN serving traffic to the static web app.</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#stagingenvironmentpolicy_yaml" style="color: inherit; text-decoration: inherit;">staging<wbr>Environment<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#stagingenvironmentpolicy">&#34;Enabled&#34; | &#34;Disabled&#34;</a></span>
    </dt>
    <dd>State indicating whether staging environments are allowed or not allowed for a static web app.</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_yaml">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#templateproperties_yaml" style="color: inherit; text-decoration: inherit;">template<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticsitetemplateoptions">Property Map</a></span>
    </dt>
    <dd>Template options for generating a new repository.</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#userprovidedfunctionapps_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Provided<wbr>Function<wbr>Apps</a>
    ...
    <dd>User provided function apps registered with the static site</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="armplanresponse">
Arm<wbr>Plan<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Arm<wbr>Plan<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="databaseconnectionoverviewresponse">
Database<wbr>Connection<wbr>Overview<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Database<wbr>Connection<wbr>Overview<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="enterprisegradecdnstatus">
Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<pulumi-choosable type="language" values="python,go" class="inline">, Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<wbr>Args</pulumi-choosable>
</h4>

<div>
<pulumi-choosable type="language" values="csharp">
<dl class="tabular"><dt>Enabled</dt>
    <dd>Enabled</dd><dt>Enabling</dt>
    <dd>Enabling</dd><dt>Disabled</dt>
...
<div>
<pulumi-choosable type="language" values="go">
<dl class="tabular"><dt>Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<wbr>Enabled</dt>
    <dd>Enabled</dd><dt>Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<wbr>Enabling</dt>
    <dd>Enabling</dd><dt>Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<wbr>Disabled</dt>
    <dd>Disabled</dd><dt>Enterprise<wbr>Grade<wbr>Cdn<wbr>Status<wbr>Disabling</dt>
    <dd>Disabling</dd></dl>
</pulumi-choosable>
</div>
...
<h4 id="errorentityresponse">
Error<wbr>Entity<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Error<wbr>Entity<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="responsemessageenveloperemoteprivateendpointconnectionresponse">
Response<wbr>Message<wbr>Envelope<wbr>Remote<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Response<wbr>Message<wbr>Envelope<wbr>Remote<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="stagingenvironmentpolicy">
Staging<wbr>Environment<wbr>Policy<pulumi-choosable type="language" values="python,go" class="inline">, Staging<wbr>Environment<wbr>Policy<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsitebuildproperties">
Static<wbr>Site<wbr>Build<wbr>Properties<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>Build<wbr>Properties<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsitebuildpropertiesresponse">
Static<wbr>Site<wbr>Build<wbr>Properties<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>Build<wbr>Properties<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsitelinkedbackendresponse">
Static<wbr>Site<wbr>Linked<wbr>Backend<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>Linked<wbr>Backend<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsitetemplateoptions">
Static<wbr>Site<wbr>Template<wbr>Options<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>Template<wbr>Options<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsitetemplateoptionsresponse">
Static<wbr>Site<wbr>Template<wbr>Options<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>Template<wbr>Options<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="staticsiteuserprovidedfunctionappresponse">
Static<wbr>Site<wbr>User<wbr>Provided<wbr>Function<wbr>App<wbr>Response<pulumi-choosable type="language" values="python,go" class="inline">, Static<wbr>Site<wbr>User<wbr>Provided<wbr>Function<wbr>App<wbr>Response<wbr>Args</pulumi-choosable>
</h4>
