...
title_tag: "azure-native.web.WebAppAuthSettingsSlot"
meta_desc: "Documentation for the azure-native.web.WebAppAuthSettingsSlot resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create WebAppAuthSettingsSlot Resource {#create}
...
<span class="k">def </span><span class="nx">WebAppAuthSettingsSlot</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WebAppAuthSettingsSlotArgs</a></span><span class="p">,</span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWebAppAuthSettingsSlot</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">WebAppAuthSettingsSlotArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WebAppAuthSettingsSlot</span>, error)</span></code></pre></div>
</div></pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">WebAppAuthSettingsSlot</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WebAppAuthSettingsSlotArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">WebAppAuthSettingsSlot</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">WebAppAuthSettingsSlotArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div></div>
</pulumi-choosable>
</div>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">azure-native:web:WebAppAuthSettingsSlot</span><span class="p"></span>
...
```csharp
var webAppAuthSettingsSlotResource = new AzureNative.Web.WebAppAuthSettingsSlot("webAppAuthSettingsSlotResource", new()
{
    Name = "string",
    Slot = "string",
...
```go
example, err := web.NewWebAppAuthSettingsSlot(ctx, "webAppAuthSettingsSlotResource", &web.WebAppAuthSettingsSlotArgs{
...
```java
var webAppAuthSettingsSlotResource = new WebAppAuthSettingsSlot("webAppAuthSettingsSlotResource", WebAppAuthSettingsSlotArgs.builder()
    .name("string")
    .slot("string")
    .resourceGroupName("string")
    .googleClientId("string")
...
```python
web_app_auth_settings_slot_resource = azure_native.web.WebAppAuthSettingsSlot("webAppAuthSettingsSlotResource",
    name="string",
    slot="string",
...
```typescript
const webAppAuthSettingsSlotResource = new azure_native.web.WebAppAuthSettingsSlot("webAppAuthSettingsSlotResource", {
    name: "string",
    slot: "string",
    resourceGroupName: "string",
    googleClientId: "string",
...
The WebAppAuthSettingsSlot resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#defaultprovider_yaml" style="color: inherit; text-decoration: inherit;">default<wbr>Provider</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#builtinauthenticationprovider">&#34;Azure<wbr>Active<wbr>Directory&#34; | &#34;Facebook&#34; | &#34;Google&#34; | &#34;Microsoft<wbr>Account&#34; | &#34;Twitter&#34; | &#34;Github&#34;</a></span>
    </dt>
    <dd>The default authentication provider to use when multiple providers are configured.
This setting is only needed if multiple providers are configured and the unauthenticated client
action is set to &quot;RedirectToLoginPage&quot;.</dd><dt class="property-optional"
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#unauthenticatedclientaction_yaml" style="color: inherit; text-decoration: inherit;">unauthenticated<wbr>Client<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#unauthenticatedclientaction">&#34;Redirect<wbr>To<wbr>Login<wbr>Page&#34; | &#34;Allow<wbr>Anonymous&#34;</a></span>
    </dt>
    <dd>The action to take when an unauthenticated client attempts to access the app.</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="builtinauthenticationprovider">
Built<wbr>In<wbr>Authentication<wbr>Provider<pulumi-choosable type="language" values="python,go" class="inline">, Built<wbr>In<wbr>Authentication<wbr>Provider<wbr>Args</pulumi-choosable>
</h4>
...
<h4 id="unauthenticatedclientaction">
Unauthenticated<wbr>Client<wbr>Action<pulumi-choosable type="language" values="python,go" class="inline">, Unauthenticated<wbr>Client<wbr>Action<wbr>Args</pulumi-choosable>
</h4>
