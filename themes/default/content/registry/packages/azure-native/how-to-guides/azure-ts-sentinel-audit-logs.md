---
title: "Pulumi Cloud Audit Logs Connector for Microsoft Sentinel | TypeScript"
h1: "Pulumi Cloud Audit Logs Connector for Microsoft Sentinel"
linktitle: "Pulumi Cloud Audit Logs Connector for Microsoft Sentinel"
meta_desc: "Pulumi Cloud Audit Logs Connector for Microsoft Sentinel How-to Guide using TypeScript"
...
<p class="mb-4 inline-flex items-center">
    <a class="rounded-md font-display text-lg text-white bg-white border-2 border-blue-600 px-3 mr-2 whitespace-no-wrap hover:text-white" style="height: 45px; line-height: 41px;" href="https://github.com/pulumi/examples/tree/master/azure-ts-sentinel-audit-logs" target="_blank">
