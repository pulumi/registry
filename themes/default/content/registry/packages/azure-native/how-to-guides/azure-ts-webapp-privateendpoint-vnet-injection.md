...
<p class="mb-4 inline-flex items-center">
    <a class="btn btn-primary no-underline mr-2" href="https://github.com/pulumi/examples/tree/master/azure-ts-webapp-privateendpoint-vnet-injection" target="_blank">
