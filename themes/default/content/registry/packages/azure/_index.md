...
layout: overview
aliases:
    - "/docs/intro/cloud-providers/azure-classic/"
---
...
The Azure provider accepts the following configuration settings.  These can be provided to the default Azure provider via `pulumi config set azure:<option>`, or passed to the constructor of [Provider]({{< relref "/registry/packages/azure/api-docs/provider" >}}) to construct a specific instance of the Azure provider.
