...
<p class="mb-4 flex">
    ...
    <a href="https://app.pulumi.com/new?template=https://github.com/pulumi/examples/blob/master/classic-azure-ts-aks-multicluster/README.md#gh-dark-mode-only" target="_blank">
