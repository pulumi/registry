...
<p class="mb-4 inline-flex items-center">
    <a class="btn btn-primary no-underline mr-2" href="https://github.com/pulumi/examples/tree/master/classic-azure-ts-serverless-url-shortener-global" target="_blank">
