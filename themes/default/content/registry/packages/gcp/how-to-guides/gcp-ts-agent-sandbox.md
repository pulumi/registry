...
<p class="mb-4 inline-flex items-center">
    <a class="btn btn-primary no-underline mr-2 h-[46px] gap-2" href="https://github.com/pulumi/examples/tree/master/gcp-ts-agent-sandbox" target="_blank">
        <i class="fab fa-github"></i>
        <span>View Code</span>
    </a>
    <a href="https://app.pulumi.com/new?template=https://github.com/pulumi/examples/blob/master/gcp-ts-agent-sandbox/README.md" target="_blank">
