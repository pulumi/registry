...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">Chart</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ChartArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">Chart</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">ChartArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">ComponentResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:helm.sh/v3:Chart</span><span class="p"></span>
...
The Chart resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<p>Required if specifying <code>ChartOpts</code> for a remote chart.</p>
            ...
            title="Optional">
        <span id="fetchopts_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fetchopts_java" style="color: inherit; text-decoration: inherit;">fetch<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fetchopts">Fetch<wbr>Opts<wbr>Args</a></span>
    </dt>
...
<p>Required if specifying <code>ChartOpts</code> for a remote chart.</p>
            ...
            title="Optional">
        <span id="fetchopts_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fetchopts_yaml" style="color: inherit; text-decoration: inherit;">fetch<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fetchopts">Property Map</a></span>
    </dt>
    <dd><p>Additional options to customize the fetching of the Helm chart.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#devel_java" style="color: inherit; text-decoration: inherit;">devel</a>
    ...
    <dd><p>Use development versions, too. Equivalent to version '&gt;0.0.0-0'. If –version is set, this is ignored.</p>
            ...
            title="Optional">
        <span id="home_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#home_java" style="color: inherit; text-decoration: inherit;">home</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#password_java" style="color: inherit; text-decoration: inherit;">password</a>
    ...
    <dd><p>Chart repository password.</p>
            ...
            title="Optional">
        <span id="prov_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prov_java" style="color: inherit; text-decoration: inherit;">prov</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repo_java" style="color: inherit; text-decoration: inherit;">repo</a>
    ...
    <dd><p>Chart repository url where to locate the requested chart.</p>
            ...
            title="Optional">
        <span id="untar_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#untar_java" style="color: inherit; text-decoration: inherit;">untar</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
    <dd><p>If set to false, will leave the chart as a tarball after downloading.</p>
            ...
            title="Optional">
        <span id="untardir_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#untardir_java" style="color: inherit; text-decoration: inherit;">untardir</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#devel_yaml" style="color: inherit; text-decoration: inherit;">devel</a>
    ...
    <dd><p>Use development versions, too. Equivalent to version '&gt;0.0.0-0'. If –version is set, this is ignored.</p>
            ...
            title="Optional">
        <span id="home_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#home_yaml" style="color: inherit; text-decoration: inherit;">home</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#password_yaml" style="color: inherit; text-decoration: inherit;">password</a>
    ...
    <dd><p>Chart repository password.</p>
            ...
            title="Optional">
        <span id="prov_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prov_yaml" style="color: inherit; text-decoration: inherit;">prov</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repo_yaml" style="color: inherit; text-decoration: inherit;">repo</a>
    ...
    <dd><p>Chart repository url where to locate the requested chart.</p>
            ...
            title="Optional">
        <span id="untar_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#untar_yaml" style="color: inherit; text-decoration: inherit;">untar</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
    <dd><p>If set to false, will leave the chart as a tarball after downloading.</p>
            ...
            title="Optional">
        <span id="untardir_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#untardir_yaml" style="color: inherit; text-decoration: inherit;">untardir</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
