...
## Does Pulumi Cloud see my credentials in the kubeconfig file?
...
stored as part of the state history of rollouts -- but they are considered opaque state by 
Pulumi Cloud. Pulumi Cloud **never** uses these values for any reason whatsoever.
...
## Does Pulumi Cloud see my cloud provider credentials?
