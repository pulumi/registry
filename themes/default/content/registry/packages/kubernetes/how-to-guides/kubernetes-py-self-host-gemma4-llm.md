---
title: "Self-Host Gemma 4 with Open WebUI and Tailscale | Python"
h1: "Self-Host Gemma 4 with Open WebUI and Tailscale"
linktitle: "Self-Host Gemma 4 with Open WebUI and Tailscale"
meta_desc: "Self-Host Gemma 4 with Open WebUI and Tailscale How-to Guide using Python"
...
<p class="mb-4 inline-flex items-center">
    <a class="rounded-md font-display text-lg text-white bg-white border-2 border-blue-600 px-3 mr-2 whitespace-no-wrap hover:text-white" style="height: 45px; line-height: 41px;" href="https://github.com/pulumi/examples/tree/master/kubernetes-py-self-host-gemma4-llm" target="_blank">
        <span class="flex items-center">
            <i class="fab fa-github pr-1.5"></i>
            <span>View Code</span>
        </span>
    </a>
    <a href="https://app.pulumi.com/new?template=https://github.com/pulumi/examples/blob/master/kubernetes-py-self-host-gemma4-llm/README.md" target="_blank">
