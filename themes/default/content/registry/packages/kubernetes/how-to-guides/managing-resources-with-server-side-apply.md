...
2. Use the [ignoreChanges resource option](/docs/concepts/resources/options/ignorechanges/) to skip the update
...
Pulumi provides a way to ignore changes for particular fields using the [ignoreChanges resource option](/docs/concepts/resources/options/ignorechanges/).
