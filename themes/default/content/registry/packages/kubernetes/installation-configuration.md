...
Note: Pulumi **never** sends **any** authentication [secrets](/docs/intro/concepts/secrets/) or credentials to Pulumi Cloud.
...
Each Kubernetes resource managed by Pulumi will have a link in the [Pulumi Cloud console](https://app.pulumi.com")
