---
title: Random Installation & Configuration
meta_desc: |
    Installation & Configuration for infrastructure as code in the Pulumi Random package
layout: installation
---
...
* Java: [`com.pulumi.random`](https://search.maven.org/search?q=com.pulumi.random)
