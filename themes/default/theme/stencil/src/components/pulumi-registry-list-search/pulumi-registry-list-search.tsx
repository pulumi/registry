...
export class PulumiRegistryListSearch {
    ...
    render() {
        const filterIcon = (
            <svg class="search-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true">
        ...
        const clearIcon = (
            <svg class="clear-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true">
            ...
            <div class="input-container">
                ...
                {this.filterContent && (
                    <div class="clear-container">
                        <button onClick={this.onClearFilter.bind(this)} class="clear-filter-button" aria-label="Clear filter">
                            {clearIcon}
                        </button>
                    </div>
                )}
