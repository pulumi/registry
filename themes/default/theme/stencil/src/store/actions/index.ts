import { SetLanguage, SetK8sLanguage, SetOS, SetCloud, SetPersona, SetBackEnd, SetPythonToolchain, SetConfigSource } from "./preferences";
...
export enum TypeKeys {
    ...
    SET_CONFIGSOURCE = "SET_CONFIGSOURCE",
...
export type PreferencesAction = SetLanguage | SetK8sLanguage | SetOS | SetCloud | SetPersona | SetBackEnd | SetPythonToolchain | SetConfigSource;
