...
meta_desc: "Create and manage foo-bar.submodule1.ModuleResource with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;foo-bar_submodule1_module_resource&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
```hcl
resource "foo-bar_submodule1_module_resource" "moduleResourceResource" {
  lifecycle {
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="thing_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#thing_hcl" style="color: inherit; text-decoration: inherit;">thing</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#toplevel">object</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="buzz_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buzz_hcl" style="color: inherit; text-decoration: inherit;">buzz</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
