...
meta_desc: "Create and manage example.myModule.IamResource with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#config_hcl" style="color: inherit; text-decoration: inherit;">config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#auditconfig">object</a></span>
    </dt>
    <dd>This type is defined in the <a href="/registry/packages/google-native">Google Cloud Native</a> package.</dd></dl>
</pulumi-choosable>
</div>
