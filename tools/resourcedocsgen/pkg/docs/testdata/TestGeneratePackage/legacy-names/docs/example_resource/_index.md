...
meta_desc: "Create and manage legacy_names.Example_resource with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;legacy_names_example_resource&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="map_enum_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#map_enum_hcl" style="color: inherit; text-decoration: inherit;">map_<wbr>enum</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd></dd><dt class="property-optional"
            title="Optional">
        <span id="request__http_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#request__http_hcl" style="color: inherit; text-decoration: inherit;">request__<wbr>http</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#request">object</a></span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_hcl" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="good__ur_ls_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#good__ur_ls_hcl" style="color: inherit; text-decoration: inherit;">good__<wbr>ur_<wbr>ls</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">list(string)</span>
    </dt>
    <dd></dd><dt class="property-"
            title="">
        <span id="url_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#url_hcl" style="color: inherit; text-decoration: inherit;">url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="content_body_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#content_body_hcl" style="color: inherit; text-decoration: inherit;">content_<wbr>body</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
