...
---
title: "Resource"
title_tag: "foo.nested/module.Resource"
meta_desc: "Create and manage foo.nested/module.Resource with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">foo:nested/module:Resource</span><span class="p"></span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;foo_nested_module_resource&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
```hcl
resource "foo_nested_module_resource" "resourceResource" {
  lifecycle {
...
```yaml
type: foo:nested/module:Resource
properties:
    bar: string
```
