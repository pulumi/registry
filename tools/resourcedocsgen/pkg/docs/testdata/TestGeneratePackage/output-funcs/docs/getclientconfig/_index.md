...
<div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">data</span> <span class="s2">&#34;mypkg_get_client_config&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="client_id_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#client_id_hcl" style="color: inherit; text-decoration: inherit;">client_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Azure Client ID (Application Object ID).</dd><dt class="property-"
            title="">
        <span id="object_id_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_id_hcl" style="color: inherit; text-decoration: inherit;">object_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Azure Object ID of the current user or service principal.</dd><dt class="property-"
            title="">
        <span id="subscription_id_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subscription_id_hcl" style="color: inherit; text-decoration: inherit;">subscription_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>Azure Subscription ID</dd><dt class="property-"
            title="">
        <span id="tenant_id_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tenant_id_hcl" style="color: inherit; text-decoration: inherit;">tenant_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
