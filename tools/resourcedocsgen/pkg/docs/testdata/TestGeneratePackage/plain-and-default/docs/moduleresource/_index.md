...
meta_desc: "Create and manage foobar.ModuleResource with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
module_resource_resource = foobar.ModuleResource("moduleResourceResource",
    plain_required_bool=False,
    required_string="string",
    required_number=float(0),
    required_enum=foobar.EnumThing.FOUR,
    required_bool=False,
    plain_required_string="string",
    plain_required_number=float(0),
    plain_required_const="string",
    optional_string="string",
    plain_optional_string="string",
    plain_optional_number=float(0),
    plain_optional_const="string",
    plain_optional_bool=False,
    optional_bool=False,
    optional_number=float(0),
...
<dl class="tabular"><dt>Four</dt>
    <dd><code>4</code></dd><dt>Six</dt>
    <dd><code>6</code></dd><dt>Eight</dt>
