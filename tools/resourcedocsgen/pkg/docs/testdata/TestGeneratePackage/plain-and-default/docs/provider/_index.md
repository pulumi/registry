...
meta_desc: "Create and manage foobar.Provider with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">pulumi:providers:foobar</span><span class="p"></span>
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;pulumi_providers_foobar&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
