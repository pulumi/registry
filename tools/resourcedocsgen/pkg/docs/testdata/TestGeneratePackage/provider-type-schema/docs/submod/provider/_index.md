...
meta_desc: "Documentation for the providerType.submod.Provider resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
