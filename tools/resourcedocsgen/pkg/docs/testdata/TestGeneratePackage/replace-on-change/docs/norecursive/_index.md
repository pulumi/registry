...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;example_norecursive&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
```hcl
resource "example_norecursive" "noRecursiveResource" {
  replace_on_changes = ["replaceMe"]
}
```
