...
meta_desc: "Create and manage example.NoRecursive with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;example_no_recursive&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
```hcl
resource "example_no_recursive" "noRecursiveResource" {
  pulumi {
    replace_on_changes = [replace_me]
  }
  lifecycle {
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_hcl" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>The provider-assigned unique ID for this managed resource.</dd><dt class="property-"
            title="">
        <span id="rec_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rec_hcl" style="color: inherit; text-decoration: inherit;">rec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rec">object</a></span>
    </dt>
    <dd></dd><dt class="property- property-replacement"
            title="">
        <span id="replace_me_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replace_me_hcl" style="color: inherit; text-decoration: inherit;">replace_<wbr>me</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="rec1_hcl">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rec1_hcl" style="color: inherit; text-decoration: inherit;">rec1</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rec">object</a></span>
    </dt>
