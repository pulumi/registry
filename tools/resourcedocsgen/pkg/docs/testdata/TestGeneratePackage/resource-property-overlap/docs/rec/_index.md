...
meta_desc: "Create and manage example.Rec with Pulumi. Full API reference with input and output properties, lookup functions, and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="no-copy"><div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">resource</span> <span class="s2">&#34;example_rec&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rec_hcl" style="color: inherit; text-decoration: inherit;">rec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">example_<wbr>rec</span>
    </dt>
    <dd></dd></dl>
</pulumi-choosable>
</div>
