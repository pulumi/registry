...
meta_desc: "Use example.doFoo with Pulumi. Full API reference with input and output properties and examples in TypeScript, Python, Go, C#, Java, and YAML."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-hcl" data-lang="hcl"><span class="k">data</span> <span class="s2">&#34;example_do_foo&#34;</span> <span class="s2">&#34;name&#34;</span> <span class="p">{</span>
